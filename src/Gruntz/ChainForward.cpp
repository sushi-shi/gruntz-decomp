...
RVA(0x00114f50, 0x3e)
void ChainForward14(Utils::RegistryHelper* p1, CGruntzMgr* p2, i32 p3, i32 p4, char* p5, i32 p6) {
...
RVA(0x00114fa0, 0x3e)
void ChainForward(Utils::RegistryHelper* p1, CGruntzMgr* p2, i32 p3, i32 p4, char* p5, i32 p6) {
