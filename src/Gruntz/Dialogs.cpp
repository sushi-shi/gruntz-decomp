...
RVA(0x00015aa0, 0x6)
DATA_MESSAGE_MAP(0x001e88b0, 0x001e88b8)
BEGIN_MESSAGE_MAP(CBattlezDlg, CDialog)
    ...
    ON_WM_MEASUREITEM()
    ON_WM_DRAWITEM()
    ON_BN_CLICKED(CTRL_PLAYER_COLOR0, CBattlezDlg::OnPlayerColor0)
    ON_BN_CLICKED(CTRL_PLAYER_COLOR1, CBattlezDlg::OnPlayerColor1)
    ON_BN_CLICKED(CTRL_PLAYER_COLOR2, CBattlezDlg::OnPlayerColor2)
    ON_BN_CLICKED(CTRL_PLAYER_COLOR3, CBattlezDlg::OnPlayerColor3)
    ON_BN_CLICKED(0x42b, CBattlezDlg::ShowCustomDlg)
    ON_CBN_SELCHANGE(0x4ff, CBattlezDlg::OnWorldSelectionChange)
    ON_EN_KILLFOCUS(0x50a, CBattlezDlg::OnPlayerNameKillFocus0)
    ON_EN_KILLFOCUS(0x50b, CBattlezDlg::OnPlayerNameKillFocus1)
    ON_EN_KILLFOCUS(0x50c, CBattlezDlg::OnPlayerNameKillFocus2)
    ON_EN_KILLFOCUS(0x50d, CBattlezDlg::OnPlayerNameKillFocus3)
    ON_EN_CHANGE(0x50b, CBattlezDlg::OnPlayerNameChange1)
    ON_EN_CHANGE(0x50a, CBattlezDlg::OnPlayerNameChange0)
    ON_EN_CHANGE(0x50c, CBattlezDlg::OnPlayerNameChange2)
    ON_EN_CHANGE(0x50d, CBattlezDlg::OnPlayerNameChange3)
    ON_WM_PAINT()
    ...
    ON_CBN_SELCHANGE(CTRL_PLAYER_MAX_GRUNTZ3, CBattlezDlg::OnMaxGruntzSelection3)
END_MESSAGE_MAP()
