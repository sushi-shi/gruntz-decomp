...
RVA(0x000af1e0, 0xf4)
i32 CreateSpotLight(CGameObject* owner){LOGIC_WORKER_PUMP(CSpotLight)}

RVA(0x000af320, 0xf4)
i32 CreateKitchenSlime(CGameObject* owner){LOGIC_WORKER_PUMP(CKitchenSlime)}

RVA(0x000af460, 0xf4)
i32 CreatePathHazard(CGameObject* owner){LOGIC_WORKER_PUMP(CPathHazard)}

RVA(0x000af5a0, 0xf4)
i32 CreateRainCloud(CGameObject* owner){LOGIC_WORKER_PUMP(CRainCloud)}
