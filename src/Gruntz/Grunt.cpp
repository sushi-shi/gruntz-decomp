...
// ==== CGrunt::Load @0x0d8060 - NOT this TU (bookkeeping note, wave3-I) ====
// Its retail body's birth position is inside the play TU's 0xd5960 interval
// (TU_MIGRATION MOVE row `0x0d8060 Load@CGrunt grunt -> 0xd5960 play`). The move
// into Play.cpp is BLOCKED for now: Play.cpp cannot include <Gruntz/Grunt.h>
// (g_gameReg/g_coordPool/GruntBoard decl conflicts with its own header set -
// build-verified); it stays here pending the play-region partition package,
// which will reconcile those headers.
// ---------------------------------------------------------------------------
