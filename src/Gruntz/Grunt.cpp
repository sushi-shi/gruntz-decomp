...
// ==== CGrunt::Load @0x0d8060 -> MOVED to src/Gruntz/Play.cpp (wave3-J) ====
// Its retail body's birth position is inside the play TU's 0xd5960 interval
// (TU_MIGRATION MOVE row `0x0d8060 Load@CGrunt grunt -> 0xd5960 play`). The
// wave3-I header wall (Play.cpp could not include <Gruntz/Grunt.h>) is GONE:
// the g_gameReg extern moved out of Grunt.h to its consumers, so Play.cpp now
// includes Grunt.h cleanly (build-verified) and hosts the definition.
...
>>>>>>> 170eed989 (rehome(V2): dissolve CAnimNameResolver phantom onto canonical CTypeKeyColl)
