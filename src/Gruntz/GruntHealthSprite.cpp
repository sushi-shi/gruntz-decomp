...
RVA_DYNINIT(0x0007ecd0, 0xa, int)
RVA_DYNINIT(0x0007ecf0, 0x15, int)
RVA_DYNINIT(0x0007ed20, 0xe, int)
RVA_DYNINIT(0x0007ed40, 0x1f, int)
...
i32 CGruntHealthSprite::SetHealthGlyph(i32 x, i32 y, i32 health) {
    ...
    i32 slot = 0x15
               - static_cast<i32>(
                    ...
                    * DATA_COMPGEN(0x001e9a98, 0.2) + DATA_COMPGEN(0x001e9aa0, 0.5)));
