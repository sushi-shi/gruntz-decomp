...
void CKitchenSlime::LoadSprites()
{
    ...
    for (int i = 0; i <= 4; ) {
        ...
        int sw = lvl->m_124 - 1;
        switch (sw) {
        case 0:  tileX = m_80;        tileY = m_84 - 0x20; break;  // north
        case 1:  tileX = m_80 + 0x20; tileY = m_84;        break;  // east
        case 2:  tileX = m_80;        tileY = m_84 + 0x20; break;  // south
        case 3:  tileX = m_80 - 0x20; tileY = m_84;        break;  // west
        }
        ...
        if (tileY >= lvl->m_138 && tileX <= lvl->m_13c &&
            tileY <= lvl->m_140 && tileX >= lvl->m_134 &&
    ...
    case 0:  // north
        ...
        m_70 = 0; m_78 = 0; *(int *)&m_78 = 0;
        *((int *)&m_70 + 1) = 0;
        *((int *)&m_78 + 1) = 0xbff00000;
        if (changed) m_38->CacheFirstFrame("LEVEL_KITCHENSLIME_NORTH");
        break;
    case 1:  // east
        *(int *)&m_60 = m_88;
        ...
        *((int *)&m_78 + 1) = 0;
        if (changed) m_38->CacheFirstFrame("LEVEL_KITCHENSLIME_EAST");
        break;
    case 2:  // south
        *(int *)&m_68 = m_88;
        ...
        *((int *)&m_70 + 1) = 0;
        if (changed) m_38->CacheFirstFrame("LEVEL_KITCHENSLIME_SOUTH");
        break;
    case 3:  // west
        ...
        *((int *)&m_78 + 1) = 0;
        if (changed) m_38->CacheFirstFrame("LEVEL_KITCHENSLIME_WEST");
        break;
    }
