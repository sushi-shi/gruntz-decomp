...
// 0x15abxx list/map methods + CreateObject_159600 live in src/DDrawMgr/DDrawSubMgr.cpp.
...
// CWwdObjMgr is the shared <Gruntz/WwdObjMgr.h> class (the parent file handle at
