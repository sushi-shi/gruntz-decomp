...
#include <Gruntz/GameLevel.h> // CGameLevel (m_world->m_level) + CDDrawWorkerHost // CGruntzMgr / CWorldZ / CGameLevel (m_world->m_level) / CGruntzMapMgr
#include <Wwd/WwdFile.h> // CDDrawWorkerHost (the world plane; m_tileGrid / m_colOffsets height grid)
#include <rva.h>
