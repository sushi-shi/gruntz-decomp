...
// archetype shared with CBehindCandy::GetTypeTag (0x00fb70), defined INLINE in the
// class body (retail keeps one deduped COMDAT copy). Owner hints noted per entry.
...
public:
    RVA(0x0000fa40, 0x6)
    LogicTypeId GetTypeTag() { return LOGIC_TAG_3EF; }
};
...
public:
    RVA(0x00010f00, 0x6)
    LogicTypeId GetTypeTag() { return LOGIC_TAG_429; }
};
...
public:
    RVA(0x00011bf0, 0x6)
    LogicTypeId GetTypeTag() { return LOGIC_TAG_428; }
};
...
public:
    RVA(0x00012ff0, 0x6)
    LogicTypeId GetTypeTag() { return LOGIC_TAG_41D; }
};
