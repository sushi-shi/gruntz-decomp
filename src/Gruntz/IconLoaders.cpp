...
struct CSpriteFactory {
    CSprite *CreateSprite(int kind, int geoB, int geoA, int hint,
...
public:
    int LoadPowerupIconSprites(int type, int geoB, int geoA,
                               int m130, int warpIdx, int m120);
...
RVA(0x07c620, 0x3c5)
int EngineLabelBacklog::LoadPowerupIconSprites(int type, int geoB, int geoA,
                                               int m130, int warpIdx, int m120)
{
    if (type == 0)
        return 0;
    ...
    CString name;
    switch (type) {
    case 1:  name = "GAME_INGAMEICONZ_TOOLZ_BOMBZ"; break;
    case 2:  name = "GAME_INGAMEICONZ_TOOLZ_BOOMERANGZ"; break;
    case 3:  name = "GAME_INGAMEICONZ_TOOLZ_BRICKZ"; break;
    case 4:  name = "GAME_INGAMEICONZ_TOOLZ_CLUBZ"; break;
    case 5:  name = "GAME_INGAMEICONZ_TOOLZ_GAUNTLETZ"; break;
    case 6:  name = "GAME_INGAMEICONZ_TOOLZ_GLOVEZ"; break;
    case 7:  name = "GAME_INGAMEICONZ_TOOLZ_GOOBERZ"; break;
    case 8:  name = "GAME_INGAMEICONZ_TOOLZ_GRAVITYBOOTZ"; break;
    case 9:  name = "GAME_INGAMEICONZ_TOOLZ_GUNHATZ"; break;
    case 10: name = "GAME_INGAMEICONZ_TOOLZ_NERFGUNZ"; break;
    case 11: name = "GAME_INGAMEICONZ_TOOLZ_ROCKZ"; break;
    case 12: name = "GAME_INGAMEICONZ_TOOLZ_SHIELDZ"; break;
    case 13: name = "GAME_INGAMEICONZ_TOOLZ_SHOVELZ"; break;
    case 14: name = "GAME_INGAMEICONZ_TOOLZ_SPRINGZ"; break;
    case 15: name = "GAME_INGAMEICONZ_TOOLZ_SPYZ"; break;
    case 16: name = "GAME_INGAMEICONZ_TOOLZ_SWORDZ"; break;
    case 17: name = "GAME_INGAMEICONZ_TOOLZ_TIMEBOMBZ"; break;
    case 18: name = "GAME_INGAMEICONZ_TOOLZ_TOOBZ"; break;
    case 19: name = "GAME_INGAMEICONZ_TOOLZ_WANDZ"; break;
    case 20:
        if (g_gameReg->m_134 == 1) {
            CResourceTracker *rt = g_gameReg->m_2c;
            CString lvl;
            lvl.Format("Level%i", rt->m_1c);
            name.Format("GAME_INGAMEICONZ_TOOLZ_WARPSTONEZ%i",
                        g_buteMgr.GetInt("WarpStone", (char *)(const char *)lvl));
        } else {
            name.Format("GAME_INGAMEICONZ_TOOLZ_WARPSTONEZ%i", warpIdx);
        }
        break;
    case 21: name = "GAME_INGAMEICONZ_TOOLZ_WELDERZ"; break;
    case 22: name = "GAME_INGAMEICONZ_TOOLZ_WINGZ"; break;
    case 23: name = "GAME_INGAMEICONZ_TOYZ_BABYWALKERZ"; break;
    case 24: name = "GAME_INGAMEICONZ_TOYZ_BEACHBALLZ"; break;
    case 25: name = "GAME_INGAMEICONZ_TOYZ_BIGWHEELZ"; break;
    case 26: name = "GAME_INGAMEICONZ_TOYZ_GOKARTZ"; break;
    case 27: name = "GAME_INGAMEICONZ_TOYZ_JACKINTHEBOXZ"; break;
    case 28: name = "GAME_INGAMEICONZ_TOYZ_JUMPROPEZ"; break;
    case 29: name = "GAME_INGAMEICONZ_TOYZ_POGOSTICKZ"; break;
    case 30: name = "GAME_INGAMEICONZ_TOYZ_SCROLLZ"; break;
    case 31: name = "GAME_INGAMEICONZ_TOYZ_SQUEAKTOYZ"; break;
    case 32: name = "GAME_INGAMEICONZ_TOYZ_YOYOZ"; break;
    case 50: name = "GAME_INGAMEICONZ_POWERUPZ_MEGAPHONEZ"; break;
    case 51: name = "GAME_INGAMEICONZ_POWERUPZ_HEALTH3"; break;
    case 52: name = "GAME_INGAMEICONZ_POWERUPZ_HEALTH2"; break;
    case 53: name = "GAME_INGAMEICONZ_POWERUPZ_HEALTH1"; break;
    case 57: name = "GAME_INGAMEICONZ_POWERUPZ_CONVERSION"; break;
    case 58: name = "GAME_INGAMEICONZ_POWERUPZ_DEATHTOUCH"; break;
    case 54: name = "GAME_INGAMEICONZ_POWERUPZ_GHOST"; break;
    case 60: name = "GAME_INGAMEICONZ_POWERUPZ_REACTIVEARMOR"; break;
    case 59: name = "GAME_INGAMEICONZ_POWERUPZ_ROIDZ"; break;
    case 56: name = "GAME_INGAMEICONZ_POWERUPZ_INVULNERABILITY"; break;
    case 55: name = "GAME_INGAMEICONZ_POWERUPZ_SUPERSPEED"; break;
    case 90: name = "GAME_INGAMEICONZ_SECRETW"; break;
    case 91: name = "GAME_INGAMEICONZ_SECRETA"; break;
    case 92: name = "GAME_INGAMEICONZ_SECRETR"; break;
    case 93: name = "GAME_INGAMEICONZ_SECRETP"; break;
    case 75: name = "GAME_INGAMEICONZ_POWERUPZ_STOPWATCH"; break;
    case 80: name = "GAME_INGAMEICONZ_POWERUPZ_COIN"; break;
    case 99: {
        CSprite *tb = g_gameReg->m_30->m_8->CreateSprite(
            0, geoB, geoA, 0xf, "TimeBomb", 0x40003);
        if (tb)
    ...
    CSprite *spr = g_gameReg->m_30->m_8->CreateSprite(
        0, geoB, geoA, 0x17318, "InGameIcon", 0x40003);
    if (!spr)
        return 0;
