...
RVA(0x0007dc60, 0xf1)
extern "C" i32 CreateGruntHealthSprite(CGameObject* owner){ANIM_WORKER_PUMP(CGruntHealthSprite)}
...
RVA(0x0007dee0, 0xf1)
extern "C" i32 CreateGruntStaminaSprite(CGameObject* owner){ANIM_WORKER_PUMP(CGruntStaminaSprite)}
// new 0x64, ctor 0x07fae0

RVA(0x0007e020, 0xf1)
extern "C" i32 CreateGruntToyTimeSprite(CGameObject* owner){ANIM_WORKER_PUMP(CGruntToyTimeSprite)}
// new 0x64, ctor 0x07fbd0

RVA(0x0007e160, 0xf1)
extern "C" i32
CreateGruntWingzTimeSprite(CGameObject* owner){ANIM_WORKER_PUMP(CGruntWingzTimeSprite)}
