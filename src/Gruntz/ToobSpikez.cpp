...
RVA_COMPGEN(0x00012c40, 0x1e, ??_GCToobSpikez@@UAEPAXI@Z)
RVA_COMPGEN(0x00012c70, 0x44, ??1CToobSpikez@@UAE@XZ)
...
RVA_DYNINIT(0x001148f0, 0xa, CActRegPool<CToobSpikez>::s_table)
RVA_DYNINIT(0x00114910, 0x15, CActRegPool<CToobSpikez>::s_table)
RVA_DYNINIT(0x00114940, 0xe, CActRegPool<CToobSpikez>::s_table)
RVA_DYNINIT(0x00114960, 0x1f, CActRegPool<CToobSpikez>::s_table)
template<> DATA(0x0024f8d0)
CActReg CActRegPool<CToobSpikez>::s_table(ACT_ID_FIRST, ACT_ID_LAST);

// @early-stop
RVA(0x001146f0, 0x18e)
