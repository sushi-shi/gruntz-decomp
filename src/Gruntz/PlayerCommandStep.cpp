...
struct CGrid {
    ...
    i32 SpawnProbe(i32 player, i32 x, i32 y, i32 a, i32 b, void* ctx, i32 c, i32 d, i32 e, i32 f,
                   i32 g, i32 h, i32 i);            // 0x4040bb
...
i32 CCmdHandler::Dispatch(u32 a2, u32 a3, u32 a4, u32 a5, u32 a6, u32 a7, u32 a8) {
    ...
    case 0: {
        i32 r = grid->SpawnProbe(a2 & 0xff, a5 & 0xffff, a6 & 0xffff, 100000, 2, g_renderCtx, 0, 0, 0,
                                 0, 0, 0, 0);
        if (r != -1) {
    ...
    case 4: {
        ...
        res = ((a4 & 0xff) == 3) ? grid->Reach(player, oa, ob, 0) : grid->ReachB(player, oa, ob, 0);
        if (res != 0) {
            if (res != -1) {
        ...
        if (g != 0) {
            if (F(g, 0x420) != 1) {
                ...
                case 0x16:
                    ...
                    break;
                default:
                    F(g, 0x2dc) = g_buteMgr.ReadRadius((const char*)0x60a9ec, (const char*)0x60e1ac, 3) + 1;
                }
