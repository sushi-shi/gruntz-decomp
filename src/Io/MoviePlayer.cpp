...
// CMoviePlayer::Open (0x17c6f0) is homed in src/DDrawMgr/DDPageMgr.cpp: it sits
// INSIDE that obj's own contiguous CMoviePlayer run (0x17c040..0x17d8a8), between
// 0x17c630 and Pump (0x17c790). This TU is only the COMDAT-pooled dtor pair.
