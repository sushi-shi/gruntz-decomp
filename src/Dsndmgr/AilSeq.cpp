...
// The XMIDI / Miles (AIL) sequence player + driver bring-up (RVA 0x138490..0x139030),
// re-homed out of the artificial src/Stub/ApiCallers.cpp aggregate. GAME code (Gruntz
// Dsndmgr module): __thiscall C++ wrappers over the Miles Sound System C imports.
