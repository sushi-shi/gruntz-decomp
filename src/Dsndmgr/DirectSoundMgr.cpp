...
void DirectSoundMgr::GetErrorString(char *file, int line, long hr)
{
    ...
    switch (hr) {
    case (int)0x80004001: strcpy(szCode, "DSERR_UNSUPPORTED");      strcpy(szMsg, "No message"); break;
    case (int)0x80004005: strcpy(szCode, "DSERR_GENERIC");         strcpy(szMsg, "No message"); break;
    case (int)0x80040110: strcpy(szCode, "DSERR_NOAGGREGATION");   strcpy(szMsg, "No message"); break;
    case (int)0x8007000e: strcpy(szCode, "DSERR_OUTOFMEMORY");     strcpy(szMsg, "No message"); break;
    case (int)0x80070057: strcpy(szCode, "DSERR_INVALIDPARAM");    strcpy(szMsg, "No message"); break;
    case (int)0x8878000a: strcpy(szCode, "DSERR_ALLOCATED");       strcpy(szMsg, "No message"); break;
    case (int)0x8878001e: strcpy(szCode, "DSERR_CONTROLUNAVAIL");  strcpy(szMsg, "No message"); break;
    case (int)0x88780032: strcpy(szCode, "DSERR_INVALIDCALL");     strcpy(szMsg, "No message"); break;
    case (int)0x88780046: strcpy(szCode, "DSERR_PRIOLEVELNEEDED"); strcpy(szMsg, "No message"); break;
    case (int)0x88780064: strcpy(szCode, "DSERR_BADFORMAT");       strcpy(szMsg, "No message"); break;
    case (int)0x88780078: strcpy(szCode, "DSERR_NODRIVER");        strcpy(szMsg, "No message"); break;
    case (int)0x88780096: strcpy(szCode, "DSERR_BUFFERLOST");      strcpy(szMsg, "No message"); break;
    case (int)0x887800a0: strcpy(szCode, "DSERR_OTHERAPPHASPRIO"); strcpy(szMsg, "No message"); break;
    case 0:          strcpy(szCode, "DS_OK");                 strcpy(szMsg, "No error"); break;
    default: break;
    }
