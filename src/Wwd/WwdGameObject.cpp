...
i32 CWwdSpriteObject::IntersectsViewport() {
    ...
    i32 left = m_screenPosition.m_x - m_frameImage->m_anchor.x;
    i32 right = m_screenPosition.m_x + m_frameImage->m_anchor.x;
    i32 top = m_screenPosition.m_y - m_frameImage->m_anchor.y;
