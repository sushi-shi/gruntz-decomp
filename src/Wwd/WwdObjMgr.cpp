...
// hoisted to <Gruntz/WwdObjMgr.h> next to its reader.)
...
CSpriteFactory::CreateSprite(i32 kind, i32 geoB, i32 geoA, i32 hint, const char* name, i32 flags) {
    ...
    // 0x159600 is CWwdObjMgr::CreateObject_159600 (the factory IS the manager); the
    // old ?CreateSpriteImpl@CSpriteFactory@ decl was a PHANTOM second name for it.
    return (CGameObject*)(void*)((CWwdObjMgr*)this)
        ->CreateObject_159600(kind, geoB, geoA, hint, (i32)tmpl, flags);
}
...
void CWwdObjMgr::TickKillCues_159a70(i32 advance) {
    ...
    for (i = 0; i < killQueue.GetSize(); i++) {
        ...
        if (obj->m_flags & 0x800) {
            ...
            m_48.RemoveKey(WwdKey(obj));
            m_2c.RemoveKey(WwdKey(obj));
            if (obj != 0) {
                delete obj;
            }
        }
...
RVA(0x00159db0, 0x5e)
void CWwdObjMgr::RemoveAndDelete_159db0(CWwdGameObject* obj) {
    if (obj->m_flags & 0x800) {
        delete obj;
        return;
    }
...
RVA(0x00159e10, 0x2e)
void CWwdObjMgr::ReinsertUnflagged_159e10(CWwdGameObject* obj) {
...
RVA(0x00159e40, 0xaa)
void CWwdObjMgr::InsertSorted_159e40(CWwdGameObject* obj, i32 addToMaps) {
    if (obj->m_flags & 0x800) {
        obj->m_posCache = 0;
        return;
    }
...
i32 CWwdObjMgr::CheckSortOrder_15a780() {
    CWwdNode* node = (CWwdNode*)m_10.GetHeadPosition();
    CWwdGameObject* anchor = node->m_obj;
    node = node->m_next;
    if (anchor == 0) {
        return 1;
    }
...
RVA(0x0015a7f0, 0x20)
CWwdGameObject* CWwdObjMgr::FindByType04_15a7f0(i32 type) {
    CWwdNode* node = (CWwdNode*)m_10.GetHeadPosition();
    while (node != 0) {
        CWwdNode* cur = node;
        node = node->m_next;
...
RVA(0x0015a810, 0x42)
CWwdGameObject* CWwdObjMgr::FindByTypeProbe_15a810(i32 type) {
    CWwdNode* node = (CWwdNode*)m_10.GetHeadPosition();
    while (node != 0) {
        CWwdNode* cur = node;
        node = node->m_next;
...
RVA(0x0015a860, 0x57)
CWwdGameObject* CWwdObjMgr::FindByWorker_15a860(i32 type, void* key) {
    CWwdNode* node = (CWwdNode*)m_10.GetHeadPosition();
    if (node == 0) {
        return 0;
    }
...
RVA(0x0015a940, 0x52)
CWwdGameObject* CWwdObjMgr::FindByField_15a940(i32 type, void* key) {
    CWwdNode* node = (CWwdNode*)m_10.GetHeadPosition();
    if (node == 0) {
        return 0;
    }
...
RVA(0x0015a9a0, 0x23)
CWwdGameObject* CWwdObjMgr::FindByKey_15a9a0(void* key) {
    CWwdNode* node = (CWwdNode*)m_10.GetHeadPosition();
    while (node != 0) {
        CWwdNode* cur = node;
        node = node->m_next;
...
RVA(0x0015a9d0, 0x45)
CWwdGameObject* CWwdObjMgr::FindByStatusKey_15a9d0(void* key) {
    CWwdNode* node = (CWwdNode*)m_10.GetHeadPosition();
    while (node != 0) {
        CWwdNode* cur = node;
        node = node->m_next;
...
// +0x48 active set).
RVA(0x0015ab30, 0x38)
void CWwdObjMgr::RemoveAll_15ab30(i32 pos, CWwdGameObject* obj) {
...
RVA(0x0015ab70, 0x27)
void CWwdObjMgr::RemoveByPosition_15ab70(i32 pos, CWwdGameObject* obj) {
    m_10.RemoveAt((POSITION)pos);
    m_2c.RemoveKey(WwdKey(obj));
}
...
RVA(0x0015aba0, 0x1a)
void CWwdObjMgr::AddToMap48_15aba0(CWwdGameObject* obj) {
    m_48[WwdKey(obj)] = obj;
}
        ...
        switch (desc.m_08) {
            ...
            case 0x1c: {
                ...
                *(i32*)((char*)rec + 4) = desc.m_00;
                // 0x159830 == CSpriteFactory::AttachSprite (the manager IS the factory)
                if (((CSpriteFactory*)this)
                        ->AttachSprite(
                            (CWwdGameObject*)rec,
                            desc.m_94,
                            desc.m_98,
...
i32 CWwdObjMgr::PruneOrphans_15b1d0() {
    ...
    if (pos != 0) {
        do {
            ...
            if (val != 0) {
                void* found = 0;
                if (!m_2c.Lookup(WwdKey(val), found)) {
                    found = 0;
                }
                if (found == 0) {
                    m_48.RemoveKey(WwdKey(val));
                    if (val != 0) {
                        delete val;
                    }
                    ++n;
