...
// WwdRegion (the region sub-object @ CWwdGameObject+0x9c), WwdRect, and the cursor
...
// WwdRegion directly, and its buckets WwdBucketHead) IS the canonical polymorphic
...
// iterator's WwdRegion* is cast to the canonical WwdRegion* at the two Remove sites
...
// the embedded +0x9c WwdRegion region (m_region).
