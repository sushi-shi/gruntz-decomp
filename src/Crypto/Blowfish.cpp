...
// key state (rep movs sources). P-init @ 0x21bef8 (18 dwords, 72 B), S-init @
// 0x21bf40 (1024 dwords, 4096 B). These are the standard Bruce Schneier Blowfish
// init constants (hex digits of pi); values read/verified against the retail
// .data bytes at those rvas (P[0]=0x243f6a88, S[0][0]=0xd1310ba6).
// Defined here (not extern-only) so the bytes land in this TU's obj and the two
// data symbols are recovered. Bound via @data-symbol (not DATA) because clang
// mangles the const array with a `Q` storage class while cl 5.0 emits `P`
// (?g_bfInitP@@3PBIB) - MSVC5 decays a global const array to a pointer mangling;
// a DATA() label's clang mangledName would miss cl's symbol. The @data-symbol
// name is the exact cl mangling and is authority-checked against the base obj.
// clang-format off
// @data-symbol: ?g_bfInitP@@3PBIB 0x0021bef8
const u32 g_bfInitP[18] = {
    0x243f6a88, 0x85a308d3, 0x13198a2e, 0x03707344, 0xa4093822, 0x299f31d0,
    0x082efa98, 0xec4e6c89, 0x452821e6, 0x38d01377, 0xbe5466cf, 0x34e90c6c,
    0xc0ac29b7, 0xc97c50dd, 0x3f84d5b5, 0xb5470917, 0x9216d5d9, 0x8979fb1b,
};
// @data-symbol: ?g_bfInitS@@3PAY0BAA@$$CBIA 0x0021bf40
const u32 g_bfInitS[4][256] = {
    {
