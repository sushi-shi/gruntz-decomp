...
RVA(0x13cff0, 0x35c)
LRESULT __stdcall CGameApp::GameWindowProc(HWND hwnd, UINT uMsg,
                                           WPARAM wParam, LPARAM lParam)
{
    ...
    case 0x0001 /*WM_CREATE*/:
        if (s_activeWnd->OnCreate(lParam)) return 0;
        break;
    case 0x0003 /*WM_MOVE*/:
        if (s_activeWnd->OnMove((int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    case 0x0005 /*WM_SIZE*/:
        if (s_activeWnd->OnSize(wParam, (int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    case 0x0002 /*WM_DESTROY*/:
        if (s_activeWnd->QuitMessageLoop()) return 0;
        break;
    case 0x000f /*WM_PAINT*/:
        if (s_activeWnd->OnPaint()) return 0;
        break;
    case 0x0010 /*WM_CLOSE*/:
        if (s_activeWnd->OnClose()) return 0;
        break;
    case 0x001c /*WM_ACTIVATEAPP*/:
        if (s_activeWnd->OnActivateApp(wParam, lParam)) return 0;
        break;
    case 0x0102 /*WM_CHAR*/:
        if (s_activeWnd->OnChar(wParam, lParam)) return 0;
        break;
    case 0x0100 /*WM_KEYDOWN*/:
        if (s_activeWnd->OnKeyDown(wParam, lParam)) return 0;
        break;
    case 0x0101 /*WM_KEYUP*/:
        if (s_activeWnd->OnKeyUp(wParam, lParam)) return 0;
        break;
    case 0x0104 /*WM_SYSKEYDOWN*/:
        if (s_activeWnd->OnSysKeyDown(wParam, lParam)) return 0;
        break;
    case 0x0111 /*WM_COMMAND*/:
        if (s_activeWnd->OnCommand(wParam, lParam)) return 0;
        break;
    case 0x0201 /*WM_LBUTTONDOWN*/:
        if (s_activeWnd->OnLButtonDown(wParam, (int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    case 0x0202 /*WM_LBUTTONUP*/:
        if (s_activeWnd->OnLButtonUp(wParam, (int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    case 0x0204 /*WM_RBUTTONDOWN*/:
        if (s_activeWnd->OnRButtonDown(wParam, (int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    case 0x0205 /*WM_RBUTTONUP*/:
        if (s_activeWnd->OnRButtonUp(wParam, (int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    case 0x0200 /*WM_MOUSEMOVE*/:
        if (s_activeWnd->OnMouseMove(wParam, (int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    case 0x0203 /*WM_LBUTTONDBLCLK*/:
        if (s_activeWnd->OnLButtonDblClk(wParam, (int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    case 0x0206 /*WM_RBUTTONDBLCLK*/:
        if (s_activeWnd->OnRButtonDblClk(wParam, (int)(lParam & 0xffff), (int)((unsigned long)lParam >> 16))) return 0;
        break;
    }
...
CGameWnd::~CGameWnd() {}
int CGameWnd::PreDispatchMessage(UINT, WPARAM, LPARAM) { return 0; }
int CGameWnd::Wap32GameWndVfunc2() { return 0; }
int CGameWnd::OnCreate(LPARAM) { return 0; }
int CGameWnd::OnClose() { return 0; }
int CGameWnd::OnMove(int, int) { return 0; }
int CGameWnd::OnSize(WPARAM, int, int) { return 0; }
int CGameWnd::OnPaint() { return 0; }
int CGameWnd::OnChar(WPARAM, LPARAM) { return 0; }
int CGameWnd::OnKeyDown(WPARAM, LPARAM) { return 0; }
int CGameWnd::OnKeyUp(WPARAM, LPARAM) { return 0; }
int CGameWnd::OnSysKeyDown(WPARAM, LPARAM) { return 0; }
int CGameWnd::OnActivateApp(WPARAM, LPARAM) { return 0; }
int CGameWnd::OnLButtonDown(WPARAM, int, int) { return 0; }
int CGameWnd::OnRButtonDown(WPARAM, int, int) { return 0; }
int CGameWnd::OnLButtonUp(WPARAM, int, int) { return 0; }
int CGameWnd::OnRButtonUp(WPARAM, int, int) { return 0; }
int CGameWnd::OnMouseMove(WPARAM, int, int) { return 0; }
int CGameWnd::OnLButtonDblClk(WPARAM, int, int) { return 0; }
int CGameWnd::OnRButtonDblClk(WPARAM, int, int) { return 0; }
int CGameWnd::OnCommand(WPARAM, LPARAM) { return 0; }
