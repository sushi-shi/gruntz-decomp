...
// (RVA-homed to their linker-layout TUs: 0x39f20 ~CWorker39f20 -> CreditzAssets.cpp;
// 0x8c400 ~CHolder8c400 -> src/Wap32/Rect.cpp; 0x390a0 ~CCredits390a0 -> src/Io/
// MoviePlayer.cpp; 0x8d000 ~CMenuState8d000 -> src/Gruntz/HelpState.cpp; 0x21570
// ~CButeTree21b -> src/Bute/ButeMgr.cpp. The class declarations stay shared in
// <Gruntz/BoundaryLowerDtorsViews.h>; only the RVA()-carrying bodies moved.)

// ===========================================================================
// 0x021310 - ~CButeTree21a (/GX, multiple inheritance): stamp both base
...
// (0x21570 ~CButeTree21b re-homed to src/Bute/ButeMgr.cpp, next to the canonical
// CButeStore its ClearRecursive callee lives on.)
