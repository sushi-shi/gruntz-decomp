...
// GapFunctions.cpp - GENERATED by `python -m gruntz.analysis.discover_gaps --emit`:
// the ~592 functions Ghidra never carved (found by .text coverage-gap analysis). Bulk
// worklist; reconstruct + re-home each out, then re-run the tool to shrink this file.
#include "GapFunctions.cpp"
