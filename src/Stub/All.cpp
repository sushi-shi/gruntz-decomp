...
// ApiCallers.cpp removed: its residual bodies were all re-homed to real class TUs,
// and its 5 DATA() pins (g_gameReg 0x24556c, g_pGetFocus/g_pSendMessageA/
// g_pInvalidateRect 0x2c45xx USER32 IAT ptrs, g_dlgInfoText 0x24c864) are all bound
// in their owning TUs (GruntzMgr.cpp / MultiStartDlgRoster.cpp / SaveGameMenu.cpp).
...
// GapFunctions.cpp - FULLY DRAINED (matcher-5, 2026-07-10): every remaining gap was
// homed out to its real owning TU (by RVA neighbourhood / xref-recovered identity), the
// gap tool's incorrectly-merged spans were split (0x1849d0->CHashSlot dtor+ctor,
// 0x191720->BucketHead dtor + CWwdGrid span-ctor, 0x139810 over-span trimmed + 0x139950
// getter split off, 0x17b950 overlap with 0x17bcd0 fixed), and the file was deleted.
