// ImageProbe.cpp - CDDScreen::CheckGrid (0x17cbe0): (re)create the tiled-display
...
// +0x520 m_bpp - and its ONLY caller is CDDScreen::Configure (0x17cfc0), which
...
#include <Win32.h>
#include <ddraw.h> // real IDirectDraw2/IDirectDrawSurface(3)/DDSURFACEDESC + IID_IDirectDrawSurface3
