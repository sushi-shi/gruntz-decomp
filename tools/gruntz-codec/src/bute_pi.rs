//! Blowfish initialization constants — the hexadecimal digits of pi.
//!
//! Published with the cipher (Schneier, *Fast Software Encryption* 1993) and
//! byte-identical to the copy compiled into retail (`g_bfInitP` @0x0021bef8,
//! `g_bfInitS` @0x0021bf40). They are not a Gruntz secret; the key is.

/// The 18-entry P-array, before the key schedule.
pub(crate) const INIT_P: [u32; 18] = [
    0x243f6a88, 0x85a308d3, 0x13198a2e, 0x03707344, 0xa4093822, 0x299f31d0, 0x082efa98, 0xec4e6c89,
    0x452821e6, 0x38d01377, 0xbe5466cf, 0x34e90c6c, 0xc0ac29b7, 0xc97c50dd, 0x3f84d5b5, 0xb5470917,
    0x9216d5d9, 0x8979fb1b,
];

/// The four 256-entry S-boxes, before the key schedule.
pub(crate) const INIT_S: [[u32; 256]; 4] = [
    [
