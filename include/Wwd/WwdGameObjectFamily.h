...
struct WwdRenderCtx;     // slot 11 param (render context; layout in WwdGameObjectRender.cpp)
...
public:
    ...
    virtual void Render(WwdRenderCtx* ctx) OVERRIDE;              // slot 11 @0x15ba20 (ret 4)
...
public:
    ...
    virtual void Render(WwdRenderCtx* ctx) OVERRIDE;              // slot 11 0x1668b0 (broadcast)
...
public:
    ...
    virtual void Render(WwdRenderCtx* ctx) OVERRIDE; // slot 11 @0x15ba70 (ret 4 - empty)
...
public:
    ...
    virtual void Render(WwdRenderCtx* ctx) OVERRIDE; // slot 11 @0x1660f0 (RenderDot)
