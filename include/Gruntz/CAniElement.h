...
// The 0x34-byte frame record (tomalla-39; vtable @0x5f02c0) the builder catalogs is
// CAniRecordView (include/Gruntz/CAniRecordView.h) - the shared minimal polymorphic
// view of the real CAniRecord (src/Gruntz/CAniRecord.cpp, VTBL @0x1f02c0).
