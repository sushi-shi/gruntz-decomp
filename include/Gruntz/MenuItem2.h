...
public:
    ...
    virtual i32 Init(CMenuPage*, const char*, const char*, i32, const char*, i32) OVERRIDE; // 0x185750  slot 1
    ...
    virtual i32 Notify(u32 dt) OVERRIDE;                     // 0x1858a0  slot 8  (frame cursor)
