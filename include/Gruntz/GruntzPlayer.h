...
public:
    ...
    i32 m_018;         // +0x018  = -2; slot key (CGruntzMgr::FindOptionsSlot match)
    i32 m_01c;         // +0x01c  (serialized) roster: ready flag
    i32 m_020;         // +0x020  = 0; loaded / live gate
    i32 m_024;         // +0x024  (serialized) "already cleared this round"
    i32 m_028;         // +0x028  joined
    i32 m_02c;         // +0x02c  = 0; done
    i32 m_030;         // +0x030  = 0
    ...
    i32 m_220;                    // +0x220  = 0 (snapped focus x)
    i32 m_224;                    // +0x224  = 0 (snapped focus y)
