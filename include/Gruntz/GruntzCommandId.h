...
enum GruntzCommand {
    ...
    kCheatBrickTextDisplay =
        0x8068, // toggle brick-text overlay (flag 0x40), clear both brick texts
    kCheatBrickTextAltDisplay =
        0x806f, // toggle alt brick-text overlay (flag 0x100), clear brick text 1
