...
// GruntCombat.cpp).  Retail has exactly ONE call to that body - CGrunt::CGrunt
...
// expansion include this header (the era's .inl idiom) and GruntCombat.cpp
// keeps the standalone body.
