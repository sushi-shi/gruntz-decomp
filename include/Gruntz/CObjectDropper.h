...
public:
    ...
    double m_58; // +0x58  per-frame speed (32.0 / time-per-tile)
    ...
    i32 m_78;    // +0x78  last-drop tile x (-1)
    i32 m_7c;    // +0x7c  last-drop tile y (-1)
    i32 m_80;    // +0x80  scroll mode (0/1)
    char m_pad84[0x88 - 0x84];
    i64 m_88; // +0x88  last-drop timestamp (64-bit)
    i64 m_90; // +0x90  drop interval (64-bit)
};
