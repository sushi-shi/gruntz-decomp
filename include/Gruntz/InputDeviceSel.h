...
// CInputConfig::m_deviceId and bound by CInputState::SelectDevices.
//
...
//   5  "Joystick 4"
//
// CInputState::SelectDevices confirms the same six independently and supplies the rest:
// arm 1 takes m_keyboard, arms 2..5 take m_joysticks[0..3] - so the human-facing
...
// CreateDeviceGroup, with the device identities coming from the GUIDs their
// creators pass: DirectInputMgr2::InitializeKeyboard builds m_keyboard on
// GUID_SysKeyboard, while InitializeMouse builds m_mouse on GUID_SysMouse.
//
