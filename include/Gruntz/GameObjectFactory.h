...
extern "C" i32
CreateDoNothingNormal(CGameObject* obj);          // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32 CreateDoNothing(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateSimpleAnimation(CGameObject* obj);            // GameObjNotifyFn ABI (CreateWorker registrant)
...
extern "C" i32
CreateFrontCandyAni(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateBehindCandyAni(CGameObject* obj);             // GameObjNotifyFn ABI (CreateWorker registrant)
...
extern "C" i32
CreateGlobalAmbientSound(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateAmbientSound(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateAmbientPosSound(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateSpotAmbientSound(CGameObject* obj);          // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32 CreateActionArea(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateStatusBarSprite(CGameObject* obj);          // GameObjNotifyFn ABI (CreateWorker registrant)
...
extern "C" i32
CreateGruntSelectedSprite(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateGruntHealthSprite(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateGruntStaminaSprite(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateGruntToySprite(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateGruntToyTimeSprite(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateGruntWingzTimeSprite(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateGruntPowerupSprite(CGameObject* obj);     // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32 CreateToyPeek(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateTileTriggerSwitch(CGameObject* obj);          // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32 CreateTileTrigger(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateTileSecretTrigger(CGameObject* obj);     // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32 CreateBrickz(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateTileTriggerTransition(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateGruntStartingPoint(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateGruntCreationPoint(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateFortressFlag(CGameObject* obj);               // GameObjNotifyFn ABI (CreateWorker registrant)
...
extern "C" i32
CreateCoveredPowerup(CGameObject* obj);             // GameObjNotifyFn ABI (CreateWorker registrant)
...
extern "C" i32
CreateObjectDropper(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateDroppedObject(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateDroppedObjectShadow(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateCheckpointTrigger(CGameObject* obj);         // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32 CreateTeleporter(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateSecretTeleporterTrigger(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateSecretLevelTrigger(CGameObject* obj);        // GameObjNotifyFn ABI (CreateWorker registrant)
...
extern "C" i32
CreateStaticHazard(CGameObject* obj);              // GameObjNotifyFn ABI (CreateWorker registrant)
...
extern "C" i32
CreateKitchenSlime(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateSingleAnimation(CGameObject* obj);           // GameObjNotifyFn ABI (CreateWorker registrant)
...
extern "C" i32
CreateWarpStonePad(CGameObject* obj);              // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32 CreateGuardPoint(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateVoiceTrigger(CGameObject* obj);             // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32 CreateLevelTime(CGameObject* obj); // GameObjNotifyFn ABI (CreateWorker registrant)
extern "C" i32
CreateCursorSnapSprite(CGameObject* obj);         // GameObjNotifyFn ABI (CreateWorker registrant)
