...
public:
    ...
    virtual i32 GetLength() = 0; // slot 5  __purecall (CFileMem: return m_length)
    virtual i32 GetOffset() = 0; // slot 6  __purecall (CFileMem: return m_offset)
    virtual i32 WantRead();      // slot 7  (0x157940) read-vs-create gate
    virtual i32 WantCreate();    // slot 8  0x157950: return m_mode == 0 (mode 0 = create)
...
public:
    ...
    virtual i32 GetLength() OVERRIDE;            // slot 5  0x157a00 (return m_length)
    virtual i32 GetOffset() OVERRIDE;            // slot 6  0x157a10 (return m_offset)
