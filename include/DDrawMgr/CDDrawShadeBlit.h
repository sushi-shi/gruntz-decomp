...
class CDDSurface; // the held DirectDraw surface (Blit's src arg); <DDrawMgr/CDDSurface.h>
...
// surface wrapper CDDSurface (<DDrawMgr/CDDSurface.h>): the blit loops Lock() it
...
public:
    // --- build / decode side (former CImageOwned; src/Image/CImageOwned.cpp) -----
    ...
    // --- blit side (src/DDrawMgr/CDDrawShadeBlit.cpp) -----------------------------
