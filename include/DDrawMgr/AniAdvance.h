...
// (CAniBlitTrigger DISSOLVED 2026-07-29: it WAS LeafCue, on three independent proofs -
//  layout: +0x00..0x0b is the CLoadable header, +0x0c is CWapObj::m_ownerCtx (the
...
//  owner: CDDrawSubMgrLeafScan::Fire dispatches it on a value out of the very map
//    whose sibling accessor returns LeafCue*.
//  TriggerBlit now lives on LeafCue (<Gruntz/LeafCue.h>); the m_randTable entries were
//  already typed LeafCue*, so the ex-cast at each dispatch is gone.)
