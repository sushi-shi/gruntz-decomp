...
extern "C" {
    ...
    extern i32 g_frameDelta; // 0x245584  frame delta (clamped <= 0x64); owner Rez/RezMgr.cpp
    extern u32 g_frameTime;  // 0x245588  running accumulated game clock (unsigned); owner Rez/RezMgr.cpp
    ...
    extern u32 g_engineFrameDelta; // 0x2bf3bc  draw-delta mirror; owner Gruntz/Play.cpp
    extern u32 g_killCueClock;     // 0x2bf3c0  draw-clock mirror; owner Gruntz/Play.cpp
}
