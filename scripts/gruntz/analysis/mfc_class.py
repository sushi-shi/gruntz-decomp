#!/usr/bin/env python3
"""gruntz.analysis.mfc_class - ask the BINARY which MFC class owns an address.
...
----------------------------
    python -m gruntz.analysis.mfc_class 0x1b4b43        # who owns this RVA?
    python -m gruntz.analysis.mfc_class 0x1ec29c        # ... a vtable
    python -m gruntz.analysis.mfc_class 0x1b4b43 0x1b55e9 ...
    python -m gruntz.analysis.mfc_class --map           # the whole recovered map
    python -m gruntz.analysis.mfc_class --audit         # audit the TREE's MFC uses
    python -m gruntz.analysis.mfc_class --labels        # AMBIG library_labels rows
                                                        # the technique disambiguates
    python -m gruntz.analysis.mfc_class --relabel [--write]
                                                        # rewrite those rows (stage 5
                                                        # of gruntz.analysis.fid_generate)
...
def main():
    ap = argparse.ArgumentParser(
        prog="python -m gruntz.analysis.mfc_class",
