...
Usage:
    python3 -m gruntz.analysis.tu_order_check              # gate, real TUs
    python3 -m gruntz.analysis.tu_order_check --tu trigger_mgr   # one TU detail
    python3 -m gruntz.analysis.tu_order_check --inter-only # only cross-TU blocks
    python3 -m gruntz.analysis.tu_order_check --csv report.csv
"""
