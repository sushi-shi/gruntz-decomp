...
Usage:
    python3 -m gruntz.analysis.tu_layout
    python3 -m gruntz.analysis.tu_layout --neighbors 0xb4020
    python3 -m gruntz.analysis.tu_layout --attribute [--emit attributions.csv]
"""
...
from gruntz.analysis.link_order import regions
