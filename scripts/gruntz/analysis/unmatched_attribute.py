...
Usage (from a `nix develop .#build` shell):
  python -m gruntz.analysis.unmatched_attribute                 # grouped worklist
  python -m gruntz.analysis.unmatched_attribute --bands 4       # + N disjoint RVA bands
  python -m gruntz.analysis.unmatched_attribute --tsv out.tsv   # write machine-readable TSV
