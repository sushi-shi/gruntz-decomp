#!/usr/bin/env python3
"""gruntz.analysis.retype_ints - whole-tree raw-int -> fixed-width-alias sweep.
...
re-run on files added later (e.g. when matchers resume).
  ...
  python3 -m gruntz.analysis.retype_ints [--check] [--root <repo>] [paths...]
...
def main(argv=None):
    ...
    if args.root:
        ...
        # scripts/gruntz/analysis/retype_ints.py -> repo root is 3 up
