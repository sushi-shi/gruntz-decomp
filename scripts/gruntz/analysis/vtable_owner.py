...
green gate cannot see, because uniqueness and coverage are both satisfied by a lie).
    ...
    python -m gruntz.analysis.vtable_owner 0x0000b940     # who owns this body?
    python -m gruntz.analysis.vtable_owner --audit        # re-derive EVERY src VTBL() binding
    python -m gruntz.analysis.vtable_owner --audit --all  # ... including the ones that agree
"""
import argparse
import bisect
import csv
