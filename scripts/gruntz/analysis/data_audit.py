...
Usage:
  python -m gruntz.analysis.data_audit                 # -> build/gen/data_attribution.tsv + summary
  python -m gruntz.analysis.data_audit --json out.json # full per-symbol evidence
  python -m gruntz.analysis.data_audit --rva 0x1e8e98  # one symbol, printed
"""
