...
Usage:
    python -m gruntz.analysis.reorder_tu <file.cpp> [<file2.cpp> ...]
    python -m gruntz.analysis.reorder_tu --check <file.cpp> ...   # would-change? (exit 1)
    python -m gruntz.analysis.reorder_tu --dry-run <file.cpp> ... # report, no write
"""
