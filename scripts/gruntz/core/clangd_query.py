...
who references it, what is its type.
  ...
  python3 -m gruntz.core.clangd_query def  <file> <line> [<col>]   # definition
  python3 -m gruntz.core.clangd_query refs <file> <line> [<col>]   # references
  python3 -m gruntz.core.clangd_query hover <file> <line> [<col>]  # type/doc at point
  python3 -m gruntz.core.clangd_query rename <file> <line> [<col>] <new-name>
                                                                # rename the symbol at
                                                                # point tree-wide (add
                                                                # --dry-run to preview)
  python3 -m gruntz.core.clangd_query index                 # build the background
...
name-independent). See gruntz.audit.rename_member for the class-member bulk
variant.
