#!/usr/bin/env python3
"""gruntz.core.vtable_scan - recover *every* vtable in GRUNTZ.EXE and its
...
Usage:
    python3 -m gruntz.core.vtable_scan                # summary + table
    python3 -m gruntz.core.vtable_scan --csv out.csv  # machine-readable
    python3 -m gruntz.core.vtable_scan --new          # only starts not yet in src/ DATA()
"""
