"""gruntz.walls.calibrate - the reflexivity control the paired sieves lacked.

    gruntz walls calibrate [--stride N] [--limit N] [--sieve NAME] [--json]
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="gruntz walls calibrate",
