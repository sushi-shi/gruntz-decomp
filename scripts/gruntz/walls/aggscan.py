"""gruntz.walls.aggscan - the BY-VALUE AGGREGATE ARGUMENT sieve.
...
one, so it does not rest on the filter.
    ...
    gruntz walls aggscan [--sites] [--json]
    gruntz walls aggscan --control     hermetic positives/negatives and the
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="gruntz walls aggscan",
