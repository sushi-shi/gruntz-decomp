"""gruntz.walls.loopscan - the loop-BODY-SIZE sieve over the worklist.
...
a source statement - it says which loop to read, not what to write.
    ...
    gruntz walls loopscan [--todo] [--unit U] [--limit N] [--all] [--json]
    gruntz walls loopscan <rva|name> ...      one row, every loop listed
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="gruntz walls loopscan",
