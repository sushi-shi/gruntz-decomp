...
gate (`gruntz verify vtables`, SLOT BINDING: WIRING is FATAL), and this
...
def virtual_census(limit: int) -> int:
    from gruntz.sema.index import index
    from gruntz.sema.vtable import slots, vtable_rows
    idx = index()
    occupied, holder = set(), {}
    ...
    print("\nFORWARD - a body a retail vtable slot holds, declared "
          "non-virtual\n  (`gruntz verify vtables` already gates this "
