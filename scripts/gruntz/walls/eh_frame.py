"""gruntz.walls.eh_frame - the /GX frame-presence + unwind-state sieve.
...
the prologue-formula and teardown anchors, one arg-push region of slack.
    ...
    gruntz walls eh-frame [--states] [--calibrate] [--unit U] [--tsv OUT]
"""
...
from gruntz.walls.pairscan import REL32
