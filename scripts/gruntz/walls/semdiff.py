"""gruntz.walls.semdiff - OPERAND-LEVEL adjudication of a normalized pair.
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="gruntz walls semdiff",
...
def sweep_main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="gruntz walls semsweep",
