#!/usr/bin/env python3
"""Unified source-variant search frontend - LIVE drive-to-100% campaign engine (ported from homm2).
...
from gruntz.permute.generate_ast_variants import main as generate_main
