"""gruntz.ghidra.export - the Model, flattened for the Ghidra viewer.

    gruntz ghidra export [--out P] [--quiet]
...
Inputs (no others):
  * build/gen/bindings.tsv  - the serialized Model (gruntz.model); regenerated
...
from gruntz.core.tsv import rint
...
def bindings() -> list[dict]:
    ...
    from gruntz.model import BINDINGS, resolve, serialize
