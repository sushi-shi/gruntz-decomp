...
delinker's COMDAT-folded empty stubs), which are a delinker-side concern, not a source bug.
    ...
    python -m gruntz.audit.assert_relocs                 # audit every near-exact function
    python -m gruntz.audit.assert_relocs --unit butemgr  # one unit
    python -m gruntz.audit.assert_relocs 0x0008dc60      # review ONE function (works at a wall)
