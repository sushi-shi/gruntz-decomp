...
instruction level), never on a citation.
    ...
    python -m gruntz.audit.stale_walls              # audit everything, ranked by yield
    python -m gruntz.audit.stale_walls --oracle     # just dump the allocation-size oracle
    python -m gruntz.audit.stale_walls --file F     # one file
"""
import argparse
import csv
import glob
