...
Usage:
    python -m gruntz.audit.exe_diff
    python -m gruntz.audit.exe_diff --json          # machine-readable summary
"""
...
def main() -> None:
    ...
    print("\n" + "-" * W)
    print("D. PROPOSED TRACKED EXE-MATCH NUMBERS  (`gruntz audit exe-diff`)")
    print("-" * W)
