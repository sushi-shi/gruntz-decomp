...
Usage:
  python -m gruntz.audit.data_home              # summary + top-TU worklist
  python -m gruntz.audit.data_home --unit foo   # one unit's globals to define
  python -m gruntz.audit.data_home --json out.json
"""
import argparse
import json
import re
...
from gruntz.audit.globals_attribute import build_db, _sec_of, _rva_to_off
...
def main():
    ...
    print(f"\n  -> `python -m gruntz.audit.data_home --unit <name>` for one TU's list")
    return 0
