...
are one solid block, which is what link.exe 5.10's contribution mechanism
...
retail RVA order (log). link.exe 5.10 lays each obj's contribution as ONE
...
<p>Regenerate: <code>python3 -m gruntz.sema.exe_map</code>
