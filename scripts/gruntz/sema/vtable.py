"""gruntz.sema.vtable - a vtable's slots, or which vtable holds a function.

    python3 -m gruntz.sema.vtable 0x1ee54c          # dump the table's slots
    python3 -m gruntz.sema.vtable 0x1c9c08          # which slot(s) hold this fn
    python3 -m gruntz.sema.vtable --list CFile      # vtable rows by name
...
def main(argv: list[str] | None = None) -> int:
    import argparse
    ap = argparse.ArgumentParser(prog="gruntz sema vtable",
