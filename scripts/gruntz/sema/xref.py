"""gruntz.sema.xref - who reaches this address?

    python3 -m gruntz.sema.xref 0x136180 0x139bf0
    python3 -m gruntz.sema.xref CGameApp::CloseResources --tree
    python3 -m gruntz.sema.xref --callees 0x136180
    python3 -m gruntz.sema.xref 0x2bf314          # a datum: its referent sites
...
def main(argv: list[str] | None = None) -> int:
    import argparse
    ap = argparse.ArgumentParser(prog="gruntz sema xref",
