"""gruntz.sema.classof - a class's vtables, members and slot topology.

    python3 -m gruntz.sema.classof CMirrorFile
    python3 -m gruntz.sema.classof 0x1c9c08        # which slot(s) hold this fn
    python3 -m gruntz.sema.classof CImage --members
...
from gruntz.sema import die, run
from gruntz.sema.index import index, short_name, split_mangled
from gruntz.sema.report import report
from gruntz.sema.vtable import dump, find_holding, slots, vtable_rows
...
def main(argv: list[str] | None = None) -> int:
    import argparse
    ap = argparse.ArgumentParser(prog="gruntz sema class",
