"""gruntz.sema.match - the objdiff scores for a unit or a function.

    python3 -m gruntz.sema.match cimage           # a unit's function table
    python3 -m gruntz.sema.match 0x153810         # one function's row
...
def main(argv: list[str] | None = None) -> int:
    import argparse
    ap = argparse.ArgumentParser(prog="gruntz sema match",
