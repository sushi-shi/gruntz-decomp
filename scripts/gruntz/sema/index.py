"""gruntz.sema.index - the Model, indexed for address queries.

sema reads identity from ONE place: `gruntz.model.resolve()`. Every name,
...
from gruntz.model import Binding, Model, resolve
