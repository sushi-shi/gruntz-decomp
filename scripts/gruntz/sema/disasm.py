"""gruntz.sema.disasm - annotated retail i386 assembly.

    python3 -m gruntz.sema.disasm 0x153810
    python3 -m gruntz.sema.disasm CImage::RenderFrame --lite
    python3 -m gruntz.sema.disasm 0x153810 --blocks
    python3 -m gruntz.sema.disasm 0x1eb2f0 --switch
...
from gruntz.sema import SemaError, die, run
from gruntz.sema.image import retail
from gruntz.sema.index import index
from gruntz.tool import ToolError, objdump
...
def main(argv: list[str] | None = None) -> int:
    import argparse
    ap = argparse.ArgumentParser(prog="gruntz sema disasm",
