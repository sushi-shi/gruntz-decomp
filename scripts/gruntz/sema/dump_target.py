"""gruntz.sema.dump_target - the matcher's target dump: bytes, relocations, asm.

    python3 -m gruntz.sema.dump_target 0x153810 [0x1549d0 ...]
    python3 -m gruntz.sema.dump_target CImage::RenderFrame --no-disasm
    python3 -m gruntz.sema.dump_target 0x1ee54c --hex        # a data row
...
from gruntz.sema.disasm import extent, listing
...
def main(argv: list[str] | None = None) -> int:
    import argparse
    ap = argparse.ArgumentParser(prog="gruntz sema dump",
