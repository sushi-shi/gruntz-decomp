"""gruntz.lineage - the surviving LithTech source adoption campaign.

    gruntz lineage discover --source <lithtech-tree> [--commit REV]
    ...
    gruntz lineage inventory [--todo] [--module MODULE]
    ...
    gruntz lineage verify [--source <lithtech-tree>] [--complete]
...
def main(argv=None) -> int:
    ...
    if args.verb == "inventory":
        from gruntz.lineage.ledger import inventory_main

        return inventory_main(args)
    from gruntz.lineage.ledger import verify_main
