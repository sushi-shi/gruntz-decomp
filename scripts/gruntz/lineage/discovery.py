"""Mechanical discovery for plausible Gruntz/LithTech source lineage."""
...
from gruntz.core.paths import INCLUDE, SRC
from gruntz.lineage.ledger import LEDGER, covered, load
...
EXCLUDED_DIRS = (
    # Vendored third-party code is not part of the LithTech/Gruntz lineage.
    "runtime/ui/src/freetype-",
)
ENTITY_MARKERS = {
    # Repeated game/sample implementations whose owner name differs in Gruntz.
