...
from gruntz.sema.xref import is_effectively_reached
from gruntz.verify.srcscan import RVA_RE, source_files
...
def main(argv=None) -> int:
    import argparse
    ap = argparse.ArgumentParser(prog="gruntz verify dead-code",
