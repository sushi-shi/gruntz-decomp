"""gruntz.verify.fingerprints - per-function source fingerprints (src_hash).
...
def write_cache(units: dict[str, dict],
    ...
    out = ["# func source fingerprints - generated by gruntz.verify."
           "fingerprints.\n",
           "# Derived cache (gitignored). Consumed by gruntz.verify.\n",
...
def main(argv=None) -> int:
    ...
    ap = argparse.ArgumentParser(
        prog="gruntz verify fingerprints", description=__doc__,
