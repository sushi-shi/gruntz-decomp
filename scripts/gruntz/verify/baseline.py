"""gruntz.verify.baseline - config/match_baseline.tsv I/O.

The schema is the ported one, byte-compatible for its other reader
(gruntz.walls.inventory reads cols[2] best_pct, cols[5] src_hash, cols[6] rva
...
HEADER = (
    "# gruntz match baseline - generated by gruntz.verify. DO NOT hand-edit.\n"
    ...
    "#   rva      = retail RVA (stable identity within the pinned target): a\n"
    "#              target-version migration resets best_pct/hist_pct before banking;\n"
    "#              a vanished row whose rva is still\n"
    ...
    "# Query: python3 -m gruntz.verify status | check | bank\n"
)
