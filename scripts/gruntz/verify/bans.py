"""gruntz.verify.bans - hard-fail guard for the four manual-vtable idioms.
...
score can never drift apart. Comments/strings are blanked first.
    ...
    python3 -m gruntz.verify.bans          # exit 1 on any hit (FATAL, no floor)
"""
...
from gruntz.verify.board import BANNED_LABELS, METRICS
from gruntz.verify.srcscan import blank_comments, rel, source_files
