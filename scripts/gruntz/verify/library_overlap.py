"""gruntz.verify.library_overlap - no src claim on a static-libs row (normal).

GRUNTZ.EXE statically links MFC + CRT; library code is never hand-
...
that narrowing vs the frozen gate is deliberate and recorded.
    ...
    python3 -m gruntz.verify.library_overlap
"""
