"""gruntz.verify.caller_callee - retail<->reconstruction call-graph
...
worklist:
  ...
  MISSING[-SPECIAL] / UNANALYZED   reported for navigation.
    ...
    python3 -m gruntz.verify.caller_callee [--metric] [--worklist]
    python3 -m gruntz.verify.caller_callee --check 0xb5460
"""
...
def _tu_edges(tu_flags):
    from gruntz.tool.clang import emit_ir
    tu, flags = tu_flags
