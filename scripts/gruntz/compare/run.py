"""gruntz.compare.run - the compare verb, end to end.

    python3 -m gruntz.compare.run [--base-dir build/objdiff/base]
...
def run(base_dir: Path = BASE_DIR, target_dir: Path = TARGET_DIR,
    ...
    from gruntz.manifest import load as load_manifest
