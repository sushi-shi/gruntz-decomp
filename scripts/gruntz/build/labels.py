...
# templated/namespaced vtables stay in retail/vtable_names.csv.
...
VTABLE_NAMES = REPO / "config/retail/vtable_names.csv"
...
def load_vtable_names(path):
    ...
    (config/retail/vtable_names.csv, generated by gruntz.core.vtable_scan)."""
    import csv
    m = {}
    if not Path(path).exists():
        return m
