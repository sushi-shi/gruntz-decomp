"""gruntz.delink.data_manifest - vostok's `--data-manifest` + section manifest.
...
#: `IMAGE_REL_I386_DIR32` - the only relocation type in the PE's `.reloc` dir.
COFF_DIR32 = 0x0006
...
def ehfuncinfo_rows(model: Model):
    ...
    from gruntz.delink.pdb_synth import unit_names
