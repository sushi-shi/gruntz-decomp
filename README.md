...
| :-- | --: | --: | --: | --: | --: |
| `.data` | 763,820 | 837,644 | +73,824 | **10.17%** | 627,628 |
| `.idata` | 15,169 | 15,169 | +0 &check; | **77.77%** | 3,307 |
| `.rdata` | 135,080 | 141,963 | +6,883 | **17.87%** | 66,776 |
| `.reloc` | 113,105 | 113,532 | +427 | **42.91%** | 59,255 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,009,429 | +22,250 | **50.05%** | 58,731 |
| **total** | 3,137,613 | 3,240,997 | +103,384 | **40.80%** | 815,697 |
...
_Independently of where the bytes landed, **36,274 of 36,585 address operands (99.15%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `84a0f0cce21b`, linked 2026-08-10 16:31. Regenerate: `ninja candidate`._
<!-- link-score:end -->
