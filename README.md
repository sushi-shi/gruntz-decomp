...
**Overall (vs full engine): 864 / 6,510 functions exact (13.27%) &middot; 24.03% fuzzy &middot; 24.03% fuzzy max.**
...
_Started units alone: 864/2,243 fns exact, 32.51% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   106 | 452 / 980 (46.1%) | 45.7% |     45.7% |
| `Stub`        |     2 | 118 / 837 (14.1%) |  5.4% |      5.4% |
