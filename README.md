...
**Overall (vs full engine): 2,763 / 4,492 functions exact (61.51%) &middot; 73.60% fuzzy &middot; 73.61% fuzzy max.**
...
_Started units alone: 2,763/4,263 fns exact, 73.90% fuzzy over 1,087,423 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,578 / 2,539 (62.2%) | 71.6% |     71.6% |
