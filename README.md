...
**Overall (vs full engine): 228 / 6,367 functions exact (3.58%) &middot; 6.14% fuzzy &middot; 6.14% fuzzy max.**
...
_Started units alone: 228/750 fns exact, 18.02% fuzzy over 338,023 of 991,849 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 342 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    41 | 103 / 212 (48.6%) |  43.9% |     43.9% |
