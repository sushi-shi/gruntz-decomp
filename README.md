...
**Overall (vs full engine): 1,837 / 3,451 functions exact (53.23%) &middot; 55.89% fuzzy &middot; 55.89% fuzzy max.**
...
_Started units alone: 1,837/3,394 fns exact, 55.94% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   364 | 1,177 / 2,266 (51.9%) | 60.9% |     60.9% |
| `Stub`        |     7 |     131 / 330 (39.7%) | 11.9% |     11.9% |
