...
**Overall (vs full engine): 935 / 6,510 functions exact (14.36%) &middot; 26.27% fuzzy &middot; 26.27% fuzzy max.**
...
_Started units alone: 935/2,244 fns exact, 35.54% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   127 | 503 / 1,063 (47.3%) | 47.5% |     47.5% |
| `Stub`        |     2 |   118 / 719 (16.4%) |  5.8% |      5.8% |
