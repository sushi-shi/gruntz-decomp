...
**Overall (vs full engine): 1,769 / 3,857 functions exact (45.86%) &middot; 65.77% fuzzy &middot; 66.08% fuzzy max.**
...
_Started units alone: 1,769/3,711 fns exact, 66.57% fuzzy over 1,056,873 of 1,069,760 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 898 / 1,883 (47.7%) | 68.3% |     68.7% |
| `Stub`        |    22 |   193 / 692 (27.9%) | 19.0% |     19.1% |
