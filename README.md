...
**Overall (vs full engine): 2,347 / 3,970 functions exact (59.12%) &middot; 73.19% fuzzy &middot; 73.23% fuzzy max.**
...
_Started units alone: 2,347/3,962 fns exact, 72.98% fuzzy over 1,081,116 of 1,078,034 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,334 / 2,368 (56.3%) | 70.6% |     70.6% |
