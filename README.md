...
**Overall (vs full engine): 1,864 / 3,364 functions exact (55.41%) &middot; 64.41% fuzzy &middot; 64.41% fuzzy max.**
...
_Started units alone: 1,864/3,361 fns exact, 64.45% fuzzy over 970,153 of 970,780 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   416 | 1,209 / 2,359 (51.3%) | 61.9% |     61.9% |
