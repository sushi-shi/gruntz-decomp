...
**Overall (vs full engine): 2,913 / 4,509 functions exact (64.60%) &middot; 75.98% fuzzy &middot; 76.07% fuzzy max.**
...
_Started units alone: 2,913/4,263 fns exact, 76.27% fuzzy over 1,088,864 of 1,093,057 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,687 / 2,539 (66.4%) | 74.6% |     74.7% |
