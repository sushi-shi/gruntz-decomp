...
**Overall (vs full engine): 1,812 / 3,279 functions exact (55.26%) &middot; 67.32% fuzzy &middot; 67.32% fuzzy max.**
...
_Started units alone: 1,812/3,276 fns exact, 67.36% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,215 / 2,377 (51.1%) | 63.9% |     63.9% |
| `Net`         |    18 |      92 / 145 (63.4%) | 79.4% |     79.4% |
