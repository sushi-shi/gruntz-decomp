...
**Overall (vs full engine): 1,786 / 3,451 functions exact (51.75%) &middot; 53.71% fuzzy &middot; 53.71% fuzzy max.**
...
_Started units alone: 1,786/3,394 fns exact, 53.76% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   345 | 1,163 / 2,237 (52.0%) | 60.2% |     60.2% |
| `Stub`        |     7 |     103 / 368 (28.0%) |  8.2% |      8.2% |
