...
**Overall (vs full engine): 848 / 6,510 functions exact (13.03%) &middot; 23.59% fuzzy &middot; 23.59% fuzzy max.**
...
_Started units alone: 848/2,243 fns exact, 31.92% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   101 | 444 / 959 (46.3%) | 45.2% |     45.2% |
| `Stub`        |     2 | 118 / 874 (13.5%) |  5.3% |      5.3% |
