...
**Overall (vs full engine): 224 / 6,367 functions exact (3.52%) &middot; 6.09% fuzzy &middot; 6.09% fuzzy max.**
...
_Started units alone: 224/746 fns exact, 17.90% fuzzy over 337,615 of 991,849 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Stub`        |     1 |   0 / 345 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    39 | 99 / 205 (48.3%) |  43.4% |     43.4% |
