...
**Overall (vs full engine): 1,726 / 3,856 functions exact (44.76%) &middot; 64.84% fuzzy &middot; 65.15% fuzzy max.**
...
_Started units alone: 1,726/3,709 fns exact, 65.63% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 866 / 1,843 (47.0%) | 68.0% |     68.4% |
| `Stub`        |    22 |   193 / 745 (25.9%) | 17.3% |     17.4% |
