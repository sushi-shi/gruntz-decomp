...
**Overall (vs full engine): 585 / 6,510 functions exact (8.99%) &middot; 13.86% fuzzy &middot; 13.86% fuzzy max.**
...
_Started units alone: 585/2,239 fns exact, 18.98% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,385 (8.4%) |  3.5% |      3.5% |
| `Gruntz`      |    58 |  230 / 514 (44.7%) | 37.0% |     37.0% |
