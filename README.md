...
**Overall (vs full engine): 416 / 6,510 functions exact (6.39%) &middot; 11.14% fuzzy &middot; 11.14% fuzzy max.**
...
_Started units alone: 416/2,238 fns exact, 15.26% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | -----: | --------: |
| `Stub`        |     2 | 120 / 1,649 (7.3%) |   3.4% |      3.4% |
| `Gruntz`      |    49 |  128 / 344 (37.2%) |  30.3% |     30.3% |
