...
**Overall (vs full engine): 2,346 / 3,970 functions exact (59.09%) &middot; 73.12% fuzzy &middot; 73.17% fuzzy max.**
...
_Started units alone: 2,346/3,962 fns exact, 72.92% fuzzy over 1,081,100 of 1,078,018 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,332 / 2,368 (56.2%) | 70.5% |     70.5% |
