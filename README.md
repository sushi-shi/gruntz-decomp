...
**Overall (vs full engine): 1,061 / 7,097 functions exact (14.95%) &middot; 29.20% fuzzy &middot; 29.20% fuzzy max.**
...
_Started units alone: 1,061/3,243 fns exact, 30.94% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,507 (7.8%) |  4.0% |      4.0% |
| `Gruntz`      |   166 | 612 / 1,250 (49.0%) | 50.1% |     50.1% |
