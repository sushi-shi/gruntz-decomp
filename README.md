...
**Overall (vs full engine): 2,925 / 4,314 functions exact (67.80%) &middot; 94.07% fuzzy &middot; 94.07% fuzzy max.**

**Data — reconstructable coverage 99.59% &middot; gross coverage 40.83% &middot; fidelity 100.00%** (initialized data; `.bss` 92.32% / 100.00% is reported apart).
