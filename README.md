...
**Overall (vs full engine): 2,699 / 4,337 functions exact (62.23%) &middot; 73.53% fuzzy &middot; 73.53% fuzzy max.**
...
_Started units alone: 2,699/4,203 fns exact, 73.71% fuzzy over 1,083,751 of 1,086,468 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,547 / 2,514 (61.5%) | 71.4% |     71.4% |
