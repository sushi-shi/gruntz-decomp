...
**Overall (vs full engine): 1,867 / 3,290 functions exact (56.75%) &middot; 71.54% fuzzy &middot; 71.55% fuzzy max.**
...
_Started units alone: 1,867/3,857 fns exact, 64.03% fuzzy over 1,075,174 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,137 / 2,086 (54.5%) | 68.8% |     68.8% |
| `Stub`        |     1 |       19 / 619 (3.1%) |  3.5% |      3.5% |
