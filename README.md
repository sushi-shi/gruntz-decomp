...
**Overall (vs full engine): 1,837 / 3,451 functions exact (53.23%) &middot; 55.81% fuzzy &middot; 55.81% fuzzy max.**
...
_Started units alone: 1,837/3,394 fns exact, 55.86% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   363 | 1,177 / 2,265 (52.0%) | 60.9% |     60.9% |
| `Stub`        |     7 |     131 / 331 (39.6%) | 11.8% |     11.8% |
