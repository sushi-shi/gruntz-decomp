...
**Overall (vs full engine): 2,257 / 3,890 functions exact (58.02%) &middot; 72.81% fuzzy &middot; 72.81% fuzzy max.**
...
_Started units alone: 2,257/3,880 fns exact, 72.77% fuzzy over 1,069,097 of 1,068,518 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   265 | 1,385 / 2,497 (55.5%) | 70.1% |     70.1% |
