...
**Overall (vs full engine): 1,325 / 3,543 functions exact (37.40%) &middot; 37.98% fuzzy &middot; 37.98% fuzzy max.**
...
_Started units alone: 1,325/3,507 fns exact, 38.01% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   191 | 813 / 1,635 (49.7%) | 54.3% |     54.3% |
| `Stub`        |     5 |  105 / 1,256 (8.4%) |  4.1% |      4.1% |
