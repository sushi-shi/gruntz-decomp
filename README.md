...
**Overall (vs full engine): 1,839 / 3,856 functions exact (47.69%) &middot; 63.59% fuzzy &middot; 63.68% fuzzy max.**
...
_Started units alone: 1,839/3,824 fns exact, 64.23% fuzzy over 1,058,943 of 1,069,620 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,109 / 2,081 (53.3%) | 68.4% |     68.6% |
