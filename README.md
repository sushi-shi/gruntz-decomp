...
**Overall (vs full engine): 867 / 6,510 functions exact (13.32%) &middot; 24.10% fuzzy &middot; 24.10% fuzzy max.**
...
_Started units alone: 867/2,243 fns exact, 32.61% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   107 | 455 / 984 (46.2%) | 45.8% |     45.8% |
| `Stub`        |     2 | 118 / 833 (14.2%) |  5.4% |      5.4% |
