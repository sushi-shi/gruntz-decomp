...
**Overall (vs full engine): 1,319 / 7,435 functions exact (17.74%) &middot; 37.55% fuzzy &middot; 37.55% fuzzy max.**
...
_Started units alone: 1,319/3,234 fns exact, 40.02% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   191 | 810 / 1,630 (49.7%) | 54.2% |     54.2% |
| `Stub`        |     4 |   105 / 991 (10.6%) |  4.5% |      4.5% |
