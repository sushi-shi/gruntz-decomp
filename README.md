...
**Overall (vs full engine): 3,257 / 4,269 functions exact (76.29%) &middot; 85.25% fuzzy &middot; 85.48% fuzzy max.**
...
_Started units alone: 3,257/4,269 fns exact, 84.06% fuzzy over 1,099,713 of 1,084,324 engine code bytes._

| Module       | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | ----: | --------: |
| `Gruntz`     |   245 | 1,853 / 2,541 (72.9%) | 82.9% |     83.2% |
| `DDrawMgr`   |    23 |     454 / 571 (79.5%) | 80.0% |     80.4% |
