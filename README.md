...
**Overall (vs full engine): 1,369 / 3,451 functions exact (39.67%) &middot; 39.36% fuzzy &middot; 39.36% fuzzy max.**
...
_Started units alone: 1,369/3,415 fns exact, 39.39% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   199 | 844 / 1,697 (49.7%) | 54.9% |     54.9% |
| `Stub`        |     5 |  105 / 1,079 (9.7%) |  4.3% |      4.3% |
