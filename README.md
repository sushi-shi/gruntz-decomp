...
**Overall (vs full engine): 980 / 7,098 functions exact (13.81%) &middot; 27.15% fuzzy &middot; 27.15% fuzzy max.**
...
_Started units alone: 980/2,268 fns exact, 36.60% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   146 | 545 / 1,130 (48.2%) | 48.5% |     48.5% |
| `Stub`        |     2 |   118 / 671 (17.6%) |  5.9% |      5.9% |
