...
**Overall (vs full engine): 2,346 / 3,970 functions exact (59.09%) &middot; 73.18% fuzzy &middot; 73.24% fuzzy max.**
...
_Started units alone: 2,346/3,962 fns exact, 72.97% fuzzy over 1,081,116 of 1,078,034 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   257 | 1,333 / 2,368 (56.3%) | 70.6% |     70.6% |
| `DDrawMgr`    |    26 |     301 / 514 (58.6%) | 67.8% |     68.0% |
