...
**Overall (vs full engine): 1,655 / 3,451 functions exact (47.96%) &middot; 49.83% fuzzy &middot; 49.83% fuzzy max.**
...
_Started units alone: 1,655/3,393 fns exact, 49.87% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   319 | 1,032 / 2,034 (50.7%) | 58.5% |     58.5% |
| `Stub`        |     7 |     113 / 592 (19.1%) |  6.6% |      6.6% |
