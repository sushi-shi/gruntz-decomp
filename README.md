...
**Overall (vs full engine): 2,389 / 3,983 functions exact (59.98%) &middot; 73.38% fuzzy &middot; 73.50% fuzzy max.**
...
_Started units alone: 2,389/3,975 fns exact, 73.17% fuzzy over 1,081,189 of 1,078,107 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,343 / 2,365 (56.8%) | 70.8% |     70.9% |
