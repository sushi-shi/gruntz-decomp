...
**Overall (vs full engine): 416 / 6,510 functions exact (6.39%) &middot; 10.92% fuzzy &middot; 10.92% fuzzy max.**
...
_Started units alone: 416/1,126 fns exact, 22.19% fuzzy over 488,151 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 121 / 593 (20.4%) |   4.6% |      4.6% |
| `Gruntz`      |    49 | 127 / 290 (43.8%) |  53.9% |     53.9% |
