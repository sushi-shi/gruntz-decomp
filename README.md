...
**Overall (vs full engine): 517 / 6,510 functions exact (7.94%) &middot; 12.80% fuzzy &middot; 12.80% fuzzy max.**
...
_Started units alone: 517/2,238 fns exact, 17.53% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,482 (7.9%) |  3.5% |      3.5% |
| `Gruntz`      |    53 |  181 / 445 (40.7%) | 34.9% |     34.9% |
