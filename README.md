...
**Overall (vs full engine): 3,303 / 4,299 functions exact (76.83%) &middot; 90.14% fuzzy &middot; 90.14% fuzzy max.**
...
_Started units alone: 3,303/4,290 fns exact, 88.52% fuzzy over 1,113,125 of 1,093,139 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,871 / 2,562 (73.0%) |  87.9% |     87.9% |
