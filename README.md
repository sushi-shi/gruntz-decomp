...
**Overall (vs full engine): 2,062 / 3,811 functions exact (54.11%) &middot; 70.85% fuzzy &middot; 70.85% fuzzy max.**
...
_Started units alone: 2,062/3,716 fns exact, 70.97% fuzzy over 1,066,124 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   361 | 1,184 / 2,298 (51.5%) | 68.3% |     68.3% |
