...
**Overall (vs full engine): 1,860 / 3,364 functions exact (55.29%) &middot; 64.40% fuzzy &middot; 64.40% fuzzy max.**
...
_Started units alone: 1,860/3,361 fns exact, 64.44% fuzzy over 970,153 of 970,780 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   416 | 1,206 / 2,359 (51.1%) | 61.9% |     61.9% |
