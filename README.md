...
**Overall (vs full engine): 284 / 6,371 functions exact (4.46%) &middot; 8.36% fuzzy &middot; 8.36% fuzzy max.**
...
_Started units alone: 284/1,078 fns exact, 17.33% fuzzy over 478,727 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 592 (0.0%) |   0.6% |      0.6% |
