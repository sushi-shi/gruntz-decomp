...
**Overall (vs full engine): 532 / 6,510 functions exact (8.17%) &middot; 12.96% fuzzy &middot; 12.96% fuzzy max.**
...
_Started units alone: 532/2,238 fns exact, 17.76% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,461 (8.0%) |  3.5% |      3.5% |
| `Gruntz`      |    55 |  192 / 460 (41.7%) | 35.3% |     35.3% |
