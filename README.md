...
**Overall (vs full engine): 1,754 / 3,856 functions exact (45.49%) &middot; 65.51% fuzzy &middot; 65.82% fuzzy max.**
...
_Started units alone: 1,754/3,710 fns exact, 66.31% fuzzy over 1,056,736 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 889 / 1,869 (47.6%) | 68.3% |     68.6% |
| `Stub`        |    22 |   193 / 714 (27.0%) | 18.5% |     18.6% |
