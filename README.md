...
**Overall (vs full engine): 715 / 6,510 functions exact (10.98%) &middot; 21.22% fuzzy &middot; 21.22% fuzzy max.**
...
_Started units alone: 715/2,242 fns exact, 28.72% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,100 (11.0%) |  5.1% |      5.1% |
| `Gruntz`      |    77 |   352 / 793 (44.4%) | 43.1% |     43.1% |
