...
**Overall (vs full engine): 2,162 / 3,811 functions exact (56.73%) &middot; 72.12% fuzzy &middot; 72.12% fuzzy max.**
...
_Started units alone: 2,162/3,794 fns exact, 72.08% fuzzy over 1,068,437 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   364 | 1,259 / 2,354 (53.5%) | 69.2% |     69.2% |
| `DDrawMgr`    |    33 |     205 / 391 (52.4%) | 66.9% |     66.9% |
| `Net`         |    22 |     126 / 187 (67.4%) | 87.2% |     87.2% |
| `Image`       |    28 |      82 / 165 (49.7%) | 80.7% |     80.7% |
| `Dsndmgr`     |    12 |      99 / 134 (73.9%) | 92.8% |     92.8% |
| `Bute`        |    10 |      72 / 126 (57.1%) | 73.3% |     73.3% |
| `Wwd`         |     9 |       41 / 99 (41.4%) | 80.5% |     80.5% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Io`          |     7 |       44 / 58 (75.9%) | 89.9% |     89.9% |
| `Wap32`       |    10 |       46 / 57 (80.7%) | 92.7% |     92.7% |
| `DinMgr2`     |     1 |       45 / 51 (88.2%) | 98.7% |     98.7% |
| `Rez`         |     7 |       34 / 46 (73.9%) | 76.8% |     76.8% |
| `Font`        |     1 |       19 / 24 (79.2%) | 82.0% |     82.0% |
| `Utils`       |     8 |       21 / 23 (91.3%) | 99.7% |     99.7% |
| `Crypto`      |     3 |        9 / 16 (56.2%) | 69.2% |     69.2% |
| `Globals.cpp` |     1 |          0 / 0 (0.0%) |  0.0% |      0.0% |
| `(unmatched)` |     — |         0 / 17 (0.0%) |  0.0% |      0.0% |
