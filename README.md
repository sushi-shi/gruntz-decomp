...
**Overall (vs full engine): 3,121 / 4,492 functions exact (69.48%) &middot; 78.16% fuzzy &middot; 78.24% fuzzy max.**
...
_Started units alone: 3,121/4,263 fns exact, 78.36% fuzzy over 1,089,137 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,789 / 2,538 (70.5%) | 77.0% |     77.1% |
