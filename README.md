...
**Overall (vs full engine): 3,280 / 4,297 functions exact (76.33%) &middot; 88.39% fuzzy &middot; 88.47% fuzzy max.**
...
_Started units alone: 3,280/4,288 fns exact, 86.81% fuzzy over 1,113,117 of 1,093,131 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   234 | 1,848 / 2,558 (72.2%) |  86.1% |     86.2% |
