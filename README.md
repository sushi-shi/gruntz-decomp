...
**Overall (vs full engine): 3,452 / 4,314 functions exact (80.02%) &middot; 94.49% fuzzy &middot; 94.50% fuzzy max.**
...
_Started units alone: 3,452/4,327 fns exact, 92.85% fuzzy over 1,134,118 of 1,114,364 engine code bytes._
...
| `.text` | 1,987,179 | 2,010,193 | +23,014 | **50.03%** | 58,731 |
| **total** | 3,137,613 | 3,241,746 | +104,133 | **40.78%** | 815,697 |
...
_Independently of where the bytes landed, **36,296 of 36,589 address operands (99.20%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `301246bf982a`, linked 2026-08-10 16:55. Regenerate: `ninja candidate`._
<!-- link-score:end -->
