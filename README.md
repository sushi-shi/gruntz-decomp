...
**Overall (vs full engine): 2,288 / 3,955 functions exact (57.85%) &middot; 72.16% fuzzy &middot; 72.16% fuzzy max.**
...
_Started units alone: 2,288/3,945 fns exact, 71.95% fuzzy over 1,080,797 of 1,077,721 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,307 / 2,361 (55.4%) | 69.3% |     69.3% |
