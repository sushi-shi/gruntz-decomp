...
**Overall (vs full engine): 1,342 / 3,543 functions exact (37.88%) &middot; 38.24% fuzzy &middot; 38.24% fuzzy max.**
...
_Started units alone: 1,342/3,507 fns exact, 38.27% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   191 | 826 / 1,658 (49.8%) | 54.4% |     54.4% |
| `Stub`        |     5 |  105 / 1,224 (8.6%) |  4.1% |      4.1% |
