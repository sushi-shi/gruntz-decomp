...
**Overall (vs full engine): 254 / 6,371 functions exact (3.99%) &middot; 7.24% fuzzy &middot; 7.24% fuzzy max.**
...
_Started units alone: 254/821 fns exact, 20.73% fuzzy over 346,304 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 385 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    46 | 112 / 235 (47.7%) |  51.4% |     51.4% |
