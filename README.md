...
**Overall (vs full engine): 3,449 / 4,314 functions exact (79.95%) &middot; 94.54% fuzzy &middot; 94.54% fuzzy max.**
...
| `.text` | 1,987,179 | 2,010,289 | +23,110 | **50.09%** | 58,731 |
| **total** | 3,137,613 | 3,241,746 | +104,133 | **40.82%** | 815,697 |
...
_Independently of where the bytes landed, **36,439 of 36,726 address operands (99.22%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `c19160a4ba78`, linked 2026-08-10 16:23. Regenerate: `ninja candidate`._
<!-- link-score:end -->
