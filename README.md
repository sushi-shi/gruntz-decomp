...
**Overall (vs full engine): 3,682 / 4,427 functions exact (83.17%) &middot; 94.55% fuzzy &middot; 94.78% fuzzy max.**
...
_Started units alone: 3,682/4,427 fns exact, 94.59% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,147 / 2,652 (81.0%) |  94.4% |     94.6% |
...
| `Net`        |     9 |     120 / 136 (88.2%) |  97.6% |     97.7% |
| `Image`      |     7 |      79 / 112 (70.5%) |  95.1% |     95.2% |
