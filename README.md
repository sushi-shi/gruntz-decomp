...
**Overall (vs full engine): 682 / 6,510 functions exact (10.48%) &middot; 19.89% fuzzy &middot; 19.89% fuzzy max.**
...
_Started units alone: 682/2,242 fns exact, 26.91% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,174 (10.3%) |  4.6% |      4.6% |
| `Gruntz`      |    70 |   320 / 724 (44.2%) | 44.1% |     44.1% |
