...
**Overall (vs full engine): 2,208 / 3,844 functions exact (57.44%) &middot; 72.77% fuzzy &middot; 72.77% fuzzy max.**
...
_Started units alone: 2,208/3,834 fns exact, 72.73% fuzzy over 1,068,695 of 1,068,116 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   279 | 1,336 / 2,446 (54.6%) | 70.0% |     70.0% |
| `DDrawMgr`    |    20 |     215 / 394 (54.6%) | 70.8% |     70.8% |
| `Wwd`         |     8 |      85 / 173 (49.1%) | 78.3% |     78.3% |
