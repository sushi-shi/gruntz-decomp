...
**Overall (vs full engine): 1,845 / 3,856 functions exact (47.85%) &middot; 63.63% fuzzy &middot; 63.67% fuzzy max.**
...
_Started units alone: 1,845/3,824 fns exact, 64.27% fuzzy over 1,058,943 of 1,069,620 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,115 / 2,081 (53.6%) | 68.5% |     68.6% |
