...
**Overall (vs full engine): 3,321 / 4,300 functions exact (77.23%) &middot; 90.69% fuzzy &middot; 90.78% fuzzy max.**
...
_Started units alone: 3,321/4,290 fns exact, 89.07% fuzzy over 1,113,088 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,883 / 2,561 (73.5%) |  88.6% |     88.8% |
| `DDrawMgr`    |    22 |     475 / 572 (83.0%) |  87.0% |     87.1% |
