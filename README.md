...
**Overall (vs full engine): 1,713 / 3,856 functions exact (44.42%) &middot; 64.27% fuzzy &middot; 64.58% fuzzy max.**
...
_Started units alone: 1,713/3,709 fns exact, 65.05% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   325 | 855 / 1,822 (46.9%) | 67.9% |     68.2% |
| `Stub`        |    22 |   193 / 770 (25.1%) | 16.3% |     16.4% |
