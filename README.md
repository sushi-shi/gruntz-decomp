...
**Overall (vs full engine): 751 / 6,510 functions exact (11.54%) &middot; 22.41% fuzzy &middot; 22.41% fuzzy max.**
...
_Started units alone: 751/2,242 fns exact, 30.33% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,024 (11.8%) |  5.4% |      5.4% |
| `Gruntz`      |    85 |   385 / 857 (44.9%) | 44.2% |     44.2% |
