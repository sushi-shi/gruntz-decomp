...
**Overall (vs full engine): 3,116 / 4,346 functions exact (71.70%) &middot; 78.19% fuzzy &middot; 78.30% fuzzy max.**
...
_Started units alone: 3,116/4,261 fns exact, 78.29% fuzzy over 1,088,827 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,789 / 2,539 (70.5%) | 76.9% |     77.1% |
