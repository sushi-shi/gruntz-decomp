...
**Overall (vs full engine): 1,781 / 3,451 functions exact (51.61%) &middot; 51.00% fuzzy &middot; 51.00% fuzzy max.**
...
_Started units alone: 1,781/3,393 fns exact, 51.04% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   334 | 1,159 / 2,196 (52.8%) | 59.1% |     59.1% |
| `Stub`        |     7 |     103 / 420 (24.5%) |  6.9% |      6.9% |
