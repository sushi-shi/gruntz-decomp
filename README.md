...
**Overall (vs full engine): 1,372 / 3,451 functions exact (39.76%) &middot; 39.57% fuzzy &middot; 39.57% fuzzy max.**
...
_Started units alone: 1,372/3,415 fns exact, 39.60% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   200 | 845 / 1,698 (49.8%) | 54.9% |     54.9% |
| `Stub`        |     5 |  105 / 1,071 (9.8%) |  4.3% |      4.3% |
