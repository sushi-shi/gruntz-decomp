...
**Overall (vs full engine): 1,581 / 3,451 functions exact (45.81%) &middot; 47.43% fuzzy &middot; 47.43% fuzzy max.**
...
_Started units alone: 1,581/3,393 fns exact, 47.47% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   293 | 966 / 1,942 (49.7%) | 58.4% |     58.4% |
| `Stub`        |     7 |   107 / 696 (15.4%) |  5.5% |      5.5% |
