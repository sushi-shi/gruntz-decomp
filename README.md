...
**Overall (vs full engine): 3,480 / 4,316 functions exact (80.63%) &middot; 94.70% fuzzy &middot; 94.71% fuzzy max.**
...
_Started units alone: 3,480/4,335 fns exact, 93.05% fuzzy over 1,134,122 of 1,114,355 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,986 / 2,577 (77.1%) |  92.6% |     92.6% |
...
| `Image`      |    10 |      87 / 121 (71.9%) |  93.7% |     93.7% |
| `Rez`        |     7 |       63 / 75 (84.0%) |  90.9% |     90.9% |
