...
**Overall (vs full engine): 1,018 / 7,098 functions exact (14.34%) &middot; 27.86% fuzzy &middot; 27.86% fuzzy max.**
...
_Started units alone: 1,018/2,270 fns exact, 37.55% fuzzy over 738,623 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   165 | 581 / 1,187 (48.9%) | 49.2% |     49.2% |
| `Stub`        |     2 |   118 / 612 (19.3%) |  6.0% |      6.0% |
