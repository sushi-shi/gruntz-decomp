...
**Overall (vs full engine): 3,243 / 4,301 functions exact (75.40%) &middot; 87.58% fuzzy &middot; 87.82% fuzzy max.**
...
_Started units alone: 3,243/4,297 fns exact, 85.92% fuzzy over 1,114,371 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,821 / 2,555 (71.3%) |  85.2% |     85.4% |
