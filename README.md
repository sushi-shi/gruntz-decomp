...
**Overall (vs full engine): 3,471 / 4,301 functions exact (80.70%) &middot; 92.60% fuzzy &middot; 92.63% fuzzy max.**
...
_Started units alone: 3,471/4,301 fns exact, 90.97% fuzzy over 1,112,794 of 1,093,174 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,001 / 2,567 (78.0%) |  90.4% |     90.4% |
| `DDrawMgr`    |    22 |     485 / 571 (84.9%) |  87.8% |     87.8% |
