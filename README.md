...
**Overall (vs full engine): 3,690 / 4,427 functions exact (83.35%) &middot; 94.57% fuzzy &middot; 94.79% fuzzy max.**
...
_Started units alone: 3,690/4,427 fns exact, 94.61% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,148 / 2,652 (81.0%) |  94.4% |     94.6% |
