...
**Overall (vs full engine): 401 / 6,371 functions exact (6.29%) &middot; 9.78% fuzzy &middot; 9.78% fuzzy max.**
...
_Started units alone: 401/1,086 fns exact, 20.18% fuzzy over 480,579 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 111 / 584 (19.0%) |   3.5% |      3.5% |
| `Gruntz`      |    47 | 127 / 266 (47.7%) |  51.1% |     51.1% |
