...
**Overall (vs full engine): 1,837 / 3,281 functions exact (55.99%) &middot; 68.56% fuzzy &middot; 68.56% fuzzy max.**
...
_Started units alone: 1,837/3,277 fns exact, 68.67% fuzzy over 964,038 of 965,483 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   426 | 1,260 / 2,420 (52.1%) | 65.2% |     65.2% |
