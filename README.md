...
**Overall (vs full engine): 2,346 / 3,972 functions exact (59.06%) &middot; 72.92% fuzzy &middot; 72.96% fuzzy max.**
...
_Started units alone: 2,346/3,962 fns exact, 72.71% fuzzy over 1,081,100 of 1,078,032 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,332 / 2,368 (56.2%) | 70.2% |     70.3% |
| `DDrawMgr`    |    26 |     301 / 514 (58.6%) | 67.8% |     67.8% |
| `Wwd`         |     8 |      89 / 184 (48.4%) | 78.8% |     79.1% |
| `Bute`        |    11 |      88 / 159 (55.3%) | 74.7% |     74.7% |
| `Dsndmgr`     |     5 |     104 / 138 (75.4%) | 92.7% |     92.7% |
| `Net`         |    13 |      90 / 126 (71.4%) | 93.6% |     93.6% |
| `Image`       |    16 |      57 / 124 (46.0%) | 80.9% |     81.0% |
| `Rez`         |     7 |       56 / 77 (72.7%) | 78.8% |     78.8% |
...
| `CRT/MFC library`    |     2,254 |  207,135 | FID-identified, statically linked                 |
| `jump thunks`        |     1,675 |    8,328 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
