...
**Overall (vs full engine): 3,108 / 4,492 functions exact (69.19%) &middot; 78.07% fuzzy &middot; 78.19% fuzzy max.**
...
_Started units alone: 3,108/4,263 fns exact, 78.27% fuzzy over 1,089,137 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,786 / 2,539 (70.3%) | 76.9% |     77.1% |
| `DDrawMgr`    |    26 |     425 / 573 (74.2%) | 71.7% |     71.8% |
