...
**Overall (vs full engine): 1,812 / 3,279 functions exact (55.26%) &middot; 65.86% fuzzy &middot; 65.86% fuzzy max.**
...
_Started units alone: 1,812/3,276 fns exact, 65.90% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,216 / 2,377 (51.2%) | 62.8% |     62.8% |
