...
**Overall (vs full engine): 524 / 6,510 functions exact (8.05%) &middot; 12.86% fuzzy &middot; 12.86% fuzzy max.**
...
_Started units alone: 524/2,238 fns exact, 17.62% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,474 (7.9%) |  3.5% |      3.5% |
| `Gruntz`      |    53 |  188 / 453 (41.5%) | 35.1% |     35.1% |
