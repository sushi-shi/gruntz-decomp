...
**Overall (vs full engine): 2,347 / 3,970 functions exact (59.12%) &middot; 72.92% fuzzy &middot; 72.95% fuzzy max.**
...
_Started units alone: 2,347/3,960 fns exact, 72.71% fuzzy over 1,081,098 of 1,078,018 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,332 / 2,368 (56.2%) | 70.2% |     70.3% |
| `DDrawMgr`    |    26 |     300 / 514 (58.4%) | 67.8% |     67.8% |
