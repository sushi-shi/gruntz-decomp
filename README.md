...
**Overall (vs full engine): 1,382 / 3,451 functions exact (40.05%) &middot; 41.53% fuzzy &middot; 41.53% fuzzy max.**
...
_Started units alone: 1,382/3,415 fns exact, 41.56% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   205 | 850 / 1,729 (49.2%) | 56.1% |     56.1% |
| `Stub`        |     5 | 105 / 1,037 (10.1%) |  4.5% |      4.5% |
