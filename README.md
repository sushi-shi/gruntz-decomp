...
**Overall (vs full engine): 415 / 6,510 functions exact (6.37%) &middot; 10.85% fuzzy &middot; 10.85% fuzzy max.**
...
_Started units alone: 415/1,092 fns exact, 22.27% fuzzy over 483,556 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 120 / 562 (21.4%) |   4.5% |      4.5% |
