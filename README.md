...
**Overall (vs full engine): 3,707 / 4,427 functions exact (83.74%) &middot; 94.99% fuzzy &middot; 95.16% fuzzy max.**
...
_Started units alone: 3,707/4,427 fns exact, 95.04% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,155 / 2,648 (81.4%) |  94.9% |     95.0% |
