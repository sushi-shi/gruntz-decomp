...
**Overall (vs full engine): 720 / 6,510 functions exact (11.06%) &middot; 21.56% fuzzy &middot; 21.56% fuzzy max.**
...
_Started units alone: 720/2,242 fns exact, 29.18% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,082 (11.2%) |  5.2% |      5.2% |
| `Gruntz`      |    78 |   354 / 800 (44.2%) | 43.4% |     43.4% |
