...
**Data: 100.00% size-weighted across 720,763 B** (`.bss` 100.00%, `.data` 100.00%, `.rdata` 99.99%) &middot; 99.77% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
