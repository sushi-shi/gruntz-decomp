...
**Overall (vs full engine): 1,330 / 3,543 functions exact (37.54%) &middot; 38.10% fuzzy &middot; 38.10% fuzzy max.**
...
_Started units alone: 1,330/3,507 fns exact, 38.13% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   191 | 815 / 1,642 (49.6%) | 54.3% |     54.3% |
| `Stub`        |     5 |  105 / 1,242 (8.5%) |  4.1% |      4.1% |
