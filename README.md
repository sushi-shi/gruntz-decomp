...
**Overall (vs full engine): 680 / 6,510 functions exact (10.45%) &middot; 19.74% fuzzy &middot; 19.74% fuzzy max.**
...
_Started units alone: 680/2,242 fns exact, 26.71% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,178 (10.3%) |  4.5% |      4.5% |
| `Gruntz`      |    69 |   318 / 720 (44.2%) | 44.7% |     44.7% |
