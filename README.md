...
**Overall (vs full engine): 3,319 / 4,300 functions exact (77.19%) &middot; 90.74% fuzzy &middot; 90.75% fuzzy max.**
...
_Started units alone: 3,319/4,291 fns exact, 89.11% fuzzy over 1,113,130 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,881 / 2,562 (73.4%) |  88.7% |     88.7% |
