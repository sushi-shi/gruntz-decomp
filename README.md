...
**Overall (vs full engine): 3,451 / 4,300 functions exact (80.26%) &middot; 91.42% fuzzy &middot; 91.52% fuzzy max.**
...
_Started units alone: 3,451/4,300 fns exact, 89.69% fuzzy over 1,114,173 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,988 / 2,565 (77.5%) |  89.1% |     89.2% |
