...
**Overall (vs full engine): 3,275 / 4,266 functions exact (76.77%) &middot; 87.04% fuzzy &middot; 87.19% fuzzy max.**
...
_Started units alone: 3,275/4,265 fns exact, 85.50% fuzzy over 1,103,223 of 1,083,761 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,872 / 2,547 (73.5%) |  84.5% |     84.7% |
