...
**Overall (vs full engine): 1,381 / 3,543 functions exact (38.98%) &middot; 38.66% fuzzy &middot; 38.66% fuzzy max.**
...
_Started units alone: 1,381/3,485 fns exact, 38.70% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   202 | 862 / 1,709 (50.4%) | 54.8% |     54.8% |
| `Stub`        |     5 |  105 / 1,148 (9.1%) |  4.1% |      4.1% |
