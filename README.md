...
**Overall (vs full engine): 2,162 / 3,811 functions exact (56.73%) &middot; 71.83% fuzzy &middot; 71.83% fuzzy max.**
...
_Started units alone: 2,162/3,794 fns exact, 71.79% fuzzy over 1,068,437 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   364 | 1,259 / 2,354 (53.5%) | 68.8% |     68.8% |
