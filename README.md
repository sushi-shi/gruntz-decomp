...
**Overall (vs full engine): 1,866 / 3,357 functions exact (55.59%) &middot; 65.42% fuzzy &middot; 65.42% fuzzy max.**
...
_Started units alone: 1,866/3,354 fns exact, 65.46% fuzzy over 967,845 of 968,475 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   417 | 1,213 / 2,359 (51.4%) | 62.5% |     62.5% |
