...
**Overall (vs full engine): 1,867 / 3,397 functions exact (54.96%) &middot; 62.50% fuzzy &middot; 62.50% fuzzy max.**
...
_Started units alone: 1,867/3,394 fns exact, 62.54% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   395 | 1,196 / 2,322 (51.5%) | 62.0% |     62.0% |
| `Stub`        |     7 |     139 / 268 (51.9%) | 31.5% |     31.5% |
