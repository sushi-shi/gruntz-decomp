...
**Candidate image: 2,541,568 B vs retail 2,511,872 B (101.18%, +29,696 B).**

| section | retail | candidate | delta | retail bytes reproduced | not measurable |
| :-- | --: | --: | --: | --: | --: |
| `.data` | 763,820 | 837,580 | +73,760 | **10.17%** | 627,628 |
| `.idata` | 15,169 | 15,169 | +0 &check; | **77.42%** | 3,307 |
| `.rdata` | 135,080 | 141,963 | +6,883 | **17.87%** | 66,776 |
| `.reloc` | 113,105 | 113,408 | +303 | **42.88%** | 59,255 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,008,149 | +20,970 | **50.00%** | 58,731 |
| **total** | 3,137,613 | 3,239,529 | +101,916 | **40.76%** | 815,697 |
...
_Candidate `09153ee1669e`, linked 2026-08-10 15:01. Regenerate: `ninja candidate`._
<!-- link-score:end -->
