...
**Overall (vs full engine): 3,072 / 4,346 functions exact (70.69%) &middot; 77.97% fuzzy &middot; 78.08% fuzzy max.**
...
_Started units alone: 3,072/4,263 fns exact, 78.05% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,765 / 2,539 (69.5%) | 76.7% |     76.8% |
