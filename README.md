...
**Overall (vs full engine): 2,842 / 4,339 functions exact (65.50%) &middot; 73.78% fuzzy &middot; 73.78% fuzzy max.**
...
_Started units alone: 2,842/4,398 fns exact, 73.72% fuzzy over 1,087,403 of 1,086,528 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,682 / 2,699 (62.3%) | 71.4% |     71.4% |
