...
**Overall (vs full engine): 997 / 7,098 functions exact (14.05%) &middot; 27.34% fuzzy &middot; 27.34% fuzzy max.**
...
_Started units alone: 997/2,268 fns exact, 36.85% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   159 | 562 / 1,155 (48.7%) | 48.8% |     48.8% |
| `Stub`        |     2 |   118 / 646 (18.3%) |  5.9% |      5.9% |
