...
**Overall (vs full engine): 1,810 / 3,279 functions exact (55.20%) &middot; 66.95% fuzzy &middot; 66.96% fuzzy max.**
...
_Started units alone: 1,810/3,276 fns exact, 67.00% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,214 / 2,377 (51.1%) | 63.8% |     63.8% |
