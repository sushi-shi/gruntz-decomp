...
**Overall (vs full engine): 1,272 / 7,435 functions exact (17.11%) &middot; 36.93% fuzzy &middot; 36.93% fuzzy max.**
...
_Started units alone: 1,272/3,234 fns exact, 39.37% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 777 / 1,586 (49.0%) | 53.8% |     53.8% |
| `Stub`        |     4 |  104 / 1,048 (9.9%) |  4.5% |      4.5% |
