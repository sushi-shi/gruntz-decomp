...
**Overall (vs full engine): 1,574 / 3,451 functions exact (45.61%) &middot; 46.98% fuzzy &middot; 46.98% fuzzy max.**
...
_Started units alone: 1,574/3,393 fns exact, 47.02% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   283 | 959 / 1,926 (49.8%) | 58.3% |     58.3% |
| `Stub`        |     7 |   107 / 712 (15.0%) |  5.4% |      5.4% |
