...
**Overall (vs full engine): 1,864 / 3,290 functions exact (56.66%) &middot; 71.50% fuzzy &middot; 71.51% fuzzy max.**
...
_Started units alone: 1,864/3,830 fns exact, 64.18% fuzzy over 1,072,071 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,134 / 2,086 (54.4%) | 68.8% |     68.8% |
