...
**Overall (vs full engine): 195 / 6,349 functions exact (3.07%) &middot; 5.79% fuzzy &middot; 5.79% fuzzy max.**
...
_Started units alone: 195/286 fns exact, 85.24% fuzzy over 67,384 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    43 | 87 / 152 (57.2%) |  75.3% |     75.3% |
