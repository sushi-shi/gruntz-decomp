...
**Overall (vs full engine): 3,153 / 4,492 functions exact (70.19%) &middot; 80.05% fuzzy &middot; 80.19% fuzzy max.**
...
_Started units alone: 3,153/4,268 fns exact, 80.15% fuzzy over 1,090,619 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,810 / 2,543 (71.2%) | 78.6% |     78.7% |
