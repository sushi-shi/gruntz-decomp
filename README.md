...
**Overall (vs full engine): 712 / 6,510 functions exact (10.94%) &middot; 21.17% fuzzy &middot; 21.17% fuzzy max.**
...
_Started units alone: 712/2,242 fns exact, 28.64% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,103 (11.0%) |  5.1% |      5.1% |
| `Gruntz`      |    76 |   349 / 790 (44.2%) | 43.0% |     43.0% |
