...
**Overall (vs full engine): 1,787 / 3,857 functions exact (46.33%) &middot; 67.39% fuzzy &middot; 67.69% fuzzy max.**
...
_Started units alone: 1,787/3,718 fns exact, 67.48% fuzzy over 1,068,147 of 1,069,623 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 910 / 1,905 (47.8%) | 68.7% |     69.1% |
| `Stub`        |    22 |   193 / 658 (29.3%) | 20.7% |     20.8% |
