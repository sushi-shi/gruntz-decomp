...
**Overall (vs full engine): 3,249 / 4,277 functions exact (75.96%) &middot; 85.81% fuzzy &middot; 85.83% fuzzy max.**
...
_Started units alone: 3,249/4,264 fns exact, 84.71% fuzzy over 1,098,478 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   208 | 1,858 / 2,547 (72.9%) | 83.5% |     83.6% |
| `DDrawMgr`    |    21 |     450 / 569 (79.1%) | 81.6% |     81.7% |
