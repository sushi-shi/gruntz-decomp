...
**Overall (vs full engine): 3,263 / 4,277 functions exact (76.29%) &middot; 85.91% fuzzy &middot; 85.93% fuzzy max.**
...
_Started units alone: 3,263/4,275 fns exact, 84.75% fuzzy over 1,099,303 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   237 | 1,859 / 2,544 (73.1%) | 83.6% |     83.6% |
