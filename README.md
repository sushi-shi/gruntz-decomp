...
**Overall (vs full engine): 3,273 / 4,266 functions exact (76.72%) &middot; 86.97% fuzzy &middot; 87.13% fuzzy max.**
...
_Started units alone: 3,273/4,265 fns exact, 85.44% fuzzy over 1,103,223 of 1,083,761 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,871 / 2,547 (73.5%) |  84.4% |     84.6% |
