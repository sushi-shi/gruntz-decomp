...
**Overall (vs full engine): 1,844 / 3,397 functions exact (54.28%) &middot; 58.93% fuzzy &middot; 58.93% fuzzy max.**
...
_Started units alone: 1,844/3,394 fns exact, 58.97% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   382 | 1,180 / 2,296 (51.4%) | 61.4% |     61.4% |
| `Stub`        |     7 |     134 / 297 (45.1%) | 17.1% |     17.1% |
