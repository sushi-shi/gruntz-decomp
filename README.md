...
**Overall (vs full engine): 2,340 / 3,966 functions exact (59.00%) &middot; 72.92% fuzzy &middot; 72.93% fuzzy max.**
...
_Started units alone: 2,340/3,956 fns exact, 72.71% fuzzy over 1,080,997 of 1,077,917 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,331 / 2,368 (56.2%) | 70.2% |     70.2% |
| `DDrawMgr`    |    27 |     294 / 510 (57.6%) | 67.7% |     67.7% |
| `Wwd`         |     8 |      90 / 184 (48.9%) | 79.0% |     79.0% |
