...
**Overall (vs full engine): 1,561 / 3,451 functions exact (45.23%) &middot; 45.92% fuzzy &middot; 45.92% fuzzy max.**
...
_Started units alone: 1,561/3,393 fns exact, 45.96% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   270 | 948 / 1,897 (50.0%) | 57.8% |     57.8% |
