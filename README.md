...
**Overall (vs full engine): 3,260 / 4,271 functions exact (76.33%) &middot; 85.12% fuzzy &middot; 85.12% fuzzy max.**
...
_Started units alone: 3,260/4,275 fns exact, 83.96% fuzzy over 1,099,303 of 1,084,326 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   243 | 1,856 / 2,543 (73.0%) | 82.8% |     82.8% |
