...
**Overall (vs full engine): 3,148 / 4,492 functions exact (70.08%) &middot; 78.53% fuzzy &middot; 78.64% fuzzy max.**
...
_Started units alone: 3,148/4,268 fns exact, 78.73% fuzzy over 1,089,186 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,806 / 2,543 (71.0%) | 77.5% |     77.6% |
