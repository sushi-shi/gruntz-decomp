...
**Data: 99.16% size-weighted across 704,132 B** (`.bss` 99.76%, `.data` 95.89%, `.rdata` 99.26%) &middot; 15.87% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
