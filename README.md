...
| :-- | --: | --: | --: | --: | --: |
| `.data` | 763,820 | 837,580 | +73,760 | **10.17%** | 627,628 |
| `.idata` | 15,169 | 15,169 | +0 &check; | **77.53%** | 3,307 |
| `.rdata` | 135,080 | 141,963 | +6,883 | **17.87%** | 66,776 |
| `.reloc` | 113,105 | 113,408 | +303 | **42.82%** | 59,255 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,008,037 | +20,858 | **49.94%** | 58,731 |
| **total** | 3,137,613 | 3,239,417 | +101,804 | **40.72%** | 815,697 |
...
_Independently of where the bytes landed, **36,259 of 36,579 address operands (99.13%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `0fef70ae4181`, linked 2026-08-10 14:52. Regenerate: `ninja candidate`._
<!-- link-score:end -->
