...
**Overall (vs full engine): 1,877 / 3,859 functions exact (48.64%) &middot; 68.54% fuzzy &middot; 68.86% fuzzy max.**
...
_Started units alone: 1,877/3,720 fns exact, 68.64% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 972 / 1,984 (49.0%) | 69.2% |     69.5% |
| `Stub`        |    22 |   195 / 555 (35.1%) | 23.8% |     24.0% |
