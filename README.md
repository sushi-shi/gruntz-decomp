...
**Overall (vs full engine): 1,172 / 7,092 functions exact (16.53%) &middot; 32.98% fuzzy &middot; 32.98% fuzzy max.**
...
_Started units alone: 1,172/3,232 fns exact, 35.06% fuzzy over 935,833 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   169 | 690 / 1,421 (48.6%) | 51.4% |     51.4% |
| `Stub`        |     4 |  117 / 1,253 (9.3%) |  4.5% |      4.5% |
