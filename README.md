...
**Overall (vs full engine): 888 / 6,510 functions exact (13.64%) &middot; 24.43% fuzzy &middot; 24.43% fuzzy max.**
...
_Started units alone: 888/2,243 fns exact, 33.06% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   114 | 467 / 1,007 (46.4%) | 46.0% |     46.0% |
| `Stub`        |     2 |   118 / 795 (14.8%) |  5.4% |      5.4% |
