...
**Overall (vs full engine): 3,445 / 4,300 functions exact (80.12%) &middot; 91.30% fuzzy &middot; 91.45% fuzzy max.**
...
_Started units alone: 3,445/4,298 fns exact, 89.59% fuzzy over 1,114,062 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,986 / 2,565 (77.4%) |  89.1% |     89.2% |
| `DDrawMgr`    |    22 |     479 / 569 (84.2%) |  87.6% |     87.8% |
