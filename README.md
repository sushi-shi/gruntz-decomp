...
**Overall (vs full engine): 748 / 6,510 functions exact (11.49%) &middot; 22.33% fuzzy &middot; 22.33% fuzzy max.**
...
_Started units alone: 748/2,242 fns exact, 30.22% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,030 (11.7%) |  5.4% |      5.4% |
| `Gruntz`      |    85 |   382 / 851 (44.9%) | 44.1% |     44.1% |
