...
**Overall (vs full engine): 1,033 / 7,097 functions exact (14.56%) &middot; 28.47% fuzzy &middot; 28.47% fuzzy max.**
...
_Started units alone: 1,033/3,243 fns exact, 30.18% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,558 (7.6%) |  3.9% |      3.9% |
