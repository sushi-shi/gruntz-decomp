...
**Overall (vs full engine): 3,255 / 4,277 functions exact (76.10%) &middot; 86.46% fuzzy &middot; 86.49% fuzzy max.**
...
_Started units alone: 3,255/4,264 fns exact, 85.29% fuzzy over 1,099,275 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,860 / 2,547 (73.0%) |  84.2% |     84.2% |
