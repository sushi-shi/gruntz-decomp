...
**Overall (vs full engine): 731 / 6,510 functions exact (11.23%) &middot; 21.88% fuzzy &middot; 21.88% fuzzy max.**
...
_Started units alone: 731/2,242 fns exact, 29.61% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,066 (11.4%) |  5.3% |      5.3% |
| `Gruntz`      |    79 |   365 / 815 (44.8%) | 43.8% |     43.8% |
