...
**Overall (vs full engine): 596 / 6,510 functions exact (9.16%) &middot; 13.98% fuzzy &middot; 13.98% fuzzy max.**
...
_Started units alone: 596/2,239 fns exact, 19.15% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,367 (8.6%) |  3.5% |      3.5% |
