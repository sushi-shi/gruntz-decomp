...
**Overall (vs full engine): 1,002 / 7,098 functions exact (14.12%) &middot; 27.42% fuzzy &middot; 27.42% fuzzy max.**
...
_Started units alone: 1,002/2,270 fns exact, 36.95% fuzzy over 738,623 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   160 | 567 / 1,163 (48.8%) | 48.9% |     48.9% |
| `Stub`        |     2 |   118 / 640 (18.4%) |  5.9% |      5.9% |
