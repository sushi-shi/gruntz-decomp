...
**Overall (vs full engine): 482 / 6,510 functions exact (7.40%) &middot; 12.00% fuzzy &middot; 12.00% fuzzy max.**
...
_Started units alone: 482/2,238 fns exact, 16.44% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,547 (7.8%) |  3.5% |      3.5% |
| `Gruntz`      |    49 |  150 / 388 (38.7%) | 32.2% |     32.2% |
