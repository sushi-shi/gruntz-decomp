...
**Overall (vs full engine): 2,347 / 3,970 functions exact (59.12%) &middot; 72.92% fuzzy &middot; 72.97% fuzzy max.**
...
_Started units alone: 2,347/3,962 fns exact, 72.71% fuzzy over 1,081,100 of 1,078,018 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,333 / 2,367 (56.3%) | 70.2% |     70.3% |
