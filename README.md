...
**Overall (vs full engine): 1,048 / 7,097 functions exact (14.77%) &middot; 28.57% fuzzy &middot; 28.57% fuzzy max.**
...
_Started units alone: 1,048/3,243 fns exact, 30.28% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,542 (7.7%) |  3.9% |      3.9% |
| `Gruntz`      |   166 | 605 / 1,223 (49.5%) | 49.5% |     49.5% |
