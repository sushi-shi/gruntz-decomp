...
**Overall (vs full engine): 898 / 6,510 functions exact (13.79%) &middot; 24.65% fuzzy &middot; 24.65% fuzzy max.**
...
_Started units alone: 898/2,243 fns exact, 33.36% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   117 | 475 / 1,018 (46.7%) | 46.2% |     46.2% |
| `Stub`        |     2 |   118 / 781 (15.1%) |  5.4% |      5.4% |
