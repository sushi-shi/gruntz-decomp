...
**Overall (vs full engine): 3,752 / 4,427 functions exact (84.75%) &middot; 95.22% fuzzy &middot; 95.37% fuzzy max.**
...
_Started units alone: 3,752/4,427 fns exact, 95.27% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,181 / 2,648 (82.4%) |  95.2% |     95.3% |
| `DDrawMgr`   |    20 |     529 / 600 (88.2%) |  93.0% |     93.2% |
