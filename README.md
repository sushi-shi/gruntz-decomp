...
**Overall (vs full engine): 2,263 / 3,928 functions exact (57.61%) &middot; 72.12% fuzzy &middot; 72.12% fuzzy max.**
...
_Started units alone: 2,263/3,916 fns exact, 72.08% fuzzy over 1,077,935 of 1,077,336 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,308 / 2,358 (55.5%) | 69.4% |     69.4% |
| `DDrawMgr`    |    27 |     276 / 500 (55.2%) | 67.3% |     67.3% |
