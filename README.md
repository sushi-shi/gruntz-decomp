...
**Overall (vs full engine): 1,369 / 3,451 functions exact (39.67%) &middot; 39.26% fuzzy &middot; 39.26% fuzzy max.**
...
_Started units alone: 1,369/3,415 fns exact, 39.29% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   198 | 844 / 1,693 (49.9%) | 54.8% |     54.8% |
| `Stub`        |     5 |  105 / 1,083 (9.7%) |  4.2% |      4.2% |
