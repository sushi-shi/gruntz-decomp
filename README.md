...
**Overall (vs full engine): 527 / 6,510 functions exact (8.10%) &middot; 12.91% fuzzy &middot; 12.91% fuzzy max.**
...
_Started units alone: 527/2,238 fns exact, 17.68% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,470 (8.0%) |  3.5% |      3.5% |
