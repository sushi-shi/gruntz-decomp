...
**Overall (vs full engine): 2,260 / 3,929 functions exact (57.52%) &middot; 72.16% fuzzy &middot; 72.17% fuzzy max.**
...
_Started units alone: 2,260/3,918 fns exact, 72.07% fuzzy over 1,078,748 of 1,077,337 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,307 / 2,359 (55.4%) | 69.4% |     69.4% |
| `DDrawMgr`    |    27 |     275 / 500 (55.0%) | 67.3% |     67.3% |
| `Wwd`         |     8 |      84 / 183 (45.9%) | 79.1% |     79.1% |
| `Bute`        |    10 |      83 / 154 (53.9%) | 74.3% |     74.3% |
| `Dsndmgr`     |     5 |     102 / 139 (73.4%) | 92.3% |     92.3% |
| `Net`         |    13 |      90 / 126 (71.4%) | 93.5% |     93.5% |
| `Image`       |    16 |      54 / 123 (43.9%) | 80.8% |     80.8% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Rez`         |     7 |       39 / 62 (62.9%) | 76.7% |     77.1% |
| `Wap32`       |     8 |       46 / 57 (80.7%) | 93.9% |     93.9% |
| `DinMgr2`     |     2 |       47 / 54 (87.0%) | 98.6% |     98.6% |
| `Io`          |     4 |       29 / 41 (70.7%) | 83.9% |     83.9% |
...
| `CRT/MFC library`    |     2,267 |  207,482 | FID-identified, statically linked                 |
| `jump thunks`        |     1,680 |    8,346 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
