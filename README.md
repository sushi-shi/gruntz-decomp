...
**Overall (vs full engine): 1,598 / 3,451 functions exact (46.31%) &middot; 49.00% fuzzy &middot; 49.00% fuzzy max.**
...
_Started units alone: 1,598/3,393 fns exact, 49.05% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   305 | 983 / 1,973 (49.8%) | 58.1% |     58.1% |
| `Stub`        |     7 |   107 / 653 (16.4%) |  6.4% |      6.4% |
