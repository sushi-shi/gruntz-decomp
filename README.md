...
**Data — reconstructable coverage 99.67% &middot; gross coverage 40.86% &middot; fidelity 98.16%** (initialized data; `.bss` 92.33% / 96.67% is reported apart).
