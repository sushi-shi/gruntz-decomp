...
**Overall (vs full engine): 3,165 / 4,492 functions exact (70.46%) &middot; 80.04% fuzzy &middot; 80.18% fuzzy max.**
...
_Started units alone: 3,165/4,268 fns exact, 80.14% fuzzy over 1,090,619 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,811 / 2,541 (71.3%) | 78.6% |     78.7% |
