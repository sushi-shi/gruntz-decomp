...
**Overall (vs full engine): 862 / 6,510 functions exact (13.24%) &middot; 23.97% fuzzy &middot; 23.97% fuzzy max.**
...
_Started units alone: 862/2,243 fns exact, 32.43% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   104 | 450 / 976 (46.1%) | 45.6% |     45.6% |
| `Stub`        |     2 | 118 / 841 (14.0%) |  5.3% |      5.3% |
