...
**Overall (vs full engine): 3,416 / 4,300 functions exact (79.44%) &middot; 91.01% fuzzy &middot; 91.11% fuzzy max.**
...
_Started units alone: 3,416/4,296 fns exact, 89.35% fuzzy over 1,113,361 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,964 / 2,564 (76.6%) |  88.8% |     88.8% |
