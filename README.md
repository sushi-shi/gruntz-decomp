...
**Overall (vs full engine): 1,820 / 3,835 functions exact (47.46%) &middot; 63.54% fuzzy &middot; 63.71% fuzzy max.**
...
_Started units alone: 1,820/3,817 fns exact, 64.14% fuzzy over 1,058,986 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,092 / 2,073 (52.7%) | 68.3% |     68.6% |
| `Stub`        |     1 |       19 / 592 (3.2%) |  3.6% |      3.6% |
| `DDrawMgr`    |    31 |     146 / 292 (50.0%) | 64.9% |     65.1% |
