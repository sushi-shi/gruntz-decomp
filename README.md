...
**Overall (vs full engine): 1,919 / 3,859 functions exact (49.73%) &middot; 68.85% fuzzy &middot; 69.15% fuzzy max.**
...
_Started units alone: 1,919/3,720 fns exact, 68.95% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 989 / 2,001 (49.4%) | 69.3% |     69.6% |
| `Stub`        |    22 |   195 / 510 (38.2%) | 24.7% |     24.9% |
