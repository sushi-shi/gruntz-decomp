...
**Overall (vs full engine): 2,366 / 3,984 functions exact (59.39%) &middot; 73.28% fuzzy &middot; 73.30% fuzzy max.**
...
_Started units alone: 2,366/3,976 fns exact, 73.07% fuzzy over 1,081,414 of 1,078,332 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   256 | 1,336 / 2,367 (56.4%) | 70.7% |     70.7% |
| `DDrawMgr`    |    26 |     301 / 515 (58.4%) | 67.7% |     67.8% |
| `Wwd`         |     8 |      88 / 184 (47.8%) | 78.7% |     78.7% |
