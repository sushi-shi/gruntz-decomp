...
**Overall (vs full engine): 945 / 7,098 functions exact (13.31%) &middot; 26.54% fuzzy &middot; 26.54% fuzzy max.**
...
_Started units alone: 945/2,268 fns exact, 35.78% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 510 / 1,082 (47.1%) | 47.8% |     47.8% |
