...
**Overall (vs full engine): 1,849 / 3,290 functions exact (56.20%) &middot; 68.98% fuzzy &middot; 68.98% fuzzy max.**
...
_Started units alone: 1,849/3,266 fns exact, 69.09% fuzzy over 960,779 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,109 / 2,065 (53.7%) | 65.5% |     65.5% |
