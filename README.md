...
**Overall (vs full engine): 2,290 / 3,957 functions exact (57.87%) &middot; 72.15% fuzzy &middot; 72.16% fuzzy max.**
...
_Started units alone: 2,290/3,945 fns exact, 71.95% fuzzy over 1,080,803 of 1,077,729 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,305 / 2,361 (55.3%) | 69.3% |     69.3% |
| `DDrawMgr`    |    27 |     280 / 506 (55.3%) | 67.2% |     67.2% |
