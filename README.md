...
**Overall (vs full engine): 3,120 / 4,492 functions exact (69.46%) &middot; 78.11% fuzzy &middot; 78.23% fuzzy max.**
...
_Started units alone: 3,120/4,263 fns exact, 78.31% fuzzy over 1,089,137 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,791 / 2,539 (70.5%) | 76.9% |     77.1% |
