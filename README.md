...
**Overall (vs full engine): 3,251 / 4,277 functions exact (76.01%) &middot; 85.81% fuzzy &middot; 85.83% fuzzy max.**
...
_Started units alone: 3,251/4,264 fns exact, 84.71% fuzzy over 1,098,478 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   208 | 1,859 / 2,547 (73.0%) | 83.5% |     83.6% |
