...
**Overall (vs full engine): 1,926 / 3,859 functions exact (49.91%) &middot; 69.09% fuzzy &middot; 69.40% fuzzy max.**
...
_Started units alone: 1,926/3,720 fns exact, 69.19% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   328 | 1,002 / 2,026 (49.5%) | 69.4% |     69.7% |
| `Stub`        |    22 |     172 / 464 (37.1%) | 24.0% |     24.1% |
| `DDrawMgr`    |    31 |     163 / 327 (49.8%) | 66.7% |     66.9% |
| `Net`         |    21 |     112 / 171 (65.5%) | 86.7% |     86.9% |
| `Image`       |    24 |      63 / 138 (45.7%) | 81.9% |     82.0% |
| `Dsndmgr`     |    12 |      95 / 129 (73.6%) | 92.4% |     92.6% |
| `Bute`        |    10 |       52 / 99 (52.5%) | 79.8% |     80.2% |
| `Wwd`         |     8 |       30 / 79 (38.0%) | 72.5% |     72.9% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Io`          |     6 |       36 / 48 (75.0%) | 89.4% |     90.4% |
| `Wap32`       |     9 |       37 / 47 (78.7%) | 93.5% |     93.5% |
| `DinMgr2`     |     1 |       38 / 42 (90.5%) | 99.4% |     99.6% |
| `Rez`         |     7 |       26 / 33 (78.8%) | 75.4% |     75.6% |
| `Utils`       |     8 |       22 / 26 (84.6%) | 94.7% |     94.7% |
| `Font`        |     1 |       12 / 19 (63.2%) | 79.4% |     82.5% |
| `Crypto`      |     3 |         6 / 9 (66.7%) | 95.3% |     95.3% |
| `Globals.cpp` |     1 |          0 / 0 (0.0%) |  0.0% |      0.0% |
| `(unmatched)` |     — |        0 / 139 (0.0%) |  0.0% |      0.0% |
