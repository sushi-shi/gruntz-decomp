...
**Overall (vs full engine): 1,581 / 3,451 functions exact (45.81%) &middot; 48.34% fuzzy &middot; 48.34% fuzzy max.**
...
_Started units alone: 1,581/3,393 fns exact, 48.38% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   295 | 966 / 1,949 (49.6%) | 58.5% |     58.5% |
| `Stub`        |     7 |   107 / 683 (15.7%) |  6.0% |      6.0% |
