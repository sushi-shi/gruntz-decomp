...
**Overall (vs full engine): 155 / 6,349 functions exact (2.44%) &middot; 4.15% fuzzy &middot; 4.15% fuzzy max.**
...
_Started units alone: 155/196 fns exact, 91.22% fuzzy over 45,090 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    19 |  51 / 75 (68.0%) |  74.9% |     74.9% |
