...
**Overall (vs full engine): 1,130 / 7,092 functions exact (15.93%) &middot; 31.77% fuzzy &middot; 31.77% fuzzy max.**
...
_Started units alone: 1,130/3,238 fns exact, 33.67% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   166 | 660 / 1,359 (48.6%) | 51.6% |     51.6% |
| `Stub`        |     4 |  118 / 1,341 (8.8%) |  4.2% |      4.2% |
