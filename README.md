...
**Overall (vs full engine): 1,865 / 3,397 functions exact (54.90%) &middot; 62.17% fuzzy &middot; 62.17% fuzzy max.**
...
_Started units alone: 1,865/3,394 fns exact, 62.21% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   393 | 1,194 / 2,318 (51.5%) | 62.0% |     62.0% |
| `Stub`        |     7 |     139 / 272 (51.1%) | 29.1% |     29.1% |
