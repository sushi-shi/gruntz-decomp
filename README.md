...
**Overall (vs full engine): 2,294 / 3,957 functions exact (57.97%) &middot; 72.15% fuzzy &middot; 72.17% fuzzy max.**
...
_Started units alone: 2,294/3,945 fns exact, 71.94% fuzzy over 1,080,803 of 1,077,729 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   258 | 1,309 / 2,361 (55.4%) | 69.2% |     69.3% |
