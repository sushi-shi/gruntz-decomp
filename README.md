...
**Overall (vs full engine): 3,536 / 4,326 functions exact (81.74%) &middot; 95.68% fuzzy &middot; 95.68% fuzzy max.**

**Data — reconstructable coverage 100.00% &middot; gross coverage 56.56% &middot; fidelity 96.78%** (initialized data; `.bss` 92.23% / 96.70% is reported apart).

| Data region           |    retail B |  excluded B |  eligible B |  enrolled B |    coverage |   fidelity |
| :-------------------- | ----------: | ----------: | ----------: | ----------: | ----------: | ---------: |
| `.rdata`              |     135,168 |      65,314 |      69,854 |      69,854 |     100.00% |     96.01% |
| `.data` (initialized) |     136,192 |      52,573 |      83,619 |      83,619 |     100.00% |     97.53% |
| **initialized total** | **271,360** | **117,887** | **153,473** | **153,473** | **100.00%** | **96.78%** |
...
_Started units alone: 3,536/4,350 fns exact, 94.01% fuzzy over 1,134,641 of 1,114,867 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   213 | 2,018 / 2,583 (78.1%) |  93.5% |     93.5% |
