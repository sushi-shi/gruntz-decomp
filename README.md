...
**Overall (vs full engine): 469 / 6,510 functions exact (7.20%) &middot; 11.70% fuzzy &middot; 11.70% fuzzy max.**
...
_Started units alone: 469/2,238 fns exact, 16.02% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,572 (7.6%) |  3.4% |      3.4% |
| `Gruntz`      |    49 |  137 / 363 (37.7%) | 31.0% |     31.0% |
