...
**Overall (vs full engine): 1,818 / 3,451 functions exact (52.68%) &middot; 55.59% fuzzy &middot; 55.59% fuzzy max.**
...
_Started units alone: 1,818/3,394 fns exact, 55.64% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,171 / 2,258 (51.9%) | 60.8% |     60.8% |
| `Stub`        |     7 |     121 / 342 (35.4%) | 11.1% |     11.1% |
