...
**Overall (vs full engine): 1,376 / 3,451 functions exact (39.87%) &middot; 39.91% fuzzy &middot; 39.91% fuzzy max.**
...
_Started units alone: 1,376/3,415 fns exact, 39.94% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   200 | 847 / 1,700 (49.8%) | 55.1% |     55.1% |
| `Stub`        |     5 |  105 / 1,067 (9.8%) |  4.3% |      4.3% |
