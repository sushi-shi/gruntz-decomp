...
**Overall (vs full engine): 1,804 / 3,451 functions exact (52.27%) &middot; 55.28% fuzzy &middot; 55.28% fuzzy max.**
...
_Started units alone: 1,804/3,394 fns exact, 55.33% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,166 / 2,258 (51.6%) | 60.6% |     60.6% |
