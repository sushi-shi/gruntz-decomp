...
**Overall (vs full engine): 3,655 / 4,427 functions exact (82.56%) &middot; 94.33% fuzzy &middot; 94.46% fuzzy max.**
...
_Started units alone: 3,655/4,427 fns exact, 94.38% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,133 / 2,652 (80.4%) |  94.2% |     94.2% |
