...
**Overall (vs full engine): 147 / 6,349 functions exact (2.32%) &middot; 4.00% fuzzy &middot; 4.00% fuzzy max.**
...
_Started units alone: 147/187 fns exact, 90.97% fuzzy over 43,610 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    17 |  43 / 66 (65.2%) |  72.2% |     72.2% |
