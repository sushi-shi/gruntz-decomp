...
**Overall (vs full engine): 895 / 6,510 functions exact (13.75%) &middot; 24.58% fuzzy &middot; 24.58% fuzzy max.**
...
_Started units alone: 895/2,243 fns exact, 33.26% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   116 | 474 / 1,016 (46.7%) | 46.2% |     46.2% |
| `Stub`        |     2 |   118 / 786 (15.0%) |  5.4% |      5.4% |
