...
**Overall (vs full engine): 790 / 6,510 functions exact (12.14%) &middot; 23.02% fuzzy &middot; 23.02% fuzzy max.**
...
_Started units alone: 790/2,242 fns exact, 31.15% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 961 (12.6%) |  5.5% |      5.5% |
