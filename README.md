...
**Overall (vs full engine): 909 / 6,510 functions exact (13.96%) &middot; 24.77% fuzzy &middot; 24.77% fuzzy max.**
...
_Started units alone: 909/2,243 fns exact, 33.52% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   119 | 483 / 1,028 (47.0%) | 46.4% |     46.4% |
| `Stub`        |     2 |   118 / 768 (15.4%) |  5.5% |      5.5% |
