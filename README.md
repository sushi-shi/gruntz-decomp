...
**Overall (vs full engine): 1,827 / 3,835 functions exact (47.64%) &middot; 63.64% fuzzy &middot; 63.71% fuzzy max.**
...
_Started units alone: 1,827/3,821 fns exact, 64.23% fuzzy over 1,059,228 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,101 / 2,077 (53.0%) | 68.5% |     68.6% |
