...
**Overall (vs full engine): 1,847 / 3,271 functions exact (56.47%) &middot; 68.71% fuzzy &middot; 68.71% fuzzy max.**
...
_Started units alone: 1,847/3,267 fns exact, 68.81% fuzzy over 960,809 of 962,254 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,105 / 2,065 (53.5%) | 65.3% |     65.3% |
