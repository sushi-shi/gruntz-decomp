...
**Overall (vs full engine): 3,274 / 4,297 functions exact (76.19%) &middot; 88.36% fuzzy &middot; 88.43% fuzzy max.**
...
_Started units alone: 3,274/4,288 fns exact, 86.77% fuzzy over 1,113,117 of 1,093,131 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   234 | 1,845 / 2,558 (72.1%) |  86.1% |     86.2% |
| `DDrawMgr`    |    22 |     467 / 570 (81.9%) |  83.9% |     84.0% |
