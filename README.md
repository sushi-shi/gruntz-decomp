...
**Overall (vs full engine): 682 / 6,510 functions exact (10.48%) &middot; 20.04% fuzzy &middot; 20.04% fuzzy max.**
...
_Started units alone: 682/2,242 fns exact, 27.12% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,172 (10.3%) |  4.7% |      4.7% |
