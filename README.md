...
**Overall (vs full engine): 3,796 / 4,427 functions exact (85.75%) &middot; 95.69% fuzzy &middot; 95.89% fuzzy max.**
...
_Started units alone: 3,796/4,427 fns exact, 95.74% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,184 / 2,648 (82.5%) |  95.3% |     95.6% |
