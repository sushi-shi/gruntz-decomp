...
**Overall (vs full engine): 960 / 7,098 functions exact (13.52%) &middot; 27.00% fuzzy &middot; 27.00% fuzzy max.**
...
_Started units alone: 960/2,268 fns exact, 36.39% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   136 | 525 / 1,107 (47.4%) | 48.3% |     48.3% |
| `Stub`        |     2 |   118 / 694 (17.0%) |  5.9% |      5.9% |
