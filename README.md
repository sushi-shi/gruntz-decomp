...
**Overall (vs full engine): 2,782 / 4,492 functions exact (61.93%) &middot; 74.98% fuzzy &middot; 74.99% fuzzy max.**
...
_Started units alone: 2,782/4,263 fns exact, 75.29% fuzzy over 1,087,423 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,593 / 2,539 (62.7%) | 73.6% |     73.6% |
| `DDrawMgr`    |    26 |     384 / 573 (67.0%) | 68.8% |     68.8% |
