...
**Overall (vs full engine): 3,247 / 4,301 functions exact (75.49%) &middot; 87.73% fuzzy &middot; 87.73% fuzzy max.**
...
_Started units alone: 3,247/4,297 fns exact, 86.09% fuzzy over 1,114,114 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,827 / 2,557 (71.5%) |  85.4% |     85.4% |
