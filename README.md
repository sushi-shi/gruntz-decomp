...
**Overall (vs full engine): 3,302 / 4,298 functions exact (76.83%) &middot; 89.73% fuzzy &middot; 89.73% fuzzy max.**
...
_Started units alone: 3,302/4,289 fns exact, 88.12% fuzzy over 1,113,124 of 1,093,138 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,866 / 2,557 (73.0%) |  87.4% |     87.4% |
