...
**Overall (vs full engine): 1,869 / 3,397 functions exact (55.02%) &middot; 63.08% fuzzy &middot; 63.08% fuzzy max.**
...
_Started units alone: 1,869/3,394 fns exact, 63.12% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   403 | 1,206 / 2,340 (51.5%) | 61.7% |     61.7% |
| `Stub`        |     6 |     126 / 245 (51.4%) | 36.8% |     36.8% |
