...
**Overall (vs full engine): 416 / 6,510 functions exact (6.39%) &middot; 10.91% fuzzy &middot; 10.91% fuzzy max.**
...
_Started units alone: 416/1,125 fns exact, 22.20% fuzzy over 487,656 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 121 / 595 (20.3%) |   4.6% |      4.6% |
