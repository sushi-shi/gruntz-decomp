...
**Overall (vs full engine): 1,371 / 3,543 functions exact (38.70%) &middot; 38.60% fuzzy &middot; 38.60% fuzzy max.**
...
_Started units alone: 1,371/3,507 fns exact, 38.63% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   198 | 843 / 1,689 (49.9%) | 54.7% |     54.7% |
| `Stub`        |     6 |  105 / 1,179 (8.9%) |  4.1% |      4.1% |
| `Net`         |     6 |    63 / 104 (60.6%) | 54.1% |     54.1% |
