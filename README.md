...
**Overall (vs full engine): 1,815 / 3,279 functions exact (55.35%) &middot; 68.08% fuzzy &middot; 68.08% fuzzy max.**
...
_Started units alone: 1,815/3,276 fns exact, 68.13% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,215 / 2,377 (51.1%) | 64.7% |     64.7% |
