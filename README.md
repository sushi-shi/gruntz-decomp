...
**Overall (vs full engine): 2,260 / 3,926 functions exact (57.56%) &middot; 72.40% fuzzy &middot; 72.40% fuzzy max.**
...
_Started units alone: 2,260/3,914 fns exact, 72.36% fuzzy over 1,077,929 of 1,077,330 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   278 | 1,387 / 2,522 (55.0%) | 69.6% |     69.6% |
...
| `jump thunks`        |     1,683 |    8,353 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
