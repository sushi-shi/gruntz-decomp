...
**Overall (vs full engine): 1,262 / 7,435 functions exact (16.97%) &middot; 36.12% fuzzy &middot; 36.13% fuzzy max.**
...
_Started units alone: 1,262/3,234 fns exact, 38.50% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 768 / 1,564 (49.1%) | 53.0% |     53.1% |
| `Stub`        |     4 |  104 / 1,071 (9.7%) |  4.5% |      4.5% |
