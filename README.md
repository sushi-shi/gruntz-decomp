...
**Overall (vs full engine): 3,466 / 4,301 functions exact (80.59%) &middot; 92.40% fuzzy &middot; 92.43% fuzzy max.**
...
_Started units alone: 3,466/4,301 fns exact, 90.77% fuzzy over 1,112,794 of 1,093,174 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,998 / 2,567 (77.8%) |  90.3% |     90.3% |
...
| `Image`       |    12 |      90 / 129 (69.8%) |  91.9% |     91.9% |
