...
**Overall (vs full engine): 1,358 / 3,543 functions exact (38.33%) &middot; 38.50% fuzzy &middot; 38.50% fuzzy max.**
...
_Started units alone: 1,358/3,507 fns exact, 38.53% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   196 | 840 / 1,684 (49.9%) | 54.6% |     54.6% |
| `Stub`        |     5 |  105 / 1,196 (8.8%) |  4.1% |      4.1% |
