...
**Overall (vs full engine): 268 / 6,371 functions exact (4.21%) &middot; 7.53% fuzzy &middot; 7.53% fuzzy max.**
...
_Started units alone: 268/821 fns exact, 21.56% fuzzy over 346,304 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 367 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    47 | 112 / 236 (47.5%) |  47.3% |     47.3% |
...
| `Image`       |     1 |  10 / 10 (100.0%) | 100.0% |    100.0% |
| `Wwd`         |     1 |     1 / 4 (25.0%) |  97.5% |     97.5% |
| `DinMgr2`     |     1 |    1 / 1 (100.0%) | 100.0% |    100.0% |
| `(unmatched)` |     — |  0 / 5,550 (0.0%) |   0.0% |      0.0% |
<!-- match-score:end -->
