...
**Overall (vs full engine): 851 / 6,510 functions exact (13.07%) &middot; 23.66% fuzzy &middot; 23.66% fuzzy max.**
...
_Started units alone: 851/2,243 fns exact, 32.02% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   102 | 447 / 964 (46.4%) | 45.4% |     45.4% |
| `Stub`        |     2 | 118 / 869 (13.6%) |  5.3% |      5.3% |
