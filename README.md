...
**Overall (vs full engine): 1,375 / 3,543 functions exact (38.81%) &middot; 38.52% fuzzy &middot; 38.52% fuzzy max.**
...
_Started units alone: 1,375/3,485 fns exact, 38.56% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   198 | 856 / 1,700 (50.4%) | 54.6% |     54.6% |
| `Stub`        |     5 |  105 / 1,157 (9.1%) |  4.1% |      4.1% |
