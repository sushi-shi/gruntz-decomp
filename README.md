...
**Overall (vs full engine): 1,378 / 3,451 functions exact (39.93%) &middot; 40.34% fuzzy &middot; 40.34% fuzzy max.**
...
_Started units alone: 1,378/3,415 fns exact, 40.37% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   201 | 848 / 1,709 (49.6%) | 55.4% |     55.4% |
| `Stub`        |     5 |  105 / 1,057 (9.9%) |  4.4% |      4.4% |
