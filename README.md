...
**Overall (vs full engine): 3,524 / 4,326 functions exact (81.46%) &middot; 95.80% fuzzy &middot; 95.80% fuzzy max.**
...
_Started units alone: 3,524/4,351 fns exact, 94.12% fuzzy over 1,134,668 of 1,114,867 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   213 | 2,015 / 2,584 (78.0%) |  93.8% |     93.8% |
