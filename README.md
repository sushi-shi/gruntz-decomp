...
**Overall (vs full engine): 3,159 / 4,492 functions exact (70.33%) &middot; 80.02% fuzzy &middot; 80.17% fuzzy max.**
...
_Started units alone: 3,159/4,268 fns exact, 80.12% fuzzy over 1,090,619 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,803 / 2,541 (71.0%) | 78.5% |     78.7% |
| `DDrawMgr`    |    23 |     439 / 571 (76.9%) | 76.2% |     76.3% |
