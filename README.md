...
**Overall (vs full engine): 3,439 / 4,300 functions exact (79.98%) &middot; 91.27% fuzzy &middot; 91.42% fuzzy max.**
...
_Started units alone: 3,439/4,298 fns exact, 89.56% fuzzy over 1,114,062 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,980 / 2,565 (77.2%) |  89.0% |     89.1% |
