...
**Overall (vs full engine): 3,246 / 4,301 functions exact (75.47%) &middot; 87.72% fuzzy &middot; 87.72% fuzzy max.**
...
_Started units alone: 3,246/4,297 fns exact, 86.07% fuzzy over 1,114,114 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,826 / 2,557 (71.4%) |  85.4% |     85.4% |
