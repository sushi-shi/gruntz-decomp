...
**Overall (vs full engine): 905 / 6,510 functions exact (13.90%) &middot; 24.72% fuzzy &middot; 24.72% fuzzy max.**
...
_Started units alone: 905/2,243 fns exact, 33.45% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   118 | 479 / 1,022 (46.9%) | 46.3% |     46.3% |
| `Stub`        |     2 |   118 / 774 (15.2%) |  5.5% |      5.5% |
