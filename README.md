...
**Overall (vs full engine): 3,074 / 4,346 functions exact (70.73%) &middot; 77.80% fuzzy &middot; 77.92% fuzzy max.**
...
_Started units alone: 3,074/4,263 fns exact, 77.88% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,774 / 2,539 (69.9%) | 76.4% |     76.6% |
| `DDrawMgr`    |    26 |     424 / 573 (74.0%) | 71.7% |     71.7% |
