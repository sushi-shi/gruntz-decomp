...
**Overall (vs full engine): 679 / 6,510 functions exact (10.43%) &middot; 18.95% fuzzy &middot; 18.95% fuzzy max.**
...
_Started units alone: 679/2,242 fns exact, 25.64% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,186 (10.2%) |  4.2% |      4.2% |
| `Gruntz`      |    65 |   317 / 712 (44.5%) | 46.3% |     46.3% |
