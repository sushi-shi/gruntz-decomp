...
**Overall (vs full engine): 1,928 / 3,859 functions exact (49.96%) &middot; 69.06% fuzzy &middot; 69.39% fuzzy max.**
...
_Started units alone: 1,928/3,720 fns exact, 69.17% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   327 | 999 / 2,021 (49.4%) | 69.3% |     69.7% |
