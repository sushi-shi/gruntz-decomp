...
**Overall (vs full engine): 1,695 / 3,451 functions exact (49.12%) &middot; 50.04% fuzzy &middot; 50.04% fuzzy max.**
...
_Started units alone: 1,695/3,393 fns exact, 50.08% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   321 | 1,072 / 2,077 (51.6%) | 58.6% |     58.6% |
| `Stub`        |     7 |     113 / 549 (20.6%) |  6.6% |      6.6% |
