...
**Overall (vs full engine): 1,825 / 3,835 functions exact (47.59%) &middot; 63.58% fuzzy &middot; 63.72% fuzzy max.**
...
_Started units alone: 1,825/3,818 fns exact, 64.22% fuzzy over 1,058,311 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,096 / 2,074 (52.8%) | 68.5% |     68.7% |
| `Stub`        |     1 |       19 / 592 (3.2%) |  3.6% |      3.6% |
| `DDrawMgr`    |    31 |     148 / 292 (50.7%) | 65.1% |     65.2% |
