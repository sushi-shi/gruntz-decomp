...
**Overall (vs full engine): 1,598 / 3,451 functions exact (46.31%) &middot; 48.87% fuzzy &middot; 48.87% fuzzy max.**
...
_Started units alone: 1,598/3,393 fns exact, 48.92% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   305 | 983 / 1,973 (49.8%) | 58.1% |     58.1% |
| `Stub`        |     7 |   107 / 659 (16.2%) |  6.3% |      6.3% |
