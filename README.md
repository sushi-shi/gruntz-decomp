...
**Overall (vs full engine): 1,152 / 7,092 functions exact (16.24%) &middot; 32.32% fuzzy &middot; 32.32% fuzzy max.**
...
_Started units alone: 1,152/3,238 fns exact, 34.25% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   167 | 673 / 1,391 (48.4%) | 51.0% |     51.0% |
| `Stub`        |     4 |  118 / 1,294 (9.1%) |  4.3% |      4.3% |
