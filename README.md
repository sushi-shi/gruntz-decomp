...
**Overall (vs full engine): 974 / 7,098 functions exact (13.72%) &middot; 27.09% fuzzy &middot; 27.09% fuzzy max.**
...
_Started units alone: 974/2,268 fns exact, 36.52% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   143 | 539 / 1,121 (48.1%) | 48.5% |     48.5% |
| `Stub`        |     2 |   118 / 680 (17.4%) |  5.9% |      5.9% |
