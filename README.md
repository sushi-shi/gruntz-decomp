...
**Overall (vs full engine): 1,743 / 3,451 functions exact (50.51%) &middot; 50.43% fuzzy &middot; 50.43% fuzzy max.**
...
_Started units alone: 1,743/3,393 fns exact, 50.48% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   325 | 1,121 / 2,139 (52.4%) | 58.8% |     58.8% |
| `Stub`        |     7 |     112 / 487 (23.0%) |  6.8% |      6.8% |
