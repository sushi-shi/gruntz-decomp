...
**Overall (vs full engine): 245 / 6,367 functions exact (3.85%) &middot; 7.01% fuzzy &middot; 7.01% fuzzy max.**
...
_Started units alone: 245/751 fns exact, 20.58% fuzzy over 338,074 of 991,849 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 323 (0.0%) |   0.3% |      0.3% |
| `Gruntz`      |    45 | 109 / 232 (47.0%) |  50.9% |     51.0% |
