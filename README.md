...
**Overall (vs full engine): 2,346 / 3,970 functions exact (59.09%) &middot; 73.12% fuzzy &middot; 73.16% fuzzy max.**
...
_Started units alone: 2,346/3,962 fns exact, 72.91% fuzzy over 1,081,100 of 1,078,018 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,333 / 2,368 (56.3%) | 70.5% |     70.5% |
| `DDrawMgr`    |    26 |     300 / 514 (58.4%) | 67.8% |     67.9% |
| `Wwd`         |     8 |      90 / 184 (48.9%) | 78.7% |     78.9% |
