...
**Overall (vs full engine): 1,642 / 3,451 functions exact (47.58%) &middot; 49.32% fuzzy &middot; 49.32% fuzzy max.**
...
_Started units alone: 1,642/3,393 fns exact, 49.36% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   309 | 1,026 / 2,020 (50.8%) | 58.3% |     58.3% |
| `Stub`        |     7 |     108 / 606 (17.8%) |  6.4% |      6.4% |
| `Net`         |    16 |      86 / 142 (60.6%) | 60.7% |     60.7% |
