...
**Overall (vs full engine): 1,368 / 3,460 functions exact (39.54%) &middot; 39.00% fuzzy &middot; 39.00% fuzzy max.**
...
_Started units alone: 1,368/3,424 fns exact, 39.02% fuzzy over 976,156 of 976,895 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   198 | 843 / 1,689 (49.9%) | 54.7% |     54.7% |
| `Stub`        |     5 |  105 / 1,096 (9.6%) |  4.2% |      4.2% |
...
| `CRT/MFC library`    |     2,138 |  190,085 | FID-identified, statically linked                 |
