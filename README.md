...
**Overall (vs full engine): 1,842 / 3,397 functions exact (54.22%) &middot; 58.26% fuzzy &middot; 58.26% fuzzy max.**
...
_Started units alone: 1,842/3,394 fns exact, 58.30% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   379 | 1,178 / 2,290 (51.4%) | 61.3% |     61.3% |
| `Stub`        |     7 |     134 / 304 (44.1%) | 15.7% |     15.7% |
