...
**Overall (vs full engine): 1,194 / 7,091 functions exact (16.84%) &middot; 33.87% fuzzy &middot; 33.87% fuzzy max.**
...
_Started units alone: 1,194/3,231 fns exact, 36.00% fuzzy over 935,763 of 994,765 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 717 / 1,470 (48.8%) | 51.6% |     51.6% |
| `Stub`        |     4 |  103 / 1,188 (8.7%) |  4.3% |      4.3% |
