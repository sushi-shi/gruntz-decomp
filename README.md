...
**Overall (vs full engine): 222 / 6,367 functions exact (3.49%) &middot; 5.79% fuzzy &middot; 5.79% fuzzy max.**
...
_Started units alone: 222/745 fns exact, 17.03% fuzzy over 337,335 of 991,849 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Stub`        |     1 |   0 / 347 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    37 | 97 / 202 (48.0%) |  39.8% |     39.8% |
