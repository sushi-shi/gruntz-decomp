...
**Overall (vs full engine): 1,516 / 3,451 functions exact (43.93%) &middot; 45.29% fuzzy &middot; 45.29% fuzzy max.**
...
_Started units alone: 1,516/3,393 fns exact, 45.33% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   258 | 929 / 1,876 (49.5%) | 57.4% |     57.4% |
| `Stub`        |     6 |   105 / 797 (13.2%) |  5.1% |      5.1% |
