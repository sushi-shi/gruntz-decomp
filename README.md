...
**Overall (vs full engine): 2,239 / 3,874 functions exact (57.80%) &middot; 72.79% fuzzy &middot; 72.79% fuzzy max.**
...
_Started units alone: 2,239/3,864 fns exact, 72.75% fuzzy over 1,068,849 of 1,068,270 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   265 | 1,370 / 2,483 (55.2%) | 70.1% |     70.1% |
| `DDrawMgr`    |    19 |     215 / 394 (54.6%) | 70.8% |     70.8% |
| `Wwd`         |     7 |      85 / 170 (50.0%) | 78.0% |     78.0% |
