...
**Overall (vs full engine): 939 / 7,098 functions exact (13.23%) &middot; 26.30% fuzzy &middot; 26.30% fuzzy max.**
...
_Started units alone: 939/2,244 fns exact, 35.70% fuzzy over 733,575 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 504 / 1,067 (47.2%) | 47.6% |     47.6% |
| `Stub`        |     2 |   118 / 711 (16.6%) |  5.8% |      5.8% |
