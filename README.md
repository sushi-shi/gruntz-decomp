...
**Overall (vs full engine): 2,383 / 3,983 functions exact (59.83%) &middot; 73.35% fuzzy &middot; 73.38% fuzzy max.**
...
_Started units alone: 2,383/3,975 fns exact, 73.14% fuzzy over 1,081,189 of 1,078,107 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   255 | 1,338 / 2,365 (56.6%) | 70.8% |     70.8% |
| `DDrawMgr`    |    26 |     303 / 514 (58.9%) | 67.9% |     67.9% |
