...
**Overall (vs full engine): 3,741 / 4,427 functions exact (84.50%) &middot; 95.15% fuzzy &middot; 95.32% fuzzy max.**
...
_Started units alone: 3,741/4,427 fns exact, 95.20% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,171 / 2,648 (82.0%) |  95.1% |     95.2% |
