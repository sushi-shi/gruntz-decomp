...
**Overall (vs full engine): 2,918 / 4,492 functions exact (64.96%) &middot; 76.02% fuzzy &middot; 76.10% fuzzy max.**
...
_Started units alone: 2,918/4,263 fns exact, 76.24% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,690 / 2,539 (66.6%) | 74.6% |     74.7% |
