...
**Overall (vs full engine): 1,835 / 3,451 functions exact (53.17%) &middot; 55.68% fuzzy &middot; 55.68% fuzzy max.**
...
_Started units alone: 1,835/3,394 fns exact, 55.73% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   360 | 1,174 / 2,261 (51.9%) | 60.9% |     60.9% |
| `Stub`        |     7 |     132 / 335 (39.4%) | 11.4% |     11.4% |
