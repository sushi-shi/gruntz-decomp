...
**Overall (vs full engine): 1,020 / 7,097 functions exact (14.37%) &middot; 28.40% fuzzy &middot; 28.40% fuzzy max.**
...
_Started units alone: 1,020/3,243 fns exact, 30.10% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,571 (7.5%) |  3.9% |      3.9% |
| `Gruntz`      |   166 | 582 / 1,199 (48.5%) | 49.3% |     49.3% |
