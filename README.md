...
**Overall (vs full engine): 2,263 / 3,932 functions exact (57.55%) &middot; 72.12% fuzzy &middot; 72.16% fuzzy max.**
...
_Started units alone: 2,263/3,923 fns exact, 71.91% fuzzy over 1,080,425 of 1,077,342 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,305 / 2,361 (55.3%) | 69.2% |     69.3% |
