...
**Overall (vs full engine): 743 / 6,510 functions exact (11.41%) &middot; 22.20% fuzzy &middot; 22.20% fuzzy max.**
...
_Started units alone: 743/2,242 fns exact, 30.04% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,043 (11.6%) |  5.3% |      5.3% |
| `Gruntz`      |    83 |   377 / 838 (45.0%) | 44.0% |     44.0% |
