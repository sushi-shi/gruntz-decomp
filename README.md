...
**Overall (vs full engine): 2,260 / 3,907 functions exact (57.84%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,260/3,895 fns exact, 72.35% fuzzy over 1,077,810 of 1,077,241 engine code bytes._
...
| `jump thunks`        |     1,677 |    8,339 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
