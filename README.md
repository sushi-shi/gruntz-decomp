...
**Overall (vs full engine): 2,334 / 3,962 functions exact (58.91%) &middot; 72.76% fuzzy &middot; 72.76% fuzzy max.**
...
_Started units alone: 2,334/3,951 fns exact, 72.55% fuzzy over 1,080,924 of 1,077,845 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,331 / 2,369 (56.2%) | 70.0% |     70.0% |
| `DDrawMgr`    |    27 |     289 / 506 (57.1%) | 67.7% |     67.7% |
| `Wwd`         |     8 |      91 / 184 (49.5%) | 79.1% |     79.1% |
