...
**Overall (vs full engine): 2,268 / 3,938 functions exact (57.59%) &middot; 72.15% fuzzy &middot; 72.16% fuzzy max.**
...
_Started units alone: 2,268/3,927 fns exact, 71.94% fuzzy over 1,080,538 of 1,077,469 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,307 / 2,361 (55.4%) | 69.2% |     69.3% |
...
| `Image`       |    16 |      56 / 125 (44.8%) | 80.8% |     80.8% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Rez`         |     7 |       39 / 62 (62.9%) | 77.4% |     77.4% |
...
| `CRT/MFC library`    |     2,266 |  207,476 | FID-identified, statically linked                 |
| `jump thunks`        |     1,675 |    8,326 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
