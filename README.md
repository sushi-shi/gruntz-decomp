...
**Overall (vs full engine): 2,688 / 4,334 functions exact (62.02%) &middot; 73.52% fuzzy &middot; 73.52% fuzzy max.**
...
_Started units alone: 2,688/4,192 fns exact, 73.71% fuzzy over 1,083,583 of 1,086,378 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,541 / 2,508 (61.4%) | 71.4% |     71.4% |
