...
**Overall (vs full engine): 930 / 6,510 functions exact (14.29%) &middot; 26.17% fuzzy &middot; 26.17% fuzzy max.**
...
_Started units alone: 930/2,244 fns exact, 35.41% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   126 | 498 / 1,058 (47.1%) | 47.4% |     47.4% |
| `Stub`        |     2 |   118 / 724 (16.3%) |  5.8% |      5.8% |
