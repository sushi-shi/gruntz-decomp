...
**Data: 99.65% size-weighted across 704,132 B** (`.bss` 99.82%, `.data` 98.63%, `.rdata` 99.88%) &middot; 90.28% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
