...
**Overall (vs full engine): 2,802 / 4,492 functions exact (62.38%) &middot; 75.01% fuzzy &middot; 75.03% fuzzy max.**
...
_Started units alone: 2,802/4,263 fns exact, 75.32% fuzzy over 1,087,423 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,607 / 2,539 (63.3%) | 73.6% |     73.6% |
