...
**Overall (vs full engine): 1,282 / 7,435 functions exact (17.24%) &middot; 37.30% fuzzy &middot; 37.30% fuzzy max.**
...
_Started units alone: 1,282/3,234 fns exact, 39.76% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   185 | 787 / 1,601 (49.2%) | 54.1% |     54.1% |
| `Stub`        |     4 | 104 / 1,033 (10.1%) |  4.5% |      4.5% |
