...
**Overall (vs full engine): 1,834 / 3,451 functions exact (53.14%) &middot; 55.73% fuzzy &middot; 55.73% fuzzy max.**
...
_Started units alone: 1,834/3,394 fns exact, 55.78% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   360 | 1,174 / 2,261 (51.9%) | 60.9% |     60.9% |
| `Stub`        |     7 |     131 / 335 (39.1%) | 11.7% |     11.7% |
