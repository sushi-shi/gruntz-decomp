...
**Overall (vs full engine): 2,121 / 3,811 functions exact (55.65%) &middot; 71.20% fuzzy &middot; 71.20% fuzzy max.**
...
_Started units alone: 2,121/3,770 fns exact, 71.24% fuzzy over 1,067,233 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   363 | 1,230 / 2,340 (52.6%) | 68.6% |     68.6% |
| `DDrawMgr`    |    33 |     204 / 390 (52.3%) | 64.2% |     64.2% |
