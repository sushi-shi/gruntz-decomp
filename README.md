...
**Overall (vs full engine): 3,798 / 4,427 functions exact (85.79%) &middot; 95.69% fuzzy &middot; 95.81% fuzzy max.**
...
_Started units alone: 3,798/4,425 fns exact, 95.74% fuzzy over 1,136,743 of 1,137,365 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   201 | 2,190 / 2,648 (82.7%) |  95.5% |     95.6% |
