...
**Overall (vs full engine): 1,274 / 7,435 functions exact (17.14%) &middot; 37.22% fuzzy &middot; 37.22% fuzzy max.**
...
_Started units alone: 1,274/3,234 fns exact, 39.68% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 779 / 1,592 (48.9%) | 54.0% |     54.0% |
| `Stub`        |     4 | 104 / 1,042 (10.0%) |  4.5% |      4.5% |
