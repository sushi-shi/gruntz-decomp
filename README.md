...
**Overall (vs full engine): 2,015 / 3,807 functions exact (52.93%) &middot; 70.82% fuzzy &middot; 70.82% fuzzy max.**
...
_Started units alone: 2,015/3,682 fns exact, 70.97% fuzzy over 1,064,832 of 1,067,103 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   342 | 1,105 / 2,185 (50.6%) | 69.8% |     69.8% |
| `DDrawMgr`    |    31 |     187 / 366 (51.1%) | 67.7% |     67.7% |
| `Net`         |    21 |     123 / 183 (67.2%) | 87.0% |     87.0% |
| `Image`       |    27 |      77 / 160 (48.1%) | 82.0% |     82.0% |
| `Stub`        |    17 |      76 / 141 (53.9%) | 18.7% |     18.7% |
| `Dsndmgr`     |    12 |      97 / 132 (73.5%) | 92.6% |     92.6% |
| `Bute`        |    10 |      60 / 108 (55.6%) | 80.4% |     80.4% |
| `Wwd`         |     9 |       34 / 92 (37.0%) | 73.1% |     73.1% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Wap32`       |    10 |       42 / 52 (80.8%) | 93.5% |     93.5% |
| `Io`          |     7 |       37 / 50 (74.0%) | 89.0% |     89.0% |
| `DinMgr2`     |     1 |       43 / 50 (86.0%) | 98.6% |     98.6% |
| `Rez`         |     7 |       28 / 39 (71.8%) | 76.1% |     76.1% |
| `Utils`       |     8 |       25 / 29 (86.2%) | 94.9% |     94.9% |
| `Font`        |     1 |       12 / 19 (63.2%) | 79.4% |     79.4% |
| `Crypto`      |     3 |        9 / 13 (69.2%) | 95.6% |     95.6% |
...
| `CRT/MFC library`    |     2,259 |  207,479 | FID-identified, statically linked                 |
| `jump thunks`        |     1,688 |    8,362 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
