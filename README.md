...
**Overall (vs full engine): 872 / 6,510 functions exact (13.39%) &middot; 24.24% fuzzy &middot; 24.24% fuzzy max.**
...
_Started units alone: 872/2,243 fns exact, 32.80% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   109 | 459 / 992 (46.3%) | 45.9% |     45.9% |
| `Stub`        |     2 | 118 / 822 (14.4%) |  5.4% |      5.4% |
