...
**Overall (vs full engine): 2,287 / 3,955 functions exact (57.83%) &middot; 72.15% fuzzy &middot; 72.16% fuzzy max.**
...
_Started units alone: 2,287/3,945 fns exact, 71.95% fuzzy over 1,080,797 of 1,077,721 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,306 / 2,361 (55.3%) | 69.3% |     69.3% |
