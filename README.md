...
**Overall (vs full engine): 3,235 / 4,301 functions exact (75.22%) &middot; 87.43% fuzzy &middot; 87.70% fuzzy max.**
...
_Started units alone: 3,235/4,295 fns exact, 85.77% fuzzy over 1,114,357 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,815 / 2,553 (71.1%) |  85.0% |     85.3% |
