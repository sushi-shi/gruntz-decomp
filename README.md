...
**Overall (vs full engine): 2,268 / 3,936 functions exact (57.62%) &middot; 72.15% fuzzy &middot; 72.17% fuzzy max.**
...
_Started units alone: 2,268/3,927 fns exact, 71.95% fuzzy over 1,080,538 of 1,077,455 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,307 / 2,361 (55.4%) | 69.3% |     69.3% |
