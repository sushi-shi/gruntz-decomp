...
**Overall (vs full engine): 3,046 / 4,346 functions exact (70.09%) &middot; 77.77% fuzzy &middot; 77.89% fuzzy max.**
...
_Started units alone: 3,046/4,263 fns exact, 77.85% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,754 / 2,539 (69.1%) | 76.5% |     76.6% |
