...
**Overall (vs full engine): 717 / 6,510 functions exact (11.01%) &middot; 21.49% fuzzy &middot; 21.49% fuzzy max.**
...
_Started units alone: 717/2,242 fns exact, 29.07% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,089 (11.1%) |  5.2% |      5.2% |
