...
**Overall (vs full engine): 156 / 6,349 functions exact (2.46%) &middot; 4.24% fuzzy &middot; 4.24% fuzzy max.**
...
_Started units alone: 156/204 fns exact, 91.27% fuzzy over 46,109 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    24 |  52 / 83 (62.7%) |  76.1% |     76.1% |
