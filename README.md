...
**Overall (vs full engine): 405 / 6,510 functions exact (6.22%) &middot; 10.47% fuzzy &middot; 10.47% fuzzy max.**
...
_Started units alone: 405/1,092 fns exact, 21.50% fuzzy over 483,556 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 111 / 565 (19.6%) |   3.7% |      3.7% |
