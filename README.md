...
**Overall (vs full engine): 703 / 6,510 functions exact (10.80%) &middot; 20.97% fuzzy &middot; 20.97% fuzzy max.**
...
_Started units alone: 703/2,242 fns exact, 28.38% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,117 (10.8%) |  5.1% |      5.1% |
| `Gruntz`      |    75 |   340 / 776 (43.8%) | 42.7% |     42.7% |
