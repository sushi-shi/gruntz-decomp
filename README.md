...
**Overall (vs full engine): 3,700 / 4,427 functions exact (83.58%) &middot; 94.90% fuzzy &middot; 95.07% fuzzy max.**

_Data: objdiff `matched_data` 560,779 of 802,899 B (69.84%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,700/4,427 fns exact, 94.95% fuzzy over 1,136,757 of 1,137,347 engine code bytes._
