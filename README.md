...
**Overall (vs full engine): 645 / 6,510 functions exact (9.91%) &middot; 15.10% fuzzy &middot; 15.10% fuzzy max.**
...
_Started units alone: 645/2,243 fns exact, 20.43% fuzzy over 733,690 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,295 (9.3%) |  3.9% |      3.9% |
| `Gruntz`      |    62 |  283 / 604 (46.9%) | 37.0% |     37.0% |
