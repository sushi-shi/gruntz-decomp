...
**Overall (vs full engine): 3,680 / 4,427 functions exact (83.13%) &middot; 94.58% fuzzy &middot; 94.82% fuzzy max.**
...
_Started units alone: 3,680/4,427 fns exact, 94.63% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,145 / 2,652 (80.9%) |  94.4% |     94.7% |
