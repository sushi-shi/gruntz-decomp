...
**Overall (vs full engine): 3,132 / 4,492 functions exact (69.72%) &middot; 78.35% fuzzy &middot; 78.48% fuzzy max.**
...
_Started units alone: 3,132/4,268 fns exact, 78.55% fuzzy over 1,089,186 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,806 / 2,543 (71.0%) | 77.3% |     77.4% |
| `DDrawMgr`    |    26 |     428 / 573 (74.7%) | 71.7% |     71.7% |
