...
**Overall (vs full engine): 2,300 / 3,962 functions exact (58.05%) &middot; 72.18% fuzzy &middot; 72.18% fuzzy max.**
...
_Started units alone: 2,300/3,950 fns exact, 71.97% fuzzy over 1,080,948 of 1,077,874 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   258 | 1,315 / 2,367 (55.6%) | 69.3% |     69.3% |
