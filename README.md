...
**Overall (vs full engine): 1,817 / 3,859 functions exact (47.08%) &middot; 68.05% fuzzy &middot; 68.36% fuzzy max.**
...
_Started units alone: 1,817/3,720 fns exact, 68.15% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 935 / 1,940 (48.2%) | 69.0% |     69.3% |
| `Stub`        |    22 |   193 / 617 (31.3%) | 22.4% |     22.5% |
