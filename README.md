...
**Overall (vs full engine): 2,259 / 3,929 functions exact (57.50%) &middot; 72.50% fuzzy &middot; 72.50% fuzzy max.**
...
_Started units alone: 2,259/3,920 fns exact, 72.30% fuzzy over 1,080,351 of 1,077,337 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,305 / 2,359 (55.3%) | 69.8% |     69.8% |
