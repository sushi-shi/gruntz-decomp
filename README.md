...
**Overall (vs full engine): 1,784 / 3,451 functions exact (51.70%) &middot; 53.36% fuzzy &middot; 53.36% fuzzy max.**
...
_Started units alone: 1,784/3,393 fns exact, 53.41% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   342 | 1,161 / 2,234 (52.0%) | 60.0% |     60.0% |
| `Stub`        |     7 |     104 / 373 (27.9%) |  8.0% |      8.0% |
