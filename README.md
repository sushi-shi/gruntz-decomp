...
**Overall (vs full engine): 2,466 / 3,995 functions exact (61.73%) &middot; 73.66% fuzzy &middot; 73.92% fuzzy max.**
...
_Started units alone: 2,466/3,991 fns exact, 73.45% fuzzy over 1,081,272 of 1,078,191 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,385 / 2,368 (58.5%) | 71.1% |     71.4% |
| `DDrawMgr`    |    26 |     326 / 518 (62.9%) | 68.4% |     68.6% |
