...
**Overall (vs full engine): 869 / 6,510 functions exact (13.35%) &middot; 24.16% fuzzy &middot; 24.16% fuzzy max.**
...
_Started units alone: 869/2,243 fns exact, 32.69% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   108 | 457 / 988 (46.3%) | 45.8% |     45.8% |
| `Stub`        |     2 | 118 / 829 (14.2%) |  5.4% |      5.4% |
