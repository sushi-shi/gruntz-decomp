...
**Overall (vs full engine): 2,175 / 3,811 functions exact (57.07%) &middot; 72.66% fuzzy &middot; 72.66% fuzzy max.**
...
_Started units alone: 2,175/3,802 fns exact, 72.61% fuzzy over 1,068,584 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   344 | 1,302 / 2,444 (53.3%) | 70.1% |     70.1% |
