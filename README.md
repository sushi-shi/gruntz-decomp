...
**Data: 99.65% size-weighted across 704,148 B** (`.bss` 99.82%, `.data` 98.63%, `.rdata` 99.87%) &middot; 90.87% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
