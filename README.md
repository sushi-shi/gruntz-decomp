...
**Overall (vs full engine): 891 / 6,510 functions exact (13.69%) &middot; 24.48% fuzzy &middot; 24.48% fuzzy max.**
...
_Started units alone: 891/2,243 fns exact, 33.12% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   115 | 470 / 1,010 (46.5%) | 46.1% |     46.1% |
| `Stub`        |     2 |   118 / 792 (14.9%) |  5.4% |      5.4% |
