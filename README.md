...
**Overall (vs full engine): 2,362 / 3,980 functions exact (59.35%) &middot; 73.20% fuzzy &middot; 73.23% fuzzy max.**
...
_Started units alone: 2,362/3,976 fns exact, 72.99% fuzzy over 1,081,414 of 1,078,304 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   257 | 1,334 / 2,368 (56.3%) | 70.6% |     70.6% |
