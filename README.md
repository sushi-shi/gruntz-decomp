...
**Overall (vs full engine): 2,334 / 3,962 functions exact (58.91%) &middot; 72.86% fuzzy &middot; 72.86% fuzzy max.**
...
_Started units alone: 2,334/3,951 fns exact, 72.65% fuzzy over 1,080,924 of 1,077,845 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,331 / 2,369 (56.2%) | 70.1% |     70.1% |
