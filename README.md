...
**Overall (vs full engine): 2,854 / 4,492 functions exact (63.54%) &middot; 75.52% fuzzy &middot; 75.62% fuzzy max.**
...
_Started units alone: 2,854/4,263 fns exact, 75.74% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,632 / 2,539 (64.3%) | 74.0% |     74.1% |
| `DDrawMgr`    |    26 |     387 / 573 (67.5%) | 69.2% |     69.2% |
