...
**Overall (vs full engine): 229 / 6,367 functions exact (3.60%) &middot; 6.46% fuzzy &middot; 6.46% fuzzy max.**
...
_Started units alone: 229/750 fns exact, 18.96% fuzzy over 338,023 of 991,849 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 330 (0.0%) |   0.3% |      0.3% |
| `Gruntz`      |    44 | 104 / 224 (46.4%) |  46.1% |     46.1% |
