...
**Overall (vs full engine): 831 / 6,510 functions exact (12.76%) &middot; 23.34% fuzzy &middot; 23.34% fuzzy max.**
...
_Started units alone: 831/2,242 fns exact, 31.58% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |    96 | 431 / 933 (46.2%) | 44.8% |     44.8% |
| `Stub`        |     2 | 120 / 905 (13.3%) |  5.5% |      5.5% |
