...
**Data: 100.00% size-weighted across 724,665 B** (`.bss` 100.00%, `.data` 100.00%, `.rdata` 100.00%) &middot; 100.00% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
