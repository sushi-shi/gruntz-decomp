...
**Overall (vs full engine): 3,104 / 4,492 functions exact (69.10%) &middot; 78.03% fuzzy &middot; 78.15% fuzzy max.**
...
_Started units alone: 3,104/4,261 fns exact, 78.25% fuzzy over 1,088,827 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,784 / 2,539 (70.3%) | 76.9% |     77.1% |
