...
**Overall (vs full engine): 1,312 / 7,435 functions exact (17.65%) &middot; 37.47% fuzzy &middot; 37.47% fuzzy max.**
...
_Started units alone: 1,312/3,234 fns exact, 39.94% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   191 | 810 / 1,630 (49.7%) | 54.2% |     54.2% |
| `Stub`        |     4 |   105 / 998 (10.5%) |  4.5% |      4.5% |
