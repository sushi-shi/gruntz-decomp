...
**Overall (vs full engine): 1,006 / 7,098 functions exact (14.17%) &middot; 27.51% fuzzy &middot; 27.51% fuzzy max.**
...
_Started units alone: 1,006/2,270 fns exact, 37.08% fuzzy over 738,623 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   161 | 571 / 1,167 (48.9%) | 49.0% |     49.0% |
| `Stub`        |     2 |   118 / 636 (18.6%) |  5.9% |      5.9% |
