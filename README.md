...
**Overall (vs full engine): 1,814 / 3,279 functions exact (55.32%) &middot; 68.08% fuzzy &middot; 68.08% fuzzy max.**
...
_Started units alone: 1,814/3,276 fns exact, 68.12% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,214 / 2,377 (51.1%) | 64.7% |     64.7% |
| `Net`         |    18 |      93 / 145 (64.1%) | 85.5% |     85.5% |
