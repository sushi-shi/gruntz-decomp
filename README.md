...
**Overall (vs full engine): 2,440 / 3,995 functions exact (61.08%) &middot; 73.63% fuzzy &middot; 73.78% fuzzy max.**
...
_Started units alone: 2,440/3,988 fns exact, 73.42% fuzzy over 1,081,236 of 1,078,197 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,365 / 2,367 (57.7%) | 71.1% |     71.3% |
| `DDrawMgr`    |    26 |     321 / 516 (62.2%) | 68.4% |     68.5% |
