...
**Overall (vs full engine): 1,845 / 3,290 functions exact (56.08%) &middot; 68.72% fuzzy &middot; 68.73% fuzzy max.**
...
_Started units alone: 1,845/3,267 fns exact, 68.83% fuzzy over 960,809 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,105 / 2,065 (53.5%) | 65.3% |     65.3% |
| `DDrawMgr`    |    31 |     150 / 293 (51.2%) | 65.1% |     65.1% |
