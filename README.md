...
**Overall (vs full engine): 668 / 6,510 functions exact (10.26%) &middot; 17.69% fuzzy &middot; 17.69% fuzzy max.**
...
_Started units alone: 668/2,242 fns exact, 23.94% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,231 (9.8%) |  4.1% |      4.1% |
| `Gruntz`      |    63 |  306 / 667 (45.9%) | 44.6% |     44.6% |
