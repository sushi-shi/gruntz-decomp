...
**Overall (vs full engine): 1,864 / 3,397 functions exact (54.87%) &middot; 60.77% fuzzy &middot; 60.77% fuzzy max.**
...
_Started units alone: 1,864/3,394 fns exact, 60.81% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   390 | 1,194 / 2,315 (51.6%) | 62.6% |     62.6% |
| `Stub`        |     7 |     138 / 275 (50.2%) | 19.7% |     19.7% |
