...
**Overall (vs full engine): 1,832 / 3,306 functions exact (55.41%) &middot; 65.60% fuzzy &middot; 65.60% fuzzy max.**
...
_Started units alone: 1,832/3,303 fns exact, 65.64% fuzzy over 966,576 of 967,209 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   415 | 1,211 / 2,352 (51.5%) | 62.6% |     62.6% |
