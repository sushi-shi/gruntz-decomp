...
**Overall (vs full engine): 1,686 / 3,856 functions exact (43.72%) &middot; 63.56% fuzzy &middot; 63.87% fuzzy max.**
...
_Started units alone: 1,686/3,709 fns exact, 64.34% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   322 | 828 / 1,789 (46.3%) | 67.6% |     67.9% |
