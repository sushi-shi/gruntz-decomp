...
**Overall (vs full engine): 156 / 6,349 functions exact (2.46%) &middot; 4.19% fuzzy &middot; 4.19% fuzzy max.**
...
_Started units alone: 156/202 fns exact, 91.25% fuzzy over 45,592 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    23 |  52 / 81 (64.2%) |  75.5% |     75.5% |
