...
**Overall (vs full engine): 2,389 / 3,984 functions exact (59.96%) &middot; 73.41% fuzzy &middot; 73.53% fuzzy max.**
...
_Started units alone: 2,389/3,976 fns exact, 73.20% fuzzy over 1,081,190 of 1,078,108 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,345 / 2,366 (56.8%) | 70.8% |     71.0% |
| `DDrawMgr`    |    26 |     304 / 515 (59.0%) | 67.9% |     68.0% |
...
| `jump thunks`        |     1,676 |    8,341 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
