...
**Overall (vs full engine): 1,271 / 7,435 functions exact (17.09%) &middot; 36.63% fuzzy &middot; 36.63% fuzzy max.**
...
_Started units alone: 1,271/3,234 fns exact, 39.05% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 776 / 1,576 (49.2%) | 53.5% |     53.5% |
| `Stub`        |     4 |  104 / 1,058 (9.8%) |  4.6% |      4.6% |
