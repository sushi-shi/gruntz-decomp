...
**Overall (vs full engine): 1,770 / 3,451 functions exact (51.29%) &middot; 50.78% fuzzy &middot; 50.78% fuzzy max.**
...
_Started units alone: 1,770/3,393 fns exact, 50.83% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   333 | 1,143 / 2,177 (52.5%) | 59.0% |     59.0% |
| `Stub`        |     7 |     112 / 443 (25.3%) |  6.9% |      6.9% |
