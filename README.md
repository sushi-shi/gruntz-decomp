...
**Overall (vs full engine): 1,856 / 3,290 functions exact (56.41%) &middot; 69.44% fuzzy &middot; 69.44% fuzzy max.**
...
_Started units alone: 1,856/3,266 fns exact, 69.55% fuzzy over 960,779 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,112 / 2,065 (53.8%) | 66.1% |     66.1% |
