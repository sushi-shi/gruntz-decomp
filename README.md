...
**Overall (vs full engine): 680 / 6,510 functions exact (10.45%) &middot; 19.09% fuzzy &middot; 19.09% fuzzy max.**
...
_Started units alone: 680/2,242 fns exact, 25.83% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,182 (10.2%) |  4.3% |      4.3% |
| `Gruntz`      |    65 |   318 / 716 (44.4%) | 46.6% |     46.6% |
