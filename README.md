...
**Overall (vs full engine): 1,556 / 3,451 functions exact (45.09%) &middot; 45.91% fuzzy &middot; 45.91% fuzzy max.**
...
_Started units alone: 1,556/3,393 fns exact, 45.96% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   270 | 946 / 1,897 (49.9%) | 57.8% |     57.8% |
