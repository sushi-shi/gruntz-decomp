...
**Overall (vs full engine): 2,255 / 3,894 functions exact (57.91%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,255/3,884 fns exact, 72.35% fuzzy over 1,077,674 of 1,077,095 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   271 | 1,382 / 2,497 (55.3%) | 69.5% |     69.5% |
| `DDrawMgr`    |    20 |     216 / 395 (54.7%) | 70.8% |     70.8% |
| `Wwd`         |     7 |      83 / 170 (48.8%) | 78.0% |     78.0% |
| `Dsndmgr`     |     5 |     102 / 138 (73.9%) | 92.6% |     92.6% |
| `Net`         |    13 |      89 / 122 (73.0%) | 93.4% |     93.4% |
| `Image`       |    15 |      54 / 121 (44.6%) | 80.7% |     80.7% |
| `Bute`        |     7 |      71 / 120 (59.2%) | 72.6% |     72.6% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Wap32`       |     8 |       46 / 57 (80.7%) | 93.9% |     93.9% |
| `DinMgr2`     |     2 |       47 / 54 (87.0%) | 98.6% |     98.6% |
| `Rez`         |     6 |       30 / 47 (63.8%) | 74.5% |     74.5% |
...
| `CRT/MFC library`    |     2,269 |  207,610 | FID-identified, statically linked                 |
| `jump thunks`        |     1,686 |    8,355 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
