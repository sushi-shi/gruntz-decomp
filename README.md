...
**Overall (vs full engine): 402 / 6,510 functions exact (6.18%) &middot; 10.42% fuzzy &middot; 10.42% fuzzy max.**
...
_Started units alone: 402/1,086 fns exact, 21.51% fuzzy over 480,579 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 111 / 563 (19.7%) |   3.7% |      3.7% |
