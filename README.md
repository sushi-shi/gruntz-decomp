...
**Overall (vs full engine): 1,747 / 3,856 functions exact (45.31%) &middot; 65.25% fuzzy &middot; 65.56% fuzzy max.**
...
_Started units alone: 1,747/3,710 fns exact, 66.05% fuzzy over 1,056,736 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 882 / 1,858 (47.5%) | 68.2% |     68.5% |
| `Stub`        |    22 |   193 / 725 (26.6%) | 18.0% |     18.1% |
