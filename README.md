...
**Overall (vs full engine): 1,163 / 7,092 functions exact (16.40%) &middot; 32.82% fuzzy &middot; 32.82% fuzzy max.**
...
_Started units alone: 1,163/3,232 fns exact, 34.89% fuzzy over 935,833 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   169 | 681 / 1,409 (48.3%) | 51.3% |     51.3% |
| `Stub`        |     4 |  117 / 1,265 (9.2%) |  4.5% |      4.5% |
