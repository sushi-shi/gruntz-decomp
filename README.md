...
**Overall (vs full engine): 874 / 6,510 functions exact (13.43%) &middot; 24.27% fuzzy &middot; 24.27% fuzzy max.**
...
_Started units alone: 874/2,243 fns exact, 32.83% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   111 | 461 / 996 (46.3%) | 45.9% |     45.9% |
| `Stub`        |     2 | 118 / 818 (14.4%) |  5.4% |      5.4% |
