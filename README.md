...
**Overall (vs full engine): 2,260 / 3,908 functions exact (57.83%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,260/3,896 fns exact, 72.35% fuzzy over 1,077,811 of 1,077,242 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   278 | 1,385 / 2,504 (55.3%) | 69.6% |     69.6% |
| `DDrawMgr`    |    20 |     217 / 394 (55.1%) | 70.9% |     70.9% |
...
| `jump thunks`        |     1,676 |    8,338 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
