...
**Data: 99.80% size-weighted across 708,175 B** (`.bss` 99.82%, `.data` 99.62%, `.rdata` 99.95%) &middot; 97.49% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
