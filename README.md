...
**Overall (vs full engine): 3,749 / 4,427 functions exact (84.68%) &middot; 95.21% fuzzy &middot; 95.35% fuzzy max.**
...
_Started units alone: 3,749/4,427 fns exact, 95.26% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,179 / 2,648 (82.3%) |  95.2% |     95.3% |
