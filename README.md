...
**Overall (vs full engine): 2,256 / 3,891 functions exact (57.98%) &middot; 72.81% fuzzy &middot; 72.82% fuzzy max.**
...
_Started units alone: 2,256/3,881 fns exact, 72.77% fuzzy over 1,069,113 of 1,068,534 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   265 | 1,384 / 2,497 (55.4%) | 70.1% |     70.1% |
| `DDrawMgr`    |    19 |     215 / 394 (54.6%) | 70.8% |     70.9% |
