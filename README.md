...
**Overall (vs full engine): 744 / 6,510 functions exact (11.43%) &middot; 22.27% fuzzy &middot; 22.27% fuzzy max.**
...
_Started units alone: 744/2,242 fns exact, 30.14% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,037 (11.7%) |  5.3% |      5.3% |
| `Gruntz`      |    84 |   378 / 844 (44.8%) | 44.1% |     44.1% |
