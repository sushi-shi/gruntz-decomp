...
**Overall (vs full engine): 1,249 / 7,435 functions exact (16.80%) &middot; 35.35% fuzzy &middot; 35.35% fuzzy max.**
...
_Started units alone: 1,249/3,233 fns exact, 37.64% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   181 | 757 / 1,536 (49.3%) | 52.8% |     52.8% |
| `Stub`        |     4 |  106 / 1,107 (9.6%) |  4.5% |      4.5% |
...
| `DDrawMgr`    |     1 |      3 / 18 (16.7%) | 61.2% |     61.2% |
