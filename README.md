...
**Overall (vs full engine): 911 / 6,510 functions exact (13.99%) &middot; 24.80% fuzzy &middot; 24.80% fuzzy max.**
...
_Started units alone: 911/2,243 fns exact, 33.55% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   119 | 483 / 1,028 (47.0%) | 46.4% |     46.4% |
| `Stub`        |     2 |   118 / 765 (15.4%) |  5.5% |      5.5% |
