...
**Overall (vs full engine): 696 / 6,510 functions exact (10.69%) &middot; 20.72% fuzzy &middot; 20.72% fuzzy max.**
...
_Started units alone: 696/2,242 fns exact, 28.03% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,138 (10.6%) |  5.0% |      5.0% |
| `Gruntz`      |    75 |   333 / 755 (44.1%) | 42.3% |     42.3% |
