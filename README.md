...
**Overall (vs full engine): 1,865 / 3,303 functions exact (56.46%) &middot; 68.68% fuzzy &middot; 68.68% fuzzy max.**
...
_Started units alone: 1,865/3,299 fns exact, 68.78% fuzzy over 964,772 of 966,217 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   426 | 1,288 / 2,442 (52.7%) | 65.3% |     65.3% |
