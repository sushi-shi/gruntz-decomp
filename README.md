...
**Overall (vs full engine): 1,790 / 3,857 functions exact (46.41%) &middot; 67.43% fuzzy &middot; 67.74% fuzzy max.**
...
_Started units alone: 1,790/3,720 fns exact, 67.52% fuzzy over 1,068,147 of 1,069,623 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 910 / 1,905 (47.8%) | 68.7% |     69.1% |
| `Stub`        |    22 |   193 / 656 (29.4%) | 20.8% |     20.9% |
