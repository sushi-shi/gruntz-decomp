...
**Overall (vs full engine): 2,917 / 4,346 functions exact (67.12%) &middot; 76.14% fuzzy &middot; 76.22% fuzzy max.**
...
_Started units alone: 2,917/4,263 fns exact, 76.24% fuzzy over 1,088,864 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,688 / 2,539 (66.5%) | 74.6% |     74.7% |
| `DDrawMgr`    |    26 |     392 / 573 (68.4%) | 69.5% |     69.5% |
