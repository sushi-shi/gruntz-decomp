...
**Overall (vs full engine): 1,792 / 3,451 functions exact (51.93%) &middot; 54.81% fuzzy &middot; 54.81% fuzzy max.**
...
_Started units alone: 1,792/3,394 fns exact, 54.86% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,166 / 2,254 (51.7%) | 60.5% |     60.5% |
| `Stub`        |     7 |     105 / 347 (30.3%) |  8.9% |      8.9% |
