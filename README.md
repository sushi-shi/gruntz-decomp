...
**Overall (vs full engine): 3,297 / 4,298 functions exact (76.71%) &middot; 88.86% fuzzy &middot; 88.87% fuzzy max.**
...
_Started units alone: 3,297/4,289 fns exact, 87.27% fuzzy over 1,113,124 of 1,093,138 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,858 / 2,557 (72.7%) |  86.5% |     86.5% |
| `DDrawMgr`    |    22 |     475 / 572 (83.0%) |  85.3% |     85.3% |
