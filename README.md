...
**Overall (vs full engine): 401 / 6,371 functions exact (6.29%) &middot; 9.97% fuzzy &middot; 9.97% fuzzy max.**
...
_Started units alone: 401/1,086 fns exact, 20.57% fuzzy over 480,579 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 111 / 575 (19.3%) |   3.5% |      3.5% |
| `Gruntz`      |    48 | 127 / 274 (46.4%) |  52.1% |     52.1% |
