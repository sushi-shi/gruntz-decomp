...
**Overall (vs full engine): 1,380 / 3,543 functions exact (38.95%) &middot; 38.66% fuzzy &middot; 38.66% fuzzy max.**
...
_Started units alone: 1,380/3,485 fns exact, 38.69% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   201 | 861 / 1,708 (50.4%) | 54.8% |     54.8% |
| `Stub`        |     5 |  105 / 1,149 (9.1%) |  4.1% |      4.1% |
