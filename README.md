...
**Overall (vs full engine): 3,472 / 4,316 functions exact (80.44%) &middot; 94.60% fuzzy &middot; 94.60% fuzzy max.**
...
_Started units alone: 3,472/4,334 fns exact, 92.95% fuzzy over 1,134,114 of 1,114,355 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,977 / 2,576 (76.7%) |  92.5% |     92.5% |
| `DDrawMgr`   |    22 |     500 / 584 (85.6%) |  92.4% |     92.4% |
| `Wwd`        |     9 |     166 / 216 (76.9%) |  93.6% |     93.6% |
...
**Candidate image: 2,543,104 B vs retail 2,511,872 B (101.24%, +31,232 B).**
...
| `.rdata` | 135,080 | 141,946 | +6,866 | **17.87%** | 66,776 |
| `.reloc` | 113,105 | 113,532 | +427 | **42.86%** | 59,251 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,009,969 | +22,790 | **50.08%** | 58,731 |
| **total** | 3,137,613 | 3,241,424 | +103,811 | **40.81%** | 815,693 |
...
_Independently of where the bytes landed, **36,454 of 36,744 address operands (99.21%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `d455db0f8a91`, linked 2026-08-10 19:31. Regenerate: `ninja candidate`._
<!-- link-score:end -->
