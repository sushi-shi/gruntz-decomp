...
**Overall (vs full engine): 2,478 / 4,004 functions exact (61.89%) &middot; 73.77% fuzzy &middot; 73.78% fuzzy max.**
...
_Started units alone: 2,478/3,996 fns exact, 73.56% fuzzy over 1,081,377 of 1,078,344 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,396 / 2,373 (58.8%) | 71.3% |     71.3% |
| `DDrawMgr`    |    26 |     327 / 518 (63.1%) | 68.4% |     68.5% |
| `Wwd`         |     8 |      89 / 185 (48.1%) | 78.5% |     78.5% |
