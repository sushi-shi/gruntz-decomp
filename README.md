...
**Overall (vs full engine): 2,174 / 3,811 functions exact (57.05%) &middot; 72.72% fuzzy &middot; 72.72% fuzzy max.**
...
_Started units alone: 2,174/3,802 fns exact, 72.67% fuzzy over 1,068,584 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   334 | 1,300 / 2,441 (53.3%) | 70.1% |     70.1% |
