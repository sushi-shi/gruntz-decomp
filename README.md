...
**Data — reconstructable coverage 95.15% &middot; gross coverage 40.45% &middot; fidelity 100.00%** (initialized data; `.bss` 91.72% / 100.00% is reported apart).
