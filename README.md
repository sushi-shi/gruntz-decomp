...
**Overall (vs full engine): 3,041 / 4,346 functions exact (69.97%) &middot; 77.81% fuzzy &middot; 77.92% fuzzy max.**
...
_Started units alone: 3,041/4,263 fns exact, 77.88% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,745 / 2,539 (68.7%) | 76.5% |     76.6% |
