...
**Overall (vs full engine): 2,338 / 3,965 functions exact (58.97%) &middot; 72.91% fuzzy &middot; 72.93% fuzzy max.**
...
_Started units alone: 2,338/3,954 fns exact, 72.71% fuzzy over 1,080,987 of 1,077,908 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,332 / 2,368 (56.2%) | 70.2% |     70.2% |
| `DDrawMgr`    |    27 |     293 / 510 (57.5%) | 67.7% |     67.7% |
| `Wwd`         |     8 |      90 / 184 (48.9%) | 79.0% |     79.1% |
