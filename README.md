...
**Overall (vs full engine): 2,918 / 4,314 functions exact (67.64%) &middot; 94.07% fuzzy &middot; 94.07% fuzzy max.**

**Data — reconstructable coverage 95.15% &middot; gross coverage 40.45% &middot; fidelity 100.00%** (initialized data; `.bss` 91.70% / 100.00% is reported apart).
...
_Started units alone: 2,918/4,327 fns exact, 92.43% fuzzy over 1,134,118 of 1,114,364 engine code bytes._
