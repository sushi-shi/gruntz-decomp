...
**Overall (vs full engine): 1,358 / 3,543 functions exact (38.33%) &middot; 38.46% fuzzy &middot; 38.46% fuzzy max.**
...
_Started units alone: 1,358/3,507 fns exact, 38.49% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   196 | 840 / 1,682 (49.9%) | 54.6% |     54.6% |
| `Stub`        |     5 |  105 / 1,198 (8.8%) |  4.1% |      4.1% |
