...
**Overall (vs full engine): 760 / 6,510 functions exact (11.67%) &middot; 22.60% fuzzy &middot; 22.60% fuzzy max.**
...
_Started units alone: 760/2,242 fns exact, 30.58% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,006 (12.0%) |  5.4% |      5.4% |
| `Gruntz`      |    86 |   389 / 870 (44.7%) | 44.3% |     44.3% |
