...
**Overall (vs full engine): 1,648 / 3,451 functions exact (47.75%) &middot; 49.40% fuzzy &middot; 49.40% fuzzy max.**
...
_Started units alone: 1,648/3,393 fns exact, 49.45% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   312 | 1,030 / 2,025 (50.9%) | 58.3% |     58.3% |
