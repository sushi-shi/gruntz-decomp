...
**Overall (vs full engine): 1,176 / 7,091 functions exact (16.58%) &middot; 33.34% fuzzy &middot; 33.34% fuzzy max.**
...
_Started units alone: 1,176/3,231 fns exact, 35.45% fuzzy over 935,763 of 994,765 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   170 | 701 / 1,436 (48.8%) | 51.5% |     51.5% |
| `Stub`        |     4 |  104 / 1,227 (8.5%) |  4.4% |      4.4% |
