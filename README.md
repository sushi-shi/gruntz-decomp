...
**Overall (vs full engine): 1,812 / 3,834 functions exact (47.26%) &middot; 63.42% fuzzy &middot; 63.59% fuzzy max.**
...
_Started units alone: 1,812/3,802 fns exact, 64.11% fuzzy over 1,057,482 of 1,069,054 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,092 / 2,073 (52.7%) | 68.3% |     68.6% |
| `Stub`        |     1 |       19 / 592 (3.2%) |  3.6% |      3.6% |
| `DDrawMgr`    |    31 |     138 / 277 (49.8%) | 64.5% |     64.7% |
...
| `jump thunks`        |     1,690 |    8,370 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
