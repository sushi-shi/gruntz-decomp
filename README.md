...
**Overall (vs full engine): 3,529 / 4,326 functions exact (81.58%) &middot; 95.66% fuzzy &middot; 95.66% fuzzy max.**
...
_Started units alone: 3,529/4,351 fns exact, 93.99% fuzzy over 1,134,668 of 1,114,867 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   214 | 2,018 / 2,582 (78.2%) |  93.6% |     93.6% |
| `DDrawMgr`   |    21 |     506 / 586 (86.3%) |  92.8% |     92.8% |
| `Wwd`        |     9 |     167 / 217 (77.0%) |  95.0% |     95.0% |
| `Bute`       |     9 |     158 / 197 (80.2%) |  95.4% |     95.4% |
...
| :-- | --: | --: | --: | --: | --: |
| `.data` | 763,820 | 835,788 | +71,968 | **10.18%** | 627,628 |
| `.idata` | 15,169 | 15,169 | +0 &check; | **78.03%** | 3,307 |
| `.rdata` | 135,080 | 141,701 | +6,621 | **17.87%** | 66,776 |
| `.reloc` | 113,105 | 113,573 | +468 | **43.23%** | 59,385 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,010,254 | +23,075 | **50.90%** | 58,731 |
| **total** | 3,137,613 | 3,239,745 | +102,132 | **41.35%** | 815,827 |
...
_Independently of where the bytes landed, **35,950 of 36,135 address operands (99.49%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `b2cc056b4eab`, linked 2026-08-12 10:35. Regenerate: `ninja candidate`._
<!-- link-score:end -->
