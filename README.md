...
**Overall (vs full engine): 945 / 7,098 functions exact (13.31%) &middot; 26.48% fuzzy &middot; 26.48% fuzzy max.**
...
_Started units alone: 945/2,268 fns exact, 35.70% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 510 / 1,079 (47.3%) | 47.7% |     47.7% |
| `Stub`        |     2 |   118 / 722 (16.3%) |  5.8% |      5.8% |
