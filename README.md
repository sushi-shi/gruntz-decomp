...
**Data: 99.85% size-weighted across 708,715 B** (`.bss` 99.82%, `.data` 99.97%, `.rdata` 99.96%) &middot; 98.09% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
...
_Started units alone: 3,498/4,325 fns exact, 92.19% fuzzy over 1,113,083 of 1,093,329 engine code bytes._
