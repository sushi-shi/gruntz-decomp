...
**Overall (vs full engine): 871 / 6,510 functions exact (13.38%) &middot; 24.22% fuzzy &middot; 24.22% fuzzy max.**
...
_Started units alone: 871/2,243 fns exact, 32.77% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   109 | 459 / 992 (46.3%) | 45.9% |     45.9% |
| `Stub`        |     2 | 118 / 825 (14.3%) |  5.4% |      5.4% |
