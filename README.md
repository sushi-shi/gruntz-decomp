...
**Overall (vs full engine): 1,716 / 3,856 functions exact (44.50%) &middot; 64.40% fuzzy &middot; 64.71% fuzzy max.**
...
_Started units alone: 1,716/3,709 fns exact, 65.18% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 856 / 1,826 (46.9%) | 67.9% |     68.3% |
| `Stub`        |    22 |   193 / 764 (25.3%) | 16.5% |     16.6% |
