...
**Overall (vs full engine): 1,686 / 3,856 functions exact (43.72%) &middot; 63.54% fuzzy &middot; 63.85% fuzzy max.**
...
_Started units alone: 1,686/3,709 fns exact, 64.31% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   322 | 828 / 1,789 (46.3%) | 67.5% |     67.9% |
| `Stub`        |    22 |   193 / 803 (24.0%) | 15.3% |     15.4% |
