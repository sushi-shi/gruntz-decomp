...
**Overall (vs full engine): 1,861 / 3,303 functions exact (56.34%) &middot; 68.66% fuzzy &middot; 68.66% fuzzy max.**
...
_Started units alone: 1,861/3,299 fns exact, 68.76% fuzzy over 964,772 of 966,217 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   426 | 1,285 / 2,442 (52.6%) | 65.3% |     65.3% |
