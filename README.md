...
**Overall (vs full engine): 1,861 / 3,397 functions exact (54.78%) &middot; 59.14% fuzzy &middot; 59.14% fuzzy max.**
...
_Started units alone: 1,861/3,394 fns exact, 59.17% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   382 | 1,191 / 2,304 (51.7%) | 61.5% |     61.5% |
