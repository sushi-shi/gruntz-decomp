...
**Overall (vs full engine): 1,155 / 7,092 functions exact (16.29%) &middot; 32.47% fuzzy &middot; 32.47% fuzzy max.**
...
_Started units alone: 1,155/3,232 fns exact, 34.52% fuzzy over 935,833 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   168 | 674 / 1,398 (48.2%) | 51.0% |     51.0% |
| `Stub`        |     4 |  118 / 1,279 (9.2%) |  4.4% |      4.4% |
