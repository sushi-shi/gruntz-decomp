...
**Overall (vs full engine): 2,468 / 3,995 functions exact (61.78%) &middot; 73.66% fuzzy &middot; 73.92% fuzzy max.**
...
_Started units alone: 2,468/3,991 fns exact, 73.45% fuzzy over 1,081,272 of 1,078,191 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,386 / 2,368 (58.5%) | 71.1% |     71.4% |
