...
**Overall (vs full engine): 1,690 / 3,856 functions exact (43.83%) &middot; 63.79% fuzzy &middot; 64.10% fuzzy max.**
...
_Started units alone: 1,690/3,709 fns exact, 64.56% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   325 | 832 / 1,801 (46.2%) | 67.6% |     68.0% |
| `Stub`        |    22 |   193 / 791 (24.4%) | 15.6% |     15.7% |
