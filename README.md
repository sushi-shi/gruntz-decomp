...
**Overall (vs full engine): 639 / 6,510 functions exact (9.82%) &middot; 15.03% fuzzy &middot; 15.03% fuzzy max.**
...
_Started units alone: 639/2,243 fns exact, 20.33% fuzzy over 733,690 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,307 (9.3%) |  3.9% |      3.9% |
| `Gruntz`      |    61 |  277 / 592 (46.8%) | 36.8% |     36.8% |
