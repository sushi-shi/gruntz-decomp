...
**Overall (vs full engine): 2,177 / 3,811 functions exact (57.12%) &middot; 72.80% fuzzy &middot; 72.80% fuzzy max.**
...
_Started units alone: 2,177/3,802 fns exact, 72.75% fuzzy over 1,068,584 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   309 | 1,314 / 2,460 (53.4%) | 70.3% |     70.3% |
