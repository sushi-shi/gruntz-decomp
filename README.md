...
**Overall (vs full engine): 1,856 / 3,302 functions exact (56.21%) &middot; 68.59% fuzzy &middot; 68.59% fuzzy max.**
...
_Started units alone: 1,856/3,298 fns exact, 68.69% fuzzy over 964,749 of 966,194 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   426 | 1,279 / 2,441 (52.4%) | 65.2% |     65.2% |
