...
**Overall (vs full engine): 1,382 / 3,451 functions exact (40.05%) &middot; 41.64% fuzzy &middot; 41.64% fuzzy max.**
...
_Started units alone: 1,382/3,415 fns exact, 41.67% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   206 | 850 / 1,732 (49.1%) | 56.2% |     56.2% |
| `Stub`        |     5 | 105 / 1,034 (10.2%) |  4.6% |      4.6% |
