...
**Overall (vs full engine): 208 / 6,378 functions exact (3.26%) &middot; 6.63% fuzzy &middot; 6.63% fuzzy max.**
...
_Started units alone: 208/429 fns exact, 56.47% fuzzy over 116,431 of 991,904 engine code bytes._

| Module        | Units |  Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | ----: | --------: |
| `Gruntz`      |    48 | 95 / 186 (51.1%) | 41.8% |     41.8% |
