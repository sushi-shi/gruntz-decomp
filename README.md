...
**Overall (vs full engine): 1,393 / 3,451 functions exact (40.37%) &middot; 43.77% fuzzy &middot; 43.77% fuzzy max.**
...
_Started units alone: 1,393/3,415 fns exact, 43.80% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   228 | 855 / 1,776 (48.1%) | 56.6% |     56.6% |
| `Stub`        |     5 |   105 / 974 (10.8%) |  5.0% |      5.0% |
| `Net`         |     9 |    69 / 113 (61.1%) | 57.0% |     57.0% |
