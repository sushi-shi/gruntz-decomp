...
**Overall (vs full engine): 1,785 / 3,451 functions exact (51.72%) &middot; 53.36% fuzzy &middot; 53.36% fuzzy max.**
...
_Started units alone: 1,785/3,393 fns exact, 53.41% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   342 | 1,162 / 2,234 (52.0%) | 60.0% |     60.0% |
