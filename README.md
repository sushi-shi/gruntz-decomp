...
**Overall (vs full engine): 1,812 / 3,451 functions exact (52.51%) &middot; 55.42% fuzzy &middot; 55.42% fuzzy max.**
...
_Started units alone: 1,812/3,394 fns exact, 55.47% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,170 / 2,258 (51.8%) | 60.8% |     60.8% |
