...
**Overall (vs full engine): 2,263 / 3,928 functions exact (57.61%) &middot; 72.39% fuzzy &middot; 72.40% fuzzy max.**
...
_Started units alone: 2,263/3,916 fns exact, 72.35% fuzzy over 1,077,935 of 1,077,336 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,307 / 2,358 (55.4%) | 69.8% |     69.8% |
