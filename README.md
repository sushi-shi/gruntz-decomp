...
**Overall (vs full engine): 1,396 / 3,543 functions exact (39.40%) &middot; 38.88% fuzzy &middot; 38.88% fuzzy max.**
...
_Started units alone: 1,396/3,485 fns exact, 38.92% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   209 | 877 / 1,729 (50.7%) | 54.9% |     54.9% |
| `Stub`        |     5 |  105 / 1,128 (9.3%) |  4.1% |      4.1% |
