...
**Overall (vs full engine): 1,801 / 3,856 functions exact (46.71%) &middot; 63.38% fuzzy &middot; 63.40% fuzzy max.**
...
_Started units alone: 1,801/3,813 fns exact, 64.03% fuzzy over 1,058,626 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   325 | 910 / 1,849 (49.2%) | 67.7% |     67.7% |
