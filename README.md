...
**Overall (vs full engine): 1,845 / 3,397 functions exact (54.31%) &middot; 59.01% fuzzy &middot; 59.01% fuzzy max.**
...
_Started units alone: 1,845/3,394 fns exact, 59.04% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   382 | 1,181 / 2,297 (51.4%) | 61.4% |     61.4% |
