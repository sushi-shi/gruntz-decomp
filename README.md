...
**Overall (vs full engine): 1,064 / 7,097 functions exact (14.99%) &middot; 29.31% fuzzy &middot; 29.31% fuzzy max.**
...
_Started units alone: 1,064/3,243 fns exact, 31.07% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,498 (7.9%) |  4.0% |      4.0% |
| `Gruntz`      |   166 | 615 / 1,259 (48.8%) | 50.1% |     50.1% |
