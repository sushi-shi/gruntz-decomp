...
**Overall (vs full engine): 503 / 6,510 functions exact (7.73%) &middot; 12.40% fuzzy &middot; 12.40% fuzzy max.**
...
_Started units alone: 503/2,238 fns exact, 16.99% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,513 (7.9%) |  3.5% |      3.5% |
| `Gruntz`      |    50 |  164 / 414 (39.6%) | 33.5% |     33.5% |
