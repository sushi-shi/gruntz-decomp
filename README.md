...
**Overall (vs full engine): 846 / 6,510 functions exact (13.00%) &middot; 23.49% fuzzy &middot; 23.49% fuzzy max.**
...
_Started units alone: 846/2,243 fns exact, 31.79% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |    98 | 442 / 951 (46.5%) | 45.1% |     45.1% |
| `Stub`        |     2 | 118 / 882 (13.4%) |  5.3% |      5.3% |
