...
**Overall (vs full engine): 3,252 / 4,497 functions exact (72.31%) &middot; 81.21% fuzzy &middot; 81.35% fuzzy max.**
...
_Started units alone: 3,252/4,268 fns exact, 81.11% fuzzy over 1,093,409 of 1,091,946 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,854 / 2,541 (73.0%) | 79.4% |     79.5% |
