...
**Overall (vs full engine): 1,388 / 3,543 functions exact (39.18%) &middot; 38.67% fuzzy &middot; 38.67% fuzzy max.**
...
_Started units alone: 1,388/3,485 fns exact, 38.70% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   203 | 869 / 1,716 (50.6%) | 54.8% |     54.8% |
| `Stub`        |     5 |  105 / 1,141 (9.2%) |  4.1% |      4.1% |
