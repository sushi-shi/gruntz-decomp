...
**Overall (vs full engine): 2,902 / 4,492 functions exact (64.60%) &middot; 75.74% fuzzy &middot; 75.82% fuzzy max.**
...
_Started units alone: 2,902/4,263 fns exact, 75.95% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,676 / 2,539 (66.0%) | 74.3% |     74.4% |
