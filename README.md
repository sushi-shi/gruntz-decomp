...
**Overall (vs full engine): 1,832 / 3,835 functions exact (47.77%) &middot; 63.64% fuzzy &middot; 63.72% fuzzy max.**
...
_Started units alone: 1,832/3,825 fns exact, 64.23% fuzzy over 1,059,256 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,106 / 2,081 (53.1%) | 68.5% |     68.6% |
