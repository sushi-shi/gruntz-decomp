...
**Overall (vs full engine): 3,320 / 4,300 functions exact (77.21%) &middot; 90.75% fuzzy &middot; 90.75% fuzzy max.**
...
_Started units alone: 3,320/4,291 fns exact, 89.12% fuzzy over 1,113,130 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,882 / 2,562 (73.5%) |  88.7% |     88.7% |
