...
**Overall (vs full engine): 3,051 / 4,346 functions exact (70.20%) &middot; 77.79% fuzzy &middot; 77.90% fuzzy max.**
...
_Started units alone: 3,051/4,263 fns exact, 77.86% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,759 / 2,539 (69.3%) | 76.5% |     76.6% |
