...
**Overall (vs full engine): 991 / 7,098 functions exact (13.96%) &middot; 27.21% fuzzy &middot; 27.21% fuzzy max.**
...
_Started units alone: 991/2,268 fns exact, 36.68% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   152 | 556 / 1,141 (48.7%) | 48.6% |     48.6% |
| `Stub`        |     2 |   118 / 660 (17.9%) |  5.9% |      5.9% |
