...
**Overall (vs full engine): 3,296 / 4,298 functions exact (76.69%) &middot; 88.70% fuzzy &middot; 88.70% fuzzy max.**
...
_Started units alone: 3,296/4,289 fns exact, 87.10% fuzzy over 1,113,124 of 1,093,138 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,857 / 2,557 (72.6%) |  86.3% |     86.3% |
