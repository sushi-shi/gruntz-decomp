...
**Overall (vs full engine): 231 / 6,367 functions exact (3.63%) &middot; 6.48% fuzzy &middot; 6.48% fuzzy max.**
...
_Started units alone: 231/750 fns exact, 19.02% fuzzy over 338,023 of 991,849 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 327 (0.0%) |   0.3% |      0.3% |
| `Gruntz`      |    45 | 106 / 227 (46.7%) |  46.3% |     46.3% |
