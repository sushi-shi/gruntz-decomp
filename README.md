...
**Overall (vs full engine): 1,251 / 7,435 functions exact (16.83%) &middot; 35.83% fuzzy &middot; 35.83% fuzzy max.**
...
_Started units alone: 1,251/3,233 fns exact, 38.16% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   183 | 759 / 1,549 (49.0%) | 52.8% |     52.8% |
| `Stub`        |     4 |  106 / 1,091 (9.7%) |  4.6% |      4.6% |
