...
**Overall (vs full engine): 1,020 / 7,097 functions exact (14.37%) &middot; 28.11% fuzzy &middot; 28.11% fuzzy max.**
...
_Started units alone: 1,020/2,269 fns exact, 37.89% fuzzy over 738,435 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   166 | 582 / 1,191 (48.9%) | 49.3% |     49.3% |
| `Stub`        |     2 |   118 / 605 (19.5%) |  6.1% |      6.1% |
