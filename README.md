...
**Overall (vs full engine): 720 / 6,510 functions exact (11.06%) &middot; 21.66% fuzzy &middot; 21.66% fuzzy max.**
...
_Started units alone: 720/2,242 fns exact, 29.31% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,081 (11.2%) |  5.2% |      5.2% |
