...
**Overall (vs full engine): 3,669 / 4,427 functions exact (82.88%) &middot; 94.58% fuzzy &middot; 94.74% fuzzy max.**

_Data: objdiff `matched_data` 560,499 of 802,859 B (69.81%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,669/4,427 fns exact, 94.63% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,139 / 2,652 (80.7%) |  94.5% |     94.6% |
