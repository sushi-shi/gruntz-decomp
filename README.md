...
**Overall (vs full engine): 511 / 6,510 functions exact (7.85%) &middot; 12.61% fuzzy &middot; 12.61% fuzzy max.**
...
_Started units alone: 511/2,238 fns exact, 17.27% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,499 (7.8%) |  3.5% |      3.5% |
| `Gruntz`      |    50 |  175 / 428 (40.9%) | 34.4% |     34.4% |
