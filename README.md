...
**Overall (vs full engine): 3,271 / 4,277 functions exact (76.48%) &middot; 87.02% fuzzy &middot; 87.25% fuzzy max.**
...
_Started units alone: 3,271/4,265 fns exact, 85.52% fuzzy over 1,103,434 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,868 / 2,547 (73.3%) |  84.4% |     84.7% |
