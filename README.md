...
**Overall (vs full engine): 907 / 6,510 functions exact (13.93%) &middot; 24.74% fuzzy &middot; 24.74% fuzzy max.**
...
_Started units alone: 907/2,243 fns exact, 33.47% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   118 | 481 / 1,025 (46.9%) | 46.3% |     46.3% |
| `Stub`        |     2 |   118 / 771 (15.3%) |  5.5% |      5.5% |
