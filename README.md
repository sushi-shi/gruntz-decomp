...
**Overall (vs full engine): 1,578 / 3,451 functions exact (45.73%) &middot; 47.14% fuzzy &middot; 47.14% fuzzy max.**
...
_Started units alone: 1,578/3,393 fns exact, 47.18% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   288 | 963 / 1,933 (49.8%) | 58.4% |     58.4% |
| `Stub`        |     7 |   107 / 705 (15.2%) |  5.4% |      5.4% |
