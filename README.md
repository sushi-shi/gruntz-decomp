...
**Overall (vs full engine): 414 / 6,510 functions exact (6.36%) &middot; 10.84% fuzzy &middot; 10.84% fuzzy max.**
...
_Started units alone: 414/1,092 fns exact, 22.26% fuzzy over 483,556 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 119 / 562 (21.2%) |   4.5% |      4.5% |
