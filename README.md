...
**Overall (vs full engine): 2,350 / 3,970 functions exact (59.19%) &middot; 72.92% fuzzy &middot; 72.94% fuzzy max.**
...
_Started units alone: 2,350/3,960 fns exact, 72.72% fuzzy over 1,081,098 of 1,078,018 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,334 / 2,368 (56.3%) | 70.2% |     70.2% |
