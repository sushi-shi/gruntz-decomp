...
**Overall (vs full engine): 496 / 6,510 functions exact (7.62%) &middot; 12.25% fuzzy &middot; 12.25% fuzzy max.**
...
_Started units alone: 496/2,238 fns exact, 16.78% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,526 (7.9%) |  3.5% |      3.5% |
| `Gruntz`      |    49 |  157 / 401 (39.2%) | 32.9% |     32.9% |
