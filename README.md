...
**Overall (vs full engine): 3,251 / 4,277 functions exact (76.01%) &middot; 85.90% fuzzy &middot; 85.93% fuzzy max.**
...
_Started units alone: 3,251/4,264 fns exact, 84.78% fuzzy over 1,098,636 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,858 / 2,547 (72.9%) |  83.6% |     83.7% |
