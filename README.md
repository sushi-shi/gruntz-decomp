...
**Overall (vs full engine): 1,857 / 3,290 functions exact (56.44%) &middot; 70.49% fuzzy &middot; 70.49% fuzzy max.**
...
_Started units alone: 1,857/3,266 fns exact, 70.61% fuzzy over 960,779 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   344 | 1,120 / 2,076 (53.9%) | 67.7% |     67.7% |
