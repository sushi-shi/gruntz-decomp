...
**Overall (vs full engine): 817 / 6,510 functions exact (12.55%) &middot; 23.25% fuzzy &middot; 23.25% fuzzy max.**
...
_Started units alone: 817/2,242 fns exact, 31.45% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 922 (13.0%) |  5.5% |      5.5% |
