...
**Overall (vs full engine): 2,178 / 3,811 functions exact (57.15%) &middot; 72.80% fuzzy &middot; 72.80% fuzzy max.**
...
_Started units alone: 2,178/3,801 fns exact, 72.76% fuzzy over 1,068,497 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   287 | 1,315 / 2,442 (53.8%) | 70.0% |     70.0% |
| `DDrawMgr`    |    29 |     238 / 437 (54.5%) | 71.1% |     71.1% |
