...
**Overall (vs full engine): 1,194 / 7,091 functions exact (16.84%) &middot; 33.93% fuzzy &middot; 33.93% fuzzy max.**
...
_Started units alone: 1,194/3,231 fns exact, 36.07% fuzzy over 935,763 of 994,765 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 717 / 1,474 (48.6%) | 51.7% |     51.7% |
| `Stub`        |     4 |  103 / 1,184 (8.7%) |  4.3% |      4.3% |
