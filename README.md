...
**Overall (vs full engine): 212 / 6,364 functions exact (3.33%) &middot; 4.85% fuzzy &middot; 4.85% fuzzy max.**
...
_Started units alone: 212/741 fns exact, 14.30% fuzzy over 336,296 of 990,979 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Stub`        |     1 |   0 / 376 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    32 | 95 / 178 (53.4%) |  38.5% |     38.5% |
