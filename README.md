...
**Overall (vs full engine): 3,500 / 4,311 functions exact (81.19%) &middot; 93.47% fuzzy &middot; 93.50% fuzzy max.**
...
_Started units alone: 3,500/4,322 fns exact, 91.81% fuzzy over 1,113,031 of 1,093,326 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,010 / 2,571 (78.2%) |  91.4% |     91.4% |
| `DDrawMgr`    |    22 |     490 / 574 (85.4%) |  88.6% |     88.7% |
| `Wwd`         |     9 |     162 / 214 (75.7%) |  93.5% |     93.6% |
| `Bute`        |     9 |     155 / 191 (81.2%) |  94.2% |     94.2% |
| `Dsndmgr`     |     4 |     144 / 153 (94.1%) |  98.2% |     98.2% |
| `Net`         |    12 |     121 / 134 (90.3%) |  97.5% |     97.5% |
| `Image`       |    12 |      91 / 130 (70.0%) |  92.9% |     92.9% |
...
| `jump thunks`                       |     1,609 |    8,028 | linker ILT jmp-table (RVA <0x7c20) + thunk_*             |
<!-- match-score:end -->
