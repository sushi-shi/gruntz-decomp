...
**Overall (vs full engine): 2,849 / 4,492 functions exact (63.42%) &middot; 75.48% fuzzy &middot; 75.58% fuzzy max.**
...
_Started units alone: 2,849/4,263 fns exact, 75.69% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,628 / 2,539 (64.1%) | 73.9% |     74.0% |
| `DDrawMgr`    |    26 |     387 / 573 (67.5%) | 69.1% |     69.1% |
