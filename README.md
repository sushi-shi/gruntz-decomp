...
**Overall (vs full engine): 3,288 / 4,269 functions exact (77.02%) &middot; 87.12% fuzzy &middot; 87.35% fuzzy max.**
...
_Started units alone: 3,288/4,279 fns exact, 85.54% fuzzy over 1,103,806 of 1,083,801 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,876 / 2,551 (73.5%) |  84.5% |     84.8% |
