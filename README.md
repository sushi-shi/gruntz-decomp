...
**Overall (vs full engine): 1,368 / 3,543 functions exact (38.61%) &middot; 38.50% fuzzy &middot; 38.50% fuzzy max.**
...
_Started units alone: 1,368/3,485 fns exact, 38.54% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   196 | 850 / 1,694 (50.2%) | 54.6% |     54.6% |
| `Stub`        |     5 |  105 / 1,164 (9.0%) |  4.1% |      4.1% |
