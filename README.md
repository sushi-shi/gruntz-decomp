...
**Overall (vs full engine): 2,345 / 3,970 functions exact (59.07%) &middot; 72.93% fuzzy &middot; 72.97% fuzzy max.**
...
_Started units alone: 2,345/3,962 fns exact, 72.72% fuzzy over 1,081,100 of 1,078,018 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,332 / 2,367 (56.3%) | 70.2% |     70.3% |
| `DDrawMgr`    |    26 |     300 / 514 (58.4%) | 67.8% |     67.8% |
| `Wwd`         |     8 |      89 / 184 (48.4%) | 78.9% |     79.1% |
