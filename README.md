...
**Overall (vs full engine): 947 / 7,098 functions exact (13.34%) &middot; 26.57% fuzzy &middot; 26.57% fuzzy max.**
...
_Started units alone: 947/2,268 fns exact, 35.82% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   131 | 512 / 1,084 (47.2%) | 47.8% |     47.8% |
