...
**Overall (vs full engine): 3,666 / 4,427 functions exact (82.81%) &middot; 94.25% fuzzy &middot; 94.49% fuzzy max.**
...
_Started units alone: 3,666/4,427 fns exact, 94.30% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,138 / 2,652 (80.6%) |  94.0% |     94.3% |
