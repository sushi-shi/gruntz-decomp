...
**Overall (vs full engine): 1,740 / 3,856 functions exact (45.12%) &middot; 65.16% fuzzy &middot; 65.47% fuzzy max.**
...
_Started units alone: 1,740/3,709 fns exact, 65.95% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 880 / 1,857 (47.4%) | 68.2% |     68.5% |
| `Stub`        |    22 |   193 / 731 (26.4%) | 17.8% |     17.9% |
