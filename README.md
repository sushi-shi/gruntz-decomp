...
**Overall (vs full engine): 604 / 6,510 functions exact (9.28%) &middot; 14.08% fuzzy &middot; 14.08% fuzzy max.**
...
_Started units alone: 604/2,239 fns exact, 19.28% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,356 (8.6%) |  3.5% |      3.5% |
| `Gruntz`      |    60 |  246 / 539 (45.6%) | 37.6% |     37.6% |
