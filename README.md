...
**Overall (vs full engine): 218 / 6,364 functions exact (3.43%) &middot; 5.56% fuzzy &middot; 5.56% fuzzy max.**
...
_Started units alone: 218/742 fns exact, 16.39% fuzzy over 336,319 of 990,979 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Stub`        |     1 |   0 / 355 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    34 | 96 / 195 (49.2%) |  38.9% |     38.9% |
