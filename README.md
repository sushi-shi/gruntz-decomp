...
**Data: 99.69% size-weighted across 707,695 B** (`.bss` 99.82%, `.data` 98.83%, `.rdata` 99.95%) &middot; 97.04% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
