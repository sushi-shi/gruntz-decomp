...
**Overall (vs full engine): 683 / 6,510 functions exact (10.49%) &middot; 20.24% fuzzy &middot; 20.24% fuzzy max.**
...
_Started units alone: 683/2,242 fns exact, 27.39% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,165 (10.4%) |  4.8% |      4.8% |
| `Gruntz`      |    74 |   320 / 728 (44.0%) | 43.1% |     43.1% |
