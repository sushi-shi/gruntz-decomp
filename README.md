...
**Overall (vs full engine): 1,867 / 3,357 functions exact (55.62%) &middot; 65.31% fuzzy &middot; 65.31% fuzzy max.**
...
_Started units alone: 1,867/3,354 fns exact, 65.36% fuzzy over 967,845 of 968,475 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   417 | 1,214 / 2,359 (51.5%) | 62.3% |     62.3% |
