...
**Overall (vs full engine): 2,292 / 3,957 functions exact (57.92%) &middot; 72.17% fuzzy &middot; 72.17% fuzzy max.**
...
_Started units alone: 2,292/3,945 fns exact, 71.97% fuzzy over 1,080,803 of 1,077,729 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   258 | 1,307 / 2,361 (55.4%) | 69.3% |     69.3% |
