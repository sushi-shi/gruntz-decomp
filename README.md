...
**Overall (vs full engine): 2,310 / 3,962 functions exact (58.30%) &middot; 72.20% fuzzy &middot; 72.23% fuzzy max.**
...
_Started units alone: 2,310/3,950 fns exact, 72.00% fuzzy over 1,080,948 of 1,077,874 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   258 | 1,319 / 2,367 (55.7%) | 69.3% |     69.3% |
| `DDrawMgr`    |    27 |     282 / 506 (55.7%) | 67.3% |     67.4% |
