...
**Overall (vs full engine): 935 / 6,510 functions exact (14.36%) &middot; 26.30% fuzzy &middot; 26.30% fuzzy max.**
...
_Started units alone: 935/2,244 fns exact, 35.58% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   129 | 503 / 1,065 (47.2%) | 47.5% |     47.5% |
| `Stub`        |     2 |   118 / 717 (16.5%) |  5.8% |      5.8% |
