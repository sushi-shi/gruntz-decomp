...
**Overall (vs full engine): 1,862 / 3,397 functions exact (54.81%) &middot; 59.62% fuzzy &middot; 59.62% fuzzy max.**
...
_Started units alone: 1,862/3,394 fns exact, 59.66% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   385 | 1,192 / 2,307 (51.7%) | 61.4% |     61.4% |
| `Stub`        |     7 |     139 / 284 (48.9%) | 19.0% |     19.0% |
