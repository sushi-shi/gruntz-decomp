...
**Overall (vs full engine): 3,082 / 4,492 functions exact (68.61%) &middot; 77.90% fuzzy &middot; 78.01% fuzzy max.**
...
_Started units alone: 3,082/4,263 fns exact, 78.09% fuzzy over 1,089,137 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,775 / 2,539 (69.9%) | 76.7% |     76.9% |
