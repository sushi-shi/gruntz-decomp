...
**Overall (vs full engine): 227 / 6,367 functions exact (3.57%) &middot; 6.10% fuzzy &middot; 6.10% fuzzy max.**
...
_Started units alone: 227/746 fns exact, 17.93% fuzzy over 337,615 of 991,849 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 342 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    40 | 102 / 208 (49.0%) |  43.5% |     43.5% |
