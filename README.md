...
**Overall (vs full engine): 1,822 / 3,835 functions exact (47.51%) &middot; 63.57% fuzzy &middot; 63.72% fuzzy max.**
...
_Started units alone: 1,822/3,819 fns exact, 64.17% fuzzy over 1,059,153 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,094 / 2,075 (52.7%) | 68.4% |     68.6% |
