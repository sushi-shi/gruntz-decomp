...
**Overall (vs full engine): 2,259 / 3,929 functions exact (57.50%) &middot; 72.17% fuzzy &middot; 72.18% fuzzy max.**
...
_Started units alone: 2,259/3,919 fns exact, 72.07% fuzzy over 1,078,835 of 1,077,337 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,305 / 2,359 (55.3%) | 69.4% |     69.4% |
...
| `Rez`         |     7 |       39 / 62 (62.9%) | 76.7% |     76.7% |
| `Wap32`       |     8 |       47 / 58 (81.0%) | 94.0% |     94.0% |
