...
**Overall (vs full engine): 944 / 7,098 functions exact (13.30%) &middot; 26.44% fuzzy &middot; 26.44% fuzzy max.**
...
_Started units alone: 944/2,268 fns exact, 35.64% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 509 / 1,077 (47.3%) | 47.7% |     47.7% |
| `Stub`        |     2 |   118 / 725 (16.3%) |  5.8% |      5.8% |
