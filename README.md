...
**Overall (vs full engine): 1,812 / 3,279 functions exact (55.26%) &middot; 65.87% fuzzy &middot; 65.87% fuzzy max.**
...
_Started units alone: 1,812/3,276 fns exact, 65.92% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,215 / 2,377 (51.1%) | 62.8% |     62.8% |
| `Net`         |    18 |      93 / 145 (64.1%) | 74.0% |     74.0% |
