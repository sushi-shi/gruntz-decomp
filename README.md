...
**Overall (vs full engine): 156 / 6,349 functions exact (2.46%) &middot; 4.17% fuzzy &middot; 4.17% fuzzy max.**
...
_Started units alone: 156/199 fns exact, 91.23% fuzzy over 45,290 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    21 |  52 / 78 (66.7%) |  75.1% |     75.1% |
