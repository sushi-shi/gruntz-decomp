...
**Overall (vs full engine): 3,505 / 4,314 functions exact (81.25%) &middot; 93.14% fuzzy &middot; 93.18% fuzzy max.**
...
_Started units alone: 3,505/4,327 fns exact, 91.52% fuzzy over 1,134,118 of 1,114,364 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   234 | 2,011 / 2,574 (78.1%) |  90.9% |     91.0% |
