...
**Overall (vs full engine): 1,811 / 3,859 functions exact (46.93%) &middot; 67.95% fuzzy &middot; 68.25% fuzzy max.**
...
_Started units alone: 1,811/3,720 fns exact, 68.05% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 930 / 1,928 (48.2%) | 69.0% |     69.3% |
| `Stub`        |    22 |   193 / 630 (30.6%) | 22.1% |     22.2% |
