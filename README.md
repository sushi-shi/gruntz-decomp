...
**Overall (vs full engine): 1,554 / 3,451 functions exact (45.03%) &middot; 45.90% fuzzy &middot; 45.90% fuzzy max.**
...
_Started units alone: 1,554/3,393 fns exact, 45.94% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   268 | 944 / 1,897 (49.8%) | 57.8% |     57.8% |
