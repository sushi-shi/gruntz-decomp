...
**Overall (vs full engine): 2,262 / 3,927 functions exact (57.60%) &middot; 72.40% fuzzy &middot; 72.40% fuzzy max.**
...
_Started units alone: 2,262/3,915 fns exact, 72.36% fuzzy over 1,077,934 of 1,077,335 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   278 | 1,388 / 2,523 (55.0%) | 69.6% |     69.6% |
| `DDrawMgr`    |    20 |     216 / 393 (55.0%) | 70.9% |     70.9% |
| `Wwd`         |     7 |      83 / 170 (48.8%) | 78.0% |     78.0% |
| `Dsndmgr`     |     5 |     102 / 139 (73.4%) | 92.3% |     92.3% |
| `Net`         |    13 |      90 / 126 (71.4%) | 93.5% |     93.5% |
| `Bute`        |     7 |      72 / 123 (58.5%) | 72.6% |     72.6% |
| `Image`       |    15 |      55 / 121 (45.5%) | 80.9% |     80.9% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Wap32`       |     8 |       46 / 57 (80.7%) | 93.9% |     93.9% |
| `DinMgr2`     |     2 |       47 / 54 (87.0%) | 98.6% |     98.6% |
| `Rez`         |     6 |       30 / 48 (62.5%) | 74.6% |     74.6% |
...
| `jump thunks`        |     1,682 |    8,348 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
