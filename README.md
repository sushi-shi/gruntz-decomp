...
**Overall (vs full engine): 1,306 / 7,435 functions exact (17.57%) &middot; 37.42% fuzzy &middot; 37.42% fuzzy max.**
...
_Started units alone: 1,306/3,234 fns exact, 39.89% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   190 | 805 / 1,624 (49.6%) | 54.2% |     54.2% |
| `Stub`        |     4 | 104 / 1,004 (10.4%) |  4.5% |      4.5% |
