...
**Overall (vs full engine): 1,791 / 3,451 functions exact (51.90%) &middot; 54.71% fuzzy &middot; 54.71% fuzzy max.**
...
_Started units alone: 1,791/3,394 fns exact, 54.75% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   355 | 1,166 / 2,252 (51.8%) | 60.5% |     60.5% |
| `Stub`        |     7 |     104 / 349 (29.8%) |  8.8% |      8.8% |
