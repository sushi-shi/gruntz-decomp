...
**Overall (vs full engine): 380 / 6,371 functions exact (5.96%) &middot; 9.17% fuzzy &middot; 9.17% fuzzy max.**
...
_Started units alone: 380/1,078 fns exact, 19.00% fuzzy over 478,727 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |  96 / 592 (16.2%) |   2.8% |      2.8% |
