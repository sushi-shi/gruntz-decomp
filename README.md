...
**Overall (vs full engine): 1,794 / 3,856 functions exact (46.52%) &middot; 63.37% fuzzy &middot; 63.39% fuzzy max.**
...
_Started units alone: 1,794/3,805 fns exact, 64.03% fuzzy over 1,058,578 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   325 | 903 / 1,841 (49.0%) | 67.7% |     67.7% |
