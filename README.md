...
**Overall (vs full engine): 2,258 / 3,898 functions exact (57.93%) &middot; 72.39% fuzzy &middot; 72.40% fuzzy max.**
...
_Started units alone: 2,258/3,886 fns exact, 72.35% fuzzy over 1,077,798 of 1,077,229 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   271 | 1,382 / 2,497 (55.3%) | 69.5% |     69.5% |
| `DDrawMgr`    |    20 |     216 / 396 (54.5%) | 70.8% |     70.9% |
...
| `CRT/MFC library`    |     2,268 |  207,486 | FID-identified, statically linked                 |
| `jump thunks`        |     1,683 |    8,345 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
