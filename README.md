...
**Overall (vs full engine): 146 / 6,349 functions exact (2.30%) &middot; 3.98% fuzzy &middot; 3.98% fuzzy max.**
...
_Started units alone: 146/186 fns exact, 90.94% fuzzy over 43,450 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    16 |  42 / 65 (64.6%) |  71.9% |     71.9% |
