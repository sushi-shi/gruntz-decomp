...
**Overall (vs full engine): 1,398 / 3,543 functions exact (39.46%) &middot; 38.94% fuzzy &middot; 38.94% fuzzy max.**
...
_Started units alone: 1,398/3,485 fns exact, 38.98% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   210 | 879 / 1,732 (50.8%) | 55.0% |     55.0% |
| `Stub`        |     5 |  105 / 1,124 (9.3%) |  4.1% |      4.1% |
