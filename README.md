...
**Overall (vs full engine): 928 / 6,510 functions exact (14.25%) &middot; 26.13% fuzzy &middot; 26.13% fuzzy max.**
...
_Started units alone: 928/2,244 fns exact, 35.36% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   125 | 496 / 1,055 (47.0%) | 47.3% |     47.3% |
| `Stub`        |     2 |   118 / 727 (16.2%) |  5.8% |      5.8% |
