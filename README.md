...
**Overall (vs full engine): 2,727 / 4,337 functions exact (62.88%) &middot; 73.58% fuzzy &middot; 73.61% fuzzy max.**
...
_Started units alone: 2,727/4,234 fns exact, 73.72% fuzzy over 1,084,482 of 1,086,468 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,569 / 2,538 (61.8%) | 71.4% |     71.4% |
