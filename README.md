...
**Overall (vs full engine): 3,244 / 4,301 functions exact (75.42%) &middot; 87.64% fuzzy &middot; 87.98% fuzzy max.**
...
_Started units alone: 3,244/4,297 fns exact, 85.98% fuzzy over 1,114,371 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,825 / 2,557 (71.4%) |  85.3% |     85.6% |
