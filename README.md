...
**Overall (vs full engine): 2,259 / 3,900 functions exact (57.92%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,259/3,888 fns exact, 72.35% fuzzy over 1,077,803 of 1,077,234 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   271 | 1,383 / 2,498 (55.4%) | 69.5% |     69.5% |
| `DDrawMgr`    |    20 |     216 / 396 (54.5%) | 70.8% |     70.8% |
