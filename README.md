...
**Overall (vs full engine): 1,182 / 7,091 functions exact (16.67%) &middot; 33.72% fuzzy &middot; 33.72% fuzzy max.**
...
_Started units alone: 1,182/3,231 fns exact, 35.85% fuzzy over 935,763 of 994,765 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   171 | 707 / 1,449 (48.8%) | 51.8% |     51.8% |
| `Stub`        |     4 |  104 / 1,214 (8.6%) |  4.4% |      4.4% |
