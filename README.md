...
**Overall (vs full engine): 1,239 / 7,435 functions exact (16.66%) &middot; 35.06% fuzzy &middot; 35.06% fuzzy max.**
...
_Started units alone: 1,239/3,233 fns exact, 37.33% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   181 | 747 / 1,518 (49.2%) | 52.5% |     52.5% |
| `Stub`        |     4 |  106 / 1,125 (9.4%) |  4.4% |      4.4% |
...
| `DDrawMgr`    |     1 |      3 / 18 (16.7%) | 61.2% |     61.7% |
