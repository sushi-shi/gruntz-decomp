...
**Overall (vs full engine): 1,853 / 3,297 functions exact (56.20%) &middot; 68.58% fuzzy &middot; 68.58% fuzzy max.**
...
_Started units alone: 1,853/3,293 fns exact, 68.68% fuzzy over 964,524 of 965,969 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   426 | 1,276 / 2,436 (52.4%) | 65.2% |     65.2% |
