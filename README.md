...
**Overall (vs full engine): 3,098 / 4,346 functions exact (71.28%) &middot; 78.14% fuzzy &middot; 78.25% fuzzy max.**
...
_Started units alone: 3,098/4,263 fns exact, 78.21% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,785 / 2,539 (70.3%) | 76.9% |     77.0% |
