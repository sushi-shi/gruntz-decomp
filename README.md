...
**Overall (vs full engine): 764 / 6,510 functions exact (11.74%) &middot; 22.74% fuzzy &middot; 22.74% fuzzy max.**
...
_Started units alone: 764/2,242 fns exact, 30.77% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 997 (12.1%) |  5.4% |      5.4% |
