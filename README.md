...
**Overall (vs full engine): 2,521 / 4,007 functions exact (62.91%) &middot; 73.82% fuzzy &middot; 73.82% fuzzy max.**
...
_Started units alone: 2,521/4,041 fns exact, 73.59% fuzzy over 1,081,760 of 1,078,370 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,420 / 2,401 (59.1%) | 71.3% |     71.3% |
