...
**Overall (vs full engine): 883 / 6,510 functions exact (13.56%) &middot; 24.37% fuzzy &middot; 24.37% fuzzy max.**
...
_Started units alone: 883/2,243 fns exact, 32.98% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   112 | 465 / 1,000 (46.5%) | 46.0% |     46.0% |
| `Stub`        |     2 |   118 / 806 (14.6%) |  5.4% |      5.4% |
