...
**Overall (vs full engine): 558 / 6,510 functions exact (8.57%) &middot; 13.63% fuzzy &middot; 13.63% fuzzy max.**
...
_Started units alone: 558/2,239 fns exact, 18.67% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,419 (8.2%) |  3.5% |      3.5% |
| `Gruntz`      |    58 |  203 / 480 (42.3%) | 36.3% |     36.3% |
