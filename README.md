...
**Overall (vs full engine): 2,945 / 4,314 functions exact (68.27%) &middot; 94.07% fuzzy &middot; 94.07% fuzzy max.**

**Data — reconstructable coverage 99.67% &middot; gross coverage 40.86% &middot; fidelity 98.16%** (initialized data; `.bss` 92.35% / 96.72% is reported apart).
...
_Started units alone: 2,945/4,327 fns exact, 92.43% fuzzy over 1,134,118 of 1,114,364 engine code bytes._
...
| `Image`      |    12 |      74 / 131 (56.5%) |  93.4% |     93.4% |
