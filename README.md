...
**Overall (vs full engine): 1,751 / 3,856 functions exact (45.41%) &middot; 65.33% fuzzy &middot; 65.64% fuzzy max.**
...
_Started units alone: 1,751/3,710 fns exact, 66.13% fuzzy over 1,056,736 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 886 / 1,862 (47.6%) | 68.2% |     68.6% |
| `Stub`        |    22 |   193 / 721 (26.8%) | 18.1% |     18.2% |
