...
**Overall (vs full engine): 2,899 / 4,340 functions exact (66.80%) &middot; 73.89% fuzzy &middot; 73.89% fuzzy max.**
...
_Started units alone: 2,899/4,480 fns exact, 73.73% fuzzy over 1,088,858 of 1,086,538 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,731 / 2,770 (62.5%) | 71.4% |     71.4% |
