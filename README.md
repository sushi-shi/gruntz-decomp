...
**Overall (vs full engine): 1,744 / 3,451 functions exact (50.54%) &middot; 50.31% fuzzy &middot; 50.31% fuzzy max.**
...
_Started units alone: 1,744/3,393 fns exact, 50.36% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   324 | 1,121 / 2,138 (52.4%) | 58.8% |     58.8% |
| `Stub`        |     7 |     113 / 488 (23.2%) |  6.6% |      6.6% |
