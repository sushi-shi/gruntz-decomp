...
**Overall (vs full engine): 1,081 / 7,097 functions exact (15.23%) &middot; 30.32% fuzzy &middot; 30.32% fuzzy max.**
...
_Started units alone: 1,081/3,243 fns exact, 32.13% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,444 (8.2%) |  4.1% |      4.1% |
| `Gruntz`      |   166 | 627 / 1,295 (48.4%) | 50.6% |     50.6% |
| `Dsndmgr`     |     9 |     50 / 77 (64.9%) | 85.5% |     85.5% |
| `Bute`        |     4 |     46 / 64 (71.9%) | 75.1% |     75.1% |
| `Net`         |     3 |     33 / 56 (58.9%) | 43.3% |     43.3% |
