...
**Overall (vs full engine): 1,271 / 7,435 functions exact (17.09%) &middot; 36.67% fuzzy &middot; 36.67% fuzzy max.**
...
_Started units alone: 1,271/3,234 fns exact, 39.09% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 776 / 1,577 (49.2%) | 53.6% |     53.6% |
| `Stub`        |     4 |  104 / 1,057 (9.8%) |  4.6% |      4.6% |
