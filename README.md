...
**Overall (vs full engine): 2,850 / 4,492 functions exact (63.45%) &middot; 75.45% fuzzy &middot; 75.50% fuzzy max.**
...
_Started units alone: 2,850/4,263 fns exact, 75.66% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,629 / 2,539 (64.2%) | 73.9% |     73.9% |
...
| `Net`         |    13 |     107 / 135 (79.3%) | 94.1% |     94.1% |
| `Image`       |    16 |      63 / 127 (49.6%) | 83.6% |     83.8% |
