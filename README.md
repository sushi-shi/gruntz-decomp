...
**Overall (vs full engine): 1,909 / 3,859 functions exact (49.47%) &middot; 68.75% fuzzy &middot; 69.06% fuzzy max.**
...
_Started units alone: 1,909/3,720 fns exact, 68.85% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 980 / 1,992 (49.2%) | 69.2% |     69.5% |
| `Stub`        |    22 |   195 / 520 (37.5%) | 24.4% |     24.6% |
