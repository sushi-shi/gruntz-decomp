...
**Overall (vs full engine): 416 / 6,510 functions exact (6.39%) &middot; 10.89% fuzzy &middot; 10.89% fuzzy max.**
...
_Started units alone: 416/1,092 fns exact, 22.36% fuzzy over 483,556 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 121 / 562 (21.5%) |   4.7% |      4.7% |
