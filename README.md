...
**Overall (vs full engine): 1,830 / 3,835 functions exact (47.72%) &middot; 63.60% fuzzy &middot; 63.72% fuzzy max.**
...
_Started units alone: 1,830/3,818 fns exact, 64.25% fuzzy over 1,058,311 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,101 / 2,074 (53.1%) | 68.5% |     68.7% |
