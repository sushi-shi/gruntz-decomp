...
**Overall (vs full engine): 1,844 / 3,397 functions exact (54.28%) &middot; 58.44% fuzzy &middot; 58.44% fuzzy max.**
...
_Started units alone: 1,844/3,394 fns exact, 58.47% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   380 | 1,180 / 2,292 (51.5%) | 61.4% |     61.4% |
| `Stub`        |     7 |     134 / 301 (44.5%) | 16.0% |     16.0% |
