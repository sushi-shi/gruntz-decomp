...
**Overall (vs full engine): 1,932 / 3,859 functions exact (50.06%) &middot; 69.10% fuzzy &middot; 69.41% fuzzy max.**
...
_Started units alone: 1,932/3,718 fns exact, 69.22% fuzzy over 1,067,766 of 1,069,721 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   331 | 1,053 / 2,097 (50.2%) | 69.6% |     69.9% |
| `Stub`        |    18 |      97 / 347 (28.0%) | 14.0% |     14.0% |
