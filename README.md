...
**Overall (vs full engine): 2,918 / 4,492 functions exact (64.96%) &middot; 76.09% fuzzy &middot; 76.17% fuzzy max.**
...
_Started units alone: 2,918/4,263 fns exact, 76.30% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,690 / 2,539 (66.6%) | 74.7% |     74.8% |
| `DDrawMgr`    |    26 |     391 / 573 (68.2%) | 69.4% |     69.5% |
