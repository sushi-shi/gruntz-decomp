...
**Overall (vs full engine): 738 / 6,510 functions exact (11.34%) &middot; 22.03% fuzzy &middot; 22.03% fuzzy max.**
...
_Started units alone: 738/2,242 fns exact, 29.81% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,053 (11.5%) |  5.3% |      5.3% |
| `Gruntz`      |    81 |   372 / 828 (44.9%) | 44.0% |     44.0% |
