...
| `.reloc` | 113,105 | 113,411 | +306 | **42.88%** | 59,255 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,008,373 | +21,194 | **50.00%** | 58,731 |
| **total** | 3,137,613 | 3,239,756 | +102,143 | **40.76%** | 815,697 |
...
_Independently of where the bytes landed, **36,267 of 36,580 address operands (99.14%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `be567e92c250`, linked 2026-08-10 15:41. Regenerate: `ninja candidate`._
<!-- link-score:end -->
