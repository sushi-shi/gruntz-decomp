...
**Overall (vs full engine): 3,454 / 4,301 functions exact (80.31%) &middot; 91.75% fuzzy &middot; 91.76% fuzzy max.**
...
_Started units alone: 3,454/4,301 fns exact, 90.02% fuzzy over 1,114,203 of 1,093,174 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,989 / 2,565 (77.5%) |  89.3% |     89.3% |
