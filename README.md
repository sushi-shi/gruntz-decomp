...
**Overall (vs full engine): 1,864 / 3,364 functions exact (55.41%) &middot; 64.19% fuzzy &middot; 64.19% fuzzy max.**
...
_Started units alone: 1,864/3,361 fns exact, 64.23% fuzzy over 970,153 of 970,780 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   413 | 1,209 / 2,356 (51.3%) | 62.0% |     62.0% |
| `Stub`        |     2 |     123 / 200 (61.5%) | 48.3% |     48.3% |
