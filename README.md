...
**Overall (vs full engine): 947 / 7,098 functions exact (13.34%) &middot; 26.63% fuzzy &middot; 26.63% fuzzy max.**
...
_Started units alone: 947/2,268 fns exact, 35.90% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   131 | 512 / 1,087 (47.1%) | 47.9% |     47.9% |
| `Stub`        |     2 |   118 / 714 (16.5%) |  5.8% |      5.8% |
