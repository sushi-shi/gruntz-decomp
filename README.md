...
**Overall (vs full engine): 966 / 7,098 functions exact (13.61%) &middot; 27.06% fuzzy &middot; 27.06% fuzzy max.**
...
_Started units alone: 966/2,268 fns exact, 36.48% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   139 | 531 / 1,113 (47.7%) | 48.4% |     48.4% |
| `Stub`        |     2 |   118 / 688 (17.2%) |  5.9% |      5.9% |
