...
**Overall (vs full engine): 3,254 / 4,497 functions exact (72.36%) &middot; 81.26% fuzzy &middot; 81.40% fuzzy max.**
...
_Started units alone: 3,254/4,268 fns exact, 81.15% fuzzy over 1,093,409 of 1,091,946 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,855 / 2,541 (73.0%) | 79.4% |     79.5% |
| `DDrawMgr`    |    23 |     451 / 571 (79.0%) | 77.5% |     77.5% |
