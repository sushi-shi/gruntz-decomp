...
**Overall (vs full engine): 3,462 / 4,301 functions exact (80.49%) &middot; 91.86% fuzzy &middot; 91.89% fuzzy max.**
...
_Started units alone: 3,462/4,301 fns exact, 90.13% fuzzy over 1,114,203 of 1,093,174 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,996 / 2,567 (77.8%) |  89.4% |     89.4% |
