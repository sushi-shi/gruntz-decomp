...
**Overall (vs full engine): 1,863 / 3,397 functions exact (54.84%) &middot; 60.16% fuzzy &middot; 60.16% fuzzy max.**
...
_Started units alone: 1,863/3,394 fns exact, 60.20% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   386 | 1,193 / 2,309 (51.7%) | 62.1% |     62.1% |
