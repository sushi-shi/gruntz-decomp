...
**Data: 99.68% size-weighted across 706,281 B** (`.bss` 99.82%, `.data` 98.82%, `.rdata` 99.95%) &middot; 92.78% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
