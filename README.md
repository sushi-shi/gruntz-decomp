...
**Overall (vs full engine): 213 / 6,364 functions exact (3.35%) &middot; 5.06% fuzzy &middot; 5.06% fuzzy max.**
...
_Started units alone: 213/742 fns exact, 14.90% fuzzy over 336,319 of 990,979 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Stub`        |     1 |   0 / 357 (0.0%) |   0.4% |      0.4% |
