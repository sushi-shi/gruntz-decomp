...
**Overall (vs full engine): 3,492 / 4,310 functions exact (81.02%) &middot; 93.25% fuzzy &middot; 93.31% fuzzy max.**
...
_Started units alone: 3,492/4,321 fns exact, 91.60% fuzzy over 1,113,024 of 1,093,319 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,007 / 2,571 (78.1%) |  91.3% |     91.4% |
| `DDrawMgr`    |    22 |     488 / 574 (85.0%) |  87.8% |     87.8% |
| `Wwd`         |     9 |     161 / 214 (75.2%) |  93.5% |     93.5% |
...
| `jump thunks`                       |     1,610 |    8,035 | linker ILT jmp-table (RVA <0x7c20) + thunk_*             |
<!-- match-score:end -->
