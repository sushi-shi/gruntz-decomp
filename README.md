...
**Data: 99.68% size-weighted across 706,177 B** (`.bss` 99.82%, `.data` 98.82%, `.rdata` 99.91%) &middot; 92.00% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
