...
**Overall (vs full engine): 933 / 6,510 functions exact (14.33%) &middot; 26.21% fuzzy &middot; 26.21% fuzzy max.**
...
_Started units alone: 933/2,244 fns exact, 35.47% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   127 | 501 / 1,061 (47.2%) | 47.4% |     47.4% |
| `Stub`        |     2 |   118 / 721 (16.4%) |  5.8% |      5.8% |
