...
**Overall (vs full engine): 2,307 / 3,962 functions exact (58.23%) &middot; 72.22% fuzzy &middot; 72.22% fuzzy max.**
...
_Started units alone: 2,307/3,950 fns exact, 72.01% fuzzy over 1,080,948 of 1,077,874 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   262 | 1,316 / 2,367 (55.6%) | 69.3% |     69.3% |
| `DDrawMgr`    |    27 |     283 / 506 (55.9%) | 67.3% |     67.3% |
| `Wwd`         |     8 |      86 / 183 (47.0%) | 78.4% |     78.4% |
| `Bute`        |    11 |      87 / 155 (56.1%) | 74.8% |     74.8% |
| `Dsndmgr`     |     5 |     104 / 138 (75.4%) | 92.7% |     92.7% |
| `Net`         |    13 |      89 / 126 (70.6%) | 93.5% |     93.5% |
| `Image`       |    16 |      58 / 125 (46.4%) | 80.9% |     80.9% |
| `Rez`         |     7 |       56 / 77 (72.7%) | 78.6% |     78.6% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Wap32`       |     8 |       48 / 56 (85.7%) | 95.0% |     95.0% |
| `DinMgr2`     |     2 |       48 / 55 (87.3%) | 98.6% |     98.6% |
| `Io`          |     4 |       28 / 41 (68.3%) | 84.2% |     84.2% |
...
| `CRT/MFC library`    |     2,242 |  206,209 | FID-identified, statically linked                 |
| `jump thunks`        |     1,676 |    8,339 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
