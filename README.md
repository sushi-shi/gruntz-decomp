...
**Overall (vs full engine): 1,848 / 3,397 functions exact (54.40%) &middot; 59.06% fuzzy &middot; 59.06% fuzzy max.**
...
_Started units alone: 1,848/3,394 fns exact, 59.09% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   382 | 1,184 / 2,297 (51.5%) | 61.5% |     61.5% |
| `Stub`        |     7 |     134 / 296 (45.3%) | 17.2% |     17.2% |
