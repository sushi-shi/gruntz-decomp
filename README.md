...
**Overall (vs full engine): 1,099 / 7,097 functions exact (15.49%) &middot; 30.93% fuzzy &middot; 30.93% fuzzy max.**
...
_Started units alone: 1,099/3,243 fns exact, 32.79% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,403 (8.4%) |  4.1% |      4.1% |
| `Gruntz`      |   166 | 636 / 1,322 (48.1%) | 51.0% |     51.0% |
