...
**Overall (vs full engine): 3,537 / 4,327 functions exact (81.74%) &middot; 94.99% fuzzy &middot; 95.01% fuzzy max.**
...
_Started units alone: 3,537/4,351 fns exact, 93.34% fuzzy over 1,134,668 of 1,114,937 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   232 | 2,019 / 2,586 (78.1%) |  92.9% |     93.0% |
| `DDrawMgr`    |    22 |     507 / 584 (86.8%) |  92.4% |     92.4% |
