...
**Overall (vs full engine): 413 / 6,510 functions exact (6.34%) &middot; 10.71% fuzzy &middot; 10.71% fuzzy max.**
...
_Started units alone: 413/1,092 fns exact, 21.99% fuzzy over 483,556 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 118 / 563 (21.0%) |   4.3% |      4.3% |
