...
**Overall (vs full engine): 940 / 7,098 functions exact (13.24%) &middot; 26.37% fuzzy &middot; 26.37% fuzzy max.**
...
_Started units alone: 940/2,268 fns exact, 35.55% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 505 / 1,071 (47.2%) | 47.6% |     47.6% |
| `Stub`        |     2 |   118 / 731 (16.1%) |  5.8% |      5.8% |
