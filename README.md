...
**Overall (vs full engine): 3,238 / 4,301 functions exact (75.28%) &middot; 87.48% fuzzy &middot; 87.74% fuzzy max.**
...
_Started units alone: 3,238/4,295 fns exact, 85.82% fuzzy over 1,114,357 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,816 / 2,553 (71.1%) |  85.0% |     85.4% |
