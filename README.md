...
**Overall (vs full engine): 176 / 6,349 functions exact (2.77%) &middot; 4.44% fuzzy &middot; 4.44% fuzzy max.**
...
_Started units alone: 176/232 fns exact, 90.58% fuzzy over 48,591 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    28 | 68 / 107 (63.6%) |  76.1% |     76.1% |
| `zlib-1.0.4`  |    11 |  47 / 50 (94.0%) |  99.4% |     99.4% |
| `Wap32`       |     2 |  16 / 18 (88.9%) |  99.3% |     99.3% |
