...
**Candidate image: 2,513,408 B vs retail 2,511,872 B (100.06%, +1,536 B).**

| section | retail | candidate | delta | retail bytes reproduced | not measurable |
| :-- | --: | --: | --: | --: | --: |
| `.data` | 763,820 | 832,780 | +68,960 | **10.06%** | 627,628 |
| `.idata` | 15,169 | 15,169 | +0 &check; | **77.59%** | 3,307 |
| `.rdata` | 135,080 | 142,728 | +7,648 | **16.96%** | 66,776 |
| `.reloc` | 113,105 | 110,856 | -2,249 | **40.96%** | 59,397 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 1,982,886 | -4,293 | **48.52%** | 58,731 |
| **total** | 3,137,613 | 3,207,679 | +70,066 | **39.69%** | 815,839 |
...
_Independently of where the bytes landed, **35,625 of 36,786 address operands (96.84%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `f20a2b0b0a1b`, linked 2026-08-09 13:12. Regenerate: `ninja candidate`._
<!-- link-score:end -->
