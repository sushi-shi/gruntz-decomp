...
**Overall (vs full engine): 823 / 6,510 functions exact (12.64%) &middot; 23.29% fuzzy &middot; 23.29% fuzzy max.**
...
_Started units alone: 823/2,242 fns exact, 31.51% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |    94 | 425 / 926 (45.9%) | 44.7% |     44.7% |
| `Stub`        |     2 | 120 / 915 (13.1%) |  5.5% |      5.5% |
