...
**Overall (vs full engine): 3,313 / 4,300 functions exact (77.05%) &middot; 90.71% fuzzy &middot; 90.71% fuzzy max.**
...
_Started units alone: 3,313/4,291 fns exact, 89.08% fuzzy over 1,113,130 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,876 / 2,562 (73.2%) |  88.7% |     88.7% |
