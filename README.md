...
_Started units alone: 1,830/3,819 fns exact, 64.20% fuzzy over 1,059,153 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,101 / 2,075 (53.1%) | 68.4% |     68.6% |
