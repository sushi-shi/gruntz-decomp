...
**Overall (vs full engine): 2,859 / 4,492 functions exact (63.65%) &middot; 75.55% fuzzy &middot; 75.65% fuzzy max.**
...
_Started units alone: 2,859/4,263 fns exact, 75.77% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,634 / 2,539 (64.4%) | 74.0% |     74.1% |
