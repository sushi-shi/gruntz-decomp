...
**Overall (vs full engine): 2,171 / 3,811 functions exact (56.97%) &middot; 72.55% fuzzy &middot; 72.55% fuzzy max.**
...
_Started units alone: 2,171/3,802 fns exact, 72.51% fuzzy over 1,068,584 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   364 | 1,262 / 2,357 (53.5%) | 69.6% |     69.6% |
