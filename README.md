...
**Overall (vs full engine): 2,262 / 3,928 functions exact (57.59%) &middot; 72.38% fuzzy &middot; 72.38% fuzzy max.**
...
_Started units alone: 2,262/3,916 fns exact, 72.34% fuzzy over 1,077,935 of 1,077,336 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,306 / 2,358 (55.4%) | 69.8% |     69.8% |
| `DDrawMgr`    |    27 |     277 / 500 (55.4%) | 67.3% |     67.3% |
...
| `jump thunks`        |     1,681 |    8,347 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
