...
**Overall (vs full engine): 1,249 / 7,435 functions exact (16.80%) &middot; 35.24% fuzzy &middot; 35.24% fuzzy max.**
...
_Started units alone: 1,249/3,233 fns exact, 37.53% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   181 | 757 / 1,535 (49.3%) | 52.7% |     52.7% |
| `Stub`        |     4 |  106 / 1,108 (9.6%) |  4.5% |      4.5% |
