...
**Overall (vs full engine): 3,323 / 4,300 functions exact (77.28%) &middot; 90.71% fuzzy &middot; 90.81% fuzzy max.**
...
_Started units alone: 3,323/4,290 fns exact, 89.09% fuzzy over 1,113,088 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,883 / 2,561 (73.5%) |  88.6% |     88.8% |
| `DDrawMgr`    |    22 |     475 / 572 (83.0%) |  87.1% |     87.2% |
