...
**Overall (vs full engine): 515 / 6,510 functions exact (7.91%) &middot; 12.74% fuzzy &middot; 12.74% fuzzy max.**
...
_Started units alone: 515/2,238 fns exact, 17.45% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,490 (7.9%) |  3.5% |      3.5% |
| `Gruntz`      |    52 |  179 / 437 (41.0%) | 34.6% |     34.6% |
