...
**Overall (vs full engine): 2,699 / 4,337 functions exact (62.23%) &middot; 73.54% fuzzy &middot; 73.55% fuzzy max.**
...
_Started units alone: 2,699/4,212 fns exact, 73.71% fuzzy over 1,084,002 of 1,086,468 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,553 / 2,523 (61.6%) | 71.4% |     71.4% |
