...
**Overall (vs full engine): 1,251 / 7,435 functions exact (16.83%) &middot; 35.74% fuzzy &middot; 35.74% fuzzy max.**
...
_Started units alone: 1,251/3,233 fns exact, 38.06% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   183 | 759 / 1,547 (49.1%) | 53.1% |     53.1% |
| `Stub`        |     4 |  106 / 1,095 (9.7%) |  4.5% |      4.5% |
