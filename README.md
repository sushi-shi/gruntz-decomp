...
**Overall (vs full engine): 755 / 6,510 functions exact (11.60%) &middot; 22.49% fuzzy &middot; 22.49% fuzzy max.**
...
_Started units alone: 755/2,242 fns exact, 30.44% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,014 (11.9%) |  5.4% |      5.4% |
| `Gruntz`      |    86 |   389 / 867 (44.9%) | 44.2% |     44.2% |
