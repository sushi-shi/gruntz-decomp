...
**Overall (vs full engine): 1,218 / 7,435 functions exact (16.38%) &middot; 34.46% fuzzy &middot; 34.46% fuzzy max.**
...
_Started units alone: 1,218/3,233 fns exact, 36.70% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 734 / 1,500 (48.9%) | 52.2% |     52.2% |
