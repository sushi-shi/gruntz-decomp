...
**Overall (vs full engine): 2,346 / 3,969 functions exact (59.11%) &middot; 73.17% fuzzy &middot; 73.21% fuzzy max.**
...
_Started units alone: 2,346/3,961 fns exact, 72.96% fuzzy over 1,081,093 of 1,078,011 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,332 / 2,367 (56.3%) | 70.5% |     70.6% |
| `DDrawMgr`    |    26 |     302 / 514 (58.8%) | 67.9% |     68.0% |
