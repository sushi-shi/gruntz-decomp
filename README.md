...
**Overall (vs full engine): 3,472 / 4,316 functions exact (80.44%) &middot; 94.59% fuzzy &middot; 94.59% fuzzy max.**
...
_Started units alone: 3,472/4,334 fns exact, 92.94% fuzzy over 1,134,114 of 1,114,355 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,977 / 2,576 (76.7%) |  92.4% |     92.4% |
