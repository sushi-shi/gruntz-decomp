...
**Overall (vs full engine): 3,694 / 4,427 functions exact (83.44%) &middot; 94.63% fuzzy &middot; 94.86% fuzzy max.**
...
_Started units alone: 3,694/4,427 fns exact, 94.68% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,148 / 2,652 (81.0%) |  94.5% |     94.7% |
| `DDrawMgr`   |    19 |     522 / 600 (87.0%) |  92.6% |     92.8% |
