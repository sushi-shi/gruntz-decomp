...
**Overall (vs full engine): 3,248 / 4,277 functions exact (75.94%) &middot; 85.77% fuzzy &middot; 85.80% fuzzy max.**
...
_Started units alone: 3,248/4,264 fns exact, 84.67% fuzzy over 1,098,478 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   208 | 1,858 / 2,547 (72.9%) | 83.5% |     83.5% |
