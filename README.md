...
**Overall (vs full engine): 1,800 / 3,835 functions exact (46.94%) &middot; 63.46% fuzzy &middot; 63.47% fuzzy max.**
...
_Started units alone: 1,800/3,814 fns exact, 64.06% fuzzy over 1,058,958 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,077 / 2,073 (52.0%) | 68.3% |     68.3% |
| `Stub`        |     1 |       18 / 592 (3.0%) |  3.6% |      3.6% |
| `DDrawMgr`    |    31 |     144 / 289 (49.8%) | 64.8% |     64.9% |
