...
**Overall (vs full engine): 2,332 / 3,962 functions exact (58.86%) &middot; 72.63% fuzzy &middot; 72.64% fuzzy max.**
...
_Started units alone: 2,332/3,951 fns exact, 72.42% fuzzy over 1,080,924 of 1,077,845 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,330 / 2,369 (56.1%) | 69.8% |     69.8% |
