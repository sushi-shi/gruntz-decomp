...
**Overall (vs full engine): 1,791 / 3,451 functions exact (51.90%) &middot; 54.11% fuzzy &middot; 54.11% fuzzy max.**
...
_Started units alone: 1,791/3,394 fns exact, 54.16% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   351 | 1,166 / 2,246 (51.9%) | 60.4% |     60.4% |
| `Stub`        |     7 |     104 / 357 (29.1%) |  8.4% |      8.4% |
