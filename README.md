...
**Overall (vs full engine): 1,862 / 3,397 functions exact (54.81%) &middot; 59.27% fuzzy &middot; 59.27% fuzzy max.**
...
_Started units alone: 1,862/3,394 fns exact, 59.31% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   382 | 1,192 / 2,304 (51.7%) | 61.7% |     61.7% |
| `Stub`        |     7 |     139 / 287 (48.4%) | 17.5% |     17.5% |
