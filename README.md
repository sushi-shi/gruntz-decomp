...
**Overall (vs full engine): 884 / 6,510 functions exact (13.58%) &middot; 24.39% fuzzy &middot; 24.39% fuzzy max.**
...
_Started units alone: 884/2,243 fns exact, 33.00% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   113 | 466 / 1,003 (46.5%) | 46.0% |     46.0% |
| `Stub`        |     2 |   118 / 803 (14.7%) |  5.4% |      5.4% |
| `Dsndmgr`     |     7 |     42 / 64 (65.6%) | 85.3% |     85.3% |
