...
**Overall (vs full engine): 683 / 6,510 functions exact (10.49%) &middot; 20.11% fuzzy &middot; 20.11% fuzzy max.**
...
_Started units alone: 683/2,242 fns exact, 27.21% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,167 (10.4%) |  4.7% |      4.7% |
| `Gruntz`      |    72 |   320 / 726 (44.1%) | 43.5% |     43.5% |
