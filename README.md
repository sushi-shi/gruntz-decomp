...
**Data: 99.71% size-weighted across 707,959 B** (`.bss` 99.82%, `.data` 98.98%, `.rdata` 99.95%) &middot; 97.22% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
