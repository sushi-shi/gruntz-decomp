...
**Overall (vs full engine): 1,857 / 3,364 functions exact (55.20%) &middot; 64.39% fuzzy &middot; 64.40% fuzzy max.**
...
_Started units alone: 1,857/3,361 fns exact, 64.43% fuzzy over 970,153 of 970,780 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   416 | 1,204 / 2,359 (51.0%) | 61.8% |     61.9% |
