...
**Overall (vs full engine): 1,836 / 3,366 functions exact (54.55%) &middot; 64.32% fuzzy &middot; 64.32% fuzzy max.**
...
_Started units alone: 1,836/3,363 fns exact, 64.36% fuzzy over 970,165 of 970,792 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   416 | 1,195 / 2,361 (50.6%) | 61.8% |     61.8% |
