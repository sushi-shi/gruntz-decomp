...
**Overall (vs full engine): 1,396 / 3,543 functions exact (39.40%) &middot; 38.82% fuzzy &middot; 38.82% fuzzy max.**
...
_Started units alone: 1,396/3,485 fns exact, 38.86% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   207 | 877 / 1,727 (50.8%) | 54.9% |     54.9% |
| `Stub`        |     5 |  105 / 1,130 (9.3%) |  4.1% |      4.1% |
