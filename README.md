...
**Overall (vs full engine): 1,842 / 3,835 functions exact (48.03%) &middot; 63.65% fuzzy &middot; 63.71% fuzzy max.**
...
_Started units alone: 1,842/3,824 fns exact, 64.26% fuzzy over 1,058,943 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,113 / 2,081 (53.5%) | 68.5% |     68.6% |
| `Stub`        |     1 |       19 / 591 (3.2%) |  3.6% |      3.6% |
