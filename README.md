...
**Overall (vs full engine): 1,824 / 3,859 functions exact (47.27%) &middot; 68.18% fuzzy &middot; 68.48% fuzzy max.**
...
_Started units alone: 1,824/3,720 fns exact, 68.28% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 939 / 1,946 (48.3%) | 69.1% |     69.4% |
| `Stub`        |    22 |   195 / 611 (31.9%) | 22.8% |     22.9% |
