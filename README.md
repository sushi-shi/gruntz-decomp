...
**Overall (vs full engine): 2,145 / 3,811 functions exact (56.28%) &middot; 71.58% fuzzy &middot; 71.58% fuzzy max.**
...
_Started units alone: 2,145/3,793 fns exact, 71.54% fuzzy over 1,068,429 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   364 | 1,241 / 2,353 (52.7%) | 68.7% |     68.7% |
