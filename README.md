...
**Overall (vs full engine): 847 / 6,510 functions exact (13.01%) &middot; 23.54% fuzzy &middot; 23.54% fuzzy max.**
...
_Started units alone: 847/2,243 fns exact, 31.86% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   100 | 443 / 956 (46.3%) | 45.2% |     45.2% |
| `Stub`        |     2 | 118 / 877 (13.5%) |  5.3% |      5.3% |
