...
**Overall (vs full engine): 3,699 / 4,427 functions exact (83.56%) &middot; 94.81% fuzzy &middot; 95.06% fuzzy max.**
...
_Started units alone: 3,699/4,427 fns exact, 94.86% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,155 / 2,652 (81.3%) |  94.7% |     94.9% |
