...
**Overall (vs full engine): 3,702 / 4,427 functions exact (83.62%) &middot; 94.94% fuzzy &middot; 95.11% fuzzy max.**
...
_Started units alone: 3,702/4,427 fns exact, 94.99% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,152 / 2,648 (81.3%) |  94.9% |     95.0% |
