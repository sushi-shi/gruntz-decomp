...
**Overall (vs full engine): 1,785 / 3,451 functions exact (51.72%) &middot; 53.48% fuzzy &middot; 53.48% fuzzy max.**
...
_Started units alone: 1,785/3,393 fns exact, 53.53% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   344 | 1,162 / 2,236 (52.0%) | 60.1% |     60.1% |
| `Stub`        |     7 |     104 / 371 (28.0%) |  8.1% |      8.1% |
