...
**Overall (vs full engine): 857 / 6,510 functions exact (13.16%) &middot; 23.76% fuzzy &middot; 23.76% fuzzy max.**
...
_Started units alone: 857/2,243 fns exact, 32.15% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   102 | 447 / 964 (46.4%) | 45.4% |     45.4% |
| `Stub`        |     2 | 118 / 858 (13.8%) |  5.3% |      5.3% |
