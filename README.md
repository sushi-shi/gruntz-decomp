...
**Overall (vs full engine): 1,841 / 3,451 functions exact (53.35%) &middot; 56.89% fuzzy &middot; 56.89% fuzzy max.**
...
_Started units alone: 1,841/3,394 fns exact, 56.94% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   373 | 1,178 / 2,280 (51.7%) | 61.1% |     61.1% |
| `Stub`        |     7 |     133 / 314 (42.4%) | 13.4% |     13.4% |
