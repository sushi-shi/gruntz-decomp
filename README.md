...
**Overall (vs full engine): 1,377 / 3,451 functions exact (39.90%) &middot; 39.97% fuzzy &middot; 39.97% fuzzy max.**
...
_Started units alone: 1,377/3,415 fns exact, 40.00% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   200 | 848 / 1,702 (49.8%) | 55.1% |     55.1% |
| `Stub`        |     5 |  105 / 1,065 (9.9%) |  4.3% |      4.3% |
...
| `DinMgr2`     |     1 |     31 / 35 (88.6%) | 98.7% |     98.7% |
