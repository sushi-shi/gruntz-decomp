...
**Overall (vs full engine): 3,470 / 4,301 functions exact (80.68%) &middot; 92.67% fuzzy &middot; 92.70% fuzzy max.**
...
_Started units alone: 3,470/4,301 fns exact, 91.04% fuzzy over 1,112,794 of 1,093,174 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,001 / 2,567 (78.0%) |  90.5% |     90.5% |
