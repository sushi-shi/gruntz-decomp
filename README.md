...
**Overall (vs full engine): 698 / 6,510 functions exact (10.72%) &middot; 20.85% fuzzy &middot; 20.85% fuzzy max.**
...
_Started units alone: 698/2,242 fns exact, 28.21% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,128 (10.7%) |  5.0% |      5.0% |
| `Gruntz`      |    75 |   335 / 765 (43.8%) | 42.5% |     42.5% |
