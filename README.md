...
**Overall (vs full engine): 1,873 / 3,397 functions exact (55.14%) &middot; 63.29% fuzzy &middot; 63.29% fuzzy max.**
...
_Started units alone: 1,873/3,394 fns exact, 63.33% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   405 | 1,209 / 2,345 (51.6%) | 61.8% |     61.8% |
| `Stub`        |     6 |     123 / 236 (52.1%) | 38.0% |     38.0% |
