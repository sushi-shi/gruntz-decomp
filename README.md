...
**Overall (vs full engine): 2,260 / 3,931 functions exact (57.49%) &middot; 72.51% fuzzy &middot; 72.51% fuzzy max.**
...
_Started units alone: 2,260/3,923 fns exact, 72.30% fuzzy over 1,080,425 of 1,077,341 engine code bytes._
...
| `jump thunks`        |     1,678 |    8,342 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
