...
**Overall (vs full engine): 1,378 / 3,543 functions exact (38.89%) &middot; 38.61% fuzzy &middot; 38.61% fuzzy max.**
...
_Started units alone: 1,378/3,485 fns exact, 38.65% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   200 | 859 / 1,706 (50.4%) | 54.7% |     54.7% |
| `Stub`        |     5 |  105 / 1,151 (9.1%) |  4.1% |      4.1% |
