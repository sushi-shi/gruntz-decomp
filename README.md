...
**Overall (vs full engine): 1,346 / 3,543 functions exact (37.99%) &middot; 38.30% fuzzy &middot; 38.30% fuzzy max.**
...
_Started units alone: 1,346/3,507 fns exact, 38.33% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   192 | 828 / 1,663 (49.8%) | 54.5% |     54.5% |
| `Stub`        |     5 |  105 / 1,217 (8.6%) |  4.1% |      4.1% |
