...
**Overall (vs full engine): 2,286 / 3,955 functions exact (57.80%) &middot; 72.14% fuzzy &middot; 72.15% fuzzy max.**
...
_Started units alone: 2,286/3,945 fns exact, 71.94% fuzzy over 1,080,797 of 1,077,721 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,305 / 2,361 (55.3%) | 69.3% |     69.3% |
| `DDrawMgr`    |    27 |     279 / 504 (55.4%) | 67.2% |     67.2% |
| `Wwd`         |     8 |      84 / 183 (45.9%) | 78.4% |     78.4% |
