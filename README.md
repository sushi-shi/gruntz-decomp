...
**Overall (vs full engine): 646 / 6,510 functions exact (9.92%) &middot; 15.32% fuzzy &middot; 15.32% fuzzy max.**
...
_Started units alone: 646/2,243 fns exact, 20.73% fuzzy over 733,690 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,292 (9.4%) |  3.9% |      3.9% |
| `Gruntz`      |    62 |  284 / 607 (46.8%) | 37.6% |     37.6% |
