...
**Overall (vs full engine): 2,919 / 4,346 functions exact (67.17%) &middot; 76.82% fuzzy &middot; 76.94% fuzzy max.**
...
_Started units alone: 2,919/4,263 fns exact, 76.89% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,689 / 2,539 (66.5%) | 75.5% |     75.7% |
