...
**Overall (vs full engine): 3,315 / 4,300 functions exact (77.09%) &middot; 90.65% fuzzy &middot; 90.71% fuzzy max.**
...
_Started units alone: 3,315/4,291 fns exact, 89.02% fuzzy over 1,113,130 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,877 / 2,562 (73.3%) |  88.6% |     88.7% |
