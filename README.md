...
**Overall (vs full engine): 681 / 6,510 functions exact (10.46%) &middot; 19.77% fuzzy &middot; 19.77% fuzzy max.**
...
_Started units alone: 681/2,242 fns exact, 26.75% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,176 (10.3%) |  4.6% |      4.6% |
| `Gruntz`      |    70 |   319 / 722 (44.2%) | 43.9% |     43.9% |
