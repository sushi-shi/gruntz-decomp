...
**Overall (vs full engine): 1,890 / 3,859 functions exact (48.98%) &middot; 68.62% fuzzy &middot; 68.93% fuzzy max.**
...
_Started units alone: 1,890/3,720 fns exact, 68.72% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 974 / 1,985 (49.1%) | 69.2% |     69.5% |
| `Stub`        |    22 |   195 / 540 (36.1%) | 24.0% |     24.2% |
