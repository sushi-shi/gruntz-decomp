...
**Overall (vs full engine): 3,497 / 4,310 functions exact (81.14%) &middot; 93.32% fuzzy &middot; 93.34% fuzzy max.**
...
_Started units alone: 3,497/4,321 fns exact, 91.67% fuzzy over 1,113,024 of 1,093,319 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,009 / 2,571 (78.1%) |  91.3% |     91.4% |
| `DDrawMgr`    |    22 |     489 / 574 (85.2%) |  88.1% |     88.1% |
