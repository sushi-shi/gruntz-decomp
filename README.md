...
**Data: 99.65% size-weighted across 706,020 B** (`.bss` 99.82%, `.data` 98.63%, `.rdata` 99.89%) &middot; 90.72% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
