...
**Overall (vs full engine): 599 / 6,510 functions exact (9.20%) &middot; 14.03% fuzzy &middot; 14.03% fuzzy max.**
...
_Started units alone: 599/2,239 fns exact, 19.21% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,363 (8.6%) |  3.5% |      3.5% |
| `Gruntz`      |    60 |  241 / 532 (45.3%) | 37.4% |     37.4% |
