...
**Overall (vs full engine): 392 / 6,371 functions exact (6.15%) &middot; 9.19% fuzzy &middot; 9.19% fuzzy max.**
...
_Started units alone: 392/1,078 fns exact, 19.05% fuzzy over 478,727 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 108 / 592 (18.2%) |   2.9% |      2.9% |
| `Gruntz`      |    47 | 121 / 250 (48.4%) |  49.2% |     49.2% |
