...
**Overall (vs full engine): 810 / 6,510 functions exact (12.44%) &middot; 23.20% fuzzy &middot; 23.20% fuzzy max.**
...
_Started units alone: 810/2,242 fns exact, 31.40% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 930 (12.9%) |  5.5% |      5.5% |
| `Gruntz`      |    93 | 419 / 919 (45.6%) | 44.7% |     44.7% |
