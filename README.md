...
**Overall (vs full engine): 1,319 / 3,547 functions exact (37.19%) &middot; 37.92% fuzzy &middot; 37.92% fuzzy max.**
...
_Started units alone: 1,319/3,507 fns exact, 37.94% fuzzy over 987,804 of 988,549 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   191 | 810 / 1,630 (49.7%) | 54.2% |     54.2% |
| `Stub`        |     5 |  105 / 1,264 (8.3%) |  4.1% |      4.1% |
