...
**Overall (vs full engine): 2,643 / 4,055 functions exact (65.18%) &middot; 73.90% fuzzy &middot; 73.93% fuzzy max.**
...
_Started units alone: 2,643/4,171 fns exact, 73.61% fuzzy over 1,082,863 of 1,078,637 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,520 / 2,498 (60.8%) | 71.3% |     71.3% |
