...
**Overall (vs full engine): 3,691 / 4,427 functions exact (83.37%) &middot; 94.57% fuzzy &middot; 94.80% fuzzy max.**

_Data: objdiff `matched_data` 560,499 of 802,851 B (69.81%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,691/4,427 fns exact, 94.62% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,148 / 2,652 (81.0%) |  94.4% |     94.6% |
| `DDrawMgr`   |    19 |     522 / 600 (87.0%) |  92.7% |     92.8% |
