...
**Overall (vs full engine): 1,640 / 3,451 functions exact (47.52%) &middot; 49.32% fuzzy &middot; 49.32% fuzzy max.**
...
_Started units alone: 1,640/3,393 fns exact, 49.36% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   309 | 1,024 / 2,020 (50.7%) | 58.3% |     58.3% |
