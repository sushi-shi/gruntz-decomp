...
**Overall (vs full engine): 3,504 / 4,314 functions exact (81.22%) &middot; 93.36% fuzzy &middot; 93.45% fuzzy max.**

**Data: 99.99% size-weighted across 720,943 B** (`.bss` 99.99%, `.data` 100.00%, `.rdata` 99.99%) &middot; 99.87% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
...
_Started units alone: 3,504/4,327 fns exact, 91.74% fuzzy over 1,134,118 of 1,114,364 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 2,011 / 2,574 (78.1%) |  91.3% |     91.3% |
