...
**Overall (vs full engine): 72 / 6,349 functions exact (1.13%) &middot; 1.11% code matched &middot; 3.67% fuzzy.**
...
_Started units alone: 72/169 fns exact, 90.27% fuzzy over 40,337 of 991,759 engine code bytes._

| Module        | Units |  Functions exact | Fuzzy | Code matched |
| :------------ | ----: | ---------------: | ----: | -----------: |
| `Gruntz`      |    11 |  14 / 52 (26.9%) | 65.8% |         3.5% |
| `zlib-1.0.4`  |    11 |  35 / 50 (70.0%) | 99.4% |        45.8% |
| `Wap32`       |     2 |   7 / 14 (50.0%) | 99.1% |        36.8% |
| `Utils`       |     2 |   9 / 12 (75.0%) | 99.3% |        45.0% |
| `Bute`        |     1 |    0 / 11 (0.0%) | 97.9% |         0.0% |
| `Io`          |     1 |   6 / 10 (60.0%) | 98.3% |        38.3% |
| `Rez`         |     1 |    1 / 8 (12.5%) | 95.3% |         4.0% |
| `Wwd`         |     1 |     0 / 4 (0.0%) | 97.5% |         0.0% |
| `Image`       |     1 |     0 / 4 (0.0%) | 99.9% |         0.0% |
| `Net`         |     1 |     0 / 4 (0.0%) | 99.2% |         0.0% |
| `(unmatched)` |     — | 0 / 6,180 (0.0%) |  0.0% |         0.0% |
<!-- match-score:end -->
