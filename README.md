...
**Overall (vs full engine): 1,272 / 7,435 functions exact (17.11%) &middot; 36.85% fuzzy &middot; 36.85% fuzzy max.**
...
_Started units alone: 1,272/3,234 fns exact, 39.28% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 777 / 1,583 (49.1%) | 53.7% |     53.7% |
| `Stub`        |     4 |  104 / 1,051 (9.9%) |  4.5% |      4.5% |
