...
**Overall (vs full engine): 3,408 / 4,300 functions exact (79.26%) &middot; 90.77% fuzzy &middot; 90.92% fuzzy max.**
...
_Started units alone: 3,408/4,290 fns exact, 89.15% fuzzy over 1,113,088 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,961 / 2,561 (76.6%) |  88.7% |     88.9% |
