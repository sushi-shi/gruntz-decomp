...
**Overall (vs full engine): 277 / 6,371 functions exact (4.35%) &middot; 7.78% fuzzy &middot; 7.78% fuzzy max.**
...
_Started units alone: 277/821 fns exact, 22.29% fuzzy over 346,304 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 353 (0.0%) |   0.4% |      0.4% |
