...
**Overall (vs full engine): 3,658 / 4,427 functions exact (82.63%) &middot; 94.35% fuzzy &middot; 94.49% fuzzy max.**

_Data: objdiff `matched_data` 560,499 of 802,867 B (69.81%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,658/4,427 fns exact, 94.40% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,133 / 2,652 (80.4%) |  94.2% |     94.3% |
| `DDrawMgr`   |    19 |     520 / 600 (86.7%) |  92.6% |     92.7% |
| `Wwd`        |     7 |     169 / 216 (78.2%) |  95.7% |     95.7% |
| `Bute`       |     7 |     162 / 198 (81.8%) |  95.2% |     97.1% |
| `Dsndmgr`    |     4 |     150 / 161 (93.2%) |  98.7% |     98.7% |
| `Net`        |     9 |     121 / 136 (89.0%) |  97.4% |     97.5% |
| `Image`      |     7 |      73 / 112 (65.2%) |  94.6% |     94.7% |
