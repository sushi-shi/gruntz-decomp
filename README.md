...
**Overall (vs full engine): 1,018 / 7,098 functions exact (14.34%) &middot; 28.07% fuzzy &middot; 28.07% fuzzy max.**
...
_Started units alone: 1,018/2,270 fns exact, 37.83% fuzzy over 738,623 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   165 | 581 / 1,190 (48.8%) | 49.3% |     49.3% |
| `Stub`        |     2 |   118 / 609 (19.4%) |  6.1% |      6.1% |
| `Dsndmgr`     |     9 |     46 / 72 (63.9%) | 84.7% |     84.7% |
