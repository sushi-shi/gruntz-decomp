...
**Overall (vs full engine): 1,924 / 3,859 functions exact (49.86%) &middot; 69.09% fuzzy &middot; 69.40% fuzzy max.**
...
_Started units alone: 1,924/3,720 fns exact, 69.19% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   328 | 1,003 / 2,030 (49.4%) | 69.4% |     69.7% |
| `Stub`        |    22 |     169 / 460 (36.7%) | 23.1% |     23.2% |
