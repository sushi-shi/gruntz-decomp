...
**Overall (vs full engine): 3,429 / 4,300 functions exact (79.74%) &middot; 91.23% fuzzy &middot; 91.38% fuzzy max.**
...
_Started units alone: 3,429/4,298 fns exact, 89.52% fuzzy over 1,114,062 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,970 / 2,565 (76.8%) |  89.0% |     89.1% |
| `DDrawMgr`    |    22 |     480 / 569 (84.4%) |  87.6% |     87.8% |
