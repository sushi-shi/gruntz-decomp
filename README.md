...
**Overall (vs full engine): 3,293 / 4,269 functions exact (77.14%) &middot; 87.25% fuzzy &middot; 87.48% fuzzy max.**
...
_Started units alone: 3,293/4,279 fns exact, 85.66% fuzzy over 1,103,870 of 1,083,801 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,881 / 2,551 (73.7%) |  84.6% |     84.9% |
