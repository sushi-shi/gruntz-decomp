...
**Overall (vs full engine): 3,125 / 4,492 functions exact (69.57%) &middot; 78.33% fuzzy &middot; 78.46% fuzzy max.**
...
_Started units alone: 3,125/4,268 fns exact, 78.52% fuzzy over 1,089,186 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,801 / 2,543 (70.8%) | 77.3% |     77.4% |
