...
**Overall (vs full engine): 1,857 / 3,357 functions exact (55.32%) &middot; 64.72% fuzzy &middot; 64.72% fuzzy max.**
...
_Started units alone: 1,857/3,354 fns exact, 64.76% fuzzy over 967,845 of 968,475 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   417 | 1,210 / 2,359 (51.3%) | 62.0% |     62.0% |
