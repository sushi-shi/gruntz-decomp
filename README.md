...
**Data: 99.16% size-weighted across 704,148 B** (`.bss` 99.76%, `.data` 95.89%, `.rdata` 99.28%) &middot; 16.40% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
