...
**Overall (vs full engine): 959 / 7,098 functions exact (13.51%) &middot; 26.97% fuzzy &middot; 26.97% fuzzy max.**
...
_Started units alone: 959/2,268 fns exact, 36.36% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   136 | 524 / 1,104 (47.5%) | 48.3% |     48.3% |
| `Stub`        |     2 |   118 / 697 (16.9%) |  5.9% |      5.9% |
