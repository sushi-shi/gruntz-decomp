...
**Overall (vs full engine): 2,389 / 3,985 functions exact (59.95%) &middot; 73.38% fuzzy &middot; 73.42% fuzzy max.**
...
_Started units alone: 2,389/3,975 fns exact, 73.17% fuzzy over 1,081,189 of 1,078,121 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,343 / 2,365 (56.8%) | 70.8% |     70.8% |
| `DDrawMgr`    |    26 |     305 / 515 (59.2%) | 67.9% |     68.0% |
| `Wwd`         |     8 |      89 / 184 (48.4%) | 78.7% |     78.7% |
| `Bute`        |    11 |      89 / 158 (56.3%) | 74.7% |     74.7% |
| `Dsndmgr`     |     5 |     117 / 148 (79.1%) | 93.4% |     93.4% |
| `Net`         |    13 |      96 / 130 (73.8%) | 93.6% |     93.6% |
| `Image`       |    16 |      56 / 123 (45.5%) | 80.9% |     81.0% |
| `Rez`         |     7 |       61 / 77 (79.2%) | 79.3% |     79.3% |
...
| `CRT/MFC library`    |     2,247 |  207,103 | FID-identified, statically linked                 |
| `jump thunks`        |     1,674 |    8,322 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
