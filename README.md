...
**Overall (vs full engine): 198 / 6,364 functions exact (3.11%) &middot; 4.75% fuzzy &middot; 4.75% fuzzy max.**
...
_Started units alone: 198/732 fns exact, 14.01% fuzzy over 335,672 of 990,979 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Stub`        |     1 |   0 / 376 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    35 | 81 / 171 (47.4%) |  36.7% |     36.7% |
