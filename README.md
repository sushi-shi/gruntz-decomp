...
**Overall (vs full engine): 763 / 6,510 functions exact (11.72%) &middot; 22.67% fuzzy &middot; 22.67% fuzzy max.**
...
_Started units alone: 763/2,242 fns exact, 30.68% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,001 (12.1%) |  5.4% |      5.4% |
| `Gruntz`      |    87 |   392 / 875 (44.8%) | 44.4% |     44.4% |
