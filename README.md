...
**Overall (vs full engine): 1,859 / 3,357 functions exact (55.38%) &middot; 65.19% fuzzy &middot; 65.19% fuzzy max.**
...
_Started units alone: 1,859/3,354 fns exact, 65.23% fuzzy over 967,845 of 968,475 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   417 | 1,210 / 2,359 (51.3%) | 62.2% |     62.2% |
