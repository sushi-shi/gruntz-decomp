...
**Overall (vs full engine): 1,925 / 3,859 functions exact (49.88%) &middot; 68.96% fuzzy &middot; 69.27% fuzzy max.**
...
_Started units alone: 1,925/3,720 fns exact, 69.07% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 993 / 2,012 (49.4%) | 69.3% |     69.6% |
| `Stub`        |    22 |   194 / 495 (39.2%) | 25.0% |     25.1% |
