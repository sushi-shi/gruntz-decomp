...
**Overall (vs full engine): 2,301 / 3,964 functions exact (58.05%) &middot; 72.18% fuzzy &middot; 72.18% fuzzy max.**
...
_Started units alone: 2,301/3,950 fns exact, 71.97% fuzzy over 1,080,948 of 1,077,888 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   258 | 1,314 / 2,367 (55.5%) | 69.3% |     69.3% |
