...
**Overall (vs full engine): 513 / 6,510 functions exact (7.88%) &middot; 12.70% fuzzy &middot; 12.70% fuzzy max.**
...
_Started units alone: 513/2,238 fns exact, 17.40% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,494 (7.8%) |  3.5% |      3.5% |
| `Gruntz`      |    51 |  177 / 433 (40.9%) | 34.5% |     34.5% |
