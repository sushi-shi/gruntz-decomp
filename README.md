...
**Overall (vs full engine): 2,146 / 3,811 functions exact (56.31%) &middot; 71.54% fuzzy &middot; 71.54% fuzzy max.**
...
_Started units alone: 2,146/3,793 fns exact, 71.51% fuzzy over 1,068,429 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   363 | 1,241 / 2,353 (52.7%) | 68.7% |     68.7% |
