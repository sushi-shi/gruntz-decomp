...
**Overall (vs full engine): 2,320 / 3,964 functions exact (58.53%) &middot; 72.51% fuzzy &middot; 72.51% fuzzy max.**
...
_Started units alone: 2,320/3,951 fns exact, 72.30% fuzzy over 1,080,924 of 1,077,859 engine code bytes._
...
| `CRT/MFC library`    |     2,258 |  207,231 | FID-identified, statically linked                 |
| `jump thunks`        |     1,673 |    8,317 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
