...
**Overall (vs full engine): 1,244 / 7,435 functions exact (16.73%) &middot; 35.19% fuzzy &middot; 35.19% fuzzy max.**
...
_Started units alone: 1,244/3,233 fns exact, 37.47% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   181 | 752 / 1,527 (49.2%) | 52.7% |     52.7% |
| `Stub`        |     4 |  106 / 1,116 (9.5%) |  4.5% |      4.5% |
