...
**Overall (vs full engine): 1,123 / 7,092 functions exact (15.83%) &middot; 31.41% fuzzy &middot; 31.41% fuzzy max.**
...
_Started units alone: 1,123/3,238 fns exact, 33.30% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,363 (8.7%) |  4.2% |      4.2% |
