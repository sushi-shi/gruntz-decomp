...
**Overall (vs full engine): 1,781 / 3,451 functions exact (51.61%) &middot; 52.12% fuzzy &middot; 52.12% fuzzy max.**
...
_Started units alone: 1,781/3,393 fns exact, 52.17% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   339 | 1,159 / 2,215 (52.3%) | 59.7% |     59.7% |
| `Stub`        |     7 |     103 / 401 (25.7%) |  7.2% |      7.2% |
