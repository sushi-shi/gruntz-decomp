...
**Overall (vs full engine): 1,779 / 3,451 functions exact (51.55%) &middot; 50.86% fuzzy &middot; 50.86% fuzzy max.**
...
_Started units alone: 1,779/3,393 fns exact, 50.91% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   334 | 1,158 / 2,192 (52.8%) | 59.1% |     59.1% |
| `Stub`        |     7 |     103 / 425 (24.2%) |  6.8% |      6.8% |
