...
**Overall (vs full engine): 1,870 / 3,397 functions exact (55.05%) &middot; 63.23% fuzzy &middot; 63.23% fuzzy max.**
...
_Started units alone: 1,870/3,394 fns exact, 63.27% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   404 | 1,206 / 2,344 (51.5%) | 61.8% |     61.8% |
| `Stub`        |     6 |     123 / 237 (51.9%) | 37.6% |     37.6% |
