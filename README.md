...
**Overall (vs full engine): 2,003 / 3,808 functions exact (52.60%) &middot; 70.73% fuzzy &middot; 70.73% fuzzy max.**
...
_Started units alone: 2,003/3,697 fns exact, 70.87% fuzzy over 1,065,648 of 1,067,765 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,136 / 2,270 (50.0%) | 69.4% |     69.4% |
