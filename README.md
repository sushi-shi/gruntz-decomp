...
**Overall (vs full engine): 534 / 6,510 functions exact (8.20%) &middot; 13.11% fuzzy &middot; 13.11% fuzzy max.**
...
_Started units alone: 534/2,238 fns exact, 17.95% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,455 (8.0%) |  3.5% |      3.5% |
| `Gruntz`      |    55 |  192 / 461 (41.6%) | 35.5% |     35.5% |
