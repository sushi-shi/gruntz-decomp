...
**Overall (vs full engine): 542 / 6,510 functions exact (8.33%) &middot; 13.22% fuzzy &middot; 13.22% fuzzy max.**
...
_Started units alone: 542/2,238 fns exact, 18.10% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,443 (8.1%) |  3.5% |      3.5% |
| `Gruntz`      |    58 |  200 / 473 (42.3%) | 36.0% |     36.0% |
