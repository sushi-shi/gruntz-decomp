...
**Overall (vs full engine): 367 / 6,371 functions exact (5.76%) &middot; 9.10% fuzzy &middot; 9.10% fuzzy max.**
...
_Started units alone: 367/1,078 fns exact, 18.85% fuzzy over 478,727 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |  83 / 592 (14.0%) |   2.6% |      2.6% |
