...
**Overall (vs full engine): 156 / 6,349 functions exact (2.46%) &middot; 4.32% fuzzy &middot; 4.32% fuzzy max.**
...
_Started units alone: 156/208 fns exact, 91.25% fuzzy over 46,955 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    27 |  52 / 87 (59.8%) |  76.8% |     76.8% |
