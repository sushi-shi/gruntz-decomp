...
**Overall (vs full engine): 3,080 / 4,346 functions exact (70.87%) &middot; 78.03% fuzzy &middot; 78.14% fuzzy max.**
...
_Started units alone: 3,080/4,261 fns exact, 78.13% fuzzy over 1,088,827 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,773 / 2,539 (69.8%) | 76.7% |     76.9% |
