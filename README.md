...
**Overall (vs full engine): 667 / 6,510 functions exact (10.25%) &middot; 17.30% fuzzy &middot; 17.30% fuzzy max.**
...
_Started units alone: 667/2,242 fns exact, 23.40% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,249 (9.7%) |  4.0% |      4.0% |
| `Gruntz`      |    63 |  305 / 649 (47.0%) | 45.5% |     45.5% |
