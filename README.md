...
**Overall (vs full engine): 1,246 / 7,435 functions exact (16.76%) &middot; 35.23% fuzzy &middot; 35.23% fuzzy max.**
...
_Started units alone: 1,246/3,233 fns exact, 37.51% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   181 | 754 / 1,530 (49.3%) | 52.7% |     52.7% |
| `Stub`        |     4 |  106 / 1,113 (9.5%) |  4.5% |      4.5% |
