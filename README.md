...
**Overall (vs full engine): 656 / 6,510 functions exact (10.08%) &middot; 15.79% fuzzy &middot; 15.79% fuzzy max.**
...
_Started units alone: 656/2,242 fns exact, 21.36% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,272 (9.5%) |  4.0% |      4.0% |
| `Gruntz`      |    62 |  294 / 626 (47.0%) | 38.8% |     38.8% |
