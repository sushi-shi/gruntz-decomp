...
**Overall (vs full engine): 1,819 / 3,279 functions exact (55.47%) &middot; 68.43% fuzzy &middot; 68.43% fuzzy max.**
...
_Started units alone: 1,819/3,276 fns exact, 68.48% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,218 / 2,377 (51.2%) | 64.9% |     64.9% |
