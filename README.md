...
**Overall (vs full engine): 1,067 / 7,097 functions exact (15.03%) &middot; 29.43% fuzzy &middot; 29.43% fuzzy max.**
...
_Started units alone: 1,067/3,243 fns exact, 31.19% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,490 (7.9%) |  4.0% |      4.0% |
| `Gruntz`      |   166 | 618 / 1,267 (48.8%) | 50.2% |     50.2% |
