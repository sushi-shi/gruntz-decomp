...
**Overall (vs full engine): 647 / 6,510 functions exact (9.94%) &middot; 15.49% fuzzy &middot; 15.49% fuzzy max.**
...
_Started units alone: 647/2,243 fns exact, 20.96% fuzzy over 733,690 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,289 (9.4%) |  3.9% |      3.9% |
| `Gruntz`      |    62 |  285 / 610 (46.7%) | 38.1% |     38.1% |
