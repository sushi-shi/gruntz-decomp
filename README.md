...
**Overall (vs full engine): 1,439 / 3,451 functions exact (41.70%) &middot; 44.96% fuzzy &middot; 44.96% fuzzy max.**
...
_Started units alone: 1,439/3,393 fns exact, 45.00% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   247 | 897 / 1,833 (48.9%) | 57.3% |     57.3% |
| `Stub`        |     6 |   105 / 887 (11.8%) |  5.2% |      5.2% |
