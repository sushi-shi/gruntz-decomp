...
**Overall (vs full engine): 2,318 / 3,962 functions exact (58.51%) &middot; 72.49% fuzzy &middot; 72.49% fuzzy max.**
...
_Started units alone: 2,318/3,951 fns exact, 72.29% fuzzy over 1,080,924 of 1,077,845 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,328 / 2,369 (56.1%) | 69.7% |     69.7% |
| `DDrawMgr`    |    27 |     282 / 506 (55.7%) | 67.4% |     67.4% |
