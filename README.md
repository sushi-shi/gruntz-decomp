...
**Overall (vs full engine): 1,107 / 7,097 functions exact (15.60%) &middot; 31.12% fuzzy &middot; 31.12% fuzzy max.**
...
_Started units alone: 1,107/3,243 fns exact, 32.99% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,389 (8.5%) |  4.1% |      4.1% |
| `Gruntz`      |   166 | 644 / 1,336 (48.2%) | 51.2% |     51.2% |
