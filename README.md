...
**Overall (vs full engine): 760 / 6,510 functions exact (11.67%) &middot; 22.58% fuzzy &middot; 22.58% fuzzy max.**
...
_Started units alone: 760/2,242 fns exact, 30.55% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,008 (12.0%) |  5.4% |      5.4% |
| `Gruntz`      |    86 |   389 / 868 (44.8%) | 44.3% |     44.3% |
