...
**Overall (vs full engine): 1,764 / 3,451 functions exact (51.12%) &middot; 50.65% fuzzy &middot; 50.65% fuzzy max.**
...
_Started units alone: 1,764/3,393 fns exact, 50.70% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   327 | 1,142 / 2,171 (52.6%) | 59.0% |     59.0% |
| `Stub`        |     7 |     112 / 455 (24.6%) |  6.9% |      6.9% |
