...
**Overall (vs full engine): 1,054 / 7,097 functions exact (14.85%) &middot; 28.84% fuzzy &middot; 28.84% fuzzy max.**
...
_Started units alone: 1,054/3,243 fns exact, 30.57% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,523 (7.7%) |  3.9% |      3.9% |
| `Gruntz`      |   166 | 611 / 1,242 (49.2%) | 49.8% |     49.8% |
