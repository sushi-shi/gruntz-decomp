...
**Overall (vs full engine): 1,854 / 3,397 functions exact (54.58%) &middot; 59.08% fuzzy &middot; 59.08% fuzzy max.**
...
_Started units alone: 1,854/3,394 fns exact, 59.12% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   382 | 1,189 / 2,302 (51.7%) | 61.5% |     61.5% |
| `Stub`        |     7 |     134 / 289 (46.4%) | 17.2% |     17.2% |
