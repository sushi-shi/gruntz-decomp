...
| `.reloc` | 113,105 | 113,534 | +429 | **42.90%** | 59,251 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,010,049 | +22,870 | **50.10%** | 58,731 |
| **total** | 3,137,613 | 3,241,506 | +103,893 | **40.83%** | 815,693 |
...
_Independently of where the bytes landed, **36,456 of 36,743 address operands (99.22%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `31764f434640`, linked 2026-08-10 18:58. Regenerate: `ninja candidate`._
<!-- link-score:end -->
