...
**Data: 99.86% size-weighted across 713,771 B** (`.bss` 99.82%, `.data` 100.00%, `.rdata` 99.97%) &middot; 98.10% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
