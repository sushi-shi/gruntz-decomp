...
**Overall (vs full engine): 1,576 / 3,451 functions exact (45.67%) &middot; 47.03% fuzzy &middot; 47.03% fuzzy max.**
...
_Started units alone: 1,576/3,393 fns exact, 47.07% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   286 | 961 / 1,929 (49.8%) | 58.3% |     58.3% |
| `Stub`        |     7 |   107 / 709 (15.1%) |  5.4% |      5.4% |
