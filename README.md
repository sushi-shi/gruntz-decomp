...
**Overall (vs full engine): 2,041 / 3,808 functions exact (53.60%) &middot; 70.78% fuzzy &middot; 70.78% fuzzy max.**
...
_Started units alone: 2,041/3,699 fns exact, 70.92% fuzzy over 1,065,664 of 1,067,765 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,174 / 2,272 (51.7%) | 69.4% |     69.4% |
| `DDrawMgr`    |    33 |     197 / 378 (52.1%) | 68.0% |     68.0% |
