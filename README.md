...
**Overall (vs full engine): 1,008 / 7,098 functions exact (14.20%) &middot; 27.55% fuzzy &middot; 27.55% fuzzy max.**
...
_Started units alone: 1,008/2,270 fns exact, 37.13% fuzzy over 738,623 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   161 | 572 / 1,171 (48.8%) | 49.0% |     49.0% |
| `Stub`        |     2 |   118 / 630 (18.7%) |  5.9% |      5.9% |
