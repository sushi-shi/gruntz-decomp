...
**Overall (vs full engine): 3,669 / 4,427 functions exact (82.88%) &middot; 94.35% fuzzy &middot; 94.51% fuzzy max.**

_Data: objdiff `matched_data` 560,499 of 802,883 B (69.81%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,669/4,427 fns exact, 94.40% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,139 / 2,652 (80.7%) |  94.2% |     94.3% |
| `DDrawMgr`   |    19 |     521 / 600 (86.8%) |  92.6% |     92.8% |
| `Wwd`        |     7 |     169 / 216 (78.2%) |  95.8% |     95.8% |
| `Bute`       |     7 |     162 / 198 (81.8%) |  95.4% |     97.3% |
| `Dsndmgr`    |     4 |     151 / 161 (93.8%) |  98.7% |     98.7% |
| `Net`        |     9 |     120 / 136 (88.2%) |  97.3% |     97.5% |
| `Image`      |     7 |      75 / 112 (67.0%) |  94.8% |     94.9% |
