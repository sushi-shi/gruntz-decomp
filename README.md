...
**Overall (vs full engine): 1,785 / 3,451 functions exact (51.72%) &middot; 53.66% fuzzy &middot; 53.66% fuzzy max.**
...
_Started units alone: 1,785/3,393 fns exact, 53.71% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   345 | 1,163 / 2,237 (52.0%) | 60.2% |     60.2% |
| `Stub`        |     7 |     103 / 370 (27.8%) |  8.2% |      8.2% |
