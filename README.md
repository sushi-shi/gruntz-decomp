...
**Overall (vs full engine): 245 / 6,371 functions exact (3.85%) &middot; 7.04% fuzzy &middot; 7.04% fuzzy max.**
...
_Started units alone: 245/816 fns exact, 20.24% fuzzy over 344,806 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 388 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    45 | 109 / 232 (47.0%) |  50.9% |     50.9% |
