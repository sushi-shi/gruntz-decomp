...
**Overall (vs full engine): 2,263 / 3,934 functions exact (57.52%) &middot; 72.14% fuzzy &middot; 72.14% fuzzy max.**
...
_Started units alone: 2,263/3,923 fns exact, 71.94% fuzzy over 1,080,425 of 1,077,356 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,305 / 2,361 (55.3%) | 69.3% |     69.3% |
| `DDrawMgr`    |    27 |     277 / 500 (55.4%) | 67.2% |     67.2% |
