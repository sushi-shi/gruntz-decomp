...
**Overall (vs full engine): 2,311 / 3,961 functions exact (58.34%) &middot; 72.39% fuzzy &middot; 72.41% fuzzy max.**
...
_Started units alone: 2,311/3,950 fns exact, 72.19% fuzzy over 1,080,948 of 1,077,869 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   262 | 1,319 / 2,367 (55.7%) | 69.6% |     69.6% |
