...
**Overall (vs full engine): 1,162 / 7,092 functions exact (16.38%) &middot; 32.68% fuzzy &middot; 32.68% fuzzy max.**
...
_Started units alone: 1,162/3,232 fns exact, 34.74% fuzzy over 935,833 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   168 | 679 / 1,404 (48.4%) | 51.1% |     51.1% |
| `Stub`        |     4 |  118 / 1,270 (9.3%) |  4.4% |      4.4% |
