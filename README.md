...
**Overall (vs full engine): 1,840 / 3,451 functions exact (53.32%) &middot; 56.05% fuzzy &middot; 56.05% fuzzy max.**
...
_Started units alone: 1,840/3,394 fns exact, 56.10% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   364 | 1,177 / 2,267 (51.9%) | 61.0% |     61.0% |
| `Stub`        |     7 |     134 / 329 (40.7%) | 12.4% |     12.4% |
