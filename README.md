...
**Overall (vs full engine): 1,844 / 3,397 functions exact (54.28%) &middot; 58.62% fuzzy &middot; 58.62% fuzzy max.**
...
_Started units alone: 1,844/3,394 fns exact, 58.66% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   381 | 1,180 / 2,293 (51.5%) | 61.5% |     61.5% |
| `Stub`        |     7 |     134 / 300 (44.7%) | 16.2% |     16.2% |
