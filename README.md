...
**Overall (vs full engine): 3,246 / 4,297 functions exact (75.54%) &middot; 87.86% fuzzy &middot; 87.87% fuzzy max.**
...
_Started units alone: 3,246/4,288 fns exact, 86.29% fuzzy over 1,113,117 of 1,093,131 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   234 | 1,834 / 2,558 (71.7%) |  85.6% |     85.6% |
