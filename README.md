...
**Overall (vs full engine): 2,342 / 3,970 functions exact (58.99%) &middot; 72.94% fuzzy &middot; 72.96% fuzzy max.**
...
_Started units alone: 2,342/3,962 fns exact, 72.73% fuzzy over 1,081,100 of 1,078,018 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,330 / 2,368 (56.2%) | 70.2% |     70.3% |
| `DDrawMgr`    |    26 |     299 / 514 (58.2%) | 67.9% |     67.9% |
| `Wwd`         |     8 |      89 / 184 (48.4%) | 79.1% |     79.1% |
