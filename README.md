...
**Overall (vs full engine): 2,201 / 3,835 functions exact (57.39%) &middot; 72.78% fuzzy &middot; 72.78% fuzzy max.**
...
_Started units alone: 2,201/3,825 fns exact, 72.74% fuzzy over 1,068,594 of 1,068,015 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   265 | 1,340 / 2,452 (54.6%) | 70.1% |     70.1% |
...
| `jump thunks`        |     1,687 |    8,359 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
