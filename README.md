...
**Overall (vs full engine): 939 / 7,102 functions exact (13.22%) &middot; 26.30% fuzzy &middot; 26.30% fuzzy max.**
...
_Started units alone: 939/2,246 fns exact, 35.69% fuzzy over 733,761 of 995,700 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 504 / 1,069 (47.1%) | 47.5% |     47.5% |
