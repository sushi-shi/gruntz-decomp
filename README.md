...
**Overall (vs full engine): 3,293 / 4,269 functions exact (77.14%) &middot; 87.27% fuzzy &middot; 87.51% fuzzy max.**
...
_Started units alone: 3,293/4,279 fns exact, 85.69% fuzzy over 1,103,870 of 1,083,801 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,881 / 2,551 (73.7%) |  84.7% |     85.0% |
