...
**Overall (vs full engine): 1,379 / 3,543 functions exact (38.92%) &middot; 38.75% fuzzy &middot; 38.75% fuzzy max.**
...
_Started units alone: 1,379/3,507 fns exact, 38.78% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   198 | 843 / 1,689 (49.9%) | 54.7% |     54.7% |
| `Stub`        |     6 |  105 / 1,162 (9.0%) |  4.1% |      4.1% |
| `Net`         |     7 |    64 / 108 (59.3%) | 55.2% |     55.2% |
| `Dsndmgr`     |     9 |     63 / 94 (67.0%) | 86.6% |     86.6% |
| `Image`       |     7 |     46 / 85 (54.1%) | 85.5% |     85.5% |
