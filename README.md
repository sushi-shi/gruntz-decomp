...
**Overall (vs full engine): 2,712 / 4,337 functions exact (62.53%) &middot; 73.56% fuzzy &middot; 73.58% fuzzy max.**
...
_Started units alone: 2,712/4,225 fns exact, 73.71% fuzzy over 1,084,317 of 1,086,468 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,560 / 2,532 (61.6%) | 71.4% |     71.4% |
