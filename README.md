...
**Overall (vs full engine): 3,303 / 4,299 functions exact (76.83%) &middot; 90.04% fuzzy &middot; 90.05% fuzzy max.**
...
_Started units alone: 3,303/4,290 fns exact, 88.43% fuzzy over 1,113,125 of 1,093,139 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,871 / 2,562 (73.0%) |  87.8% |     87.8% |
