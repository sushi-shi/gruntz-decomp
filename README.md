...
**Overall (vs full engine): 1,370 / 3,543 functions exact (38.67%) &middot; 38.51% fuzzy &middot; 38.51% fuzzy max.**
...
_Started units alone: 1,370/3,485 fns exact, 38.54% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   197 | 852 / 1,696 (50.2%) | 54.6% |     54.6% |
| `Stub`        |     5 |  105 / 1,162 (9.0%) |  4.1% |      4.1% |
