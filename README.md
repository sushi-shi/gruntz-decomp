...
**Overall (vs full engine): 1,841 / 3,451 functions exact (53.35%) &middot; 56.16% fuzzy &middot; 56.16% fuzzy max.**
...
_Started units alone: 1,841/3,394 fns exact, 56.21% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   365 | 1,177 / 2,269 (51.9%) | 61.0% |     61.0% |
| `Stub`        |     7 |     134 / 326 (41.1%) | 12.5% |     12.5% |
