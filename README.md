...
**Overall (vs full engine): 2,934 / 4,346 functions exact (67.51%) &middot; 77.00% fuzzy &middot; 77.09% fuzzy max.**
...
_Started units alone: 2,934/4,263 fns exact, 77.10% fuzzy over 1,088,864 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,688 / 2,539 (66.5%) | 75.4% |     75.5% |
| `DDrawMgr`    |    26 |     408 / 573 (71.2%) | 71.6% |     71.6% |
