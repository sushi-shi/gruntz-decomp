...
**Overall (vs full engine): 156 / 6,349 functions exact (2.46%) &middot; 4.31% fuzzy &middot; 4.31% fuzzy max.**
...
_Started units alone: 156/207 fns exact, 91.31% fuzzy over 46,763 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    26 |  52 / 86 (60.5%) |  76.8% |     76.8% |
