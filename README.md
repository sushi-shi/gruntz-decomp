...
**Overall (vs full engine): 1,393 / 3,543 functions exact (39.32%) &middot; 38.75% fuzzy &middot; 38.75% fuzzy max.**
...
_Started units alone: 1,393/3,485 fns exact, 38.78% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   206 | 874 / 1,724 (50.7%) | 54.8% |     54.8% |
| `Stub`        |     5 |  105 / 1,133 (9.3%) |  4.1% |      4.1% |
