...
**Overall (vs full engine): 2,310 / 3,961 functions exact (58.32%) &middot; 72.22% fuzzy &middot; 72.22% fuzzy max.**
...
_Started units alone: 2,310/3,950 fns exact, 72.01% fuzzy over 1,080,948 of 1,077,869 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   262 | 1,319 / 2,367 (55.7%) | 69.3% |     69.3% |
| `DDrawMgr`    |    27 |     283 / 506 (55.9%) | 67.4% |     67.4% |
...
| `jump thunks`        |     1,677 |    8,344 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
