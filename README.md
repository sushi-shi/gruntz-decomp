...
**Overall (vs full engine): 532 / 6,510 functions exact (8.17%) &middot; 13.03% fuzzy &middot; 13.03% fuzzy max.**
...
_Started units alone: 532/2,238 fns exact, 17.84% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,460 (8.0%) |  3.5% |      3.5% |
