...
**Overall (vs full engine): 3,746 / 4,427 functions exact (84.62%) &middot; 95.17% fuzzy &middot; 95.33% fuzzy max.**
...
_Started units alone: 3,746/4,427 fns exact, 95.22% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,174 / 2,648 (82.1%) |  95.1% |     95.2% |
