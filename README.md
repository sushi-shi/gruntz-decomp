...
**Overall (vs full engine): 1,810 / 3,279 functions exact (55.20%) &middot; 66.29% fuzzy &middot; 66.29% fuzzy max.**
...
_Started units alone: 1,810/3,276 fns exact, 66.34% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,214 / 2,377 (51.1%) | 62.9% |     62.9% |
