...
**Overall (vs full engine): 1,901 / 3,859 functions exact (49.26%) &middot; 68.71% fuzzy &middot; 69.02% fuzzy max.**
...
_Started units alone: 1,901/3,720 fns exact, 68.82% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 979 / 1,991 (49.2%) | 69.2% |     69.5% |
| `Stub`        |    22 |   195 / 528 (36.9%) | 24.3% |     24.5% |
