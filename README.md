...
**Overall (vs full engine): 1,857 / 3,290 functions exact (56.44%) &middot; 69.88% fuzzy &middot; 69.96% fuzzy max.**
...
_Started units alone: 1,857/3,266 fns exact, 70.00% fuzzy over 960,779 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,112 / 2,066 (53.8%) | 66.8% |     66.9% |
...
| `Stub`        |     1 |       39 / 50 (78.0%) | 43.4% |     43.4% |
| `Wap32`       |     9 |       38 / 48 (79.2%) | 93.0% |     93.0% |
