...
**Overall (vs full engine): 923 / 6,510 functions exact (14.18%) &middot; 25.98% fuzzy &middot; 25.98% fuzzy max.**
...
_Started units alone: 923/2,244 fns exact, 35.15% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   123 | 493 / 1,050 (47.0%) | 47.2% |     47.2% |
| `Stub`        |     2 |   118 / 735 (16.1%) |  5.7% |      5.7% |
