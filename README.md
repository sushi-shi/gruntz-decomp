...
**Overall (vs full engine): 1,780 / 3,451 functions exact (51.58%) &middot; 51.70% fuzzy &middot; 51.70% fuzzy max.**
...
_Started units alone: 1,780/3,393 fns exact, 51.74% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   338 | 1,159 / 2,213 (52.4%) | 59.5% |     59.5% |
| `Stub`        |     7 |     102 / 403 (25.3%) |  7.1% |      7.1% |
