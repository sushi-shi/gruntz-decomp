...
**Overall (vs full engine): 2,919 / 4,492 functions exact (64.98%) &middot; 76.17% fuzzy &middot; 76.26% fuzzy max.**
...
_Started units alone: 2,919/4,263 fns exact, 76.38% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,691 / 2,539 (66.6%) | 74.8% |     74.9% |
