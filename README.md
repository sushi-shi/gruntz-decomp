...
**Overall (vs full engine): 1,840 / 3,856 functions exact (47.72%) &middot; 63.62% fuzzy &middot; 63.68% fuzzy max.**
...
_Started units alone: 1,840/3,824 fns exact, 64.26% fuzzy over 1,058,943 of 1,069,620 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,111 / 2,081 (53.4%) | 68.5% |     68.6% |
