...
**Overall (vs full engine): 631 / 6,510 functions exact (9.69%) &middot; 14.93% fuzzy &middot; 14.93% fuzzy max.**
...
_Started units alone: 631/2,239 fns exact, 20.44% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,322 (9.2%) |  3.8% |      3.8% |
| `Gruntz`      |    60 |  269 / 573 (46.9%) | 40.0% |     40.0% |
