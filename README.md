...
**Overall (vs full engine): 1,837 / 3,835 functions exact (47.90%) &middot; 63.65% fuzzy &middot; 63.71% fuzzy max.**
...
_Started units alone: 1,837/3,824 fns exact, 64.26% fuzzy over 1,058,943 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,110 / 2,081 (53.3%) | 68.5% |     68.6% |
