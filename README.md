...
**Overall (vs full engine): 1,810 / 3,279 functions exact (55.20%) &middot; 67.10% fuzzy &middot; 67.10% fuzzy max.**
...
_Started units alone: 1,810/3,276 fns exact, 67.15% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,214 / 2,377 (51.1%) | 63.9% |     63.9% |
