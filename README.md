...
**Overall (vs full engine): 1,849 / 3,290 functions exact (56.20%) &middot; 70.74% fuzzy &middot; 70.81% fuzzy max.**
...
_Started units alone: 1,849/3,825 fns exact, 63.93% fuzzy over 1,064,756 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,118 / 2,081 (53.7%) | 68.5% |     68.6% |
