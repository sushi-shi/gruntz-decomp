...
**Overall (vs full engine): 1,216 / 7,435 functions exact (16.36%) &middot; 34.41% fuzzy &middot; 34.41% fuzzy max.**
...
_Started units alone: 1,216/3,233 fns exact, 36.64% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 732 / 1,497 (48.9%) | 52.1% |     52.1% |
| `Stub`        |     4 |  103 / 1,155 (8.9%) |  4.4% |      4.4% |
