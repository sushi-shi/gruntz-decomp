...
**Overall (vs full engine): 3,491 / 4,310 functions exact (81.00%) &middot; 92.78% fuzzy &middot; 92.83% fuzzy max.**
...
_Started units alone: 3,491/4,321 fns exact, 91.14% fuzzy over 1,113,024 of 1,093,319 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,006 / 2,571 (78.0%) |  90.6% |     90.7% |
