...
**Overall (vs full engine): 3,435 / 4,300 functions exact (79.88%) &middot; 91.25% fuzzy &middot; 91.39% fuzzy max.**
...
_Started units alone: 3,435/4,298 fns exact, 89.53% fuzzy over 1,114,062 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,976 / 2,565 (77.0%) |  89.0% |     89.1% |
