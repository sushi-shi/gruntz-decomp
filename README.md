...
**Overall (vs full engine): 1,866 / 3,290 functions exact (56.72%) &middot; 71.22% fuzzy &middot; 71.23% fuzzy max.**
...
_Started units alone: 1,866/3,265 fns exact, 71.45% fuzzy over 959,263 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   344 | 1,137 / 2,086 (54.5%) | 68.7% |     68.7% |
