...
**Overall (vs full engine): 1,865 / 3,397 functions exact (54.90%) &middot; 61.27% fuzzy &middot; 61.27% fuzzy max.**
...
_Started units alone: 1,865/3,394 fns exact, 61.31% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   391 | 1,194 / 2,316 (51.6%) | 62.7% |     62.7% |
| `Stub`        |     7 |     139 / 274 (50.7%) | 22.6% |     22.6% |
