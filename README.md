...
**Overall (vs full engine): 1,565 / 3,451 functions exact (45.35%) &middot; 46.61% fuzzy &middot; 46.61% fuzzy max.**
...
_Started units alone: 1,565/3,393 fns exact, 46.66% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   271 | 952 / 1,912 (49.8%) | 58.2% |     58.2% |
| `Stub`        |     7 |   107 / 729 (14.7%) |  5.3% |      5.3% |
