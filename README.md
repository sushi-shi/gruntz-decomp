...
**Overall (vs full engine): 1,265 / 7,435 functions exact (17.01%) &middot; 36.20% fuzzy &middot; 36.20% fuzzy max.**
...
_Started units alone: 1,265/3,234 fns exact, 38.58% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 770 / 1,567 (49.1%) | 53.1% |     53.1% |
| `Stub`        |     4 |  104 / 1,067 (9.7%) |  4.5% |      4.5% |
