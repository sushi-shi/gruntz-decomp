...
**Overall (vs full engine): 2,347 / 3,969 functions exact (59.13%) &middot; 73.19% fuzzy &middot; 73.22% fuzzy max.**
...
_Started units alone: 2,347/3,961 fns exact, 72.98% fuzzy over 1,081,093 of 1,078,011 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   259 | 1,333 / 2,367 (56.3%) | 70.6% |     70.6% |
