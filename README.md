...
**Overall (vs full engine): 1,810 / 3,451 functions exact (52.45%) &middot; 55.41% fuzzy &middot; 55.41% fuzzy max.**
...
_Started units alone: 1,810/3,394 fns exact, 55.46% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,168 / 2,258 (51.7%) | 60.8% |     60.8% |
