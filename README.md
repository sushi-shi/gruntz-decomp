...
**Overall (vs full engine): 914 / 6,510 functions exact (14.04%) &middot; 25.51% fuzzy &middot; 25.51% fuzzy max.**
...
_Started units alone: 914/2,243 fns exact, 34.52% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   120 | 485 / 1,038 (46.7%) | 46.7% |     46.7% |
| `Stub`        |     2 |   118 / 751 (15.7%) |  5.6% |      5.6% |
