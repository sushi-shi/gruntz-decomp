...
| `.reloc` | 113,105 | 113,576 | +471 | **43.22%** | 59,237 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,010,350 | +23,171 | **50.96%** | 58,731 |
| **total** | 3,137,613 | 3,239,860 | +102,247 | **41.39%** | 815,679 |
...
_Independently of where the bytes landed, **36,577 of 36,805 address operands (99.38%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
