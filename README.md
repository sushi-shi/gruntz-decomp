...
**Overall (vs full engine): 861 / 6,510 functions exact (13.23%) &middot; 23.86% fuzzy &middot; 23.86% fuzzy max.**
...
_Started units alone: 861/2,243 fns exact, 32.28% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   103 | 449 / 968 (46.4%) | 45.4% |     45.4% |
| `Stub`        |     2 | 118 / 849 (13.9%) |  5.3% |      5.3% |
