...
**Overall (vs full engine): 2,485 / 4,007 functions exact (62.02%) &middot; 73.79% fuzzy &middot; 73.80% fuzzy max.**
...
_Started units alone: 2,485/4,000 fns exact, 73.58% fuzzy over 1,081,415 of 1,078,370 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,396 / 2,373 (58.8%) | 71.3% |     71.3% |
| `DDrawMgr`    |    26 |     333 / 522 (63.8%) | 68.5% |     68.6% |
| `Wwd`         |     8 |      90 / 185 (48.6%) | 78.5% |     78.5% |
...
| `jump thunks`        |     1,665 |    8,325 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
