...
**Overall (vs full engine): 3,546 / 4,326 functions exact (81.97%) &middot; 95.54% fuzzy &middot; 95.55% fuzzy max.**
...
_Started units alone: 3,546/4,351 fns exact, 93.87% fuzzy over 1,134,668 of 1,114,867 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   214 | 2,019 / 2,582 (78.2%) |  93.5% |     93.5% |
