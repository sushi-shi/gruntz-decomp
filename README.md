...
**Overall (vs full engine): 231 / 6,367 functions exact (3.63%) &middot; 6.56% fuzzy &middot; 6.56% fuzzy max.**
...
_Started units alone: 231/750 fns exact, 19.24% fuzzy over 338,023 of 991,849 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 325 (0.0%) |   0.3% |      0.3% |
| `Gruntz`      |    45 | 106 / 229 (46.3%) |  47.0% |     47.0% |
