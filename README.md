...
**Overall (vs full engine): 957 / 7,098 functions exact (13.48%) &middot; 26.78% fuzzy &middot; 26.78% fuzzy max.**
...
_Started units alone: 957/2,268 fns exact, 36.10% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   135 | 522 / 1,098 (47.5%) | 48.1% |     48.1% |
| `Stub`        |     2 |   118 / 703 (16.8%) |  5.8% |      5.8% |
