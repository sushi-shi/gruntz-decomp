...
**Overall (vs full engine): 939 / 7,098 functions exact (13.23%) &middot; 26.34% fuzzy &middot; 26.34% fuzzy max.**
...
_Started units alone: 939/2,268 fns exact, 35.51% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 504 / 1,069 (47.1%) | 47.5% |     47.5% |
| `Stub`        |     2 |   118 / 733 (16.1%) |  5.8% |      5.8% |
