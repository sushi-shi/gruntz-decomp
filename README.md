...
**Overall (vs full engine): 912 / 6,510 functions exact (14.01%) &middot; 25.07% fuzzy &middot; 25.07% fuzzy max.**
...
_Started units alone: 912/2,243 fns exact, 33.92% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   119 | 484 / 1,034 (46.8%) | 46.5% |     46.5% |
| `Stub`        |     2 |   118 / 757 (15.6%) |  5.5% |      5.5% |
