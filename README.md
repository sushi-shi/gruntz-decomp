...
**Overall (vs full engine): 1,599 / 3,451 functions exact (46.33%) &middot; 49.16% fuzzy &middot; 49.16% fuzzy max.**
...
_Started units alone: 1,599/3,393 fns exact, 49.21% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   306 | 983 / 1,977 (49.7%) | 58.2% |     58.2% |
| `Stub`        |     7 |   108 / 649 (16.6%) |  6.4% |      6.4% |
