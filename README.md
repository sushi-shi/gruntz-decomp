...
**Overall (vs full engine): 3,756 / 4,427 functions exact (84.84%) &middot; 95.17% fuzzy &middot; 95.39% fuzzy max.**
...
_Started units alone: 3,756/4,427 fns exact, 95.22% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,183 / 2,648 (82.4%) |  95.1% |     95.3% |
