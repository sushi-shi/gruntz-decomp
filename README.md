...
**Overall (vs full engine): 2,097 / 3,811 functions exact (55.02%) &middot; 71.12% fuzzy &middot; 71.12% fuzzy max.**
...
_Started units alone: 2,097/3,750 fns exact, 71.18% fuzzy over 1,066,900 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   363 | 1,217 / 2,329 (52.3%) | 68.6% |     68.6% |
