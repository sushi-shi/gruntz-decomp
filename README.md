...
**Overall (vs full engine): 1,385 / 3,451 functions exact (40.13%) &middot; 42.61% fuzzy &middot; 42.61% fuzzy max.**
...
_Started units alone: 1,385/3,415 fns exact, 42.64% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   217 | 853 / 1,756 (48.6%) | 56.5% |     56.5% |
| `Stub`        |     5 | 105 / 1,008 (10.4%) |  4.8% |      4.8% |
