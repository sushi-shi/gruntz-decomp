...
| `.reloc` | 113,105 | 113,573 | +468 | **43.22%** | 59,237 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,010,350 | +23,171 | **50.95%** | 58,731 |
| **total** | 3,137,613 | 3,239,857 | +102,244 | **41.38%** | 815,679 |
...
_Independently of where the bytes landed, **36,574 of 36,803 address operands (99.38%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `b9d8525bed58`, linked 2026-08-11 14:18. Regenerate: `ninja candidate`._
<!-- link-score:end -->
