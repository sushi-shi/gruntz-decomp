...
**Overall (vs full engine): 3,502 / 4,312 functions exact (81.22%) &middot; 93.64% fuzzy &middot; 93.69% fuzzy max.**

**Data: 99.16% size-weighted across 704,140 B** (`.bss` 99.76%, `.data` 95.89%, `.rdata` 99.25%) &middot; 15.87% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
...
_Started units alone: 3,502/4,325 fns exact, 91.98% fuzzy over 1,113,083 of 1,093,329 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   233 | 2,009 / 2,572 (78.1%) |  91.5% |     91.6% |
| `DDrawMgr`   |    22 |     491 / 574 (85.5%) |  88.8% |     88.9% |
