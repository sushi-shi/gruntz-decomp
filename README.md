...
**Overall (vs full engine): 3,248 / 4,492 functions exact (72.31%) &middot; 81.08% fuzzy &middot; 81.23% fuzzy max.**
...
_Started units alone: 3,248/4,268 fns exact, 80.97% fuzzy over 1,093,409 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,849 / 2,541 (72.8%) | 79.2% |     79.4% |
| `DDrawMgr`    |    23 |     451 / 571 (79.0%) | 77.1% |     77.2% |
