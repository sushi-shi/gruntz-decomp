...
**Overall (vs full engine): 3,750 / 4,427 functions exact (84.71%) &middot; 95.16% fuzzy &middot; 95.38% fuzzy max.**
...
_Started units alone: 3,750/4,427 fns exact, 95.21% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,179 / 2,648 (82.3%) |  95.1% |     95.3% |
