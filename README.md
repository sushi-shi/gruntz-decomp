...
**Overall (vs full engine): 3,452 / 4,314 functions exact (80.02%) &middot; 94.52% fuzzy &middot; 94.52% fuzzy max.**

**Data — reconstructable coverage 99.67% &middot; gross coverage 40.86% &middot; fidelity 96.81%** (initialized data; `.bss` 92.33% / 96.67% is reported apart).
...
_Started units alone: 3,452/4,327 fns exact, 92.87% fuzzy over 1,134,118 of 1,114,364 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,967 / 2,574 (76.4%) |  92.3% |     92.3% |
| `DDrawMgr`   |    22 |     499 / 584 (85.4%) |  92.3% |     92.3% |
| `Wwd`        |     9 |     161 / 214 (75.2%) |  93.6% |     93.6% |
| `Bute`       |     9 |     155 / 191 (81.2%) |  94.2% |     94.2% |
| `Dsndmgr`    |     4 |     144 / 153 (94.1%) |  98.2% |     98.2% |
| `Net`        |    12 |     117 / 134 (87.3%) |  97.7% |     97.7% |
| `Image`      |    10 |      88 / 121 (72.7%) |  93.5% |     93.5% |
...
| `.reloc` | 113,105 | 113,534 | +429 | **42.90%** | 59,255 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,010,241 | +23,062 | **50.07%** | 58,731 |
| **total** | 3,137,613 | 3,241,698 | +104,085 | **40.81%** | 815,697 |
...
_Independently of where the bytes landed, **36,434 of 36,726 address operands (99.20%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `36efb0f513b2`, linked 2026-08-10 18:10. Regenerate: `ninja candidate`._
<!-- link-score:end -->
