...
**Overall (vs full engine): 1,923 / 3,859 functions exact (49.83%) &middot; 68.88% fuzzy &middot; 69.18% fuzzy max.**
...
_Started units alone: 1,923/3,720 fns exact, 68.98% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 990 / 2,003 (49.4%) | 69.3% |     69.6% |
| `Stub`        |    22 |   195 / 505 (38.6%) | 24.8% |     25.0% |
