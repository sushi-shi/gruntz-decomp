...
**Overall (vs full engine): 1,832 / 3,856 functions exact (47.51%) &middot; 63.57% fuzzy &middot; 63.69% fuzzy max.**
...
_Started units alone: 1,832/3,824 fns exact, 64.21% fuzzy over 1,058,943 of 1,069,620 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,104 / 2,081 (53.1%) | 68.4% |     68.6% |
