...
**Overall (vs full engine): 1,842 / 3,451 functions exact (53.38%) &middot; 56.25% fuzzy &middot; 56.25% fuzzy max.**
...
_Started units alone: 1,842/3,394 fns exact, 56.30% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   368 | 1,178 / 2,273 (51.8%) | 61.1% |     61.1% |
| `Stub`        |     7 |     134 / 322 (41.6%) | 12.6% |     12.6% |
