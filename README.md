...
**Overall (vs full engine): 144 / 6,326 functions exact (2.28%) &middot; 3.98% fuzzy &middot; 3.98% fuzzy max.**
...
_Started units alone: 144/186 fns exact, 90.91% fuzzy over 43,450 of 991,463 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    16 |  40 / 65 (61.5%) |  71.8% |     71.8% |
