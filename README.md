...
**Overall (vs full engine): 501 / 6,510 functions exact (7.70%) &middot; 12.29% fuzzy &middot; 12.29% fuzzy max.**
...
_Started units alone: 501/2,238 fns exact, 16.83% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,519 (7.9%) |  3.5% |      3.5% |
| `Gruntz`      |    50 |  162 / 408 (39.7%) | 33.0% |     33.0% |
