...
**Overall (vs full engine): 3,151 / 4,492 functions exact (70.15%) &middot; 80.04% fuzzy &middot; 80.18% fuzzy max.**
...
_Started units alone: 3,151/4,268 fns exact, 80.14% fuzzy over 1,090,619 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,809 / 2,543 (71.1%) | 78.6% |     78.7% |
| `DDrawMgr`    |    26 |     436 / 573 (76.1%) | 75.9% |     76.0% |
| `Wwd`         |     8 |     145 / 213 (68.1%) | 87.6% |     87.7% |
| `Bute`        |    10 |     129 / 169 (76.3%) | 79.0% |     79.0% |
| `Dsndmgr`     |     5 |     133 / 152 (87.5%) | 94.8% |     94.8% |
| `Net`         |    13 |     114 / 135 (84.4%) | 96.8% |     96.8% |
| `Image`       |    16 |      78 / 127 (61.4%) | 84.9% |     85.0% |
| `Rez`         |     7 |       61 / 76 (80.3%) | 80.9% |     80.9% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `DinMgr2`     |     2 |       56 / 60 (93.3%) | 99.4% |     99.4% |
| `Wap32`       |     7 |       47 / 53 (88.7%) | 95.7% |     95.7% |
| `Io`          |     4 |       35 / 40 (87.5%) | 89.2% |     89.2% |
| `Utils`       |     8 |       22 / 26 (84.6%) | 90.6% |     91.2% |
| `Font`        |     1 |       16 / 22 (72.7%) | 78.1% |     78.1% |
| `Crypto`      |     4 |       10 / 16 (62.5%) | 85.1% |     93.2% |
| `(unmatched)` |     — |        0 / 224 (0.0%) |  0.0% |      0.0% |
...
| `CRT/MFC library`    |     1,941 |  194,366 | FID-identified, statically linked                 |
| `jump thunks`        |     1,616 |    8,055 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
