...
**Overall (vs full engine): 1,863 / 3,290 functions exact (56.63%) &middot; 71.21% fuzzy &middot; 71.22% fuzzy max.**
...
_Started units alone: 1,863/3,265 fns exact, 71.44% fuzzy over 959,263 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   344 | 1,135 / 2,086 (54.4%) | 68.7% |     68.7% |
