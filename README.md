...
**Overall (vs full engine): 1,250 / 7,435 functions exact (16.81%) &middot; 35.57% fuzzy &middot; 35.57% fuzzy max.**
...
_Started units alone: 1,250/3,233 fns exact, 37.88% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   181 | 758 / 1,541 (49.2%) | 53.0% |     53.0% |
| `Stub`        |     4 |  106 / 1,102 (9.6%) |  4.5% |      4.5% |
