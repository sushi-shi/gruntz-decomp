...
**Overall (vs full engine): 1,681 / 3,856 functions exact (43.59%) &middot; 62.92% fuzzy &middot; 63.23% fuzzy max.**
...
_Started units alone: 1,681/3,709 fns exact, 63.69% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   325 | 834 / 1,777 (46.9%) | 67.3% |     67.7% |
| `Stub`        |    19 |   182 / 815 (22.3%) | 14.0% |     14.1% |
