...
**Overall (vs full engine): 3,318 / 4,300 functions exact (77.16%) &middot; 90.68% fuzzy &middot; 90.77% fuzzy max.**
...
_Started units alone: 3,318/4,290 fns exact, 89.06% fuzzy over 1,113,088 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,880 / 2,561 (73.4%) |  88.6% |     88.7% |
| `DDrawMgr`    |    22 |     476 / 572 (83.2%) |  87.1% |     87.1% |
