...
**Overall (vs full engine): 1,079 / 7,097 functions exact (15.20%) &middot; 29.81% fuzzy &middot; 29.81% fuzzy max.**
...
_Started units alone: 1,079/3,243 fns exact, 31.60% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,465 (8.1%) |  4.0% |      4.0% |
