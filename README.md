...
**Overall (vs full engine): 1,153 / 7,092 functions exact (16.26%) &middot; 32.39% fuzzy &middot; 32.39% fuzzy max.**
...
_Started units alone: 1,153/3,238 fns exact, 34.33% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   167 | 674 / 1,394 (48.4%) | 51.0% |     51.0% |
| `Stub`        |     4 |  118 / 1,291 (9.1%) |  4.3% |      4.3% |
