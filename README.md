...
**Overall (vs full engine): 2,982 / 4,492 functions exact (66.38%) &middot; 77.54% fuzzy &middot; 77.66% fuzzy max.**
...
_Started units alone: 2,982/4,263 fns exact, 77.73% fuzzy over 1,089,137 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,718 / 2,539 (67.7%) | 76.3% |     76.5% |
| `DDrawMgr`    |    26 |     411 / 573 (71.7%) | 71.7% |     71.7% |
