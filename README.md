...
**Overall (vs full engine): 1,784 / 3,451 functions exact (51.70%) &middot; 52.92% fuzzy &middot; 52.92% fuzzy max.**
...
_Started units alone: 1,784/3,393 fns exact, 52.97% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   342 | 1,161 / 2,228 (52.1%) | 59.9% |     59.9% |
| `Stub`        |     7 |     104 / 379 (27.4%) |  7.8% |      7.8% |
