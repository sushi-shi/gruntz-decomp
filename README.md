...
**Overall (vs full engine): 1,869 / 3,397 functions exact (55.02%) &middot; 62.67% fuzzy &middot; 62.67% fuzzy max.**
...
_Started units alone: 1,869/3,394 fns exact, 62.71% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   399 | 1,205 / 2,335 (51.6%) | 62.0% |     62.0% |
| `Stub`        |     6 |     127 / 250 (50.8%) | 31.2% |     31.2% |
