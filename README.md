...
**Overall (vs full engine): 1,377 / 3,543 functions exact (38.87%) &middot; 38.55% fuzzy &middot; 38.55% fuzzy max.**
...
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   200 | 858 / 1,704 (50.4%) | 54.7% |     54.7% |
| `Stub`        |     5 |  105 / 1,153 (9.1%) |  4.1% |      4.1% |
