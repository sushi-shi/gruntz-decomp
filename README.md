...
**Overall (vs full engine): 3,501 / 4,312 functions exact (81.19%) &middot; 93.56% fuzzy &middot; 93.60% fuzzy max.**
...
_Started units alone: 3,501/4,324 fns exact, 91.90% fuzzy over 1,113,061 of 1,093,329 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,009 / 2,572 (78.1%) |  91.5% |     91.5% |
| `DDrawMgr`    |    22 |     491 / 574 (85.5%) |  88.6% |     88.7% |
