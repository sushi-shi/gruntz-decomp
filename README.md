...
**Overall (vs full engine): 1,223 / 7,435 functions exact (16.45%) &middot; 34.46% fuzzy &middot; 34.46% fuzzy max.**
...
_Started units alone: 1,223/3,233 fns exact, 36.70% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 738 / 1,500 (49.2%) | 52.2% |     52.2% |
| `Stub`        |     4 |  103 / 1,152 (8.9%) |  4.4% |      4.4% |
