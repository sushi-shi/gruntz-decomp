...
**Overall (vs full engine): 2,915 / 3,539 functions exact (82.37%) &middot; 87.08% fuzzy &middot; 87.16% fuzzy max.**
...
_Started units alone: 2,915/4,263 fns exact, 76.22% fuzzy over 1,088,864 of 953,095 engine code bytes._
...
| `CRT/MFC library`    |     1,907 |  192,636 | FID-identified, statically linked                 |
| `jump thunks`        |     1,629 |    8,130 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
