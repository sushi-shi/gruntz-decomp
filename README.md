...
**Overall (vs full engine): 2,468 / 3,995 functions exact (61.78%) &middot; 73.72% fuzzy &middot; 73.92% fuzzy max.**
...
_Started units alone: 2,468/3,991 fns exact, 73.51% fuzzy over 1,081,272 of 1,078,191 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,389 / 2,368 (58.7%) | 71.2% |     71.4% |
| `DDrawMgr`    |    26 |     324 / 518 (62.5%) | 68.5% |     68.6% |
