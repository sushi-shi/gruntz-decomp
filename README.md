...
**Overall (vs full engine): 2,399 / 3,982 functions exact (60.25%) &middot; 73.59% fuzzy &middot; 73.64% fuzzy max.**
...
_Started units alone: 2,399/3,976 fns exact, 73.38% fuzzy over 1,081,162 of 1,078,067 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,353 / 2,366 (57.2%) | 71.1% |     71.1% |
