...
**Overall (vs full engine): 1,847 / 3,290 functions exact (56.14%) &middot; 68.88% fuzzy &middot; 68.88% fuzzy max.**
...
_Started units alone: 1,847/3,266 fns exact, 69.00% fuzzy over 960,779 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,107 / 2,065 (53.6%) | 65.5% |     65.5% |
