...
**Overall (vs full engine): 3,302 / 4,299 functions exact (76.81%) &middot; 90.61% fuzzy &middot; 90.63% fuzzy max.**
...
_Started units alone: 3,302/4,290 fns exact, 88.98% fuzzy over 1,113,125 of 1,093,139 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,870 / 2,562 (73.0%) |  88.6% |     88.6% |
| `DDrawMgr`    |    22 |     474 / 572 (82.9%) |  86.7% |     86.9% |
