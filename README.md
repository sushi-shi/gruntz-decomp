...
**Overall (vs full engine): 679 / 6,510 functions exact (10.43%) &middot; 18.49% fuzzy &middot; 18.49% fuzzy max.**
...
_Started units alone: 679/2,242 fns exact, 25.02% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,207 (10.0%) |  4.1% |      4.1% |
| `Gruntz`      |    64 |   317 / 691 (45.9%) | 47.0% |     47.0% |
