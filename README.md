...
**Overall (vs full engine): 1,865 / 3,397 functions exact (54.90%) &middot; 61.01% fuzzy &middot; 61.01% fuzzy max.**
...
_Started units alone: 1,865/3,394 fns exact, 61.05% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   390 | 1,194 / 2,315 (51.6%) | 62.6% |     62.6% |
| `Stub`        |     7 |     139 / 275 (50.5%) | 22.0% |     22.0% |
