...
**Overall (vs full engine): 2,919 / 4,314 functions exact (67.66%) &middot; 94.08% fuzzy &middot; 94.08% fuzzy max.**
...
_Started units alone: 2,919/4,327 fns exact, 92.44% fuzzy over 1,134,118 of 1,114,364 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,644 / 2,574 (63.9%) |  92.2% |     92.2% |
| `DDrawMgr`   |    22 |     390 / 574 (67.9%) |  89.6% |     89.6% |
