...
**Overall (vs full engine): 2,260 / 3,925 functions exact (57.58%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,260/3,913 fns exact, 72.35% fuzzy over 1,077,928 of 1,077,329 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   278 | 1,387 / 2,521 (55.0%) | 69.6% |     69.6% |
| `DDrawMgr`    |    20 |     215 / 393 (54.7%) | 70.9% |     70.9% |
...
| `CRT/MFC library`    |     2,267 |  207,483 | FID-identified, statically linked                 |
| `jump thunks`        |     1,684 |    8,353 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
