...
**Overall (vs full engine): 2,453 / 3,995 functions exact (61.40%) &middot; 73.68% fuzzy &middot; 73.81% fuzzy max.**
...
_Started units alone: 2,453/3,988 fns exact, 73.48% fuzzy over 1,081,236 of 1,078,197 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,374 / 2,367 (58.0%) | 71.1% |     71.3% |
| `DDrawMgr`    |    26 |     323 / 516 (62.6%) | 68.4% |     68.5% |
