...
**Overall (vs full engine): 3,096 / 4,492 functions exact (68.92%) &middot; 78.02% fuzzy &middot; 78.14% fuzzy max.**
...
_Started units alone: 3,096/4,261 fns exact, 78.24% fuzzy over 1,088,827 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,783 / 2,539 (70.2%) | 76.9% |     77.1% |
