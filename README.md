...
**Overall (vs full engine): 3,086 / 4,492 functions exact (68.70%) &middot; 78.02% fuzzy &middot; 78.13% fuzzy max.**
...
_Started units alone: 3,086/4,261 fns exact, 78.24% fuzzy over 1,088,827 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,779 / 2,539 (70.1%) | 76.9% |     77.0% |
