...
**Overall (vs full engine): 1,397 / 3,543 functions exact (39.43%) &middot; 38.90% fuzzy &middot; 38.90% fuzzy max.**
...
_Started units alone: 1,397/3,485 fns exact, 38.94% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   210 | 878 / 1,731 (50.7%) | 55.0% |     55.0% |
| `Stub`        |     5 |  105 / 1,126 (9.3%) |  4.1% |      4.1% |
