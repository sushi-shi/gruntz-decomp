...
**Overall (vs full engine): 2,684 / 4,190 functions exact (64.06%) &middot; 73.97% fuzzy &middot; 73.98% fuzzy max.**
...
_Started units alone: 2,684/4,188 fns exact, 73.73% fuzzy over 1,083,535 of 1,080,043 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,539 / 2,506 (61.4%) | 71.4% |     71.4% |
...
| `CRT/MFC library`    |     2,238 |  205,921 | FID-identified, statically linked                 |
