...
**Overall (vs full engine): 1,835 / 3,859 functions exact (47.55%) &middot; 68.23% fuzzy &middot; 68.54% fuzzy max.**
...
_Started units alone: 1,835/3,720 fns exact, 68.33% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 950 / 1,958 (48.5%) | 69.1% |     69.4% |
| `Stub`        |    22 |   195 / 599 (32.6%) | 22.9% |     23.1% |
