...
**Overall (vs full engine): 2,173 / 3,811 functions exact (57.02%) &middot; 72.72% fuzzy &middot; 72.72% fuzzy max.**
...
_Started units alone: 2,173/3,802 fns exact, 72.68% fuzzy over 1,068,584 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   324 | 1,305 / 2,449 (53.3%) | 70.2% |     70.2% |
