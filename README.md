...
**Overall (vs full engine): 1,051 / 7,097 functions exact (14.81%) &middot; 28.76% fuzzy &middot; 28.76% fuzzy max.**
...
_Started units alone: 1,051/3,243 fns exact, 30.48% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,530 (7.7%) |  3.9% |      3.9% |
| `Gruntz`      |   166 | 608 / 1,235 (49.2%) | 49.7% |     49.7% |
