...
**Overall (vs full engine): 312 / 6,371 functions exact (4.90%) &middot; 9.09% fuzzy &middot; 9.09% fuzzy max.**
...
_Started units alone: 312/3,484 fns exact, 9.11% fuzzy over 989,948 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 28 / 2,998 (0.9%) |   1.1% |      1.1% |
