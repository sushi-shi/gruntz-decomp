...
**Overall (vs full engine): 2,391 / 3,984 functions exact (60.02%) &middot; 73.59% fuzzy &middot; 73.63% fuzzy max.**
...
_Started units alone: 2,391/3,976 fns exact, 73.38% fuzzy over 1,081,190 of 1,078,108 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,346 / 2,366 (56.9%) | 71.1% |     71.1% |
