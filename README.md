...
**Overall (vs full engine): 2,664 / 4,184 functions exact (63.67%) &middot; 73.81% fuzzy &middot; 73.81% fuzzy max.**
...
_Started units alone: 2,664/4,177 fns exact, 73.61% fuzzy over 1,082,936 of 1,079,891 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,529 / 2,500 (61.2%) | 71.3% |     71.3% |
| `DDrawMgr`    |    26 |     356 / 547 (65.1%) | 68.6% |     68.6% |
