...
**Overall (vs full engine): 229 / 6,367 functions exact (3.60%) &middot; 6.27% fuzzy &middot; 6.27% fuzzy max.**
...
_Started units alone: 229/750 fns exact, 18.41% fuzzy over 338,023 of 991,849 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 337 (0.0%) |   0.3% |      0.3% |
| `Gruntz`      |    43 | 104 / 217 (47.9%) |  44.6% |     44.6% |
