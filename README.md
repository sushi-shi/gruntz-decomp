...
**Overall (vs full engine): 3,329 / 4,300 functions exact (77.42%) &middot; 90.71% fuzzy &middot; 90.82% fuzzy max.**
...
_Started units alone: 3,329/4,290 fns exact, 89.09% fuzzy over 1,113,088 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,884 / 2,561 (73.6%) |  88.6% |     88.8% |
