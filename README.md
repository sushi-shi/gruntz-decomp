...
**Overall (vs full engine): 3,538 / 4,327 functions exact (81.77%) &middot; 95.16% fuzzy &middot; 95.16% fuzzy max.**

**Data — reconstructable coverage 99.76% &middot; gross coverage 56.47% &middot; fidelity 97.02%** (initialized data; `.bss` 92.23% / 96.70% is reported apart).
...
_Started units alone: 3,538/4,351 fns exact, 93.50% fuzzy over 1,134,668 of 1,114,937 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   232 | 2,020 / 2,586 (78.1%) |  93.1% |     93.1% |
| `DDrawMgr`    |    22 |     507 / 584 (86.8%) |  92.7% |     92.7% |
| `Wwd`         |     9 |     167 / 217 (77.0%) |  93.7% |     93.7% |
...
| `CRT/MFC library`                   |     1,976 |  198,763 | FID-identified, statically linked                        |
...
| :-- | --: | --: | --: | --: | --: |
| `.data` | 763,820 | 835,852 | +72,032 | **10.18%** | 627,628 |
| `.idata` | 15,169 | 15,169 | +0 &check; | **78.03%** | 3,307 |
| `.rdata` | 135,080 | 141,725 | +6,645 | **17.87%** | 66,776 |
| `.reloc` | 113,105 | 113,565 | +460 | **43.15%** | 59,237 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,010,878 | +23,699 | **50.76%** | 58,731 |
| **total** | 3,137,613 | 3,240,449 | +102,836 | **41.26%** | 815,679 |
...
_Independently of where the bytes landed, **36,543 of 36,778 address operands (99.36%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `4229dcc8d251`, linked 2026-08-11 07:19. Regenerate: `ninja candidate`._
<!-- link-score:end -->
