...
**Overall (vs full engine): 1,846 / 3,835 functions exact (48.14%) &middot; 63.66% fuzzy &middot; 63.71% fuzzy max.**
...
_Started units alone: 1,846/3,824 fns exact, 64.27% fuzzy over 1,058,943 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,116 / 2,081 (53.6%) | 68.5% |     68.6% |
