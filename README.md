...
**Overall (vs full engine): 2,366 / 3,984 functions exact (59.39%) &middot; 73.27% fuzzy &middot; 73.30% fuzzy max.**
...
_Started units alone: 2,366/3,976 fns exact, 73.06% fuzzy over 1,081,414 of 1,078,332 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   257 | 1,334 / 2,367 (56.4%) | 70.7% |     70.7% |
