...
**Overall (vs full engine): 2,848 / 4,492 functions exact (63.40%) &middot; 75.45% fuzzy &middot; 75.50% fuzzy max.**
...
_Started units alone: 2,848/4,263 fns exact, 75.66% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,630 / 2,539 (64.2%) | 73.9% |     73.9% |
| `DDrawMgr`    |    26 |     388 / 573 (67.7%) | 69.0% |     69.0% |
