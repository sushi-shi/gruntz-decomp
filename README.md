...
**Overall (vs full engine): 2,200 / 3,834 functions exact (57.38%) &middot; 72.77% fuzzy &middot; 72.77% fuzzy max.**
...
_Started units alone: 2,200/3,824 fns exact, 72.73% fuzzy over 1,068,591 of 1,068,012 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   273 | 1,339 / 2,450 (54.7%) | 70.0% |     70.0% |
