...
**Overall (vs full engine): 548 / 6,510 functions exact (8.42%) &middot; 13.42% fuzzy &middot; 13.42% fuzzy max.**
...
_Started units alone: 548/2,239 fns exact, 18.38% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,435 (8.2%) |  3.5% |      3.5% |
