...
**Overall (vs full engine): 401 / 6,371 functions exact (6.29%) &middot; 9.82% fuzzy &middot; 9.82% fuzzy max.**
...
_Started units alone: 401/1,086 fns exact, 20.26% fuzzy over 480,579 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 111 / 583 (19.0%) |   3.6% |      3.6% |
