...
**Overall (vs full engine): 2,847 / 4,492 functions exact (63.38%) &middot; 75.50% fuzzy &middot; 75.59% fuzzy max.**
...
_Started units alone: 2,847/4,263 fns exact, 75.71% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,627 / 2,539 (64.1%) | 73.9% |     74.0% |
| `DDrawMgr`    |    26 |     386 / 573 (67.4%) | 69.2% |     69.2% |
