...
**Overall (vs full engine): 1,291 / 7,435 functions exact (17.36%) &middot; 37.33% fuzzy &middot; 37.33% fuzzy max.**
...
_Started units alone: 1,291/3,234 fns exact, 39.79% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   190 | 796 / 1,610 (49.4%) | 54.1% |     54.1% |
| `Stub`        |     4 | 104 / 1,024 (10.2%) |  4.5% |      4.5% |
