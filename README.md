...
**Overall (vs full engine): 1,829 / 3,856 functions exact (47.43%) &middot; 63.54% fuzzy &middot; 63.69% fuzzy max.**
...
_Started units alone: 1,829/3,824 fns exact, 64.18% fuzzy over 1,058,943 of 1,069,620 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,101 / 2,081 (52.9%) | 68.4% |     68.6% |
