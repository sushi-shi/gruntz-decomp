...
**Overall (vs full engine): 740 / 6,510 functions exact (11.37%) &middot; 22.06% fuzzy &middot; 22.06% fuzzy max.**
...
_Started units alone: 740/2,242 fns exact, 29.84% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,048 (11.5%) |  5.3% |      5.3% |
| `Gruntz`      |    82 |   374 / 833 (44.9%) | 43.8% |     43.8% |
