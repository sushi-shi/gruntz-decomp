...
**Overall (vs full engine): 2,003 / 3,808 functions exact (52.60%) &middot; 70.74% fuzzy &middot; 70.74% fuzzy max.**
...
_Started units alone: 2,003/3,697 fns exact, 70.88% fuzzy over 1,065,648 of 1,067,765 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   348 | 1,136 / 2,270 (50.0%) | 69.4% |     69.4% |
| `DDrawMgr`    |    31 |     197 / 378 (52.1%) | 67.6% |     67.6% |
| `Net`         |    22 |     126 / 187 (67.4%) | 86.9% |     86.9% |
| `Image`       |    28 |      79 / 161 (49.1%) | 81.9% |     81.9% |
| `Dsndmgr`     |    12 |      98 / 133 (73.7%) | 92.5% |     92.5% |
| `Bute`        |    10 |      64 / 116 (55.2%) | 80.7% |     80.7% |
| `Wwd`         |     9 |       37 / 93 (39.8%) | 73.0% |     73.0% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Io`          |     7 |       43 / 56 (76.8%) | 89.8% |     89.8% |
| `Wap32`       |    10 |       44 / 55 (80.0%) | 92.7% |     92.7% |
| `DinMgr2`     |     1 |       43 / 50 (86.0%) | 98.6% |     98.6% |
| `Rez`         |     7 |       34 / 46 (73.9%) | 76.5% |     76.5% |
| `Stub`        |     1 |         0 / 33 (0.0%) |  0.7% |      0.7% |
| `Utils`       |     8 |       21 / 23 (91.3%) | 99.7% |     99.7% |
| `Font`        |     1 |       12 / 19 (63.2%) | 79.1% |     79.1% |
| `Crypto`      |     3 |        9 / 14 (64.3%) | 95.3% |     95.3% |
| `Globals.cpp` |     1 |          0 / 0 (0.0%) |  0.0% |      0.0% |
| `(unmatched)` |     — |        0 / 111 (0.0%) |  0.0% |      0.0% |
...
| `CRT/MFC library`    |     2,260 |  207,521 | FID-identified, statically linked                 |
