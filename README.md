...
**Overall (vs full engine): 1,765 / 3,451 functions exact (51.14%) &middot; 50.76% fuzzy &middot; 50.76% fuzzy max.**
...
_Started units alone: 1,765/3,393 fns exact, 50.80% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   333 | 1,143 / 2,177 (52.5%) | 59.0% |     59.0% |
| `Stub`        |     7 |     112 / 449 (24.9%) |  6.9% |      6.9% |
