...
**Overall (vs full engine): 1,068 / 7,097 functions exact (15.05%) &middot; 29.69% fuzzy &middot; 29.69% fuzzy max.**
...
_Started units alone: 1,068/3,243 fns exact, 31.47% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,479 (8.0%) |  4.0% |      4.0% |
| `Gruntz`      |   166 | 619 / 1,278 (48.4%) | 50.4% |     50.4% |
