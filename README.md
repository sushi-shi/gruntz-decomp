...
**Overall (vs full engine): 1,869 / 3,859 functions exact (48.43%) &middot; 68.45% fuzzy &middot; 68.76% fuzzy max.**
...
_Started units alone: 1,869/3,720 fns exact, 68.55% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 964 / 1,975 (48.8%) | 69.2% |     69.5% |
| `Stub`        |    22 |   195 / 564 (34.6%) | 23.5% |     23.7% |
