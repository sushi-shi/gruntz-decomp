...
**Overall (vs full engine): 1,831 / 3,306 functions exact (55.38%) &middot; 65.63% fuzzy &middot; 65.64% fuzzy max.**
...
_Started units alone: 1,831/3,303 fns exact, 65.67% fuzzy over 966,576 of 967,209 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   415 | 1,210 / 2,352 (51.4%) | 62.7% |     62.7% |
