...
**Overall (vs full engine): 1,050 / 7,097 functions exact (14.79%) &middot; 28.71% fuzzy &middot; 28.71% fuzzy max.**
...
_Started units alone: 1,050/3,243 fns exact, 30.43% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,535 (7.7%) |  3.9% |      3.9% |
| `Gruntz`      |   166 | 607 / 1,230 (49.3%) | 49.7% |     49.7% |
