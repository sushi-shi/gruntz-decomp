...
**Overall (vs full engine): 2,256 / 3,894 functions exact (57.94%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,256/3,884 fns exact, 72.35% fuzzy over 1,077,674 of 1,077,095 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   265 | 1,385 / 2,500 (55.4%) | 69.6% |     69.6% |
...
| `CRT/MFC library`    |     2,269 |  207,609 | FID-identified, statically linked                 |
