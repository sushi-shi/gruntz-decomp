...
**Overall (vs full engine): 1,211 / 7,091 functions exact (17.08%) &middot; 34.27% fuzzy &middot; 34.27% fuzzy max.**
...
_Started units alone: 1,211/3,231 fns exact, 36.44% fuzzy over 935,763 of 994,765 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 727 / 1,487 (48.9%) | 51.9% |     51.9% |
| `Stub`        |     4 |  103 / 1,163 (8.9%) |  4.4% |      4.4% |
