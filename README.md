...
**Overall (vs full engine): 2,858 / 4,492 functions exact (63.62%) &middot; 75.54% fuzzy &middot; 75.63% fuzzy max.**
...
_Started units alone: 2,858/4,263 fns exact, 75.75% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,633 / 2,539 (64.3%) | 74.0% |     74.1% |
| `DDrawMgr`    |    26 |     390 / 573 (68.1%) | 69.2% |     69.2% |
