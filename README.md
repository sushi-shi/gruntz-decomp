...
**Overall (vs full engine): 942 / 7,098 functions exact (13.27%) &middot; 26.41% fuzzy &middot; 26.41% fuzzy max.**
...
_Started units alone: 942/2,268 fns exact, 35.60% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 507 / 1,073 (47.3%) | 47.6% |     47.6% |
| `Stub`        |     2 |   118 / 729 (16.2%) |  5.8% |      5.8% |
