...
**Overall (vs full engine): 615 / 6,510 functions exact (9.45%) &middot; 14.71% fuzzy &middot; 14.71% fuzzy max.**
...
_Started units alone: 615/2,239 fns exact, 20.15% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,342 (9.0%) |  3.8% |      3.8% |
