...
**Overall (vs full engine): 2,919 / 4,492 functions exact (64.98%) &middot; 77.48% fuzzy &middot; 77.60% fuzzy max.**
...
_Started units alone: 2,919/4,263 fns exact, 77.68% fuzzy over 1,089,137 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,687 / 2,539 (66.4%) | 76.3% |     76.4% |
