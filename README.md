...
**Overall (vs full engine): 284 / 6,371 functions exact (4.46%) &middot; 7.84% fuzzy &middot; 7.84% fuzzy max.**
...
_Started units alone: 284/821 fns exact, 22.46% fuzzy over 346,304 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 346 (0.0%) |   0.4% |      0.4% |
