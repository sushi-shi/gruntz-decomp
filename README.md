...
**Overall (vs full engine): 1,382 / 3,451 functions exact (40.05%) &middot; 40.62% fuzzy &middot; 40.62% fuzzy max.**
...
_Started units alone: 1,382/3,415 fns exact, 40.65% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   204 | 850 / 1,721 (49.4%) | 55.5% |     55.5% |
| `Stub`        |     5 | 105 / 1,045 (10.0%) |  4.4% |      4.4% |
