...
**Overall (vs full engine): 1,565 / 3,451 functions exact (45.35%) &middot; 46.46% fuzzy &middot; 46.46% fuzzy max.**
...
_Started units alone: 1,565/3,393 fns exact, 46.50% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   270 | 952 / 1,905 (50.0%) | 58.1% |     58.1% |
| `Stub`        |     7 |   107 / 736 (14.5%) |  5.3% |      5.3% |
