...
**Overall (vs full engine): 3,161 / 4,492 functions exact (70.37%) &middot; 80.02% fuzzy &middot; 80.16% fuzzy max.**
...
_Started units alone: 3,161/4,268 fns exact, 80.12% fuzzy over 1,090,619 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,807 / 2,541 (71.1%) | 78.5% |     78.7% |
