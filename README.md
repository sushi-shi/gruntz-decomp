...
**Overall (vs full engine): 1,842 / 3,366 functions exact (54.72%) &middot; 64.34% fuzzy &middot; 64.34% fuzzy max.**
...
_Started units alone: 1,842/3,366 fns exact, 64.38% fuzzy over 970,209 of 970,792 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   416 | 1,195 / 2,359 (50.7%) | 61.8% |     61.8% |
