...
**Overall (vs full engine): 1,096 / 7,097 functions exact (15.44%) &middot; 30.74% fuzzy &middot; 30.74% fuzzy max.**
...
_Started units alone: 1,096/3,243 fns exact, 32.58% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,417 (8.3%) |  4.1% |      4.1% |
| `Gruntz`      |   166 | 633 / 1,308 (48.4%) | 50.9% |     50.9% |
