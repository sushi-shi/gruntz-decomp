...
**Overall (vs full engine): 151 / 6,349 functions exact (2.38%) &middot; 4.08% fuzzy &middot; 4.08% fuzzy max.**
...
_Started units alone: 151/192 fns exact, 91.09% fuzzy over 44,461 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    18 |  47 / 71 (66.2%) |  73.7% |     73.7% |
