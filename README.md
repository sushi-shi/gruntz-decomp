...
**Overall (vs full engine): 3,545 / 4,399 functions exact (80.59%) &middot; 93.73% fuzzy &middot; 93.88% fuzzy max.**

_Data: objdiff `matched_data` 560,427 of 802,783 B (69.81%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,545/4,362 fns exact, 93.97% fuzzy over 1,135,192 of 1,138,142 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   205 | 2,039 / 2,609 (78.2%) |  93.5% |     93.7% |
| `DDrawMgr`    |    21 |     507 / 586 (86.5%) |  92.6% |     92.7% |
