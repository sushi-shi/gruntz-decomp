...
**Overall (vs full engine): 3,255 / 4,277 functions exact (76.10%) &middot; 86.45% fuzzy &middot; 86.60% fuzzy max.**
...
_Started units alone: 3,255/4,264 fns exact, 85.08% fuzzy over 1,101,924 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,860 / 2,547 (73.0%) |  83.9% |     84.1% |
