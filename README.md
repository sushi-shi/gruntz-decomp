...
**Overall (vs full engine): 3,493 / 4,320 functions exact (80.86%) &middot; 94.82% fuzzy &middot; 94.84% fuzzy max.**
...
_Started units alone: 3,493/4,340 fns exact, 93.17% fuzzy over 1,134,143 of 1,114,375 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,994 / 2,579 (77.3%) |  92.7% |     92.7% |
