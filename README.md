...
**Overall (vs full engine): 340 / 6,371 functions exact (5.34%) &middot; 8.82% fuzzy &middot; 8.82% fuzzy max.**
...
_Started units alone: 340/1,078 fns exact, 18.28% fuzzy over 478,727 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |   56 / 592 (9.5%) |   1.9% |      1.9% |
