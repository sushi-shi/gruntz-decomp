...
**Overall (vs full engine): 1,927 / 3,859 functions exact (49.94%) &middot; 69.09% fuzzy &middot; 69.40% fuzzy max.**
...
_Started units alone: 1,927/3,720 fns exact, 69.19% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   327 | 998 / 2,021 (49.4%) | 69.4% |     69.7% |
| `Stub`        |    22 |   181 / 473 (38.3%) | 24.3% |     24.5% |
