...
**Overall (vs full engine): 1,823 / 3,859 functions exact (47.24%) &middot; 68.15% fuzzy &middot; 68.45% fuzzy max.**
...
_Started units alone: 1,823/3,720 fns exact, 68.25% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 939 / 1,945 (48.3%) | 69.1% |     69.4% |
| `Stub`        |    22 |   195 / 612 (31.9%) | 22.7% |     22.8% |
