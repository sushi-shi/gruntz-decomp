...
**Overall (vs full engine): 3,287 / 4,297 functions exact (76.50%) &middot; 88.51% fuzzy &middot; 88.67% fuzzy max.**
...
_Started units alone: 3,287/4,288 fns exact, 86.93% fuzzy over 1,113,117 of 1,093,131 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   234 | 1,854 / 2,558 (72.5%) |  86.1% |     86.3% |
| `DDrawMgr`    |    22 |     471 / 570 (82.6%) |  84.5% |     84.7% |
