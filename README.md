...
**Overall (vs full engine): 957 / 7,098 functions exact (13.48%) &middot; 26.88% fuzzy &middot; 26.88% fuzzy max.**
...
_Started units alone: 957/2,268 fns exact, 36.23% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   135 | 522 / 1,100 (47.5%) | 48.2% |     48.2% |
| `Stub`        |     2 |   118 / 701 (16.8%) |  5.9% |      5.9% |
