...
**Overall (vs full engine): 826 / 6,510 functions exact (12.69%) &middot; 23.32% fuzzy &middot; 23.32% fuzzy max.**
...
_Started units alone: 826/2,242 fns exact, 31.56% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |    95 | 426 / 927 (46.0%) | 44.7% |     44.7% |
| `Stub`        |     2 | 120 / 911 (13.2%) |  5.5% |      5.5% |
