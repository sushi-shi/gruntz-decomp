...
**Overall (vs full engine): 1,234 / 7,435 functions exact (16.60%) &middot; 34.67% fuzzy &middot; 34.67% fuzzy max.**
...
_Started units alone: 1,234/3,233 fns exact, 36.92% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 742 / 1,502 (49.4%) | 52.2% |     52.2% |
