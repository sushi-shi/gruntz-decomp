...
**Overall (vs full engine): 3,158 / 4,492 functions exact (70.30%) &middot; 80.06% fuzzy &middot; 80.20% fuzzy max.**
...
_Started units alone: 3,158/4,268 fns exact, 80.16% fuzzy over 1,090,619 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,805 / 2,541 (71.0%) | 78.6% |     78.7% |
