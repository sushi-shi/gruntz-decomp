...
**Overall (vs full engine): 1,824 / 3,297 functions exact (55.32%) &middot; 65.63% fuzzy &middot; 65.63% fuzzy max.**
...
_Started units alone: 1,824/3,294 fns exact, 65.67% fuzzy over 966,463 of 967,096 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,213 / 2,365 (51.3%) | 62.6% |     62.6% |
| `Stub`        |     1 |     111 / 161 (68.9%) | 58.1% |     58.1% |
...
| `CRT/MFC library`    |     2,179 |  199,380 | FID-identified, statically linked                 |
