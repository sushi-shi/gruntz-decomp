...
**Overall (vs full engine): 583 / 6,510 functions exact (8.96%) &middot; 13.73% fuzzy &middot; 13.73% fuzzy max.**
...
_Started units alone: 583/2,239 fns exact, 18.80% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,393 (8.4%) |  3.5% |      3.5% |
| `Gruntz`      |    58 |  228 / 506 (45.1%) | 36.5% |     36.5% |
