...
**Overall (vs full engine): 2,409 / 3,989 functions exact (60.39%) &middot; 73.59% fuzzy &middot; 73.65% fuzzy max.**
...
_Started units alone: 2,409/3,982 fns exact, 73.39% fuzzy over 1,081,163 of 1,078,124 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,355 / 2,365 (57.3%) | 71.1% |     71.1% |
