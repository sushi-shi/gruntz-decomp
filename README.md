...
**Overall (vs full engine): 3,682 / 4,427 functions exact (83.17%) &middot; 94.59% fuzzy &middot; 94.83% fuzzy max.**
...
_Started units alone: 3,682/4,427 fns exact, 94.64% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,147 / 2,652 (81.0%) |  94.5% |     94.7% |
