...
**Overall (vs full engine): 1,251 / 7,435 functions exact (16.83%) &middot; 35.94% fuzzy &middot; 35.94% fuzzy max.**
...
_Started units alone: 1,251/3,234 fns exact, 38.31% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 759 / 1,552 (48.9%) | 52.9% |     52.9% |
| `Stub`        |     4 |  106 / 1,089 (9.7%) |  4.6% |      4.6% |
