...
**Overall (vs full engine): 2,919 / 4,346 functions exact (67.17%) &middot; 76.57% fuzzy &middot; 76.66% fuzzy max.**
...
_Started units alone: 2,919/4,263 fns exact, 76.66% fuzzy over 1,088,864 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,689 / 2,539 (66.5%) | 75.0% |     75.1% |
| `DDrawMgr`    |    26 |     393 / 573 (68.6%) | 70.5% |     70.5% |
