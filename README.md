...
**Overall (vs full engine): 1,654 / 3,451 functions exact (47.93%) &middot; 49.44% fuzzy &middot; 49.44% fuzzy max.**
...
_Started units alone: 1,654/3,393 fns exact, 49.48% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   315 | 1,031 / 2,029 (50.8%) | 58.3% |     58.3% |
| `Stub`        |     7 |     113 / 597 (18.9%) |  6.4% |      6.4% |
