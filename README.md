...
**Overall (vs full engine): 1,289 / 3,547 functions exact (36.34%) &middot; 37.70% fuzzy &middot; 37.70% fuzzy max.**
...
_Started units alone: 1,289/3,507 fns exact, 37.72% fuzzy over 987,804 of 988,549 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   190 | 794 / 1,608 (49.4%) | 54.1% |     54.1% |
| `Stub`        |     5 |  104 / 1,299 (8.0%) |  4.1% |      4.1% |
...
| `CRT/MFC library`    |     2,061 |  178,458 | FID-identified, statically linked                 |
| `jump thunks`        |     1,560 |    7,796 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
