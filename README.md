...
**Overall (vs full engine): 3,255 / 4,497 functions exact (72.38%) &middot; 82.34% fuzzy &middot; 82.48% fuzzy max.**
...
_Started units alone: 3,255/4,268 fns exact, 82.06% fuzzy over 1,095,647 of 1,091,946 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,856 / 2,541 (73.0%) | 80.5% |     80.7% |
