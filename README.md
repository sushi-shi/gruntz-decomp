...
**Overall (vs full engine): 1,389 / 3,543 functions exact (39.20%) &middot; 38.70% fuzzy &middot; 38.70% fuzzy max.**
...
_Started units alone: 1,389/3,485 fns exact, 38.73% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   204 | 870 / 1,718 (50.6%) | 54.8% |     54.8% |
| `Stub`        |     5 |  105 / 1,139 (9.2%) |  4.1% |      4.1% |
