...
**Overall (vs full engine): 3,115 / 4,346 functions exact (71.68%) &middot; 78.18% fuzzy &middot; 78.30% fuzzy max.**
...
_Started units alone: 3,115/4,261 fns exact, 78.28% fuzzy over 1,088,827 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,788 / 2,539 (70.4%) | 76.9% |     77.1% |
