...
**Overall (vs full engine): 2,387 / 3,983 functions exact (59.93%) &middot; 73.38% fuzzy &middot; 73.43% fuzzy max.**
...
_Started units alone: 2,387/3,975 fns exact, 73.17% fuzzy over 1,081,189 of 1,078,107 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,342 / 2,365 (56.7%) | 70.8% |     70.8% |
