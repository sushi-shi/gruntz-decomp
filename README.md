...
**Overall (vs full engine): 1,172 / 7,092 functions exact (16.53%) &middot; 33.26% fuzzy &middot; 33.26% fuzzy max.**
...
_Started units alone: 1,172/3,232 fns exact, 35.36% fuzzy over 935,833 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   169 | 690 / 1,423 (48.5%) | 51.4% |     51.4% |
| `Stub`        |     4 |  117 / 1,251 (9.4%) |  4.6% |      4.6% |
