...
**Overall (vs full engine): 3,105 / 4,509 functions exact (68.86%) &middot; 78.20% fuzzy &middot; 78.31% fuzzy max.**
...
_Started units alone: 3,105/4,261 fns exact, 78.50% fuzzy over 1,088,827 of 1,093,057 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,785 / 2,539 (70.3%) | 77.3% |     77.4% |
| `DDrawMgr`    |    26 |     425 / 573 (74.2%) | 71.7% |     71.7% |
| `Wwd`         |     8 |     148 / 211 (70.1%) | 81.8% |     81.8% |
| `Bute`        |    10 |     125 / 169 (74.0%) | 78.5% |     78.5% |
| `Dsndmgr`     |     5 |     133 / 152 (87.5%) | 94.8% |     94.8% |
| `Net`         |    13 |     108 / 135 (80.0%) | 94.8% |     94.9% |
| `Image`       |    16 |      78 / 127 (61.4%) | 84.1% |     84.2% |
| `Rez`         |     7 |       62 / 76 (81.6%) | 80.4% |     80.4% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `DinMgr2`     |     2 |       56 / 60 (93.3%) | 99.4% |     99.4% |
| `Wap32`       |     7 |       47 / 53 (88.7%) | 95.7% |     95.7% |
| `Io`          |     4 |       29 / 39 (74.4%) | 87.1% |     87.2% |
| `Utils`       |     8 |       22 / 26 (84.6%) | 91.2% |     91.2% |
| `Font`        |     1 |       16 / 22 (72.7%) | 78.1% |     78.1% |
| `Crypto`      |     4 |       11 / 16 (68.8%) | 93.1% |     93.1% |
| `(unmatched)` |     — |        0 / 248 (0.0%) |  0.0% |      0.0% |
...
| `jump thunks`        |     1,614 |    8,042 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
