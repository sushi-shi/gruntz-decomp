...
**Overall (vs full engine): 2,395 / 3,983 functions exact (60.13%) &middot; 73.60% fuzzy &middot; 73.63% fuzzy max.**
...
_Started units alone: 2,395/3,976 fns exact, 73.39% fuzzy over 1,081,162 of 1,078,072 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,350 / 2,366 (57.1%) | 71.1% |     71.1% |
