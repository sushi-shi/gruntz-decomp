...
**Overall (vs full engine): 1,791 / 3,451 functions exact (51.90%) &middot; 54.22% fuzzy &middot; 54.22% fuzzy max.**
...
_Started units alone: 1,791/3,394 fns exact, 54.27% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   352 | 1,166 / 2,247 (51.9%) | 60.3% |     60.3% |
| `Stub`        |     7 |     104 / 354 (29.4%) |  8.5% |      8.5% |
