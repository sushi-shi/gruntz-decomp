...
**Overall (vs full engine): 1,144 / 7,092 functions exact (16.13%) &middot; 32.19% fuzzy &middot; 32.19% fuzzy max.**
...
_Started units alone: 1,144/3,238 fns exact, 34.12% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   166 | 666 / 1,378 (48.3%) | 51.6% |     51.6% |
| `Stub`        |     4 |  118 / 1,308 (9.0%) |  4.3% |      4.3% |
...
| `DinMgr2`     |     1 |     24 / 28 (85.7%) | 98.1% |     98.1% |
