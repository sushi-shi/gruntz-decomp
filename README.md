...
**Overall (vs full engine): 3,488 / 4,320 functions exact (80.74%) &middot; 94.74% fuzzy &middot; 94.76% fuzzy max.**
...
_Started units alone: 3,488/4,340 fns exact, 93.09% fuzzy over 1,134,143 of 1,114,375 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,992 / 2,579 (77.2%) |  92.6% |     92.7% |
