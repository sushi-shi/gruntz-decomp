...
**Overall (vs full engine): 3,471 / 4,301 functions exact (80.70%) &middot; 92.43% fuzzy &middot; 92.45% fuzzy max.**
...
_Started units alone: 3,471/4,301 fns exact, 90.80% fuzzy over 1,112,794 of 1,093,174 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,002 / 2,567 (78.0%) |  90.3% |     90.3% |
