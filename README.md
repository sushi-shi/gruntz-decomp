...
**Overall (vs full engine): 2,259 / 3,902 functions exact (57.89%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,259/3,890 fns exact, 72.35% fuzzy over 1,077,805 of 1,077,236 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   277 | 1,385 / 2,502 (55.4%) | 69.6% |     69.6% |
| `DDrawMgr`    |    20 |     216 / 394 (54.8%) | 70.9% |     70.9% |
| `Wwd`         |     7 |      84 / 170 (49.4%) | 78.0% |     78.0% |
| `Dsndmgr`     |     5 |     102 / 139 (73.4%) | 92.3% |     92.3% |
| `Bute`        |     7 |      71 / 122 (58.2%) | 72.6% |     72.6% |
| `Net`         |    13 |      90 / 122 (73.8%) | 93.5% |     93.5% |
| `Image`       |    15 |      55 / 121 (45.5%) | 80.7% |     80.7% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Wap32`       |     8 |       46 / 57 (80.7%) | 93.9% |     93.9% |
| `DinMgr2`     |     2 |       47 / 54 (87.0%) | 98.6% |     98.6% |
| `Rez`         |     6 |       30 / 48 (62.5%) | 74.5% |     74.5% |
...
| `jump thunks`        |     1,682 |    8,344 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
