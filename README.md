...
**Overall (vs full engine): 2,238 / 3,874 functions exact (57.77%) &middot; 72.78% fuzzy &middot; 72.79% fuzzy max.**
...
_Started units alone: 2,238/3,864 fns exact, 72.75% fuzzy over 1,068,849 of 1,068,270 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   265 | 1,370 / 2,483 (55.2%) | 70.1% |     70.1% |
| `DDrawMgr`    |    19 |     215 / 394 (54.6%) | 70.8% |     70.8% |
| `Wwd`         |     7 |      84 / 170 (49.4%) | 77.7% |     77.7% |
| `Dsndmgr`     |     5 |     102 / 138 (73.9%) | 92.6% |     92.6% |
| `Net`         |    13 |      88 / 121 (72.7%) | 93.4% |     93.4% |
| `Bute`        |     7 |      71 / 120 (59.2%) | 72.5% |     72.5% |
| `Image`       |    15 |      51 / 118 (43.2%) | 80.6% |     80.6% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `Wap32`       |     8 |       46 / 57 (80.7%) | 93.9% |     93.9% |
| `DinMgr2`     |     2 |       47 / 54 (87.0%) | 98.6% |     98.6% |
| `Rez`         |     5 |       29 / 46 (63.0%) | 73.9% |     73.9% |
...
| `CRT/MFC library`    |     2,270 |  207,625 | FID-identified, statically linked                 |
| `jump thunks`        |     1,686 |    8,356 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
