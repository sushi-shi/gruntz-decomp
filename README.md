...
**Overall (vs full engine): 207 / 6,349 functions exact (3.26%) &middot; 6.43% fuzzy &middot; 6.43% fuzzy max.**
...
_Started units alone: 207/411 fns exact, 66.16% fuzzy over 96,359 of 991,759 engine code bytes._

| Module        | Units |  Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | ----: | --------: |
| `Gruntz`      |    44 | 95 / 180 (52.8%) | 65.9% |     65.9% |
| `zlib-1.0.4`  |    11 |  47 / 50 (94.0%) | 99.4% |     99.4% |
| `Font`        |     1 |   7 / 35 (20.0%) | 13.1% |     13.1% |
