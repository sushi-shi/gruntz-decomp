...
**Overall (vs full engine): 861 / 6,510 functions exact (13.23%) &middot; 23.93% fuzzy &middot; 23.93% fuzzy max.**
...
_Started units alone: 861/2,243 fns exact, 32.38% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   104 | 449 / 972 (46.2%) | 45.5% |     45.5% |
| `Stub`        |     2 | 118 / 845 (14.0%) |  5.3% |      5.3% |
