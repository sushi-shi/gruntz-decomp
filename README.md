...
**Overall (vs full engine): 1,826 / 3,451 functions exact (52.91%) &middot; 55.62% fuzzy &middot; 55.62% fuzzy max.**
...
_Started units alone: 1,826/3,394 fns exact, 55.67% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   360 | 1,174 / 2,261 (51.9%) | 60.9% |     60.9% |
| `Stub`        |     7 |     124 / 337 (36.8%) | 11.1% |     11.1% |
