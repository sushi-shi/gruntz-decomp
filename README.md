...
**Overall (vs full engine): 312 / 6,371 functions exact (4.90%) &middot; 8.59% fuzzy &middot; 8.59% fuzzy max.**
...
_Started units alone: 312/1,078 fns exact, 17.80% fuzzy over 478,727 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |   28 / 592 (4.7%) |   1.2% |      1.2% |
