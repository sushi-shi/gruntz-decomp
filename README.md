...
**Overall (vs full engine): 555 / 6,510 functions exact (8.53%) &middot; 13.53% fuzzy &middot; 13.53% fuzzy max.**
...
_Started units alone: 555/2,239 fns exact, 18.52% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,426 (8.2%) |  3.5% |      3.5% |
