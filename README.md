...
**Overall (vs full engine): 1,113 / 7,092 functions exact (15.69%) &middot; 31.21% fuzzy &middot; 31.21% fuzzy max.**
...
_Started units alone: 1,113/3,238 fns exact, 33.08% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,376 (8.6%) |  4.2% |      4.2% |
| `Gruntz`      |   166 | 650 / 1,343 (48.4%) | 51.3% |     51.3% |
