...
**Overall (vs full engine): 1,264 / 7,435 functions exact (17.00%) &middot; 36.13% fuzzy &middot; 36.13% fuzzy max.**
...
_Started units alone: 1,264/3,234 fns exact, 38.51% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 769 / 1,565 (49.1%) | 53.0% |     53.0% |
| `Stub`        |     4 |  104 / 1,069 (9.7%) |  4.5% |      4.5% |
