...
**Overall (vs full engine): 3,237 / 4,301 functions exact (75.26%) &middot; 87.47% fuzzy &middot; 87.73% fuzzy max.**
...
_Started units alone: 3,237/4,295 fns exact, 85.81% fuzzy over 1,114,357 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,816 / 2,553 (71.1%) |  85.0% |     85.4% |
| `DDrawMgr`    |    21 |     455 / 570 (79.8%) |  82.9% |     83.0% |
