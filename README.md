...
| `.idata` | 15,169 | 15,169 | +0 &check; | **78.20%** | 3,307 |
| `.rdata` | 135,080 | 141,669 | +6,589 | **17.87%** | 66,776 |
| `.reloc` | 113,105 | 113,560 | +455 | **43.30%** | 59,385 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,010,558 | +23,379 | **51.03%** | 58,731 |
| **total** | 3,137,613 | 3,240,036 | +102,423 | **41.43%** | 815,827 |
...
_Independently of where the bytes landed, **35,962 of 36,132 address operands (99.53%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `a015ed455642`, linked 2026-08-13 02:18. Regenerate: `ninja candidate`._
<!-- link-score:end -->
