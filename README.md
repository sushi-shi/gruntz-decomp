...
**Overall (vs full engine): 1,835 / 3,366 functions exact (54.52%) &middot; 64.34% fuzzy &middot; 64.34% fuzzy max.**
...
_Started units alone: 1,835/3,363 fns exact, 64.38% fuzzy over 970,165 of 970,792 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   416 | 1,194 / 2,361 (50.6%) | 61.8% |     61.8% |
...
| `jump thunks`        |     1,674 |    8,288 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
