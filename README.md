...
**Overall (vs full engine): 3,695 / 4,427 functions exact (83.47%) &middot; 94.64% fuzzy &middot; 94.86% fuzzy max.**
...
_Started units alone: 3,695/4,427 fns exact, 94.69% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,148 / 2,652 (81.0%) |  94.5% |     94.7% |
