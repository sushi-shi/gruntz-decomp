...
**Overall (vs full engine): 3,252 / 4,492 functions exact (72.40%) &middot; 81.19% fuzzy &middot; 81.33% fuzzy max.**
...
_Started units alone: 3,252/4,268 fns exact, 81.08% fuzzy over 1,093,409 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,853 / 2,541 (72.9%) | 79.3% |     79.4% |
| `DDrawMgr`    |    23 |     451 / 571 (79.0%) | 77.4% |     77.5% |
