...
**Overall (vs full engine): 595 / 6,510 functions exact (9.14%) &middot; 13.98% fuzzy &middot; 13.98% fuzzy max.**
...
_Started units alone: 595/2,239 fns exact, 19.14% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,368 (8.6%) |  3.5% |      3.5% |
| `Gruntz`      |    60 |  240 / 531 (45.2%) | 37.4% |     37.4% |
