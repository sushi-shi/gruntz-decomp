...
**Overall (vs full engine): 938 / 7,098 functions exact (13.21%) &middot; 26.28% fuzzy &middot; 26.28% fuzzy max.**
...
_Started units alone: 938/2,244 fns exact, 35.67% fuzzy over 733,575 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   129 | 503 / 1,065 (47.2%) | 47.5% |     47.5% |
| `Stub`        |     2 |   118 / 713 (16.5%) |  5.8% |      5.8% |
