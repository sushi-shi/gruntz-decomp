...
**Overall (vs full engine): 3,236 / 4,297 functions exact (75.31%) &middot; 87.48% fuzzy &middot; 87.49% fuzzy max.**
...
_Started units alone: 3,236/4,290 fns exact, 85.90% fuzzy over 1,113,228 of 1,093,131 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   228 | 1,830 / 2,558 (71.5%) |  85.2% |     85.2% |
