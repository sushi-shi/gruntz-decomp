...
**Overall (vs full engine): 1,828 / 3,835 functions exact (47.67%) &middot; 63.59% fuzzy &middot; 63.72% fuzzy max.**
...
_Started units alone: 1,828/3,818 fns exact, 64.24% fuzzy over 1,058,311 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,099 / 2,074 (53.0%) | 68.5% |     68.7% |
