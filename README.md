...
**Overall (vs full engine): 2,255 / 3,893 functions exact (57.92%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,255/3,885 fns exact, 72.35% fuzzy over 1,077,797 of 1,077,204 engine code bytes._
...
| `CRT/MFC library`    |     2,253 |  206,506 | FID-identified, statically linked                 |
| `jump thunks`        |     1,690 |    8,383 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
