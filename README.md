...
**Overall (vs full engine): 1,175 / 7,091 functions exact (16.57%) &middot; 33.34% fuzzy &middot; 33.34% fuzzy max.**
...
_Started units alone: 1,175/3,231 fns exact, 35.44% fuzzy over 935,763 of 994,765 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   170 | 692 / 1,427 (48.5%) | 51.4% |     51.4% |
| `Stub`        |     4 |  117 / 1,242 (9.4%) |  4.6% |      4.6% |
