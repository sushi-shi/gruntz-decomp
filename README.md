...
**Overall (vs full engine): 2,469 / 3,995 functions exact (61.80%) &middot; 73.74% fuzzy &middot; 73.88% fuzzy max.**
...
_Started units alone: 2,469/3,993 fns exact, 73.53% fuzzy over 1,081,286 of 1,078,191 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   247 | 1,388 / 2,370 (58.6%) | 71.2% |     71.4% |
