...
**Overall (vs full engine): 2,324 / 3,962 functions exact (58.66%) &middot; 72.55% fuzzy &middot; 72.56% fuzzy max.**
...
_Started units alone: 2,324/3,951 fns exact, 72.35% fuzzy over 1,080,924 of 1,077,845 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,328 / 2,369 (56.1%) | 69.7% |     69.7% |
| `DDrawMgr`    |    27 |     287 / 506 (56.7%) | 67.7% |     67.7% |
