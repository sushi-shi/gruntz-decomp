...
**Overall (vs full engine): 158 / 6,349 functions exact (2.49%) &middot; 4.33% fuzzy &middot; 4.33% fuzzy max.**
...
_Started units alone: 158/210 fns exact, 91.27% fuzzy over 47,085 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    28 |  54 / 89 (60.7%) |  77.0% |     77.0% |
