...
**Overall (vs full engine): 3,279 / 4,266 functions exact (76.86%) &middot; 87.54% fuzzy &middot; 87.79% fuzzy max.**
...
_Started units alone: 3,279/4,266 fns exact, 85.94% fuzzy over 1,103,990 of 1,083,761 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,875 / 2,548 (73.6%) |  85.0% |     85.3% |
