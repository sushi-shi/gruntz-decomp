...
**Overall (vs full engine): 703 / 6,510 functions exact (10.80%) &middot; 21.09% fuzzy &middot; 21.09% fuzzy max.**
...
_Started units alone: 703/2,242 fns exact, 28.53% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,114 (10.9%) |  5.1% |      5.1% |
| `Gruntz`      |    75 |   340 / 779 (43.6%) | 42.8% |     42.8% |
