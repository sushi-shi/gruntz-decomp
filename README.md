...
**Overall (vs full engine): 1,791 / 3,451 functions exact (51.90%) &middot; 54.49% fuzzy &middot; 54.49% fuzzy max.**
...
_Started units alone: 1,791/3,394 fns exact, 54.54% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   353 | 1,166 / 2,250 (51.8%) | 60.4% |     60.4% |
| `Stub`        |     7 |     104 / 351 (29.6%) |  8.7% |      8.7% |
