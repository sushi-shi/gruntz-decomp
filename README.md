...
**Overall (vs full engine): 1,385 / 3,451 functions exact (40.13%) &middot; 42.28% fuzzy &middot; 42.28% fuzzy max.**
...
_Started units alone: 1,385/3,415 fns exact, 42.32% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   215 | 853 / 1,752 (48.7%) | 56.5% |     56.5% |
| `Stub`        |     5 | 105 / 1,013 (10.4%) |  4.7% |      4.7% |
