...
**Overall (vs full engine): 1,831 / 3,859 functions exact (47.45%) &middot; 68.21% fuzzy &middot; 68.51% fuzzy max.**
...
_Started units alone: 1,831/3,720 fns exact, 68.31% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 946 / 1,954 (48.4%) | 69.1% |     69.4% |
| `Stub`        |    22 |   195 / 603 (32.3%) | 22.8% |     23.0% |
