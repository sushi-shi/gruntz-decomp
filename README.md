...
**Overall (vs full engine): 2,703 / 4,337 functions exact (62.32%) &middot; 73.54% fuzzy &middot; 73.56% fuzzy max.**
...
_Started units alone: 2,703/4,216 fns exact, 73.70% fuzzy over 1,084,066 of 1,086,468 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,551 / 2,523 (61.5%) | 71.4% |     71.4% |
