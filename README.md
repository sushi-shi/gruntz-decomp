...
**Overall (vs full engine): 3,060 / 4,346 functions exact (70.41%) &middot; 77.79% fuzzy &middot; 77.91% fuzzy max.**
...
_Started units alone: 3,060/4,263 fns exact, 77.87% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,762 / 2,539 (69.4%) | 76.4% |     76.6% |
