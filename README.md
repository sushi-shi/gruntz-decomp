...
**Overall (vs full engine): 1,716 / 3,856 functions exact (44.50%) &middot; 64.48% fuzzy &middot; 64.79% fuzzy max.**
...
_Started units alone: 1,716/3,709 fns exact, 65.27% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 856 / 1,828 (46.8%) | 67.9% |     68.2% |
| `Stub`        |    22 |   193 / 760 (25.4%) | 16.7% |     16.8% |
