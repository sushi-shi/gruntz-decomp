...
**Overall (vs full engine): 1,799 / 3,451 functions exact (52.13%) &middot; 55.02% fuzzy &middot; 55.02% fuzzy max.**
...
_Started units alone: 1,799/3,394 fns exact, 55.07% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,166 / 2,258 (51.6%) | 60.6% |     60.6% |
| `Stub`        |     7 |     111 / 342 (32.5%) |  9.0% |      9.0% |
