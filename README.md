...
**Overall (vs full engine): 2,170 / 3,811 functions exact (56.94%) &middot; 72.61% fuzzy &middot; 72.61% fuzzy max.**
...
_Started units alone: 2,170/3,802 fns exact, 72.57% fuzzy over 1,068,584 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   364 | 1,261 / 2,357 (53.5%) | 69.7% |     69.7% |
