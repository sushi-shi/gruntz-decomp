...
**Overall (vs full engine): 1,857 / 3,290 functions exact (56.44%) &middot; 70.30% fuzzy &middot; 70.30% fuzzy max.**
...
_Started units alone: 1,857/3,266 fns exact, 70.42% fuzzy over 960,779 of 962,368 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,112 / 2,066 (53.8%) | 67.4% |     67.4% |
