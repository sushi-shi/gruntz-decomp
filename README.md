...
**Overall (vs full engine): 1,865 / 3,397 functions exact (54.90%) &middot; 61.69% fuzzy &middot; 61.69% fuzzy max.**
...
_Started units alone: 1,865/3,394 fns exact, 61.73% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   392 | 1,194 / 2,317 (51.5%) | 62.7% |     62.7% |
| `Stub`        |     7 |     139 / 273 (50.9%) | 24.2% |     24.2% |
