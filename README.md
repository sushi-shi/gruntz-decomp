...
**Overall (vs full engine): 1,152 / 7,092 functions exact (16.24%) &middot; 32.25% fuzzy &middot; 32.25% fuzzy max.**
...
_Started units alone: 1,152/3,238 fns exact, 34.19% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   167 | 673 / 1,388 (48.5%) | 51.7% |     51.7% |
| `Stub`        |     4 |  118 / 1,297 (9.1%) |  4.3% |      4.3% |
