...
**Overall (vs full engine): 877 / 6,510 functions exact (13.47%) &middot; 24.32% fuzzy &middot; 24.32% fuzzy max.**
...
_Started units alone: 877/2,243 fns exact, 32.91% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   111 | 461 / 996 (46.3%) | 45.9% |     45.9% |
| `Stub`        |     2 | 118 / 814 (14.5%) |  5.4% |      5.4% |
