...
**Overall (vs full engine): 3,747 / 4,427 functions exact (84.64%) &middot; 95.18% fuzzy &middot; 95.32% fuzzy max.**
...
_Started units alone: 3,747/4,427 fns exact, 95.23% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,177 / 2,648 (82.2%) |  95.1% |     95.2% |
