...
**Overall (vs full engine): 2,177 / 3,811 functions exact (57.12%) &middot; 72.81% fuzzy &middot; 72.81% fuzzy max.**
...
_Started units alone: 2,177/3,802 fns exact, 72.76% fuzzy over 1,068,584 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   305 | 1,314 / 2,460 (53.4%) | 70.3% |     70.3% |
