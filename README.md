...
**Overall (vs full engine): 2,464 / 3,995 functions exact (61.68%) &middot; 73.69% fuzzy &middot; 73.94% fuzzy max.**
...
_Started units alone: 2,464/3,991 fns exact, 73.48% fuzzy over 1,081,272 of 1,078,191 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,384 / 2,368 (58.4%) | 71.1% |     71.4% |
