...
**Overall (vs full engine): 1,873 / 3,397 functions exact (55.14%) &middot; 63.84% fuzzy &middot; 63.84% fuzzy max.**
...
_Started units alone: 1,873/3,394 fns exact, 63.88% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   411 | 1,209 / 2,355 (51.3%) | 61.9% |     61.9% |
| `Stub`        |     6 |     123 / 223 (55.2%) | 43.1% |     43.1% |
