...
**Overall (vs full engine): 164 / 6,349 functions exact (2.58%) &middot; 4.35% fuzzy &middot; 4.35% fuzzy max.**
...
_Started units alone: 164/216 fns exact, 91.30% fuzzy over 47,234 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    28 |  60 / 95 (63.2%) |  77.2% |     77.2% |
