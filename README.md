...
**Overall (vs full engine): 2,262 / 3,934 functions exact (57.50%) &middot; 72.14% fuzzy &middot; 72.14% fuzzy max.**
...
_Started units alone: 2,262/3,923 fns exact, 71.93% fuzzy over 1,080,425 of 1,077,356 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,304 / 2,361 (55.2%) | 69.3% |     69.3% |
