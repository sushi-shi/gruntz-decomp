...
**Overall (vs full engine): 1,873 / 3,397 functions exact (55.14%) &middot; 63.67% fuzzy &middot; 63.67% fuzzy max.**
...
_Started units alone: 1,873/3,394 fns exact, 63.71% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   409 | 1,209 / 2,351 (51.4%) | 61.9% |     61.9% |
| `Stub`        |     6 |     123 / 227 (54.2%) | 41.4% |     41.4% |
