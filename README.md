...
**Overall (vs full engine): 3,061 / 4,346 functions exact (70.43%) &middot; 77.83% fuzzy &middot; 77.95% fuzzy max.**
...
_Started units alone: 3,061/4,263 fns exact, 77.90% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,763 / 2,539 (69.4%) | 76.5% |     76.6% |
...
| `CRT/MFC library`    |     1,925 |  194,321 | FID-identified, statically linked                 |
| `jump thunks`        |     1,629 |    8,120 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
