...
**Overall (vs full engine): 2,829 / 4,492 functions exact (62.98%) &middot; 75.10% fuzzy &middot; 75.11% fuzzy max.**
...
_Started units alone: 2,829/4,263 fns exact, 75.41% fuzzy over 1,087,423 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,624 / 2,539 (64.0%) | 73.7% |     73.7% |
