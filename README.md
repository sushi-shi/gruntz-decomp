...
**Overall (vs full engine): 1,774 / 3,857 functions exact (45.99%) &middot; 66.99% fuzzy &middot; 67.29% fuzzy max.**
...
_Started units alone: 1,774/3,717 fns exact, 67.08% fuzzy over 1,068,112 of 1,069,623 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 901 / 1,895 (47.5%) | 68.7% |     69.0% |
| `Stub`        |    22 |   193 / 671 (28.8%) | 19.7% |     19.8% |
