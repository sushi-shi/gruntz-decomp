...
**Overall (vs full engine): 1,368 / 3,451 functions exact (39.64%) &middot; 39.08% fuzzy &middot; 39.08% fuzzy max.**
...
_Started units alone: 1,368/3,415 fns exact, 39.11% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   198 | 843 / 1,689 (49.9%) | 54.7% |     54.7% |
| `Stub`        |     5 |  105 / 1,087 (9.7%) |  4.2% |      4.2% |
