...
**Overall (vs full engine): 3,310 / 4,300 functions exact (76.98%) &middot; 90.67% fuzzy &middot; 90.67% fuzzy max.**
...
_Started units alone: 3,310/4,291 fns exact, 89.04% fuzzy over 1,113,130 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,873 / 2,562 (73.1%) |  88.7% |     88.7% |
| `DDrawMgr`    |    22 |     475 / 572 (83.0%) |  86.7% |     86.7% |
