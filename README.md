...
**Overall (vs full engine): 2,145 / 3,811 functions exact (56.28%) &middot; 71.81% fuzzy &middot; 71.81% fuzzy max.**
...
_Started units alone: 2,145/3,794 fns exact, 71.78% fuzzy over 1,068,437 of 1,067,918 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   364 | 1,242 / 2,354 (52.8%) | 68.8% |     68.8% |
