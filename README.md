...
**Overall (vs full engine): 3,538 / 4,327 functions exact (81.77%) &middot; 95.15% fuzzy &middot; 95.15% fuzzy max.**
...
| `.text` | 1,987,179 | 2,010,862 | +23,683 | **50.76%** | 58,731 |
| **total** | 3,137,613 | 3,240,433 | +102,820 | **41.26%** | 815,679 |
