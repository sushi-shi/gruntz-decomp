...
**Overall (vs full engine): 3,446 / 4,300 functions exact (80.14%) &middot; 91.36% fuzzy &middot; 91.51% fuzzy max.**
...
_Started units alone: 3,446/4,298 fns exact, 89.65% fuzzy over 1,114,062 of 1,093,144 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,987 / 2,565 (77.5%) |  89.1% |     89.2% |
