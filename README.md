...
**Overall (vs full engine): 902 / 6,510 functions exact (13.86%) &middot; 24.70% fuzzy &middot; 24.70% fuzzy max.**
...
_Started units alone: 902/2,243 fns exact, 33.42% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   118 | 479 / 1,022 (46.9%) | 46.3% |     46.3% |
| `Stub`        |     2 |   118 / 777 (15.2%) |  5.5% |      5.5% |
