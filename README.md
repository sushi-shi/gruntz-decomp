...
_Started units alone: 2,260/3,912 fns exact, 72.35% fuzzy over 1,077,890 of 1,077,329 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   278 | 1,386 / 2,520 (55.0%) | 69.6% |     69.6% |
...
| `jump thunks`        |     1,684 |    8,354 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
