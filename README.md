...
**Overall (vs full engine): 2,259 / 3,924 functions exact (57.57%) &middot; 72.38% fuzzy &middot; 72.38% fuzzy max.**
...
_Started units alone: 2,259/3,911 fns exact, 72.35% fuzzy over 1,077,886 of 1,077,325 engine code bytes._
...
| `jump thunks`        |     1,685 |    8,358 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
