...
**Overall (vs full engine): 1,858 / 3,205 functions exact (57.97%) &middot; 70.23% fuzzy &middot; 70.23% fuzzy max.**
...
_Started units alone: 1,858/3,291 fns exact, 68.76% fuzzy over 964,254 of 944,066 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   395 | 1,143 / 2,170 (52.7%) | 65.5% |     65.5% |
...
| `CRT/MFC library`    |     2,184 |  201,464 | FID-identified, statically linked                 |
| `jump thunks`        |     1,686 |    8,331 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
