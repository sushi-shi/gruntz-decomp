...
**Overall (vs full engine): 3,669 / 4,427 functions exact (82.88%) &middot; 94.25% fuzzy &middot; 94.49% fuzzy max.**
...
_Started units alone: 3,669/4,427 fns exact, 94.30% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,139 / 2,652 (80.7%) |  94.0% |     94.3% |
