...
**Overall (vs full engine): 1,865 / 3,397 functions exact (54.90%) &middot; 62.40% fuzzy &middot; 62.40% fuzzy max.**
...
_Started units alone: 1,865/3,394 fns exact, 62.44% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   394 | 1,194 / 2,319 (51.5%) | 61.9% |     61.9% |
| `Stub`        |     7 |     139 / 271 (51.3%) | 31.0% |     31.0% |
