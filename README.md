...
**Overall (vs full engine): 1,130 / 7,092 functions exact (15.93%) &middot; 31.87% fuzzy &middot; 31.87% fuzzy max.**
...
_Started units alone: 1,130/3,238 fns exact, 33.78% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   166 | 660 / 1,361 (48.5%) | 51.4% |     51.4% |
| `Stub`        |     4 |  118 / 1,339 (8.8%) |  4.2% |      4.2% |
