...
**Overall (vs full engine): 3,246 / 4,301 functions exact (75.47%) &middot; 87.67% fuzzy &middot; 87.90% fuzzy max.**
...
_Started units alone: 3,246/4,297 fns exact, 86.00% fuzzy over 1,114,371 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,825 / 2,555 (71.4%) |  85.3% |     85.5% |
