...
**Overall (vs full engine): 408 / 6,510 functions exact (6.27%) &middot; 10.52% fuzzy &middot; 10.52% fuzzy max.**
...
_Started units alone: 408/1,092 fns exact, 21.60% fuzzy over 483,556 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 114 / 565 (20.2%) |   3.8% |      3.8% |
