...
**Overall (vs full engine): 448 / 6,510 functions exact (6.88%) &middot; 11.43% fuzzy &middot; 11.43% fuzzy max.**
...
_Started units alone: 448/2,238 fns exact, 15.66% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,603 (7.5%) |  3.4% |      3.4% |
