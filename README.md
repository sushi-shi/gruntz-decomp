...
**Overall (vs full engine): 647 / 6,510 functions exact (9.94%) &middot; 15.52% fuzzy &middot; 15.52% fuzzy max.**
...
_Started units alone: 647/2,243 fns exact, 21.00% fuzzy over 733,690 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,288 (9.4%) |  3.9% |      3.9% |
| `Gruntz`      |    62 |  285 / 611 (46.6%) | 38.0% |     38.0% |
