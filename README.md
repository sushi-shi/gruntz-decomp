...
**Overall (vs full engine): 3,738 / 4,427 functions exact (84.44%) &middot; 95.13% fuzzy &middot; 95.30% fuzzy max.**
...
_Started units alone: 3,738/4,427 fns exact, 95.18% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,168 / 2,648 (81.9%) |  95.1% |     95.2% |
