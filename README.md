...
**Overall (vs full engine): 1,225 / 7,435 functions exact (16.48%) &middot; 34.67% fuzzy &middot; 34.67% fuzzy max.**
...
_Started units alone: 1,225/3,233 fns exact, 36.92% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 738 / 1,502 (49.1%) | 52.2% |     52.2% |
| `Stub`        |     4 |  103 / 1,142 (9.0%) |  4.4% |      4.4% |
