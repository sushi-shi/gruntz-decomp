...
**Overall (vs full engine): 2,665 / 4,184 functions exact (63.70%) &middot; 73.83% fuzzy &middot; 73.83% fuzzy max.**
...
_Started units alone: 2,665/4,177 fns exact, 73.62% fuzzy over 1,082,936 of 1,079,891 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,529 / 2,500 (61.2%) | 71.3% |     71.3% |
...
| `Image`       |    16 |      61 / 128 (47.7%) | 80.9% |     80.9% |
