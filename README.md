...
**Overall (vs full engine): 1,386 / 3,451 functions exact (40.16%) &middot; 43.38% fuzzy &middot; 43.38% fuzzy max.**
...
_Started units alone: 1,386/3,415 fns exact, 43.42% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   221 | 853 / 1,765 (48.3%) | 56.6% |     56.6% |
| `Stub`        |     5 |   105 / 992 (10.6%) |  4.9% |      4.9% |
