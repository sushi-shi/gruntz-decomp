...
_Data: objdiff `matched_data` 560,427 of 802,767 B (69.81%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   205 | 2,041 / 2,609 (78.2%) |  93.6% |     93.7% |
