...
**Overall (vs full engine): 1,784 / 3,451 functions exact (51.70%) &middot; 52.46% fuzzy &middot; 52.46% fuzzy max.**
...
_Started units alone: 1,784/3,393 fns exact, 52.51% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   342 | 1,161 / 2,228 (52.1%) | 59.9% |     59.9% |
| `Stub`        |     7 |     104 / 388 (26.8%) |  7.6% |      7.6% |
