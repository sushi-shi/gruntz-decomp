...
**Overall (vs full engine): 479 / 6,510 functions exact (7.36%) &middot; 11.87% fuzzy &middot; 11.87% fuzzy max.**
...
_Started units alone: 479/2,238 fns exact, 16.26% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,557 (7.7%) |  3.4% |      3.4% |
| `Gruntz`      |    49 |  147 / 378 (38.9%) | 31.7% |     31.7% |
