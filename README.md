...
**Overall (vs full engine): 2,264 / 3,934 functions exact (57.55%) &middot; 72.12% fuzzy &middot; 72.12% fuzzy max.**
...
_Started units alone: 2,264/3,925 fns exact, 71.91% fuzzy over 1,080,445 of 1,077,362 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,305 / 2,361 (55.3%) | 69.2% |     69.2% |
| `DDrawMgr`    |    27 |     276 / 500 (55.2%) | 67.2% |     67.2% |
...
| `CRT/MFC library`    |     2,252 |  206,502 | FID-identified, statically linked                 |
| `jump thunks`        |     1,679 |    8,354 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
