...
**Overall (vs full engine): 1,016 / 7,098 functions exact (14.31%) &middot; 27.63% fuzzy &middot; 27.63% fuzzy max.**
...
_Started units alone: 1,016/2,270 fns exact, 37.24% fuzzy over 738,623 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   164 | 580 / 1,183 (49.0%) | 49.1% |     49.1% |
| `Stub`        |     2 |   118 / 618 (19.1%) |  6.0% |      6.0% |
