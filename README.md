...
**Overall (vs full engine): 985 / 7,098 functions exact (13.88%) &middot; 27.18% fuzzy &middot; 27.18% fuzzy max.**
...
_Started units alone: 985/2,268 fns exact, 36.63% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   149 | 550 / 1,135 (48.5%) | 48.6% |     48.6% |
| `Stub`        |     2 |   118 / 666 (17.7%) |  5.9% |      5.9% |
