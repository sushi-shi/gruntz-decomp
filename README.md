...
**Overall (vs full engine): 2,915 / 4,492 functions exact (64.89%) &middot; 76.00% fuzzy &middot; 76.08% fuzzy max.**
...
_Started units alone: 2,915/4,263 fns exact, 76.21% fuzzy over 1,088,864 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,687 / 2,539 (66.4%) | 74.5% |     74.6% |
