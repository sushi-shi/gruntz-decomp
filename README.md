...
**Overall (vs full engine): 2,260 / 3,903 functions exact (57.90%) &middot; 72.39% fuzzy &middot; 72.39% fuzzy max.**
...
_Started units alone: 2,260/3,891 fns exact, 72.35% fuzzy over 1,077,806 of 1,077,237 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   279 | 1,385 / 2,503 (55.3%) | 69.6% |     69.6% |
...
| `jump thunks`        |     1,681 |    8,343 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
