...
**Overall (vs full engine): 1,028 / 7,097 functions exact (14.48%) &middot; 28.45% fuzzy &middot; 28.45% fuzzy max.**
...
_Started units alone: 1,028/3,243 fns exact, 30.15% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,563 (7.5%) |  3.9% |      3.9% |
| `Gruntz`      |   166 | 590 / 1,207 (48.9%) | 49.4% |     49.4% |
