...
**Overall (vs full engine): 2,470 / 3,995 functions exact (61.83%) &middot; 73.77% fuzzy &middot; 73.92% fuzzy max.**
...
_Started units alone: 2,470/3,988 fns exact, 73.56% fuzzy over 1,081,236 of 1,078,197 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,388 / 2,367 (58.6%) | 71.2% |     71.4% |
| `DDrawMgr`    |    26 |     325 / 516 (63.0%) | 68.5% |     68.6% |
| `Wwd`         |     8 |      91 / 184 (49.5%) | 78.8% |     78.8% |
| `Bute`        |    11 |      99 / 167 (59.3%) | 75.8% |     75.8% |
| `Dsndmgr`     |     5 |     117 / 148 (79.1%) | 93.4% |     93.4% |
| `Net`         |    13 |      97 / 130 (74.6%) | 93.6% |     93.6% |
| `Image`       |    16 |      59 / 125 (47.2%) | 80.9% |     81.0% |
| `Rez`         |     7 |       60 / 76 (78.9%) | 79.3% |     79.3% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `DinMgr2`     |     2 |       55 / 60 (91.7%) | 99.4% |     99.4% |
| `Wap32`       |     8 |       48 / 56 (85.7%) | 95.1% |     95.1% |
...
| `CRT/MFC library`    |     2,247 |  206,138 | FID-identified, statically linked                 |
| `jump thunks`        |     1,677 |    8,378 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
