...
**Overall (vs full engine): 2,306 / 3,964 functions exact (58.17%) &middot; 72.17% fuzzy &middot; 72.17% fuzzy max.**
...
_Started units alone: 2,306/3,950 fns exact, 71.97% fuzzy over 1,080,948 of 1,077,888 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   258 | 1,316 / 2,367 (55.6%) | 69.3% |     69.3% |
| `DDrawMgr`    |    27 |     282 / 506 (55.7%) | 67.3% |     67.3% |
...
| `CRT/MFC library`    |     2,256 |  207,183 | FID-identified, statically linked                 |
| `jump thunks`        |     1,673 |    8,318 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
