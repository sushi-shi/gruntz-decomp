...
**Overall (vs full engine): 1,812 / 3,279 functions exact (55.26%) &middot; 67.56% fuzzy &middot; 67.56% fuzzy max.**
...
_Started units alone: 1,812/3,276 fns exact, 67.60% fuzzy over 964,832 of 965,465 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,215 / 2,377 (51.1%) | 64.2% |     64.2% |
