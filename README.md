...
**Overall (vs full engine): 912 / 6,510 functions exact (14.01%) &middot; 25.26% fuzzy &middot; 25.26% fuzzy max.**
...
_Started units alone: 912/2,243 fns exact, 34.18% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   120 | 484 / 1,037 (46.7%) | 46.6% |     46.6% |
| `Stub`        |     2 |   118 / 753 (15.7%) |  5.6% |      5.6% |
