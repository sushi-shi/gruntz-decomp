...
**Overall (vs full engine): 1,239 / 7,435 functions exact (16.66%) &middot; 35.17% fuzzy &middot; 35.17% fuzzy max.**
...
_Started units alone: 1,239/3,233 fns exact, 37.45% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   181 | 747 / 1,521 (49.1%) | 52.6% |     52.6% |
| `Stub`        |     4 |  106 / 1,122 (9.4%) |  4.5% |      4.5% |
