...
**Overall (vs full engine): 2,900 / 4,340 functions exact (66.82%) &middot; 73.83% fuzzy &middot; 73.83% fuzzy max.**
...
_Started units alone: 2,900/4,476 fns exact, 73.71% fuzzy over 1,088,297 of 1,086,538 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,731 / 2,769 (62.5%) | 71.4% |     71.4% |
| `DDrawMgr`    |    26 |     366 / 556 (65.8%) | 68.6% |     68.6% |
...
| `CRT/MFC library`    |     2,088 |  199,426 | FID-identified, statically linked                 |
