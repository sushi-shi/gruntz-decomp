...
**Overall (vs full engine): 1,877 / 3,357 functions exact (55.91%) &middot; 65.55% fuzzy &middot; 65.55% fuzzy max.**
...
_Started units alone: 1,877/3,354 fns exact, 65.59% fuzzy over 967,845 of 968,475 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   417 | 1,215 / 2,359 (51.5%) | 62.5% |     62.5% |
