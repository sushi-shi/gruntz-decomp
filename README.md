...
**Overall (vs full engine): 1,813 / 3,451 functions exact (52.54%) &middot; 55.43% fuzzy &middot; 55.43% fuzzy max.**
...
_Started units alone: 1,813/3,394 fns exact, 55.48% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,171 / 2,258 (51.9%) | 60.8% |     60.8% |
