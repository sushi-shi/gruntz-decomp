...
**Overall (vs full engine): 1,140 / 7,092 functions exact (16.07%) &middot; 32.11% fuzzy &middot; 32.11% fuzzy max.**
...
_Started units alone: 1,140/3,238 fns exact, 34.03% fuzzy over 938,607 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   166 | 664 / 1,374 (48.3%) | 51.6% |     51.6% |
| `Stub`        |     4 |  118 / 1,317 (9.0%) |  4.2% |      4.2% |
