...
**Overall (vs full engine): 1,236 / 7,435 functions exact (16.62%) &middot; 34.78% fuzzy &middot; 34.78% fuzzy max.**
...
_Started units alone: 1,236/3,233 fns exact, 37.04% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 744 / 1,509 (49.3%) | 52.3% |     52.3% |
| `Stub`        |     4 |  106 / 1,135 (9.3%) |  4.4% |      4.4% |
