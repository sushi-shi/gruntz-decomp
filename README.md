...
**Overall (vs full engine): 3,547 / 4,399 functions exact (80.63%) &middot; 93.78% fuzzy &middot; 93.87% fuzzy max.**

_Data: objdiff `matched_data` 354,766 of 802,130 B (44.23%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,547/4,362 fns exact, 94.03% fuzzy over 1,135,192 of 1,138,142 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   212 | 2,028 / 2,594 (78.2%) |  93.6% |     93.7% |
...
| `CRT/MFC library`                   |     2,007 |  406,407 | static-lib labels (functions_static_libs, non-LOW)           |
