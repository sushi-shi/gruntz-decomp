...
**Overall (vs full engine): 433 / 6,510 functions exact (6.65%) &middot; 11.31% fuzzy &middot; 11.31% fuzzy max.**
...
_Started units alone: 433/2,238 fns exact, 15.50% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,624 (7.4%) |  3.4% |      3.4% |
