...
**Overall (vs full engine): 485 / 6,510 functions exact (7.45%) &middot; 12.12% fuzzy &middot; 12.12% fuzzy max.**
...
_Started units alone: 485/2,238 fns exact, 16.60% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,538 (7.8%) |  3.5% |      3.5% |
| `Gruntz`      |    49 |  153 / 397 (38.5%) | 32.5% |     32.5% |
