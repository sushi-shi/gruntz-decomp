...
**Overall (vs full engine): 1,822 / 3,289 functions exact (55.40%) &middot; 65.74% fuzzy &middot; 65.74% fuzzy max.**
...
_Started units alone: 1,822/3,286 fns exact, 65.79% fuzzy over 964,904 of 965,537 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   423 | 1,216 / 2,377 (51.2%) | 62.6% |     62.6% |
| `Net`         |    18 |      91 / 145 (62.8%) | 73.7% |     73.7% |
| `Stub`        |     1 |     102 / 132 (77.3%) | 61.8% |     61.8% |
| `Image`       |    15 |      49 / 116 (42.2%) | 84.8% |     84.8% |
| `Dsndmgr`     |     9 |      67 / 101 (66.3%) | 90.5% |     90.5% |
| `Bute`        |     8 |       58 / 98 (59.2%) | 74.1% |     74.1% |
| `zlib-1.0.4`  |    11 |       52 / 55 (94.5%) | 99.5% |     99.5% |
| `Wap32`       |     9 |       44 / 53 (83.0%) | 93.6% |     93.6% |
...
| `CRT/MFC library`    |     2,187 |  200,939 | FID-identified, statically linked                 |
| `jump thunks`        |     1,683 |    8,334 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
