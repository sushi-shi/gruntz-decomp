...
**Overall (vs full engine): 2,432 / 3,995 functions exact (60.88%) &middot; 73.58% fuzzy &middot; 73.74% fuzzy max.**
...
_Started units alone: 2,432/3,988 fns exact, 73.37% fuzzy over 1,081,236 of 1,078,197 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,359 / 2,367 (57.4%) | 71.0% |     71.2% |
| `DDrawMgr`    |    26 |     319 / 516 (61.8%) | 68.3% |     68.5% |
