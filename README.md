...
**Overall (vs full engine): 922 / 6,510 functions exact (14.16%) &middot; 25.74% fuzzy &middot; 25.74% fuzzy max.**
...
_Started units alone: 922/2,244 fns exact, 34.83% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   122 | 492 / 1,044 (47.1%) | 47.0% |     47.0% |
| `Stub`        |     2 |   118 / 743 (15.9%) |  5.7% |      5.7% |
