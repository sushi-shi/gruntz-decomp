...
**Overall (vs full engine): 2,920 / 4,314 functions exact (67.69%) &middot; 94.07% fuzzy &middot; 94.08% fuzzy max.**
...
_Started units alone: 2,920/4,327 fns exact, 92.44% fuzzy over 1,134,118 of 1,114,364 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,644 / 2,574 (63.9%) |  92.2% |     92.2% |
| `DDrawMgr`   |    22 |     391 / 574 (68.1%) |  89.6% |     89.6% |
