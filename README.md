...
**Overall (vs full engine): 3,408 / 4,314 functions exact (79.00%) &middot; 94.39% fuzzy &middot; 94.39% fuzzy max.**
...
**Candidate image: 2,540,544 B vs retail 2,511,872 B (101.14%, +28,672 B).**

| section | retail | candidate | delta | retail bytes reproduced | not measurable |
| :-- | --: | --: | --: | --: | --: |
| `.data` | 763,820 | 837,420 | +73,600 | **10.16%** | 627,628 |
| `.idata` | 15,169 | 15,169 | +0 &check; | **77.54%** | 3,307 |
| `.rdata` | 135,080 | 141,963 | +6,883 | **17.87%** | 66,776 |
| `.reloc` | 113,105 | 113,329 | +224 | **42.81%** | 59,275 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,007,301 | +20,122 | **49.92%** | 58,731 |
| **total** | 3,137,613 | 3,238,442 | +100,829 | **40.71%** | 815,717 |
...
_Independently of where the bytes landed, **36,213 of 36,534 address operands (99.12%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `34aa0b9af084`, linked 2026-08-10 14:13. Regenerate: `ninja candidate`._
<!-- link-score:end -->
