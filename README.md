...
**Overall (vs full engine): 2,463 / 3,995 functions exact (61.65%) &middot; 73.67% fuzzy &middot; 73.81% fuzzy max.**
...
_Started units alone: 2,463/3,993 fns exact, 73.46% fuzzy over 1,081,286 of 1,078,191 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   247 | 1,386 / 2,370 (58.5%) | 71.1% |     71.3% |
| `DDrawMgr`    |    26 |     325 / 518 (62.7%) | 68.5% |     68.6% |
| `Wwd`         |     8 |      88 / 185 (47.6%) | 78.5% |     78.8% |
| `Bute`        |    11 |     100 / 168 (59.5%) | 75.5% |     75.6% |
| `Dsndmgr`     |     5 |     117 / 148 (79.1%) | 93.4% |     93.4% |
| `Net`         |    13 |      96 / 129 (74.4%) | 93.5% |     93.6% |
| `Image`       |    16 |      59 / 125 (47.2%) | 80.9% |     80.9% |
| `Rez`         |     7 |       60 / 76 (78.9%) | 79.2% |     79.3% |
| `zlib-1.0.4`  |    11 |       60 / 63 (95.2%) | 99.5% |     99.5% |
| `DinMgr2`     |     2 |       55 / 60 (91.7%) | 99.4% |     99.4% |
| `Wap32`       |     8 |       47 / 55 (85.5%) | 95.1% |     95.1% |
| `Io`          |     4 |       27 / 39 (69.2%) | 83.9% |     84.0% |
| `Utils`       |     7 |       20 / 22 (90.9%) | 99.7% |     99.7% |
| `Font`        |     1 |       13 / 19 (68.4%) | 78.0% |     78.2% |
...
| `CRT/MFC library`    |     2,248 |  206,145 | FID-identified, statically linked                 |
| `jump thunks`        |     1,676 |    8,377 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
...
include/                      shared headers (mirror retail `incs\`): rva.h (RVA()/DATA()/VTBL()
                              ...
                              Globals.h, and per-class headers under module subdirs
