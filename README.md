...
**Overall (vs full engine): 1,176 / 7,091 functions exact (16.58%) &middot; 33.51% fuzzy &middot; 33.51% fuzzy max.**
...
_Started units alone: 1,176/3,231 fns exact, 35.62% fuzzy over 935,763 of 994,765 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   171 | 701 / 1,441 (48.6%) | 51.6% |     51.6% |
| `Stub`        |     4 |  104 / 1,222 (8.5%) |  4.4% |      4.4% |
