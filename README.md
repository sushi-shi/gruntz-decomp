...
**Overall (vs full engine): 1,250 / 7,435 functions exact (16.81%) &middot; 35.64% fuzzy &middot; 35.64% fuzzy max.**
...
_Started units alone: 1,250/3,233 fns exact, 37.96% fuzzy over 935,843 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   183 | 758 / 1,543 (49.1%) | 53.1% |     53.1% |
| `Stub`        |     4 |  106 / 1,100 (9.6%) |  4.5% |      4.5% |
