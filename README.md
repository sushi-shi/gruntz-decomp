...
**Overall (vs full engine): 1,288 / 3,409 functions exact (37.78%) &middot; 38.62% fuzzy &middot; 38.62% fuzzy max.**
...
_Started units alone: 1,288/3,234 fns exact, 39.79% fuzzy over 934,922 of 963,202 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   190 | 793 / 1,608 (49.3%) | 54.1% |     54.1% |
| `Stub`        |     4 | 104 / 1,026 (10.1%) |  4.5% |      4.5% |
| `Dsndmgr`     |     9 |     63 / 94 (67.0%) | 86.6% |     86.6% |
| `Net`         |     4 |     46 / 85 (54.1%) | 52.4% |     52.4% |
| `Image`       |     6 |     39 / 72 (54.2%) | 84.8% |     84.8% |
| `Bute`        |     5 |     50 / 71 (70.4%) | 75.0% |     75.0% |
...
| `CRT/MFC library`    |     2,182 |  203,650 | FID-identified, statically linked                 |
| `jump thunks`        |     1,575 |    7,871 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
