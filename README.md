...
**Overall (vs full engine): 667 / 6,510 functions exact (10.25%) &middot; 17.57% fuzzy &middot; 17.57% fuzzy max.**
...
_Started units alone: 667/2,242 fns exact, 23.77% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,240 (9.8%) |  4.1% |      4.1% |
| `Gruntz`      |    63 |  305 / 658 (46.4%) | 44.3% |     44.3% |
