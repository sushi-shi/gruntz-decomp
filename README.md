...
**Overall (vs full engine): 893 / 6,510 functions exact (13.72%) &middot; 24.51% fuzzy &middot; 24.51% fuzzy max.**
...
_Started units alone: 893/2,243 fns exact, 33.16% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   116 | 472 / 1,013 (46.6%) | 46.1% |     46.1% |
| `Stub`        |     2 |   118 / 789 (15.0%) |  5.4% |      5.4% |
