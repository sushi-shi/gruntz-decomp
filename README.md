...
**Overall (vs full engine): 1,824 / 3,835 functions exact (47.56%) &middot; 63.58% fuzzy &middot; 63.72% fuzzy max.**
...
_Started units alone: 1,824/3,819 fns exact, 64.18% fuzzy over 1,059,153 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,096 / 2,075 (52.8%) | 68.4% |     68.6% |
