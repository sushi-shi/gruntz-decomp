...
**Data: 99.86% size-weighted across 708,739 B** (`.bss` 99.82%, `.data` 100.00%, `.rdata` 99.96%) &middot; 98.17% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
