...
**Overall (vs full engine): 3,498 / 4,312 functions exact (81.12%) &middot; 93.86% fuzzy &middot; 93.91% fuzzy max.**

**Data: 99.99% size-weighted across 720,835 B** (`.bss` 99.99%, `.data` 100.00%, `.rdata` 99.99%) &middot; 99.76% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
...
_Started units alone: 3,498/4,325 fns exact, 92.20% fuzzy over 1,113,083 of 1,093,329 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   234 | 2,009 / 2,572 (78.1%) |  91.9% |     91.9% |
| `DDrawMgr`   |    22 |     489 / 574 (85.2%) |  88.8% |     88.9% |
| `Wwd`        |     9 |     162 / 214 (75.7%) |  93.6% |     93.6% |
| `Bute`       |     9 |     154 / 191 (80.6%) |  94.2% |     94.2% |
| `Dsndmgr`    |     4 |     144 / 153 (94.1%) |  98.2% |     98.2% |
| `Net`        |    12 |     120 / 134 (89.6%) |  97.7% |     97.8% |
| `Image`      |    12 |      92 / 131 (70.2%) |  93.4% |     93.4% |
...
| `jump thunks`                       |     1,608 |    8,025 | linker ILT jmp-table (RVA <0x7c20) + thunk_*             |
<!-- match-score:end -->
