...
**Overall (vs full engine): 1,272 / 7,435 functions exact (17.11%) &middot; 36.70% fuzzy &middot; 36.70% fuzzy max.**
...
_Started units alone: 1,272/3,234 fns exact, 39.12% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 777 / 1,580 (49.2%) | 53.6% |     53.6% |
| `Stub`        |     4 |  104 / 1,054 (9.9%) |  4.5% |      4.5% |
