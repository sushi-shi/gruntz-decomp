...
**Overall (vs full engine): 439 / 6,510 functions exact (6.74%) &middot; 11.37% fuzzy &middot; 11.37% fuzzy max.**
...
_Started units alone: 439/2,238 fns exact, 15.58% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,614 (7.4%) |  3.4% |      3.4% |
