...
**Overall (vs full engine): 427 / 6,510 functions exact (6.56%) &middot; 11.25% fuzzy &middot; 11.25% fuzzy max.**
...
_Started units alone: 427/2,238 fns exact, 15.42% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,633 (7.3%) |  3.4% |      3.4% |
