...
| **total** | 3,137,613 | 3,239,860 | +102,247 | **41.38%** | 815,679 |
...
_Independently of where the bytes landed, **36,573 of 36,803 address operands (99.38%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `ab3dfdb21866`, linked 2026-08-11 15:03. Regenerate: `ninja candidate`._
<!-- link-score:end -->
