...
**Overall (vs full engine): 1,643 / 3,451 functions exact (47.61%) &middot; 49.39% fuzzy &middot; 49.39% fuzzy max.**
...
_Started units alone: 1,643/3,393 fns exact, 49.44% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   312 | 1,027 / 2,025 (50.7%) | 58.3% |     58.3% |
| `Stub`        |     7 |     108 / 601 (18.0%) |  6.4% |      6.4% |
