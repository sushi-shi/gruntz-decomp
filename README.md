...
**Overall (vs full engine): 955 / 7,098 functions exact (13.45%) &middot; 26.76% fuzzy &middot; 26.76% fuzzy max.**
...
_Started units alone: 955/2,268 fns exact, 36.07% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   135 | 520 / 1,095 (47.5%) | 48.0% |     48.0% |
| `Stub`        |     2 |   118 / 706 (16.7%) |  5.8% |      5.8% |
