...
**Overall (vs full engine): 896 / 6,510 functions exact (13.76%) &middot; 24.60% fuzzy &middot; 24.60% fuzzy max.**
...
_Started units alone: 896/2,243 fns exact, 33.29% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   117 | 475 / 1,018 (46.7%) | 46.2% |     46.2% |
| `Stub`        |     2 |   118 / 784 (15.1%) |  5.4% |      5.4% |
