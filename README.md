...
**Overall (vs full engine): 1,350 / 3,543 functions exact (38.10%) &middot; 38.39% fuzzy &middot; 38.39% fuzzy max.**
...
_Started units alone: 1,350/3,507 fns exact, 38.42% fuzzy over 987,804 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   193 | 832 / 1,671 (49.8%) | 54.5% |     54.5% |
| `Stub`        |     5 |  105 / 1,209 (8.7%) |  4.1% |      4.1% |
