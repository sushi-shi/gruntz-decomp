...
**Overall (vs full engine): 538 / 6,510 functions exact (8.26%) &middot; 13.15% fuzzy &middot; 13.15% fuzzy max.**
...
_Started units alone: 538/2,238 fns exact, 18.02% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,451 (8.1%) |  3.5% |      3.5% |
| `Gruntz`      |    56 |  196 / 465 (42.2%) | 35.7% |     35.7% |
| `zlib-1.0.4`  |    11 |    47 / 50 (94.0%) | 99.4% |     99.4% |
| `Dsndmgr`     |     5 |    32 / 49 (65.3%) | 85.1% |     85.1% |
