...
**Overall (vs full engine): 3,537 / 4,327 functions exact (81.74%) &middot; 95.05% fuzzy &middot; 95.06% fuzzy max.**
...
_Started units alone: 3,537/4,351 fns exact, 93.39% fuzzy over 1,134,668 of 1,114,937 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   232 | 2,019 / 2,586 (78.1%) |  93.0% |     93.0% |
