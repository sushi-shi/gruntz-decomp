...
**Overall (vs full engine): 2,345 / 3,970 functions exact (59.07%) &middot; 73.18% fuzzy &middot; 73.20% fuzzy max.**
...
_Started units alone: 2,345/3,962 fns exact, 72.98% fuzzy over 1,081,116 of 1,078,034 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   257 | 1,335 / 2,368 (56.4%) | 70.6% |     70.6% |
| `DDrawMgr`    |    26 |     299 / 514 (58.2%) | 67.7% |     67.8% |
