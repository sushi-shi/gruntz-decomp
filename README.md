...
**Overall (vs full engine): 3,499 / 4,312 functions exact (81.15%) &middot; 93.86% fuzzy &middot; 93.91% fuzzy max.**

**Data: 99.86% size-weighted across 708,739 B** (`.bss` 99.82%, `.data` 100.00%, `.rdata` 99.96%) &middot; 98.26% of bytes in sections that are exact, which is what objdiff's `matched_data` reports.
...
_Started units alone: 3,499/4,325 fns exact, 92.19% fuzzy over 1,113,083 of 1,093,329 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   233 | 2,009 / 2,572 (78.1%) |  91.9% |     91.9% |
