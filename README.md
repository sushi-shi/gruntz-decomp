...
**Overall (vs full engine): 3,110 / 4,346 functions exact (71.56%) &middot; 78.28% fuzzy &middot; 78.36% fuzzy max.**
...
_Started units alone: 3,110/4,261 fns exact, 78.38% fuzzy over 1,088,827 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,786 / 2,538 (70.4%) | 77.1% |     77.2% |
| `DDrawMgr`    |    26 |     426 / 573 (74.3%) | 71.7% |     71.7% |
