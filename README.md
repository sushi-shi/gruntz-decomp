...
**Overall (vs full engine): 680 / 6,510 functions exact (10.45%) &middot; 19.70% fuzzy &middot; 19.70% fuzzy max.**
...
_Started units alone: 680/2,242 fns exact, 26.66% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,180 (10.3%) |  4.4% |      4.4% |
| `Gruntz`      |    67 |   318 / 718 (44.3%) | 46.5% |     46.5% |
