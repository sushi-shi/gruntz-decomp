...
**Overall (vs full engine): 926 / 6,510 functions exact (14.22%) &middot; 26.09% fuzzy &middot; 26.09% fuzzy max.**
...
_Started units alone: 926/2,244 fns exact, 35.31% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   124 | 494 / 1,052 (47.0%) | 47.3% |     47.3% |
| `Stub`        |     2 |   118 / 730 (16.2%) |  5.8% |      5.8% |
