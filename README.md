...
**Overall (vs full engine): 3,542 / 4,327 functions exact (81.86%) &middot; 95.26% fuzzy &middot; 95.26% fuzzy max.**
...
_Started units alone: 3,542/4,351 fns exact, 93.60% fuzzy over 1,134,668 of 1,114,937 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   214 | 2,017 / 2,582 (78.1%) |  93.3% |     93.3% |
...
| `.reloc` | 113,105 | 113,573 | +468 | **43.21%** | 59,237 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,010,318 | +23,139 | **50.95%** | 58,731 |
| **total** | 3,137,613 | 3,239,825 | +102,212 | **41.38%** | 815,679 |
...
_Independently of where the bytes landed, **36,568 of 36,788 address operands (99.40%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `7fd1adafafcf`, linked 2026-08-11 11:43. Regenerate: `ninja candidate`._
<!-- link-score:end -->
