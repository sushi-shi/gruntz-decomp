...
**Overall (vs full engine): 774 / 6,510 functions exact (11.89%) &middot; 22.89% fuzzy &middot; 22.89% fuzzy max.**
...
_Started units alone: 774/2,242 fns exact, 30.97% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 981 (12.3%) |  5.5% |      5.5% |
