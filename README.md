...
**Overall (vs full engine): 683 / 6,510 functions exact (10.49%) &middot; 20.50% fuzzy &middot; 20.50% fuzzy max.**
...
_Started units alone: 683/2,242 fns exact, 27.74% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,160 (10.4%) |  5.0% |      5.0% |
| `Gruntz`      |    74 |   320 / 733 (43.7%) | 42.0% |     42.0% |
