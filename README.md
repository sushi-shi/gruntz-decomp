...
**Overall (vs full engine): 1,366 / 3,543 functions exact (38.55%) &middot; 38.50% fuzzy &middot; 38.50% fuzzy max.**
...
_Started units alone: 1,366/3,485 fns exact, 38.53% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   196 | 848 / 1,692 (50.1%) | 54.6% |     54.6% |
| `Stub`        |     5 |  105 / 1,166 (9.0%) |  4.1% |      4.1% |
