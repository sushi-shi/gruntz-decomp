...
**Overall (vs full engine): 879 / 6,510 functions exact (13.50%) &middot; 24.36% fuzzy &middot; 24.36% fuzzy max.**
...
_Started units alone: 879/2,243 fns exact, 32.96% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   111 | 461 / 996 (46.3%) | 45.9% |     45.9% |
| `Stub`        |     2 | 118 / 810 (14.6%) |  5.4% |      5.4% |
