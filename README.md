...
**Overall (vs full engine): 3,719 / 4,427 functions exact (84.01%) &middot; 95.09% fuzzy &middot; 95.26% fuzzy max.**
...
_Started units alone: 3,719/4,427 fns exact, 95.14% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,157 / 2,648 (81.5%) |  95.0% |     95.1% |
