...
**Overall (vs full engine): 3,505 / 4,314 functions exact (81.25%) &middot; 94.05% fuzzy &middot; 94.05% fuzzy max.**
...
_Started units alone: 3,505/4,327 fns exact, 92.42% fuzzy over 1,134,118 of 1,114,364 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 2,010 / 2,574 (78.1%) |  92.2% |     92.2% |
| `DDrawMgr`   |    22 |     492 / 574 (85.7%) |  89.1% |     89.1% |
| `Wwd`        |     9 |     163 / 214 (76.2%) |  93.6% |     93.6% |
| `Bute`       |     9 |     155 / 191 (81.2%) |  94.2% |     94.2% |
| `Dsndmgr`    |     4 |     144 / 153 (94.1%) |  98.2% |     98.2% |
| `Net`        |    12 |     121 / 134 (90.3%) |  97.8% |     97.8% |
...
**Candidate image: 2,395,136 B vs retail 2,511,872 B (95.35%, -116,736 B).**

| section | retail | candidate | delta | retail bytes reproduced | not measurable |
| :-- | --: | --: | --: | --: | --: |
| `.data` | 763,820 | 832,108 | +68,288 | **10.16%** | 627,628 |
| `.idata` | 15,169 | 15,169 | +0 &check; | **78.02%** | 3,307 |
| `.rdata` | 135,080 | 142,599 | +7,519 | **17.12%** | 66,776 |
| `.reloc` | 113,105 | 111,028 | -2,077 | **42.68%** | 59,353 |
| `.rsrc` | 123,260 | 0 | -123,260 | - | - |
| `.text` | 1,987,179 | 1,988,296 | +1,117 | **49.67%** | 58,731 |
| **total** | 3,014,353 | 3,089,200 | +74,847 | **38.08%** | 815,795 |
...
_Independently of where the bytes landed, **36,037 of 36,559 address operands (98.57%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `5867d99a9a0d`, linked 2026-08-10 00:51. Regenerate: `ninja candidate`._
<!-- link-score:end -->
