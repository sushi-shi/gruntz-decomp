...
**Overall (vs full engine): 2,472 / 4,001 functions exact (61.78%) &middot; 73.77% fuzzy &middot; 73.91% fuzzy max.**
...
_Started units alone: 2,472/3,993 fns exact, 73.56% fuzzy over 1,081,285 of 1,078,252 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   247 | 1,389 / 2,370 (58.6%) | 71.3% |     71.4% |
