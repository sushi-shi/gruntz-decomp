...
**Overall (vs full engine): 1,550 / 3,451 functions exact (44.91%) &middot; 45.68% fuzzy &middot; 45.68% fuzzy max.**
...
_Started units alone: 1,550/3,393 fns exact, 45.72% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   263 | 940 / 1,883 (49.9%) | 57.7% |     57.7% |
| `Stub`        |     7 |   107 / 763 (14.0%) |  5.2% |      5.2% |
