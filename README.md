...
**Overall (vs full engine): 475 / 6,510 functions exact (7.30%) &middot; 11.74% fuzzy &middot; 11.74% fuzzy max.**
...
_Started units alone: 475/2,238 fns exact, 16.08% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,566 (7.7%) |  3.4% |      3.4% |
| `Gruntz`      |    49 |  143 / 369 (38.8%) | 31.2% |     31.2% |
