...
**Overall (vs full engine): 3,263 / 4,277 functions exact (76.29%) &middot; 85.94% fuzzy &middot; 85.95% fuzzy max.**
...
_Started units alone: 3,263/4,275 fns exact, 84.77% fuzzy over 1,099,303 of 1,084,422 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   242 | 1,858 / 2,543 (73.1%) | 83.6% |     83.6% |
