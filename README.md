...
**Overall (vs full engine): 1,785 / 3,857 functions exact (46.28%) &middot; 67.35% fuzzy &middot; 67.66% fuzzy max.**
...
_Started units alone: 1,785/3,718 fns exact, 67.45% fuzzy over 1,068,147 of 1,069,623 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 908 / 1,903 (47.7%) | 68.7% |     69.0% |
| `Stub`        |    22 |   193 / 660 (29.2%) | 20.6% |     20.7% |
