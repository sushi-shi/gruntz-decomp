...
**Overall (vs full engine): 3,063 / 4,346 functions exact (70.48%) &middot; 77.86% fuzzy &middot; 77.98% fuzzy max.**
...
_Started units alone: 3,063/4,263 fns exact, 77.93% fuzzy over 1,089,137 of 1,090,195 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,765 / 2,539 (69.5%) | 76.5% |     76.7% |
