...
**Overall (vs full engine): 3,245 / 4,301 functions exact (75.45%) &middot; 87.65% fuzzy &middot; 87.99% fuzzy max.**
...
_Started units alone: 3,245/4,297 fns exact, 85.99% fuzzy over 1,114,371 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,825 / 2,557 (71.4%) |  85.3% |     85.6% |
| `DDrawMgr`    |    21 |     457 / 570 (80.2%) |  83.1% |     83.2% |
