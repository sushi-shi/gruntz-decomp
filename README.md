...
**Overall (vs full engine): 475 / 6,510 functions exact (7.30%) &middot; 11.81% fuzzy &middot; 11.81% fuzzy max.**
...
_Started units alone: 475/2,238 fns exact, 16.18% fuzzy over 724,591 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 120 / 1,562 (7.7%) |  3.4% |      3.4% |
| `Gruntz`      |    49 |  143 / 373 (38.3%) | 31.5% |     31.5% |
