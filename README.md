...
**Overall (vs full engine): 3,134 / 4,492 functions exact (69.77%) &middot; 78.40% fuzzy &middot; 78.52% fuzzy max.**
...
_Started units alone: 3,134/4,268 fns exact, 78.60% fuzzy over 1,089,186 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,803 / 2,543 (70.9%) | 77.3% |     77.5% |
| `DDrawMgr`    |    26 |     427 / 573 (74.5%) | 71.8% |     71.8% |
