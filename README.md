...
**Overall (vs full engine): 1,377 / 3,543 functions exact (38.87%) &middot; 38.54% fuzzy &middot; 38.54% fuzzy max.**
...
_Started units alone: 1,377/3,485 fns exact, 38.58% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   199 | 858 / 1,703 (50.4%) | 54.7% |     54.7% |
| `Stub`        |     5 |  105 / 1,154 (9.1%) |  4.1% |      4.1% |
