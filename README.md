...
**Overall (vs full engine): 1,851 / 3,835 functions exact (48.27%) &middot; 63.66% fuzzy &middot; 63.71% fuzzy max.**
...
_Started units alone: 1,851/3,824 fns exact, 64.27% fuzzy over 1,058,943 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,120 / 2,081 (53.8%) | 68.5% |     68.6% |
