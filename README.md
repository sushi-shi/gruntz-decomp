...
**Overall (vs full engine): 923 / 6,510 functions exact (14.18%) &middot; 25.86% fuzzy &middot; 25.86% fuzzy max.**
...
_Started units alone: 923/2,244 fns exact, 34.99% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   123 | 493 / 1,049 (47.0%) | 47.1% |     47.1% |
| `Stub`        |     2 |   118 / 736 (16.0%) |  5.7% |      5.7% |
| `Dsndmgr`     |     8 |     45 / 70 (64.3%) | 84.5% |     84.5% |
| `Bute`        |     4 |     46 / 63 (73.0%) | 75.4% |     75.4% |
| `zlib-1.0.4`  |    11 |     47 / 50 (94.0%) | 99.4% |     99.4% |
| `Net`         |     3 |     22 / 43 (51.2%) | 39.4% |     39.4% |
| `Image`       |     3 |     27 / 41 (65.9%) | 84.2% |     84.2% |
| `Io`          |     3 |     29 / 39 (74.4%) | 77.6% |     77.6% |
| `Wap32`       |     4 |     26 / 36 (72.2%) | 94.5% |     94.5% |
| `DinMgr2`     |     1 |     23 / 27 (85.2%) | 98.1% |     98.1% |
| `Font`        |     1 |     10 / 21 (47.6%) | 34.5% |     34.5% |
| `Crt`         |     4 |     12 / 18 (66.7%) | 94.3% |     94.3% |
| `Utils`       |     5 |     12 / 16 (75.0%) | 76.8% |     76.8% |
| `Rez`         |     1 |      8 / 14 (57.1%) | 74.3% |     74.3% |
| `Wwd`         |     1 |      1 / 10 (10.0%) | 53.8% |     53.8% |
| `DDrawMgr`    |     1 |       3 / 9 (33.3%) | 67.6% |     67.6% |
| `Crypto`      |     1 |       1 / 2 (50.0%) | 99.9% |     99.9% |
| `(unmatched)` |     — |    0 / 4,266 (0.0%) |  0.0% |      0.0% |
<!-- match-score:end -->
