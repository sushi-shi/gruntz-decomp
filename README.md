...
**Overall (vs full engine): 2,200 / 3,834 functions exact (57.38%) &middot; 72.78% fuzzy &middot; 72.78% fuzzy max.**
...
_Started units alone: 2,200/3,824 fns exact, 72.74% fuzzy over 1,068,591 of 1,068,012 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   264 | 1,339 / 2,451 (54.6%) | 70.1% |     70.1% |
