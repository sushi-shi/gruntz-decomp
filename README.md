...
**Overall (vs full engine): 923 / 6,510 functions exact (14.18%) &middot; 25.82% fuzzy &middot; 25.82% fuzzy max.**
...
_Started units alone: 923/2,244 fns exact, 34.93% fuzzy over 733,575 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   123 | 493 / 1,049 (47.0%) | 47.1% |     47.1% |
| `Stub`        |     2 |   118 / 738 (16.0%) |  5.7% |      5.7% |
