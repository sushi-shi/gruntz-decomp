...
**Overall (vs full engine): 3,466 / 4,313 functions exact (80.36%) &middot; 94.54% fuzzy &middot; 94.54% fuzzy max.**
...
_Started units alone: 3,466/4,328 fns exact, 92.89% fuzzy over 1,134,104 of 1,114,348 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,975 / 2,574 (76.7%) |  92.4% |     92.4% |
