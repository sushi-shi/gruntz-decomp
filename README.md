...
**Overall (vs full engine): 1,841 / 3,397 functions exact (54.19%) &middot; 58.07% fuzzy &middot; 58.07% fuzzy max.**
...
_Started units alone: 1,841/3,394 fns exact, 58.11% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   377 | 1,178 / 2,287 (51.5%) | 61.3% |     61.3% |
| `Stub`        |     7 |     133 / 307 (43.3%) | 15.4% |     15.4% |
