...
**Overall (vs full engine): 611 / 6,510 functions exact (9.39%) &middot; 14.60% fuzzy &middot; 14.60% fuzzy max.**
...
_Started units alone: 611/2,239 fns exact, 20.00% fuzzy over 724,687 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 117 / 1,342 (8.7%) |  3.6% |      3.6% |
| `Gruntz`      |    60 |  253 / 553 (45.8%) | 39.3% |     39.3% |
