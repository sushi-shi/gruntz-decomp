...
**Overall (vs full engine): 3,696 / 4,427 functions exact (83.49%) &middot; 94.75% fuzzy &middot; 94.97% fuzzy max.**
...
_Started units alone: 3,696/4,427 fns exact, 94.79% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,152 / 2,652 (81.1%) |  94.6% |     94.8% |
