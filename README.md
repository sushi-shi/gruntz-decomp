...
**Overall (vs full engine): 1,258 / 7,435 functions exact (16.92%) &middot; 36.09% fuzzy &middot; 36.09% fuzzy max.**
...
_Started units alone: 1,258/3,234 fns exact, 38.47% fuzzy over 934,903 of 996,555 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   184 | 761 / 1,556 (48.9%) | 53.0% |     53.0% |
| `Stub`        |     4 |  107 / 1,079 (9.9%) |  4.6% |      4.6% |
