...
**Overall (vs full engine): 859 / 6,510 functions exact (13.20%) &middot; 23.81% fuzzy &middot; 23.81% fuzzy max.**
...
_Started units alone: 859/2,243 fns exact, 32.22% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Gruntz`      |   102 | 447 / 964 (46.4%) | 45.4% |     45.4% |
| `Stub`        |     2 | 118 / 853 (13.8%) |  5.3% |      5.3% |
