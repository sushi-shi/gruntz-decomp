...
**Overall (vs full engine): 3,294 / 4,280 functions exact (76.96%) &middot; 87.59% fuzzy &middot; 87.83% fuzzy max.**
...
_Started units alone: 3,294/4,280 fns exact, 86.01% fuzzy over 1,104,362 of 1,084,462 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,882 / 2,552 (73.7%) |  85.1% |     85.4% |
