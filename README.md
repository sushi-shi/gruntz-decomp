...
**Overall (vs full engine): 247 / 6,371 functions exact (3.88%) &middot; 7.03% fuzzy &middot; 7.03% fuzzy max.**
...
_Started units alone: 247/816 fns exact, 20.23% fuzzy over 344,806 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 388 (0.0%) |   0.4% |      0.4% |
