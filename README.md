...
**Overall (vs full engine): 1,805 / 3,859 functions exact (46.77%) &middot; 67.76% fuzzy &middot; 68.07% fuzzy max.**
...
_Started units alone: 1,805/3,720 fns exact, 67.86% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 924 / 1,920 (48.1%) | 68.9% |     69.2% |
| `Stub`        |    22 |   193 / 638 (30.3%) | 21.6% |     21.7% |
