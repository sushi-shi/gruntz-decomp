...
**Overall (vs full engine): 1,715 / 3,856 functions exact (44.48%) &middot; 64.36% fuzzy &middot; 64.68% fuzzy max.**
...
_Started units alone: 1,715/3,709 fns exact, 65.15% fuzzy over 1,056,730 of 1,069,620 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   325 | 855 / 1,824 (46.9%) | 67.9% |     68.2% |
| `Stub`        |    22 |   193 / 766 (25.2%) | 16.4% |     16.5% |
