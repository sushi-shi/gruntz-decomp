...
**Overall (vs full engine): 195 / 6,349 functions exact (3.07%) &middot; 6.08% fuzzy &middot; 6.08% fuzzy max.**
...
_Started units alone: 195/378 fns exact, 68.47% fuzzy over 88,107 of 991,759 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Gruntz`      |    43 | 84 / 185 (45.4%) |  62.7% |     62.7% |
| `zlib-1.0.4`  |    11 |  47 / 50 (94.0%) |  99.4% |     99.4% |
| `Font`        |     1 |    3 / 31 (9.7%) |   5.8% |      5.8% |
