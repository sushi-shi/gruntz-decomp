...
**Overall (vs full engine): 1,792 / 3,451 functions exact (51.93%) &middot; 55.01% fuzzy &middot; 55.01% fuzzy max.**
...
_Started units alone: 1,792/3,394 fns exact, 55.06% fuzzy over 973,887 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   357 | 1,166 / 2,258 (51.6%) | 60.6% |     60.6% |
| `Stub`        |     7 |     105 / 343 (30.6%) |  9.0% |      9.0% |
