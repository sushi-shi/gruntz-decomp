...
**Overall (vs full engine): 2,685 / 4,191 functions exact (64.07%) &middot; 73.95% fuzzy &middot; 73.99% fuzzy max.**
...
_Started units alone: 2,685/4,189 fns exact, 73.71% fuzzy over 1,083,540 of 1,080,048 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,540 / 2,507 (61.4%) | 71.4% |     71.4% |
...
| `CRT/MFC library`    |     2,237 |  205,916 | FID-identified, statically linked                 |
