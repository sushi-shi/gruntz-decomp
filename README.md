...
**Overall (vs full engine): 1,390 / 3,451 functions exact (40.28%) &middot; 43.67% fuzzy &middot; 43.67% fuzzy max.**
...
_Started units alone: 1,390/3,415 fns exact, 43.70% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   224 | 854 / 1,772 (48.2%) | 56.6% |     56.6% |
| `Stub`        |     5 |   105 / 980 (10.7%) |  5.0% |      5.0% |
