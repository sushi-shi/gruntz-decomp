...
**Overall (vs full engine): 2,767 / 4,492 functions exact (61.60%) &middot; 73.62% fuzzy &middot; 73.63% fuzzy max.**
...
_Started units alone: 2,767/4,263 fns exact, 73.93% fuzzy over 1,087,423 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,579 / 2,539 (62.2%) | 71.6% |     71.7% |
