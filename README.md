...
**Overall (vs full engine): 1,856 / 3,859 functions exact (48.10%) &middot; 68.34% fuzzy &middot; 68.65% fuzzy max.**
...
_Started units alone: 1,856/3,720 fns exact, 68.44% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 951 / 1,961 (48.5%) | 69.1% |     69.4% |
| `Stub`        |    22 |   195 / 578 (33.7%) | 23.2% |     23.3% |
