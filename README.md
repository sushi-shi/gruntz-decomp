...
**Overall (vs full engine): 3,549 / 4,399 functions exact (80.68%) &middot; 93.78% fuzzy &middot; 93.88% fuzzy max.**

_Data: objdiff `matched_data` 556,882 of 802,386 B (69.40%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,549/4,362 fns exact, 94.02% fuzzy over 1,135,192 of 1,138,142 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   205 | 2,040 / 2,608 (78.2%) |  93.6% |     93.7% |
| `DDrawMgr`    |    21 |     507 / 586 (86.5%) |  92.6% |     92.7% |
| `Wwd`         |     7 |     163 / 212 (76.9%) |  95.0% |     95.0% |
