...
**Overall (vs full engine): 1,392 / 3,543 functions exact (39.29%) &middot; 38.74% fuzzy &middot; 38.74% fuzzy max.**
...
_Started units alone: 1,392/3,485 fns exact, 38.77% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   205 | 873 / 1,723 (50.7%) | 54.8% |     54.8% |
| `Stub`        |     5 |  105 / 1,134 (9.3%) |  4.1% |      4.1% |
