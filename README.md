...
**Overall (vs full engine): 667 / 6,510 functions exact (10.25%) &middot; 15.98% fuzzy &middot; 15.98% fuzzy max.**
...
_Started units alone: 667/2,242 fns exact, 21.63% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,250 (9.7%) |  4.0% |      4.0% |
| `Gruntz`      |    63 |  305 / 648 (47.1%) | 39.4% |     39.4% |
