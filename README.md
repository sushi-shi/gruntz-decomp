...
**Overall (vs full engine): 664 / 6,510 functions exact (10.20%) &middot; 15.84% fuzzy &middot; 15.84% fuzzy max.**
...
_Started units alone: 664/2,242 fns exact, 21.43% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |    Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 1,261 (9.6%) |  4.0% |      4.0% |
| `Gruntz`      |    62 |  302 / 637 (47.4%) | 38.9% |     38.9% |
