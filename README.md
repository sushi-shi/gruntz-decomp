...
**Overall (vs full engine): 1,837 / 3,856 functions exact (47.64%) &middot; 63.59% fuzzy &middot; 63.69% fuzzy max.**
...
_Started units alone: 1,837/3,824 fns exact, 64.23% fuzzy over 1,058,943 of 1,069,620 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,107 / 2,081 (53.2%) | 68.4% |     68.6% |
