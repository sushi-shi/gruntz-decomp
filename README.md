...
**Overall (vs full engine): 801 / 6,510 functions exact (12.30%) &middot; 23.17% fuzzy &middot; 23.17% fuzzy max.**
...
_Started units alone: 801/2,242 fns exact, 31.35% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 940 (12.9%) |  5.5% |      5.5% |
| `Gruntz`      |    93 | 413 / 912 (45.3%) | 44.6% |     44.6% |
