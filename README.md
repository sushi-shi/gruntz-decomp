...
**Overall (vs full engine): 2,468 / 3,995 functions exact (61.78%) &middot; 73.75% fuzzy &middot; 73.90% fuzzy max.**
...
_Started units alone: 2,468/3,988 fns exact, 73.55% fuzzy over 1,081,236 of 1,078,197 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,387 / 2,367 (58.6%) | 71.2% |     71.4% |
...
| `Image`       |    16 |      58 / 125 (46.4%) | 80.9% |     81.0% |
