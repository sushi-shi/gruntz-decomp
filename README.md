...
**Overall (vs full engine): 3,298 / 4,298 functions exact (76.73%) &middot; 89.78% fuzzy &middot; 89.79% fuzzy max.**
...
_Started units alone: 3,298/4,289 fns exact, 88.17% fuzzy over 1,113,124 of 1,093,138 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 1,864 / 2,557 (72.9%) |  87.5% |     87.5% |
