...
**Overall (vs full engine): 1,828 / 3,835 functions exact (47.67%) &middot; 63.62% fuzzy &middot; 63.74% fuzzy max.**
...
_Started units alone: 1,828/3,821 fns exact, 64.21% fuzzy over 1,059,228 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,101 / 2,077 (53.0%) | 68.4% |     68.6% |
