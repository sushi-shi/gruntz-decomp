...
**Overall (vs full engine): 993 / 7,098 functions exact (13.99%) &middot; 27.27% fuzzy &middot; 27.27% fuzzy max.**
...
_Started units alone: 993/2,268 fns exact, 36.76% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   156 | 558 / 1,149 (48.6%) | 48.7% |     48.7% |
| `Stub`        |     2 |   118 / 652 (18.1%) |  5.9% |      5.9% |
