...
**Overall (vs full engine): 1,017 / 7,098 functions exact (14.33%) &middot; 27.66% fuzzy &middot; 27.66% fuzzy max.**
...
_Started units alone: 1,017/2,270 fns exact, 37.29% fuzzy over 738,623 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   164 | 581 / 1,185 (49.0%) | 49.1% |     49.1% |
| `Stub`        |     2 |   118 / 616 (19.2%) |  6.0% |      6.0% |
