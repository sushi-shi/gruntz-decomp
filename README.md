...
**Overall (vs full engine): 1,783 / 3,451 functions exact (51.67%) &middot; 52.20% fuzzy &middot; 52.20% fuzzy max.**
...
_Started units alone: 1,783/3,393 fns exact, 52.24% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   341 | 1,161 / 2,225 (52.2%) | 59.7% |     59.7% |
| `Stub`        |     7 |     103 / 391 (26.3%) |  7.3% |      7.3% |
