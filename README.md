...
**Overall (vs full engine): 1,436 / 3,451 functions exact (41.61%) &middot; 44.82% fuzzy &middot; 44.82% fuzzy max.**
...
_Started units alone: 1,436/3,393 fns exact, 44.86% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   247 | 897 / 1,833 (48.9%) | 57.3% |     57.3% |
| `Stub`        |     6 |   105 / 890 (11.8%) |  5.1% |      5.1% |
