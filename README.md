...
**Overall (vs full engine): 1,395 / 3,451 functions exact (40.42%) &middot; 43.85% fuzzy &middot; 43.85% fuzzy max.**
...
_Started units alone: 1,395/3,415 fns exact, 43.89% fuzzy over 974,018 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   232 | 857 / 1,782 (48.1%) | 56.7% |     56.7% |
| `Stub`        |     5 |   105 / 968 (10.8%) |  5.0% |      5.0% |
