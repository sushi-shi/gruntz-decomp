...
**Overall (vs full engine): 1,163 / 7,092 functions exact (16.40%) &middot; 32.73% fuzzy &middot; 32.73% fuzzy max.**
...
_Started units alone: 1,163/3,232 fns exact, 34.80% fuzzy over 935,833 of 994,835 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   168 | 679 / 1,404 (48.4%) | 51.1% |     51.1% |
| `Stub`        |     4 |  119 / 1,270 (9.4%) |  4.5% |      4.5% |
