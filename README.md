...
**Overall (vs full engine): 2,464 / 3,995 functions exact (61.68%) &middot; 73.64% fuzzy &middot; 73.82% fuzzy max.**
...
_Started units alone: 2,464/3,993 fns exact, 73.43% fuzzy over 1,081,286 of 1,078,191 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   247 | 1,387 / 2,370 (58.5%) | 71.1% |     71.3% |
