...
**Data — reconstructable coverage 98.00% &middot; gross coverage 40.45% &middot; fidelity 100.00%** (initialized data; `.bss` 89.16% / 100.00% is reported apart).
