...
**Overall (vs full engine): 764 / 6,510 functions exact (11.74%) &middot; 22.80% fuzzy &middot; 22.80% fuzzy max.**
...
_Started units alone: 764/2,242 fns exact, 30.85% fuzzy over 733,541 of 992,564 engine code bytes._

| Module        | Units |   Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ----: | --------: |
| `Stub`        |     2 | 121 / 993 (12.2%) |  5.5% |      5.5% |
| `Gruntz`      |    87 | 392 / 879 (44.6%) | 44.3% |     44.3% |
