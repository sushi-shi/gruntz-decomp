...
**Overall (vs full engine): 3,499 / 4,310 functions exact (81.18%) &middot; 93.35% fuzzy &middot; 93.37% fuzzy max.**
...
_Started units alone: 3,499/4,321 fns exact, 91.69% fuzzy over 1,113,024 of 1,093,319 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   233 | 2,010 / 2,571 (78.2%) |  91.4% |     91.4% |
| `DDrawMgr`    |    22 |     490 / 574 (85.4%) |  88.1% |     88.1% |
