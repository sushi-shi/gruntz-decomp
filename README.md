...
**Overall (vs full engine): 2,411 / 3,991 functions exact (60.41%) &middot; 73.55% fuzzy &middot; 73.70% fuzzy max.**
...
_Started units alone: 2,411/3,984 fns exact, 73.34% fuzzy over 1,081,201 of 1,078,162 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,353 / 2,366 (57.2%) | 71.0% |     71.2% |
| `DDrawMgr`    |    26 |     306 / 515 (59.4%) | 68.0% |     68.1% |
| `Wwd`         |     8 |      91 / 184 (49.5%) | 78.7% |     78.7% |
