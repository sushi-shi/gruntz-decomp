...
**Overall (vs full engine): 2,317 / 3,962 functions exact (58.48%) &middot; 72.49% fuzzy &middot; 72.51% fuzzy max.**
...
_Started units alone: 2,317/3,951 fns exact, 72.28% fuzzy over 1,080,924 of 1,077,845 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   260 | 1,327 / 2,369 (56.0%) | 69.7% |     69.7% |
| `DDrawMgr`    |    27 |     282 / 506 (55.7%) | 67.3% |     67.3% |
| `Wwd`         |     8 |      88 / 183 (48.1%) | 78.7% |     78.7% |
