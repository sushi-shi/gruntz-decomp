...
**Overall (vs full engine): 3,242 / 4,301 functions exact (75.38%) &middot; 87.55% fuzzy &middot; 87.79% fuzzy max.**
...
_Started units alone: 3,242/4,297 fns exact, 85.89% fuzzy over 1,114,371 of 1,093,222 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   208 | 1,820 / 2,555 (71.2%) |  85.2% |     85.4% |
