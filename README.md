...
**Overall (vs full engine): 2,036 / 3,808 functions exact (53.47%) &middot; 70.68% fuzzy &middot; 70.68% fuzzy max.**
...
_Started units alone: 2,036/3,697 fns exact, 70.83% fuzzy over 1,065,648 of 1,067,765 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   345 | 1,170 / 2,267 (51.6%) | 69.4% |     69.4% |
