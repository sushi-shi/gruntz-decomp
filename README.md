...
**Overall (vs full engine): 1,923 / 3,859 functions exact (49.83%) &middot; 69.03% fuzzy &middot; 69.34% fuzzy max.**
...
_Started units alone: 1,923/3,718 fns exact, 69.16% fuzzy over 1,067,766 of 1,069,721 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   331 | 1,045 / 2,090 (50.0%) | 69.5% |     69.9% |
| `Stub`        |    18 |      97 / 357 (27.2%) | 13.9% |     13.9% |
