...
**Overall (vs full engine): 1,430 / 3,451 functions exact (41.44%) &middot; 44.58% fuzzy &middot; 44.58% fuzzy max.**
...
_Started units alone: 1,430/3,393 fns exact, 44.62% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   239 | 893 / 1,821 (49.0%) | 57.2% |     57.2% |
| `Stub`        |     5 |   105 / 907 (11.6%) |  5.1% |      5.1% |
