...
**Overall (vs full engine): 247 / 6,510 functions exact (3.79%) &middot; 7.14% fuzzy &middot; 7.14% fuzzy max.**
...
_Started units alone: 247/1,064 fns exact, 14.94% fuzzy over 474,031 of 992,564 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 |    0 / 636 (0.0%) |   0.6% |      0.6% |
| `Gruntz`      |    45 | 110 / 232 (47.4%) |  50.9% |     50.9% |
