...
**Overall (vs full engine): 3,661 / 4,427 functions exact (82.70%) &middot; 94.36% fuzzy &middot; 94.49% fuzzy max.**
...
_Started units alone: 3,661/4,427 fns exact, 94.41% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,136 / 2,652 (80.5%) |  94.2% |     94.3% |
