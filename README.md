...
**Overall (vs full engine): 3,123 / 4,492 functions exact (69.52%) &middot; 78.36% fuzzy &middot; 78.49% fuzzy max.**
...
_Started units alone: 3,123/4,268 fns exact, 78.55% fuzzy over 1,089,186 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,797 / 2,543 (70.7%) | 77.3% |     77.4% |
| `DDrawMgr`    |    26 |     426 / 573 (74.3%) | 71.7% |     71.8% |
