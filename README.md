...
**Overall (vs full engine): 3,527 / 4,326 functions exact (81.53%) &middot; 95.75% fuzzy &middot; 95.75% fuzzy max.**
...
_Started units alone: 3,527/4,351 fns exact, 94.08% fuzzy over 1,134,668 of 1,114,867 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   213 | 2,018 / 2,584 (78.1%) |  93.7% |     93.7% |
