...
**Overall (vs full engine): 2,406 / 3,989 functions exact (60.32%) &middot; 73.59% fuzzy &middot; 73.64% fuzzy max.**
...
_Started units alone: 2,406/3,983 fns exact, 73.38% fuzzy over 1,081,219 of 1,078,124 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   248 | 1,354 / 2,366 (57.2%) | 71.1% |     71.1% |
