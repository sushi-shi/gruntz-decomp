...
**Overall (vs full engine): 1,864 / 3,397 functions exact (54.87%) &middot; 60.34% fuzzy &middot; 60.34% fuzzy max.**
...
_Started units alone: 1,864/3,394 fns exact, 60.38% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   388 | 1,194 / 2,311 (51.7%) | 62.2% |     62.2% |
| `Stub`        |     7 |     139 / 280 (49.6%) | 19.4% |     19.4% |
