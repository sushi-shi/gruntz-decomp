...
**Overall (vs full engine): 1,823 / 3,835 functions exact (47.54%) &middot; 63.58% fuzzy &middot; 63.72% fuzzy max.**
...
_Started units alone: 1,823/3,819 fns exact, 64.17% fuzzy over 1,059,153 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,095 / 2,075 (52.8%) | 68.4% |     68.6% |
