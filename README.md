...
**Overall (vs full engine): 945 / 7,098 functions exact (13.31%) &middot; 26.53% fuzzy &middot; 26.53% fuzzy max.**
...
_Started units alone: 945/2,268 fns exact, 35.76% fuzzy over 738,490 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   130 | 510 / 1,081 (47.2%) | 47.7% |     47.7% |
| `Stub`        |     2 |   118 / 720 (16.4%) |  5.8% |      5.8% |
