...
**Overall (vs full engine): 937 / 7,098 functions exact (13.20%) &middot; 26.25% fuzzy &middot; 26.25% fuzzy max.**
...
_Started units alone: 937/2,244 fns exact, 35.62% fuzzy over 733,575 of 995,504 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   129 | 503 / 1,065 (47.2%) | 47.5% |     47.5% |
| `Stub`        |     2 |   118 / 715 (16.5%) |  5.8% |      5.8% |
...
| `Crypto`      |     1 |       3 / 4 (75.0%) | 99.8% |     99.9% |
| `(unmatched)` |     — |    0 / 4,854 (0.0%) |  0.0% |      0.0% |
<!-- match-score:end -->
