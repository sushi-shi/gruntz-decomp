...
**Overall (vs full engine): 1,578 / 3,451 functions exact (45.73%) &middot; 47.34% fuzzy &middot; 47.34% fuzzy max.**
...
_Started units alone: 1,578/3,393 fns exact, 47.38% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   291 | 963 / 1,937 (49.7%) | 58.3% |     58.3% |
| `Stub`        |     7 |   107 / 701 (15.3%) |  5.5% |      5.5% |
