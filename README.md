...
**Overall (vs full engine): 3,700 / 4,427 functions exact (83.58%) &middot; 94.91% fuzzy &middot; 95.08% fuzzy max.**

_Data: objdiff `matched_data` 560,777 of 802,901 B (69.84%) - a per-unit sum (a shared COMDAT counts once per emitting unit), history, never a headline. The coverage/fidelity partition is the data-audit slice's product and is not re-derived here._
...
_Started units alone: 3,700/4,427 fns exact, 94.96% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   201 | 2,151 / 2,648 (81.2%) |  94.8% |     94.9% |
| `DDrawMgr`   |    20 |     523 / 600 (87.2%) |  92.9% |     93.1% |
| `Wwd`        |     7 |     174 / 216 (80.6%) |  96.3% |     96.3% |
| `Bute`       |     7 |     162 / 198 (81.8%) |  95.4% |     97.3% |
| `Dsndmgr`    |     4 |     155 / 161 (96.3%) |  99.7% |     99.7% |
| `Net`        |     9 |     123 / 140 (87.9%) |  97.5% |     97.6% |
| `Image`      |     7 |      80 / 112 (71.4%) |  95.3% |     95.3% |
