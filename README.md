...
**Overall (vs full engine): 1,834 / 3,278 functions exact (55.95%) &middot; 68.56% fuzzy &middot; 68.64% fuzzy max.**
...
_Started units alone: 1,834/3,274 fns exact, 68.66% fuzzy over 963,990 of 965,435 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   426 | 1,257 / 2,417 (52.0%) | 65.2% |     65.3% |
| `Net`         |    18 |      93 / 145 (64.1%) | 86.8% |     86.9% |
