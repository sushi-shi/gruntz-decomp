...
**Overall (vs full engine): 1,562 / 3,451 functions exact (45.26%) &middot; 46.15% fuzzy &middot; 46.15% fuzzy max.**
...
_Started units alone: 1,562/3,393 fns exact, 46.19% fuzzy over 973,883 of 974,757 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   270 | 949 / 1,900 (49.9%) | 58.0% |     58.0% |
| `Stub`        |     7 |   107 / 746 (14.3%) |  5.3% |      5.3% |
