...
**Overall (vs full engine): 3,240 / 4,297 functions exact (75.40%) &middot; 87.49% fuzzy &middot; 87.49% fuzzy max.**
...
_Started units alone: 3,240/4,290 fns exact, 85.91% fuzzy over 1,113,228 of 1,093,131 engine code bytes._

| Module        | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | -----: | --------: |
| `Gruntz`      |   207 | 1,833 / 2,558 (71.7%) |  85.2% |     85.2% |
| `DDrawMgr`    |    21 |     459 / 574 (80.0%) |  83.2% |     83.2% |
