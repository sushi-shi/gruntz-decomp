...
**Overall (vs full engine): 1,396 / 3,543 functions exact (39.40%) &middot; 38.86% fuzzy &middot; 38.86% fuzzy max.**
...
_Started units alone: 1,396/3,485 fns exact, 38.89% fuzzy over 987,669 of 988,543 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   208 | 877 / 1,728 (50.8%) | 54.9% |     54.9% |
| `Stub`        |     5 |  105 / 1,129 (9.3%) |  4.1% |      4.1% |
