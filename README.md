...
**Overall (vs full engine): 221 / 6,367 functions exact (3.47%) &middot; 5.69% fuzzy &middot; 5.69% fuzzy max.**
...
_Started units alone: 221/745 fns exact, 16.74% fuzzy over 337,335 of 991,849 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `Stub`        |     1 |   0 / 350 (0.0%) |   0.4% |      0.4% |
| `Gruntz`      |    36 | 96 / 201 (47.8%) |  39.3% |     39.3% |
