...
**Overall (vs full engine): 3,668 / 4,427 functions exact (82.86%) &middot; 94.26% fuzzy &middot; 94.42% fuzzy max.**
...
_Started units alone: 3,668/4,427 fns exact, 94.31% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,138 / 2,652 (80.6%) |  94.1% |     94.2% |
| `DDrawMgr`   |    19 |     521 / 600 (86.8%) |  92.6% |     92.7% |
