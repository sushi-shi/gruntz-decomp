...
**Overall (vs full engine): 1,842 / 3,397 functions exact (54.22%) &middot; 58.23% fuzzy &middot; 58.23% fuzzy max.**
...
_Started units alone: 1,842/3,394 fns exact, 58.26% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   379 | 1,178 / 2,289 (51.5%) | 61.3% |     61.3% |
| `Stub`        |     7 |     134 / 305 (43.9%) | 15.7% |     15.7% |
