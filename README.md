...
**Overall (vs full engine): 915 / 6,510 functions exact (14.06%) &middot; 25.62% fuzzy &middot; 25.62% fuzzy max.**
...
_Started units alone: 915/2,243 fns exact, 34.66% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   121 | 486 / 1,041 (46.7%) | 46.9% |     46.9% |
| `Stub`        |     2 |   118 / 748 (15.8%) |  5.7% |      5.7% |
