...
**Overall (vs full engine): 1,198 / 7,091 functions exact (16.89%) &middot; 34.04% fuzzy &middot; 34.04% fuzzy max.**
...
_Started units alone: 1,198/3,231 fns exact, 36.19% fuzzy over 935,763 of 994,765 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   180 | 719 / 1,477 (48.7%) | 51.7% |     51.7% |
| `Stub`        |     4 |  103 / 1,178 (8.7%) |  4.3% |      4.3% |
