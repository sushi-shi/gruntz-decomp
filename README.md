...
**Overall (vs full engine): 1,831 / 3,835 functions exact (47.74%) &middot; 63.61% fuzzy &middot; 63.73% fuzzy max.**
...
_Started units alone: 1,831/3,820 fns exact, 64.21% fuzzy over 1,059,185 of 1,069,060 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   343 | 1,102 / 2,076 (53.1%) | 68.4% |     68.6% |
