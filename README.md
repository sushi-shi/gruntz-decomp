...
**Overall (vs full engine): 2,942 / 4,492 functions exact (65.49%) &middot; 77.51% fuzzy &middot; 77.63% fuzzy max.**
...
_Started units alone: 2,942/4,263 fns exact, 77.71% fuzzy over 1,089,137 of 1,091,897 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   245 | 1,689 / 2,539 (66.5%) | 76.3% |     76.4% |
