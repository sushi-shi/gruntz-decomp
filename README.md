...
**Overall (vs full engine): 912 / 6,510 functions exact (14.01%) &middot; 24.85% fuzzy &middot; 24.85% fuzzy max.**
...
_Started units alone: 912/2,243 fns exact, 33.62% fuzzy over 733,545 of 992,564 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   119 | 484 / 1,031 (46.9%) | 46.4% |     46.4% |
| `Stub`        |     2 |   118 / 762 (15.5%) |  5.5% |      5.5% |
