...
**Overall (vs full engine): 1,861 / 3,859 functions exact (48.22%) &middot; 68.37% fuzzy &middot; 68.69% fuzzy max.**
...
_Started units alone: 1,861/3,720 fns exact, 68.47% fuzzy over 1,068,147 of 1,069,721 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Gruntz`      |   326 | 956 / 1,966 (48.6%) | 69.1% |     69.5% |
| `Stub`        |    22 |   195 / 573 (34.0%) | 23.3% |     23.4% |
