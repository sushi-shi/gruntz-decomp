...
**Overall (vs full engine): 1,068 / 7,097 functions exact (15.05%) &middot; 29.54% fuzzy &middot; 29.54% fuzzy max.**
...
_Started units alone: 1,068/3,243 fns exact, 31.31% fuzzy over 939,088 of 995,316 engine code bytes._

| Module        | Units |     Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ----: | --------: |
| `Stub`        |     4 |  118 / 1,484 (8.0%) |  4.0% |      4.0% |
| `Gruntz`      |   166 | 619 / 1,273 (48.6%) | 50.3% |     50.3% |
