...
_Started units alone: 3,450/4,327 fns exact, 92.81% fuzzy over 1,134,118 of 1,114,364 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   232 | 1,966 / 2,574 (76.4%) |  92.3% |     92.3% |
| `DDrawMgr`   |    22 |     498 / 584 (85.3%) |  92.4% |     92.4% |
| `Wwd`        |     9 |     162 / 214 (75.7%) |  93.6% |     93.6% |
| `Bute`       |     9 |     153 / 191 (80.1%) |  94.2% |     94.2% |
| `Dsndmgr`    |     4 |     144 / 153 (94.1%) |  98.2% |     98.2% |
| `Net`        |    12 |     118 / 134 (88.1%) |  97.8% |     97.8% |
| `Image`      |    10 |      88 / 121 (72.7%) |  93.4% |     93.4% |
...
| `.reloc` | 113,105 | 113,413 | +308 | **42.90%** | 59,255 |
| `.rsrc` | 123,260 | 123,260 | +0 &check; | **100.00%** | 0 |
| `.text` | 1,987,179 | 2,008,389 | +21,210 | **50.05%** | 58,731 |
| **total** | 3,137,613 | 3,239,774 | +102,161 | **40.79%** | 815,697 |
...
_Independently of where the bytes landed, **36,266 of 36,580 address operands (99.14%) in paired regions reach the same referent in the same order**. That is the measure a byte diff cannot give and per-object objdiff masks away: it is what catches a wrong string literal or a call to the wrong function._
...
_Candidate `d61d8ca43753`, linked 2026-08-10 16:07. Regenerate: `ninja candidate`._
<!-- link-score:end -->
