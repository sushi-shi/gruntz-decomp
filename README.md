...
**Overall (vs full engine): 396 / 6,371 functions exact (6.22%) &middot; 9.49% fuzzy &middot; 9.49% fuzzy max.**
...
_Started units alone: 396/1,080 fns exact, 19.64% fuzzy over 479,374 of 991,869 engine code bytes._

| Module        | Units |   Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | -----: | --------: |
| `Stub`        |     1 | 111 / 592 (18.8%) |   3.5% |      3.5% |
| `Gruntz`      |    47 | 122 / 252 (48.4%) |  50.1% |     50.1% |
