...
**Overall (vs full engine): 1,863 / 3,397 functions exact (54.84%) &middot; 60.76% fuzzy &middot; 60.76% fuzzy max.**
...
_Started units alone: 1,863/3,394 fns exact, 60.80% fuzzy over 973,887 of 974,514 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   390 | 1,194 / 2,315 (51.6%) | 62.6% |     62.6% |
| `Stub`        |     7 |     138 / 276 (50.0%) | 19.7% |     19.7% |
