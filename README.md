...
**Overall (vs full engine): 1,858 / 3,364 functions exact (55.23%) &middot; 64.40% fuzzy &middot; 64.40% fuzzy max.**
...
_Started units alone: 1,858/3,361 fns exact, 64.44% fuzzy over 970,153 of 970,780 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   416 | 1,204 / 2,359 (51.0%) | 61.9% |     61.9% |
| `Stub`        |     2 |     123 / 197 (62.4%) | 54.5% |     54.5% |
| `Net`         |    19 |      94 / 151 (62.3%) | 62.2% |     62.2% |
...
| `CRT/MFC library`    |     2,116 |  195,686 | FID-identified, statically linked                 |
| `jump thunks`        |     1,676 |    8,300 | linker ILT jmp-table (RVA <0x7c20) + thunk_*      |
<!-- match-score:end -->
