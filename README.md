...
**Overall (vs full engine): 3,673 / 4,427 functions exact (82.97%) &middot; 94.51% fuzzy &middot; 94.67% fuzzy max.**
...
_Started units alone: 3,673/4,427 fns exact, 94.56% fuzzy over 1,136,757 of 1,137,347 engine code bytes._

| Module       | Units |       Functions exact |  Fuzzy | Fuzzy Max |
| :----------- | ----: | --------------------: | -----: | --------: |
| `Gruntz`     |   203 | 2,141 / 2,652 (80.7%) |  94.4% |     94.5% |
