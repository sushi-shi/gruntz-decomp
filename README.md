...
**Overall (vs full engine): 2,311 / 3,961 functions exact (58.34%) &middot; 72.21% fuzzy &middot; 72.22% fuzzy max.**
...
_Started units alone: 2,311/3,950 fns exact, 72.01% fuzzy over 1,080,948 of 1,077,869 engine code bytes._

| Module        | Units |       Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------------: | ----: | --------: |
| `Gruntz`      |   262 | 1,319 / 2,367 (55.7%) | 69.3% |     69.3% |
| `DDrawMgr`    |    27 |     283 / 506 (55.9%) | 67.4% |     67.4% |
| `Wwd`         |     8 |      87 / 183 (47.5%) | 78.4% |     78.4% |
