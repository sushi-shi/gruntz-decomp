...
| kitchenslime-clamp.json | CKitchenSlime::CKitchenSlime 0xb23a0 | 64 | NEGATIVE - all four min/max ternary spellings tie across the three mismatching clamps, spread 96.8709-96.8841 (+0.013). Retail loads the ternary's THEN value first and compares in source order; our cl loads the condition's LEFT operand first and inverts the branch. Not condition-spelling steerable - the residual is the /GX leaf-vptr stamp position + the m_object reload allocation |
