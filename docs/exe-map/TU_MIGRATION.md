...
| `0x008c00` | `?SerializeAnimationState@CWapX@@QAEHPAVCFileMemBase@@W4SerialMode@@W4LogicType` | userlogic | `0x8c00` ? |
...
| `0x00d210` | `?RestoreGameFromFile@@YAHPAVCGruntzMgr@@PAD@Z` | serialobjectfactory | `0xd210` ? |
| `0x00d2a0` | `?GameSerializationCallback@@YAHPAX0W4SerialMode@@W4LogicTypeId@@0@` | serialobjectfactory | `0xd2a0` ? |
...
| `0x0612a0` | `?UpdateDeathAnimation@CGrunt@@QAEHXZ` | gruntbehaviorleaf | `0x612a0` ? |
| `0x061570` | `?UpdateDecayFade@CGrunt@@QAEHXZ` | gruntbehaviorleaf | `0x61570` ? |
...
| `0x0810f0` | `?BuildCellAttributes@CGruntzMapMgr@@QAEHHH@Z` | brickzload | `0x810f0` ? |
...
| `0x0ec670` | `?StepBomberBehavior@CGrunt@@QAEHXZ` | gruntarrivalscan | `0xec670` ? |
| `0x0ecc90` | `?StepBrickLayerBehavior@CGrunt@@QAEHXZ` | gruntbricklayerstep | `0xecc90` ? |
| `0x0ed9f0` | `?StepHitAndRunnerBehavior@CGrunt@@QAEHXZ` | gruntwanderstep | `0xed9f0` ? |
| `0x0ee800` | `?StepDefenderBehavior@CGrunt@@QAEHXZ` | gruntreticlescan | `0xee800` ? |
| `0x0ef6b0` | `?StepDumbChaserBehavior@CGrunt@@QAEHXZ` | gruntchargestep | `0xef6b0` ? |
| `0x0f0130` | `?StepGauntletGruntBehavior@CGrunt@@QAEHXZ` | gruntarrivalupdate | `0xf0130` ? |
...
| `0x0f1c70` | `?StepObjectGuardBehavior@CGrunt@@QAEHXZ` | gruntdefensealt | `0xf1c70` ? |
| `0x0f26f0` | `?StepPostGuardBehavior@CGrunt@@QAEHXZ` | gruntarrivalneighbor | `0xf26f0` ? |
| `0x0f2b20` | `?StepScrollGruntBehavior@CGrunt@@QAEHXZ` | gruntdefensestep | `0xf2b20` ? |
| `0x0f36a0` | `?StepDiggerBehavior@CGrunt@@QAEHXZ` | gruntdiggerstep | `0xf36a0` ? |
| `0x0f42f0` | `?StepSmartChaserBehavior@CGrunt@@QAEHXZ` | gruntscantarget | `0xf42f0` ? |
| `0x0f60f0` | `?StepTimeBomberBehavior@CGrunt@@QAEHXZ` | gruntphasestep | `0xf60f0` ? |
| `0x0f71c0` | `?StepToolThiefBehavior@CGrunt@@QAEHXZ` | gruntseektarget | `0xf71c0` ? |
| `0x0f7d90` | `?StepToyerBehavior@CGrunt@@QAEHXZ` | gruntpeertracking | `0xf7d90` ? |
| `0x0f8240` | `?StepMagicWandGruntBehavior@CGrunt@@QAEHXZ` | gruntdefenselean | `0xf8240` ? |
