...
## Reproduction on the current helper owners

The 2026-09-24 recovery from PR #72 repeats this control on main `520d5b06b`.
The constructor still has source fingerprint `8d7c16b3c71c`; the shared guard
