...
(`AddLogicHit/Attack/Bump`, `SetSoundCueByName`, `SetImageSetByName`, `SetImageFrameByName/Geometry`,
`ResolveLinkedObject`, `CreateNamed_1593e0/1595b0/159a10`, `CreateSprite`, `Find`,
`PruneOrphans`, `SetImageSetByName`, `Read`), so it is worth knowing exactly what does NOT move it:
