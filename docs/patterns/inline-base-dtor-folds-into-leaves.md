# Inline the trivial base dtor so leaf `??1` destructors FOLD the whole base teardown (and pin the base COMDAT with RVA_COMPGEN)
...
RVA_COMPGEN(0x00011290, 0x44, ??1B@@UAE@XZ)
