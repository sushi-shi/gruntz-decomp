...
|---|---|---|---|---|
| `gen/` | generated source metadata: `symbol_names.csv`, signatures, locals, record layouts, enums and globals | `gruntz labels` / `structs` | delink name map plus optional viewer inputs | ~1 MB |
