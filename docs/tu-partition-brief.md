...
Aggregates (`globals`, `vtables`, `engine_label_stubs`) span by construction and are
not compilands — exclude them from band analysis, but they must drain eventually too.
