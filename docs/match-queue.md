...
Totals: 389 labeled-unmatched candidates · 76 READY (leaf, sized, in .text) · 313 blocked/gap.
Excluded: 225 matched · 3219 library(FID) · 0 v1.01-changed.

Order: readiness (unmatched engine callees) → middle-small band (64–512 B) → size. Match top-down.

## READY — middle-small first (24 in 64–512 B band)
...
## BLOCKED / boundary-gap (313) — unlock as deps match
...
…and 193 more (re-run after matches land).
