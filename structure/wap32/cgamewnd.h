#ifndef WAP32_CGAMEWND_H
#define WAP32_CGAMEWND_H

/*
 * WAP32::CGameWnd — engine main-window base (CGruntzWnd derives from this).
 * .?AVCGameWnd@@
 *
 * LAYOUT PORTED FROM tomalla (refs/tomalla-gruntz/wap32/cgamewnd.h), attributed.
 * @address values are for the PATCHED build 1.0.1.77 — approximate for v1.0.0.76.
 * Most vtable slots are tomalla "UnknownVirtualMethodNN" guesses; only
 * QuitMessageLoop (@offset 34) is named.
 */
...
namespace WAP32
{
    ...
    public:
        ...
        //@address: 005ea344 (vftable)   //@todo: most slots
        //@offset: 4
