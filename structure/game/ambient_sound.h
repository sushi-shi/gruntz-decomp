#ifndef GAME_AMBIENT_SOUND_H
#define GAME_AMBIENT_SOUND_H
...
class CAmbientSound       { /* .?AVCAmbientSound@@ */ };
class CAmbientPosSound    { /* .?AVCAmbientPosSound@@ */ };
class CRandomAmbientSound { /* .?AVCRandomAmbientSound@@ */ };

#endif /* GAME_AMBIENT_SOUND_H */
